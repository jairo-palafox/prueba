...
# Modulo       => AEX                                                                              #
# Programa     => AEXL01                                                                           #
# Objetivo     => Lanzador para carga de archivo de Aportaciones Extraordinarias                   #
# Autor        => Omnisys                                                                          #
# Fecha        => 30/07/2020                                                                       #
####################################################################################################
IMPORT os
...
MAIN 
   ...
   LET g_proceso_cod = 501         --se asigna valor al proceso
   LET g_opera_cod   = 1           --se asigna la operacion
   LET v_extension   = "apext"     --se asigna el tipo de extenxion que se tomara de la ruta rescate
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AEXL01.log")

   OPEN WINDOW AEXL01 WITH FORM "AEXL01"
