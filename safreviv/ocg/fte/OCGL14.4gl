...
#                de créditos liquidados enviado por Cartera         #
#                    de Anualidades Garantizadas                    #
#Autor        => Mauro Muñiz Caballero                              #
#Fecha inicio => 7 de abril de 2016                                 #
#####################################################################
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".OCGL14.log")
   ...
   OPEN WINDOW w_integra_arch_cred_liq WITH FORM "OCGL141"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/OCGE11 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
