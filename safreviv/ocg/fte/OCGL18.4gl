...
#Modulo            => OCG                                                     #
#Programa          => OCGL18                                                  #
#Objetivo          => Lanzador para la generación del archivo de marcas 43Bis # 
#Autor             => Emilio Abarca Sánchez, EFP                              #
#Fecha inicio      => 07 de Febrero del 2017                                  #
###############################################################################
...
MAIN 
   ...
   CALL STARTLOG(g_usuario CLIPPED || ".OCGL18.log")
   ...
   OPEN WINDOW vnt1 WITH FORM "OCGL181"
      ...
      MENU ""
         ...
         ON ACTION ACCEPT
            IF (v_fecha_desde = TODAY) THEN 
               CALL fn_mensaje("","El archivo de marcas ya fue generado por el día de hoy","")
               EXIT MENU 
            ELSE 
               -- Se genera el PID
               ...
               ELSE 
                  ...
                  LET v_notifica = "Se ejecutó la generación del archivo de marcas"," \n",
