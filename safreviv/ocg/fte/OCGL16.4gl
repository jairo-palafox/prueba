...
#Modulo             => OCG                                                             #
#Programa           => OCGL08                                                          #
#Objetivo           => Programa Lanzador para arcchivo part 50007  pendientes de       #
#                      formalizar                                                      #
...
MAIN 
   ...
   LET g_proceso_cod   = 3917   -- numero de proceso correspondiente   
   LET g_opera_cod     = 1       -- numero de operacion correspondiente 

       -- se abre la ventana de consulta
   OPEN WINDOW OCGL161 WITH FORM "OCGL161"
...
FUNCTION fn_genera_archivo()
   ...
   {   LET v_estado = 0  #Esto se agregó en el lanzado
