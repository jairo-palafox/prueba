      ...
      ON ACTION ACCEPT
         ...
         LET v_resp = fn_ventana_confirma("",v_mnsj_confirma,"")
           ...
           ELSE
               ...
               -- Recupera información de ocg_formalizacion de acuerdo 
               ...
               DECLARE crsr_1 CURSOR FOR 
                  SELECT frm.id_ocg_formalizacion,
                   ...
                   WHERE frm.id_ocg_formalizacion = mg.id_ocg_referencia
                     ...
                     AND frm.tpo_credito IN (7,8) # Crédito cofinavit.
               ...
               FOREACH crsr_1 INTO v_id_ocg_form, v_id_ocg_det, v_id_ocg_tmt, v_id_dh, v_cve_ef, 
                  ...
                  -- Recupera la fecha de liquidación
                        ...
                        IF(v_monto_acciones IS NOT NULL) THEN
                          ...
                          -- " imp_ap_pat:",v_imp_ap_pat," monto_acciones:", v_monto_acciones, " monto_pesos_cal:", v_monto_pesos
                           ...
                           IF(v_exists_pagados >= 1) THEN
                              ...
                              CONTINUE FOREACH 
                           ELSE
                              -- Conversión periodo_pago a bimestre 
                             ...
                             --DISPLAY "Existe Trans: ", v_exist_ctr
                              ...
                              IF (v_ind_trx = 0) THEN 
                                 ...
                                 -- Verifica en ocg_solicitud_uso_garantia que no exista una petición.
                                 SELECT COUNT(*)
                                    INTO v_peticion_ug
                                ...
                                --DISPLAY "Petición UG: ", v_peticion_ug
               ...
               # Generación del archivo de salida con aportaciones pendientes por pagar a la EF
               # de créditos cofinavit
               ...
               FOREACH csr_sol_sp003 INTO tmp_id_ocg_fz,
                  ...
                  -- Solicitud de uso de garantìa (SP003)
...
FUNCTION Gen_arhs_salida()
   ...
   # Generación del archivo de salida Apoyo Infonavit
