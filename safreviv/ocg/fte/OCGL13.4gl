...
#Módulo       => OCG                                                #
#Programa     => OCGL13                                             #
#Objetivo     => Invoca la carga de créditos liquidados cartera     #
...
MAIN
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "OCGL13",
                           "",p_usuario_cod, TRUE) RETURNING v_rest_valida
   ELSE
