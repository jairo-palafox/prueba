...
#Modulo             => OCG                                                 #
#Programa           => OCGL91                                              #
#Objetivo           => Programa que permite la carga de información  del   #
#                      archivo de migración de datos de detalles de ADS    #
#                      al Sistema de Administración de Créditos 43 bis     #
#                      Saci SAFRE                                          #
...
#Objetivo:
#  Carga de archivo de migración de "detalles" de ADS a Saci SAFRE SAC43Bis
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".OCGL91.log")
   ...
   -- se inicializan variables del módulo
   LET v_d_pid          = 0
   LET v_i_proceso_cod  = 3991
   LET v_i_opera_cod    = 1 -- valida archivo migración detalles
   LET v_d_folio        = 0
   LET p_b_tipo_carga   = 2
   LET v_v_nom_archivo  = NULL
   LET v_c_programa_cod = "OCGL91"
   LET v_r_operacion    = 91
   LET v_r_estado       = 10
...
DISPLAY "Valida: ", r_b_valida
   ...
   IF r_b_valida = 0 THEN      
      ...
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/OCGE91 ",
                                   p_v_usuario     , " ",
                                   v_d_pid         , " ",
                                   v_i_proceso_cod , " ",
                                   v_i_opera_cod   , " ",
