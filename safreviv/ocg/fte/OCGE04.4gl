...
MAIN
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".OCGE04.log")

   CLOSE WINDOW SCREEN 
   
   OPEN WINDOW w_nss WITH FORM "OCGE041"
...
FUNCTION fn_prorroga_cancela(p_nss,p_id_ocg_tramite)
   ...
   LET v_s_qry = " SELECT id_ocg_tramite     ,
                           cve_ent_financiera ,
                           id_derechohabiente ,
                           rfc                ,
                           curp               ,
...
--******************************************************************************
                     ...
                     EXECUTE prp_upd_t USING v_rec_tramite.id_ocg_tramite
