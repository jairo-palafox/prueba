...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".OCGL01.log")
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/OCGP101 ",

      -- Crea el comando que ejecuta el modulo que reliza la insercion del registro de control
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/OCGE01 ",
                                   p_v_usuario     , " ",
                                   v_d_pid         , " ",
                                   v_i_proceso_cod , " ",
                                   v_i_opera_cod   , " ",
      ...
      CALL fn_carga_archivo(v_d_pid, v_i_proceso_cod, v_i_opera_cod, p_b_tipo_carga, v_c_programa_cod, v_s_comando, p_v_usuario, TRUE)
      RETURNING v_b_continua
   ELSE 
