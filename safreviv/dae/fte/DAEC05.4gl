...
CLOSE WINDOW SCREEN  
OPEN WINDOW vtn_AvancePagos WITH FORM "DAEC050"
         ...
         IF v_i_det > 1 THEN
            ...
            ATTRIBUTES (ACCEPT = FALSE, CANCEL = FALSE)
               ...
               ON ACTION Consulta_Derechohabiente
                 ...
                 LET v_comando = "fglrun ../../afi/bin/AFIC01.42r " || p_usuario || "1 'Consulta de Derechohabiente' " || arr_detalles_ajustes [ARR_CURR()].v_nss
                 RUN v_comando
               ...
               ON ACTION reporte
                  IF fgl_report_loadCurrentSettings("DAEC051.4rp") THEN
