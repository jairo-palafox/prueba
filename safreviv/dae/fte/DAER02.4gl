...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = 2400 -- devolucion de operaciones
   ...
   IF(r_bandera = 0)THEN
      ...
      CALL fn_dae_reversa_integracion(p_d_folio)
...
#OBJETIVO: Eliminar los datos almacenados durante la integración
FUNCTION fn_dae_reversa_integracion(p_d_folio)
  DEFINE 
   p_d_folio                 LIKE dis_preliquida.folio_liquida
   --
   DELETE FROM dae_det_solicitud
   ...
   DELETE FROM dae_ctr_archivo_montos
   WHERE  folio = p_d_folio
   AND    estado = 2;  -- integrado
...
END FUNCTION -- fn_dae_reversa_integracion