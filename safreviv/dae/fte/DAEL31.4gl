...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   DISPLAY v_r_arch_pend, v_dte_fechaArchiv
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Atención",
                                  ...
                                  " de Ajuste Individual de Amortizaciones Excedentes?",
                                  "quest") 
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      --Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"DAEL31","",p_usuario_cod)
           RETURNING r_bnd_fin_oper

      IF (r_bnd_fin_oper = 0) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAEP09 ",
