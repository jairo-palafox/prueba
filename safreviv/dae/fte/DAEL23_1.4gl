...
#Modulo           => DAE                                                       #
#Programa         => DAEL08                                                    #
#Objetivo         => Programa lanzador que ejecuta el reverso de la            #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "DAEL230"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         DECLARE cur_folios CURSOR FOR 
                                       ...
                                       WHERE  a.folio = g.folio_referencia
                                       AND    g.proceso_cod = g_proceso_cod
                                       AND    g.status = 1 --Preliquidado
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dae_reverso_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
#OBJETIVO: Ejecuta reverso de preliquidacion de Devolución de Amortizaciones Excedentes
FUNCTION fn_dae_reverso_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAER08 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
