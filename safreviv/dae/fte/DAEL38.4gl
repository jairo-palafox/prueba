...
#Modulo           => DAE                                                       #
#Programa         => DAEL38                                                    #
#Objetivo         => Lanzador del reverso de Liquidación Ajuste Ind DAE        #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DAEL380"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAER14 ",
