...
DEFINE p_pid            LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET g_pid         = p_pid      
   LET g_proceso_cod = 2400 -- Devolución de Amortizaciones Excedentes
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_dae_preliquida(?, ?, ?, ?)"
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_fin(g_pid, g_proceso_cod, g_opera_cod)
         ...
         LET p_mensaje = "=================================================\n",
                         ...
                         "=    Total registros encontrados: ",v_i_total_registros_encontrados,
                         "= \n",
                         "================================================="
   ELSE
      -- Indica que ocurrio
