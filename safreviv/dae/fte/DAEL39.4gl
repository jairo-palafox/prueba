...
#Modulo           => DAE                                                       #
#Programa         => DAEL39                                                    #
#Objetivo         => Lanzador del reverso de Archivo Salida Ajuste Ind DAE     #
...
DEFINE v_proceso_desc    LIKE cat_proceso.proceso_desc,
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DAEL390"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAER15 ",
