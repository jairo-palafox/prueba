...
#Modulo           => DAE                                                       #
#Programa         => DAER14                                                    #
#Objetivo         => Lanzado del reverso de Liquidación Ajuste Ind DAE         #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
       ...
       ,p_folio_liquida        LIKE dis_preliquida.folio_liquida
   ...
   LET p_folio_liquida        = ARG_VAL(5)  --Folio de liquidación
   ...
   END IF
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".DAER14.log")
   ...
   EXECUTE prp_folio_lote INTO v_folio_lote

   DISPLAY "Folio Lote        : ", v_folio_lote
   DISPLAY "Folio Liquidación : ", p_folio_liquida
      
   -- Se invoca rutina para reversar la liquidación.
   CALL fn_reverso_liquidacion(p_folio_liquida)
      RETURNING r_bandera
      DISPLAY r_bandera
   ...
   IF(r_bandera = 0)THEN
      ...
      CALL fn_reverso_reg_cnt(p_folio_liquida)
      RETURNING r_bnd_cnt
   ...
   LET p_titulo = "Finalización de la operación Reverso de Liquidación"
   
   LET p_mensaje = "   Finalización de la operación Reverso de Liquidación","\n",
