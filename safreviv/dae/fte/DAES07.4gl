...
#Modulo       => DAE                                                           #
#Programa     => DAES06                                                        #
#Objetivo     => Lanzado para generar el archivo Ajuste Individual             #
#                Amortizaciones Excedentes                                     #
#Fecha inicio => 10/Mar/2016                                                   #
################################################################################
...
END RECORD 
   ...
   CALL STARTLOG(p_usuario CLIPPED|| ".DAES06.log")
   ...
   LET v_busca_archivo = "AIAE_"||v_d_hoy||"_"
   ...
   LET v_v_nom_archivo = "/"||v_busca_archivo||v_reg_dia||".aidae"
   ...
   LET v_consulta = "\n SELECT b.id_dae_referencia, ",
                    ...
                    "\n        a.nss,               ",
                    "\n        b.monto_pesos,       ", -- agregar fecha pago
                    "\n        b.monto_acciones,    ",
                    "\n        b.folio_liquida,     ",
                    "\n        b.fecha_valor,       ",
                    "\n        b.fecha_liquida,     ",
         ...
         FOREACH cur_dae_det_solicitud INTO rec_detalles_ajuste.v_id_dae_referencia , 
            ...
            IF rec_detalles_ajuste.v_resul_operacion = 1 THEN
               IF rec_detalles_ajuste.v_id_derechohabiente IS NOT NULL OR rec_detalles_ajuste.v_id_dae_referencia IS NOT NULL THEN
                  ...
                  SELECT num_credito, periodo_pago, fecha_pago, registro_pago
                  INTO   rec_detalles_ajuste.v_num_credito,
                         rec_detalles_ajuste.v_periodo_pago,
                         rec_detalles_ajuste.v_fecha_pago,
                         rec_detalles_ajuste.v_registro_pago
            ...
            LET v_s_registro = "02",
                               ...
                               rec_detalles_ajuste.v_fecha_pago USING "YYYYMMDD",
