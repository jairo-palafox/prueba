...
-- Fecha ultima modificacion: 05/Nov/2014 Se cambia el mensaje de finalización
--==============================================================================
...
#Modulo       => DAE                                                           #
#Programa     => DAEL18                                                        #
#Objetivo     => Programa lanzado  de preliquidación de Ajuste Amortizaciones  #
#                Excedentes                                                    #
...
DEFINE p_pid            LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET g_pid         = p_pid      
   LET g_proceso_cod = 2403 --- Ajuste Amortizaciones Excedentes
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_dae_preliquida_ajuste(?, ?, ?)"
