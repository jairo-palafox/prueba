...
#Modulo       => DAE                                                           #
#Programa     => DAEL34                                                        #
#Objetivo     => Lanzador para generar el archivo de Ajuste Individual         #
...
DEFINE p_usuario         LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( bnd_valida_op = 0 ) THEN
      -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,"DAEL34","",p_usuario)
      RETURNING bnd_opera_ini
      IF ( bnd_opera_ini = 0) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAES06 ",
                             p_usuario CLIPPED, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
