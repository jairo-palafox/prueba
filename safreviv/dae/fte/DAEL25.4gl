...
#Modulo           => DAE                                                       #
#Programa         => DAEL25                                                    #
#Objetivo         => Programa lanzador que ejecuta el reverso de la generación #
#                    del archivo del Ajuste de Amortizaciones Excedentes       #    
...
DEFINE v_proceso_desc    LIKE cat_proceso.proceso_desc,
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DAEL250"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dae_reverso_genera_archivo_IMSS(v_folio, p_usuario_cod, v_r_glo_ctr_archivo.v_nombre_archivo)
         EXIT INPUT
...
FUNCTION fn_dae_reverso_genera_archivo_IMSS(p_folio, p_usuario_cod, v_nombre_archivo)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAER10 ",
