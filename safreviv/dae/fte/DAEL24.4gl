...
#Modulo           => DAE                                                       #
#Programa         => DAEL24                                                    #
#Objetivo         => Programa lanzador que ejecuta el reverso de la liquidación#
#                    del Ajuste de Devolución de Amortizaciones Excedentes     #
#Fecha inicio     => 20/03/2014                                                #
################################################################################

--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 
-- 05/Nov/2014 Cambia el orden del folio en combo AG
--==============================================================================
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DAEL240"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         DECLARE cur_folios CURSOR FOR
                                       ...
                                       AND    a.folio = g.folio_referencia
                                       AND    g.status = 2
                                       GROUP BY 1,2
                                       ORDER BY 1 DESC 
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dae_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
#OBJETIVO: Ejecutar el lanzado del reverso de la liquidación.
FUNCTION fn_dae_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET p_usuario_cod = p_usuario_cod CLIPPED

      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DAER09 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
