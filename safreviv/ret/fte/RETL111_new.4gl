...
#                del detalle de retiro por fondo de ahorro                      #
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch -- retiro por fondo de ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoahorro_preliquidacion -- preliquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1110"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         FROM glo_ctr_archivo a,
              glo_folio b
         WHERE a.proceso_cod = g_proceso_cod -- retiros por fondo de ahorro
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida_ret_fondo_ahorro(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquida_ret_fondo_ahorro
Fecha creacion: Febrero 23, 2012
Autor: Erick Rodriguez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros por fondo de ahorro
para un folio dado
...
FUNCTION fn_preliquida_ret_fondo_ahorro(p_folio, p_usuario_cod)
       ...
       IF ( v_i_resultado = 0 ) THEN
         ...
         RETURNING r_resultado_opera
       	IF (r_resultado_opera  = 0) THEN   
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP111 ",
