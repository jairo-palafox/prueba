...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL111"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         FROM glo_ctr_archivo a,
              glo_folio b
         WHERE a.proceso_cod = g_proceso_cod_ret_disposicion -- retiros por disposicion de recursos
       ...
       IF ( v_i_resultado = 0 ) THEN
         ...
         RETURNING r_resultado_opera
       	IF (r_resultado_opera  = 0) THEN   
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP11 ",
