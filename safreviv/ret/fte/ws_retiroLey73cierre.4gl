...
PRIVATE DEFINE fn_cierra_solicitud_retiro_ley73HTTPReq     com.HTTPRequest
PRIVATE DEFINE fn_cierra_solicitud_retiro_ley73HTTPResp    com.HTTPResponse
...
#
# Operation: fn_cierra_solicitud_retiro_ley73
#

#
# FUNCTION: fn_cierra_solicitud_retiro_ley73
#
FUNCTION fn_cierra_solicitud_retiro_ley73(p_nss, p_codigo_rechazo)
  DEFINE	soapStatus		INTEGER
  DEFINE	p_nss		tfn_cierra_solicitud_retiro_ley73_nss
  DEFINE	p_codigo_rechazo		SMALLINT

  LET fn_cierra_solicitud_retiro_ley73.nss = p_nss
  LET fn_cierra_solicitud_retiro_ley73.codigo_rechazo = p_codigo_rechazo

  LET soapStatus = fn_cierra_solicitud_retiro_ley73_g()

  RETURN soapStatus, fn_cierra_solicitud_retiro_ley73Response.nss, fn_cierra_solicitud_retiro_ley73Response.codigo_retorno, fn_cierra_solicitud_retiro_ley73Response.mensaje_retorno
END FUNCTION

#
# FUNCTION: fn_cierra_solicitud_retiro_ley73_g
#   RETURNING: soapStatus
#   INPUT: GLOBAL fn_cierra_solicitud_retiro_ley73
#   OUTPUT: GLOBAL fn_cierra_solicitud_retiro_ley73Response
#
FUNCTION fn_cierra_solicitud_retiro_ley73_g()
  DEFINE wsstatus   INTEGER
  DEFINE retryAuth  INTEGER
  ...
  WHILE retry
    ...
    TRY
      ...
      CALL WSHelper_WriteStaxSOAP11StartEnvelope(writer)
      CALL WSHelper_WriteStaxSOAP11StartBody(writer)
      CALL xml.Serializer.VariableToStax(fn_cierra_solicitud_retiro_ley73,writer)
      CALL WSHelper_WriteStaxSOAP11EndBody(writer)
      CALL WSHelper_WriteStaxSOAP11EndEnvelope(writer)
      CALL request.endXmlRequest(writer)
    CATCH
      ...
      CASE response.getStatusCode()
        ...
        WHEN 200 # SOAP Result
          ...
          IF NOT WSHelper_RetrieveStaxSOAP11Message(reader) THEN
            EXIT CASE
          END IF
          CALL xml.Serializer.StaxToVariable(reader,fn_cierra_solicitud_retiro_ley73Response)
          IF NOT WSHelper_ReadStaxSOAP11EndBody(reader) THEN
            EXIT CASE
          END IF
          IF NOT WSHelper_ReadStaxSOAP11EndEnvelope(reader) THEN
...
FUNCTION fn_cierra_solicitud_retiro_ley73Request_g()
  DEFINE wsstatus   INTEGER
  DEFINE writer     xml.StaxWriter
  ...
  # CHECK PREVIOUS CALL  
  #
  IF fn_cierra_solicitud_retiro_ley73HTTPReq IS NOT NULL AND fn_cierra_solicitud_retiro_ley73HTTPResp IS NULL THEN
    # Request was sent but there was no response yet
    CALL WSHelper_FillSOAP11WSError("Client","Cannot issue a new request until previous response was received")
    RETURN -2 # waiting for the response
  ELSE
  ...
  #
  TRY
    LET fn_cierra_solicitud_retiro_ley73HTTPReq = com.HTTPRequest.Create(RetiroLey73_RetiroLey73PortTypeLocation)
    CALL fn_cierra_solicitud_retiro_ley73HTTPReq.setMethod("POST")
    CALL fn_cierra_solicitud_retiro_ley73HTTPReq.setCharset("UTF-8")
    CALL fn_cierra_solicitud_retiro_ley73HTTPReq.setHeader("SOAPAction","\"\"")
  CATCH
    LET wsstatus = STATUS
    CALL WSHelper_FillSOAP11WSError("Client","Cannot create HTTPRequest")
    LET fn_cierra_solicitud_retiro_ley73HTTPReq = NULL
    RETURN wsstatus
  END TRY
    ...
    #
    TRY
      LET writer = fn_cierra_solicitud_retiro_ley73HTTPReq.beginXmlRequest()
      CALL WSHelper_WriteStaxSOAP11StartEnvelope(writer)
      CALL WSHelper_WriteStaxSOAP11StartBody(writer)
      CALL xml.Serializer.VariableToStax(fn_cierra_solicitud_retiro_ley73,writer)
      CALL WSHelper_WriteStaxSOAP11EndBody(writer)
      CALL WSHelper_WriteStaxSOAP11EndEnvelope(writer)
      CALL fn_cierra_solicitud_retiro_ley73HTTPReq.endXmlRequest(writer)
    CATCH
      LET wsstatus = STATUS
      CALL WSHelper_FillSOAP11WSError("Client",SQLCA.SQLERRM)
      LET fn_cierra_solicitud_retiro_ley73HTTPReq = NULL
  ...
  #
  TRY
    LET fn_cierra_solicitud_retiro_ley73HTTPResp = fn_cierra_solicitud_retiro_ley73HTTPReq.getAsyncResponse()
    RETURN 0 # SUCCESS
  CATCH
    LET wsstatus = STATUS
    CALL WSHelper_FillSOAP11WSError("Server",SQLCA.SQLERRM)
...
FUNCTION fn_cierra_solicitud_retiro_ley73Response_g()
  DEFINE wsstatus   INTEGER
  DEFINE reader     xml.StaxReader
  ...
  # CHECK PREVIOUS CALL  
  #
  IF fn_cierra_solicitud_retiro_ley73HTTPReq IS NULL THEN
    # No request was sent
    CALL WSHelper_FillSOAP11WSError("Client","No request has been sent")
    RETURN -1
  END IF
  ...
  TRY
    ...
    # PROCESS RESPONSE
    #
    IF fn_cierra_solicitud_retiro_ley73HTTPResp IS NULL THEN
      # Still no response, try again
      LET fn_cierra_solicitud_retiro_ley73HTTPResp = fn_cierra_solicitud_retiro_ley73HTTPReq.getAsyncResponse()
    END IF
    ...
    END IF
      ...
      CASE fn_cierra_solicitud_retiro_ley73HTTPResp.getStatusCode()

        WHEN 500 # SOAP Fault
          #
          # STAX SOAP FAULT
          #
          LET reader = fn_cierra_solicitud_retiro_ley73HTTPResp.beginXmlResponse() # Begin Streaming Response
          IF NOT WSHelper_ReadStaxSOAP11StartEnvelope(reader) THEN
            EXIT CASE
          END IF
          IF WSHelper_CheckStaxSOAP11Header(reader) THEN
          ...
          END IF
          # End Streaming Response
          CALL fn_cierra_solicitud_retiro_ley73HTTPResp.endXmlResponse(reader)
        ...
        OTHERWISE
          CALL WSHelper_FillSOAP11WSError("Server","HTTP Error "||fn_cierra_solicitud_retiro_ley73HTTPResp.getStatusCode()||" ("||fn_cierra_solicitud_retiro_ley73HTTPResp.getStatusDescription()||")")
  ...
  #
  LET fn_cierra_solicitud_retiro_ley73HTTPReq = NULL
  LET fn_cierra_solicitud_retiro_ley73HTTPResp = NULL
  RETURN wsstatus
END FUNCTION
