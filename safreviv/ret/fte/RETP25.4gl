...
#                para retiro de ley 73 por webservices                                  #
...
DEFINE p_pid                   LIKE bat_ctr_operacion.pid,         -- PID del proceso
   ...
   DISPLAY "Ejecutado rutina de preliquidación de Retiro Ley 73 WS..."
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_preliquida_ley73_ws(?,?,?,?,?)"
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      LET p_titulo = "Preliquidación Retiro Ley 73 WS "
