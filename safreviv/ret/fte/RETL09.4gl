...
#                las solicitudes de solo infonavit de recursos liquidadas               #
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_solo_infonavit -- retiro por solo infonavit de recursos
   LET g_opera_cod   = g_opera_cod_ret_soloInfo_salida_tesoreria -- generacion del archivo de salida para Tesoreria
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL091"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         LET v_s_cadena =   "\n SELECT max(gl.folio)                 ",
                                   "\n FROM   glo_folio gl           ",
                                   "\n       ,ret_solo_infonavit si  ",
                                   "\n WHERE gl.proceso_cod = ", g_proceso_cod  ,
                                   "\n   AND gl.folio  =  si.folio   ",
                                   "\n   AND gl.status  =  2         ",
                                   "\n   AND si.estado_solicitud = 60"
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_genera_salida_ret_solo_infonavit(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_genera_salida_ret_solo_infonavit
Fecha creacion: Abril 23, 2012
Autor: Erick Rodriguez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros solo infonavit 
para un folio dado
...
FUNCTION fn_genera_salida_ret_solo_infonavit(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       WHERE
          ...
          --LET v_nombre_archivo = year(TODAY),MONTH(TODAY) USING "&&",DAY(TODAY) USING "&&"
       ...
       IF ( v_i_resultado = 0 ) THEN
          LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS04 ",
