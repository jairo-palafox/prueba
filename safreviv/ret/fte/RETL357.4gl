...
#Modulo       => RET                                                           #
#Programa     => RETL357                                                       #
#Objetivo     => Invoca la carga de datos para aclaraciones del fondo ahorro   #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_aclara_fa          -- Retiro por fondo ahorro 
   LET g_opera_cod   = g_opera_cod_valida_aclara_fa -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
            ...
            CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL357",
