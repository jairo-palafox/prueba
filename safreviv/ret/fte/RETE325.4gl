#############################################################################
#Módulo          => RET                                                     #        
#Programa        => RETE325.4gl                                             #
#Objetivo        => Programa carga de archivo de marca de embargos          #
#Fecha Inicio    => 1 Diciembre 2014                                        #
#############################################################################
DATABASE safre_viv
GLOBALS 
...
DEFINE p_nom_archivo       STRING,
   ...
   LET v_cadena_registros = p_usuario CLIPPED, ".", "RETE325.log"
   ...
   DISPLAY "Generando tabla temporal tmp_ret_marca_embargo"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_marca_embargo"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_marca_embargo (          ", 
               "\n      nss                     CHAR    (11),   ",
               "\n      estatus_ssv             CHAR    (13),   ",
               "\n      desc_ssv                CHAR    (40),   ",
               "\n      estatus_jfca            CHAR    (14),   ",
   ...
   WHILE ( v_ch_archivo.read([v_registro_archivo.*]) )
       ...
       IF v_reg_archivo > 3 THEN 
           ...
           INSERT INTO tmp_ret_marca_embargo values (v_registro_archivo.*)
