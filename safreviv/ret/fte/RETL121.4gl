...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch             --100 -- RETIRO Fondo ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoahorro_preliquidacion      --1   -- preliquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETR1210"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   -- si se puede hacer el reverso
   IF ( v_resultado = 0 ) THEN
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR121 ",
