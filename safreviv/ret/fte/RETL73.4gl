...
#                las solicitudes de retiro por fortalecimiento al credito liquidadas    #
...
DEFINE p_usuario_cod            LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fortal_credito -- retiro por fortalecimiento al credito
   LET g_opera_cod   = g_opera_cod_ret_FC_salida_tesoreria -- generacion del archivo de salida para Tesoreria
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL731"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_genera_salida_ret_FC(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_genera_salida_ret_FC
Fecha creacion: Febrero 23, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros por fortalecimiento al credito
para un folio dado
...
FUNCTION fn_genera_salida_ret_FC(p_folio, p_usuario_cod)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
             ...
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS74 ",
