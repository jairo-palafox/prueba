...
#                para las aclaraciones del fondo ahorro                                 #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_aclara_fa                   -- ACLARACIONES DEL FONDO DE AHORRO
   LET g_opera_cod   = g_opera_cod_preliquida_aclara_fa      -- preliquidacion
  ...
  AND    b.status      = 0
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL3591"
...
Fecha creacion: Abril 10, 2015
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de Aclaraciones del Fondo ahorro
para un folio dado
...
DEFINE v_i_resultado     SMALLINT 
   ...
   IF ( v_bandera = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                     "RETL359",v_nombre_archivo,p_usuario_cod) RETURNING v_i_resultado
      ...
      IF ( v_i_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP359 ",
