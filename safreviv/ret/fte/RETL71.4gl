...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL711"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida_ret_FC(v_folio, p_usuario_cod)
         EXIT INPUT
...
FUNCTION fn_preliquida_ret_FC(p_folio, p_usuario_cod)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
             ...
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP71 ",
