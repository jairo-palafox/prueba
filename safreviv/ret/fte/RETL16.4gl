...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro -- retiros fondo_ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoAho_salida_tesoreria -- archivo de salida para tesoreria
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL161"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         IF ( v_i_conArch < 1 OR v_r_glo_ctr_archivo.folio IS NULL ) THEN
            CALL fn_mensaje("Atención",
                 "No existen archivos para tesorería generados","info")
            EXIT INPUT
         END IF
      ...
      ON ACTION ACCEPT
        ...
        SELECT MAX(pid)
         ...
         CALL fn_ret_fondoAhorro_reverso_archivo_salida(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_fondoAhorro_reverso_archivo_salida
Fecha creacion: Marzo 01, 2012
Autor: Luis Erick Rodriguez Vázquez, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la creacion de archivo de retiros fondo ahorro
...
FUNCTION fn_ret_fondoAhorro_reverso_archivo_salida(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod,       -- usuario que ejecuta el programa
       p_folio           LIKE glo_folio.folio,               -- folio para preliquidar
       v_mensaje         STRING,
       v_resultado       INTEGER, -- resultado del proceso
       v_s_comando       STRING, -- comando que se ejecutara
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR16 ",
