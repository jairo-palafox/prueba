...
#                    DE ARCHIVO DE SALIDA DE RETIROS GENERICO                                #
##############################################################################################
IMPORT os
DATABASE safre_viv
...
DEFINE p_folio        LIKE glo_folio.folio,
   ...
   ELSE -- se ejecuta la generación de archivo
      ...
      LET v_nom_archivo = "SACI_TRANSF", TODAY USING "yyyymmdd"
      ...
      LET v_sql="\n SELECT rs.id_derechohabiente      ,                 ",
                ...
                "\n AND rs.modalidad_retiro = 9                         ", -- modalidades de retiro que no son fondo de ahorro
      ...
      LET v_comando = "cp ",v_v_ruta_nomarch," ",v_c_ruta_env_acr CLIPPED,"/SACI_TRANSF.TXT"
      ...
      LET v_comando = "shasum ", v_c_ruta_env_acr CLIPPED, "/SACI_TRANSF.TXT > ", v_c_ruta_env_acr CLIPPED, "/SACI_TRANSF.KEY"
      DISPLAY "\n\n ==== Generando hash del archivo SACI_TRANSF.TXT ==="
      DISPLAY v_comando
      RUN v_comando 
      DISPLAY "Finalizado..."
