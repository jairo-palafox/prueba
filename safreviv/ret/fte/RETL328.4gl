...
#                del detalle de retiro de fondo ahorro contingente combinado            #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_rest_pago_vencido_fondo_ahorro_integra -- integracion
   ...
   CALL fn_drgandrop_integra_devol_comb(p_usuario_cod)
END MAIN

FUNCTION fn_drgandrop_integra_devol_comb(p_usuario_cod)
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n WHERE proceso_cod = ", g_proceso_cod_ret_rest_pago_vencido_fondo_ahorro
                    ,"\n   AND opera_cod   = ", g_opera_rest_pago_vencido_fondo_ahorro_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL3281"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_rest_fondo_ahorro"
...
Ejecuta la integracion de retiros de fondo ahorro
para un folio dado
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                "RETL328",v_archivo,p_usuario_cod) RETURNING r_resultado_opera
              
      IF( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP328 ",
