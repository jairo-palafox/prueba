...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR141.log")

   DISPLAY "Ejecutando rutina de reverso de integración..."
   DISPLAY "PID             : ", g_pid           
   ...
   LET v_ls_SqlQry = "EXECUTE PROCEDURE sp_ret_rev_int_ley73_cont(?,?,?,?)"
   PREPARE ex_desmarc_cuenta FROM v_ls_SqlQry
   EXECUTE ex_desmarc_cuenta USING p_d_folio, p_marca, g_proceso_cod, p_nombre_archivo
