...
#Modulo       => RET                                                                    #
#Programa     => RETL262                                                                #
#Objetivo     => Lanzador del reverso de la carga de archivo de SPESS                   #
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_carga_spes -- retiros fortalecimiento al credito
   LET g_opera_cod   = g_opera_cod_ret_carga_spes_carga -- carga de archivo
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL2621"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_SPESS_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_SPESS_reverso_carga_archivo
Fecha creacion: Marzo 08, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la carga de archivo de retiros por fortalecimiento
al credito
...
FUNCTION fn_ret_SPESS_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   AND    opera_cod = g_opera_cod_ret_transf_integracion
   ...
   -- LET v_resultado = fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod) se quita esta validacion a peticion de Benjamin Rodriguez
  LET v_resultado = 0 
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR262 ",
