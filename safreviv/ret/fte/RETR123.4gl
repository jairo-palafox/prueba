...
#Modulo       => RET                                                                    #
#Programa     => RETR123                                                                #
#Objetivo     => Programa que ejecuta el reverso de la carga de archivo de retiros por  #
#                fondo de ahorro                                                        #
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR123.log")

   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch -- retiros por fondo de ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoahorro_carga  -- carga
