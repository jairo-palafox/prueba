...
#                del detalle del archivo CANINT                                         #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_canint           -- Proceso CANINT
   LET g_opera_cod   = g_opera_cod_integra_canint -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod,       -- usuario que ejecuta el programa
       ...
       l_i_tot_reg        DECIMAL(7,0),                      -- total de registros en archivo
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_valida_canint --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL3321"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT total_registros"
                            ,"\n FROM safre_tmp:tmp_ret_sum_canint"
      ...
      --ON ACTION ACCEPT
         ...
         CALL fn_ventana_confirma("Retiros",
              "¿Desea ejecutar el proceso de Integración de Carga del Archivo\n"||
              " CANINT?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           LET l_v_arch_proceso = l_arr_integrados[1].nom_archivo 
           CALL fn_ret_ejecuta_integracion_canint(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_canint
Fecha creacion: Febrero 18, 2015
Autor: Ricardo Perez, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion del archivo CANINT
para un folio dado
...
FUNCTION fn_ret_ejecuta_integracion_canint(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
         ...
         IF( r_resultado_opera = 0 ) THEN
           LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP332 ",
