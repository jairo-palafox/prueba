...
#                     de retiros rechazados por FICO de fondo de ahorro        #
#Autor             =>                                                          #
#Fecha inicio      => 06 Noviemvre 2013                                        #
################################################################################
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_ret_generico_72fico     # 1542 Restitución de fondo de ahorro rechazo fico
   LET g_opera_cod   = g_opera_cod_valida_rechazo_fico # 1    Preliquidacion
   ...
   LET v_consulta = "     SELECT NVL(COUNT(*),0)", 
                    ...
                    "  \n AND  cod_rechazo = 64",
                    "  \n AND modalidad_retiro = 2" # 2 = fondo de ahorro
   PREPARE prp_conteo_solicitudes FROM v_consulta
  
   # se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM g_reg_modulo.ruta_exp CLIPPED||"/RETL3041"
...
#Descripcion       =>                                                          #
#Autor             =>                                                          #
#Fecha inicio      => 06 de Noviembre de 2013                                    #
################################################################################
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, # usuario que ejecuta el programa
   ...
   IF ( v_estado_operacion = 0 ) THEN
      ...
      IF ( v_bandera = 0 ) THEN
         ...
         IF( v_bandera = 0 ) THEN
            LET v_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP300 ",
