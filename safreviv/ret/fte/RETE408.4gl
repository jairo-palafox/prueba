...
#Módulo          => RET                                                     #        
#Programa        => RETE408                                                 #
#Objetivo        => Programa carga de archivo de marca de embargos con nuevo#
#                   layout.                                                 #
...
DEFINE p_nom_archivo       STRING,
       ...
       v_registro_archivo  RECORD    -- registro del archivo
           ...
           tpo_proceso             CHAR( 4),
           tpo_marca               CHAR( 4),
           doc_contable            CHAR(11),
           ejercicio_fiscal        CHAR( 4),
           campo_vacio1            CHAR(10),
           campo_vacio2            CHAR(10),
           campo_vacio3            CHAR(10),
           campo_vacio4            CHAR(10)
        END RECORD,
   ...
   LET v_cadena_registros = p_usuario CLIPPED, ".", "RETE408.log"
   ...
   DISPLAY "Generando tabla temporal tmp_ret_marca_embargo_todas"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_marca_embargo_todas"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_marca_embargo_todas (    ", 
               "\n      nss                     CHAR    (11),   ",
               "\n      tpo_proceso             CHAR    (13),   ",
               "\n      tpo_marca               CHAR    (40),   ",
               "\n      doc_contable            CHAR    (14),   ",
               "\n      ejercicio_fiscal        CHAR    (40)    ",
               "\n      );                                      "
   ...
   WHILE ( v_ch_archivo.read([v_registro_archivo.*]) )
       ...
       IF v_reg_archivo > 0 THEN 
           ...
           INSERT INTO tmp_ret_marca_embargo_todas(nss             ,
                                                   tpo_proceso     ,
                                                   tpo_marca       ,
                                                   doc_contable    ,
                                                   ejercicio_fiscal)
                                            VALUES(v_registro_archivo.nss             ,
                                                   v_registro_archivo.tpo_proceso     ,
                                                   v_registro_archivo.tpo_marca       ,
                                                   v_registro_archivo.doc_contable    ,
                                                   v_registro_archivo.ejercicio_fiscal)
