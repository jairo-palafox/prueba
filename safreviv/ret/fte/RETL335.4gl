...
#Modulo       => RET                                                                    #
#Programa     => RETL335                                                                #
#Objetivo     => Lanzador del reverso de integracion del archivo CANINT                 #
#                                                                                       #
#Fecha inicio > Febrero 26, 2015                                                        #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod   = g_proceso_canint           -- CANINT
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL3351"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_CANINT_reverso_integracion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_CANINT_reverso_integracion
...
FUNCTION fn_ret_CANINT_reverso_integracion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR335 ",
