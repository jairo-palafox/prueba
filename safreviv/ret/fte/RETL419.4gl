...
#                de la carga de datos historicos de retiro Ley 73 contracargos          #
#Fecha inicio => Marzo 21, 2013                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_ley73_anexo_1_contracargos -- contracargos historico de retiro ley 73
   LET g_opera_cod   = g_opera_ley73_anexo_1_contracargos_integra -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n WHERE proceso_cod = ", g_proceso_cod
                    ,"\n   AND opera_cod   = ", g_opera_cod_ret_his_ley73_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL4191"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_ley73_contracargo_his_anexo1"
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros",
              ...
              " de datos Contracargos Historicos de Retiro Ley 73?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           LET l_v_arch_proceso = l_arr_integrados[1].nom_archivo 
           CALL fn_ret_ejecuta_integracion_his_ley73(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_his_ley73
Fecha creacion: Marzo 21, 2013
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de carga de datos historicos de retiro
ley 73 Contracargos
...
FUNCTION fn_ret_ejecuta_integracion_his_ley73(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF (  r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP419 ",
