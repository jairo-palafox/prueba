...
#Modulo       => RET                                                                    #
#Programa     => RETL08                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de Retiros por fondo de ahorro  #
#                en webservices
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro -- Retiro fondo de ahorro WS
   LET g_opera_cod   = g_opera_cod_ret_fondoAho_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL080"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         IF ( v_i_conArch < 1 ) THEN
            CALL fn_mensaje("Atención", "No existen folios recientemente liquidados","info")
            EXIT INPUT
         END IF
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_fondo_ahorro_ws_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_fondo_ahorro_ws_reverso_liquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de una devolucion de retiros por disposicion 
de recursos para un folio dado
...
FUNCTION fn_ret_fondo_ahorro_ws_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR04 ",
