...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   END IF
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETL213.log")

   LET g_proceso_cod = g_proceso_cod_ret_carga_his_ley73 -- Anexo 1 L73
   LET g_opera_cod   = g_opera_cod_ret_his_ley73_liquidacion -- liquidacion
