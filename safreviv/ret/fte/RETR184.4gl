...
#                de salida de retiros por disposicion de recursos para Tesoreria        #
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR184.log")
 ...
 -- se cambia el estado de las solicitudes a 100 (rechzada )
   UPDATE ret_disposicion
