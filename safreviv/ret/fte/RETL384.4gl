...
#Modulo        => RET                                                          #
#Programa      => RETL384                                                      #
#Ojetivo       => Programa lanzador de la preliquidacion del archivo de SIAFF. #
...
DEFINE v_proceso_desc        STRING, -- descripcion del proceso
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL3841"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF ( r_resultado_opera  = 0 ) THEN   
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP384 ",
