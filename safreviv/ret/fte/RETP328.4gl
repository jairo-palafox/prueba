...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   --Se contruye el enuncionado SQL-- MLPM moverle a la funcion sql para que tome toooodas las V ok gracias!! :)
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_rest_pago_vencido_fondo_ahorro(?,?,?,?,?)" 
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                      "Proceso      : RESTITUCIÓN DE PAGOS VENCIDOS DEL FONDO AHORRO\n",
...
--      RUN v_s_comando
      ...
      LET p_titulo = "Finalización de operación - RESTITUCIÓN DE PAGOS VENCIDOS DEL FONDO AHORRO - INTEGRACION"
