...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   EXECUTE sid_integradeo USING p_usuario_cod, p_folio, g_pid, p_proceso_cod, '1502'
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : NOTIFICACION DISP_BP_INT\n",
   ...
   LET p_titulo = "Finalización de operación - NOTIFICACION DISP_BP_INT - INTEGRACION"
