...
#                     retiros genéricos amortización voluntarias               #
#Autor             =>                                                          #
...
DEFINE p_pid              LIKE bat_ctr_operacion.pid,         # PID del proceso
   ...
   WHERE  estado_solicitud = 90 AND cod_rechazo = p_cod_rechazo -- listos para restitución de rechazo
   ...
   ELSE -- se ejecuta la restitución de rechazo
      ...
      LET v_consulta = "EXECUTE FUNCTION fn_restitucion_retiros_genericos_excedentes(?,?,?,?,?,?,?,?)"
