...
#                resultado de la consulta de pago de solicitudes hacia CRM              #
#                                                                                       #
#Fecha inicio => Marzo 9, 2018                                                          #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl" 
GLOBALS
...
DEFINE p_usuario_cod        LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   OPEN WINDOW w_consulta WITH FORM "RETL12731"
...
--   AND    modalidad_retiro = 3
   ...
   AND    ((a.estado_solicitud IN (71) -- pagadas 
     OR (a.estado_solicitud = 210 AND a.cod_rechazo IN (64,65,66))))    --22/07/2020 SE AGREGA 66
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL1273","NA",p_usuario_cod)
         RETURNING v_resultado
      
         -- se invoca la ejecucion del programa lanzado
         LET v_s_comando = "nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP1273 ",
