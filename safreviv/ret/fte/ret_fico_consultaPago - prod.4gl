...
FUNCTION consultar_g()
  ...
  IF ConsultaPago_ConsultaPagoHttpService_ConsultaPago_ConsultaPagoHttpPortLocation IS NULL THEN
    LET ConsultaPago_ConsultaPagoHttpService_ConsultaPago_ConsultaPagoHttpPortLocation = "http://10.90.1.31:80/ConsultaPagoAcreedorMediationSapV6Web/sca/ConsultaPago"
  END IF
