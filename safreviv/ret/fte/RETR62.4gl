...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR62.log")

   DISPLAY "Ejecutando rutina de reverso de Liquidación de Retiro Tipo N..."
   ...
   IF ( r_bandera = 0 ) THEN
      LET v_s_sql = " EXECUTE PROCEDURE sp_ret_reverso_liquidacion_tipo_n(?,?)"
