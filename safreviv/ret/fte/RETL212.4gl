...
#                del Retiro Carga Anexo 1 Ley 73                                        #
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_carga_his_ley73 -- carga anexo 1
   LET g_opera_cod   = g_opera_cod_ret_his_ley73_preliquidacion -- preliquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL2121"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         FROM glo_ctr_archivo a,
              glo_folio b
         WHERE a.proceso_cod = g_proceso_cod_ret_carga_his_ley73
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF ( r_resultado_opera  = 0 ) THEN   
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP212 ",
