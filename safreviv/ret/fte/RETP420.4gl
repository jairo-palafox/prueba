...
#                para retiro Anexo 1 Ley 73 Contracargo                                 #
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   DISPLAY "Realizando preliquidación de retiros Anexo 1 Ley 73"
   
   -- se contruye el enuncionado SQL
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_preliquida_his_ley73_contra(?,?,?,?,?)"
   ...
   LET p_titulo = "Finalización de operación - RETIROS ANEXO 1 LEY7 3 CONTRACARGOS - PRELIQUIDACION"
