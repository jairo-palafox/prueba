...
#                del detalle de retiro por disposicion de recursos                      #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_pmg_integracion -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_ret_pmg_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL102"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      --ON ACTION ACCEPT
         ...
         CALL fn_ventana_confirma("Retiros",
              ...
              " de Retiros por disposición de recursos?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           LET l_v_arch_proceso = l_arr_integrados[1].nom_archivo 
           CALL fn_ret_ejecuta_integracion_disposicion(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_disposicion
Fecha creacion: Febrero 22, 2012
Autor: Erick Rodriguez, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de retiros por disposicion de recursos
para un folio dado
...
FUNCTION fn_ret_ejecuta_integracion_disposicion(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
         ...
         IF( r_resultado_opera = 0 ) THEN
           LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP170 ",
