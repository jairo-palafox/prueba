...
#Modulo       => RET                                                                    #
#Programa     => RETR65                                                                 #
#Objetivo     => Programa que ejecuta la rutina de reverso de retiros tipo N            #
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR65.log")
   ...
   DISPLAY "Se inicia el reverso del proceso de Retiros tipo N por inconsistencia de\n",
   ...
   LET v_sql = "EXECUTE FUNCTION fn_ret_tipoN_reverso_inconsistencia(?, ?, ?)"
