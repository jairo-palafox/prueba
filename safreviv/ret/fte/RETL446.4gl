...
#                     FICO de la Notificación de Pagos de Excepciones de       #
#                     la Devolución del SSV                                    #
#Fecha inicio      => 06/12/2017                                               #
################################################################################
...
DEFINE v_usuario         VARCHAR(30), -- Almacena al usuario
   ...
   LET g_proceso_cod = g_proceso_excep_devol_ssv_resp_fico
   LET g_opera_cod = g_opera_resp_excep_devol_ssv_carga
