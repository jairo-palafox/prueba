...
#Modulo       => RET                                                                    #
#Programa     => RETL22                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de Retiros por disposicion      #
#                de recursos
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_disposicion_pmg -- retiros por disposicion de recursos
   LET g_opera_cod   = g_opera_cod_ret_pmg_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1821"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_disposicion_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_disposicion_reverso_liquidacion
Fecha creacion: Erick Rodriguez, 2012
...
FUNCTION fn_ret_disposicion_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR182 ",
