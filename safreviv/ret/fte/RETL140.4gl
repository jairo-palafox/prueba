...
#Modulo       => RET                                                                    #
#Programa     => RETL140                                                                #
#Objetivo     => Lanzador del reverso de la carga de archivo de retiros por Ley 73      #
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_Ley73_arch -- retiros por Ley 73
   LET g_opera_cod   = g_opera_cod_ret_ley73_carga -- carga de archivo
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1401"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   -- se obtiene el maximo pid con el que se cargo el archivo
   SELECT MAX(pid)
   INTO   g_pid
   FROM   bat_ctr_proceso
   WHERE  proceso_cod    = g_proceso_cod
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR140 ",
