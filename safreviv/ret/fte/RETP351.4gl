...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   DISPLAY "Esta es una prueba:::::"
   DISPLAY "fn_ret_integra_but_1 "
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : NOTIFICACION TRAN_BUT_INT\n",
   ...
   LET p_titulo = "Finalización de operación - NOTIFICACION TRAN_BUT_INT - INTEGRACION"
