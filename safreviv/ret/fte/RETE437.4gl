#############################################################################
#Módulo          => RET                                                     #        
#Programa        => RETE437.4gl                                             #
#Objetivo        => Programa de carga de Diferencias SSV Pensionados        #
...
DEFINE p_nom_archivo       STRING,
   ...
   LET v_cadena_registros = p_usuario CLIPPED, ".", "RETE437.log"
   ...
   DISPLAY "Generando tabla temporal tmp_ret_ret_dif_ssv_pensionado"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_dif_ssv_pensionado"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_dif_ssv_pensionado (",
               "\n nss                   CHAR(11),  ",
               "\n marca_ws              CHAR(2),   ",
               "\n marca_credito         CHAR(3),   ",
               "\n marca_operativa       CHAR(3),   ",
   ...
   WHILE ( v_ch_archivo.read([v_registro_archivo.*]) )
      ...
      DISPLAY "Registro leido (NSS): ", v_registro_archivo.nss
         ...
         INSERT INTO tmp_ret_dif_ssv_pensionado values (v_registro_archivo.*)
