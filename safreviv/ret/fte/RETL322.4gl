...
#                de la notificacion de DAPS vencidos                                    #
#Fecha inicio => Septiembre 19, 2014                                                     #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_not_daps_vencidos-- notificacion DAPS vencidos
   LET g_opera_cod   = g_opera_cod_not_dap_vencidos_preliquidacion -- preliquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL3221"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida_ret_not_dap_vencidos(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquida_ret_not_dap_vencidos
Fecha creacion: Diciembre 19, 2013
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros carga de anexo 1 Ley 73
para un folio dado
...
FUNCTION fn_preliquida_ret_not_dap_vencidos(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF ( r_resultado_opera  = 0 ) THEN   
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP322 ",
