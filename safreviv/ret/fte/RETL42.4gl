...
#Modulo       => RET                                                                    #
#Programa     => RETL42                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de Retiros por transferencia    #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL421"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         SELECT a.nombre_archivo, g.folio
           FROM glo_folio g LEFT OUTER JOIN glo_ctr_archivo a
             ON a.folio = g.folio
          WHERE g.proceso_cod = g_proceso_cod_ret_transferencia
            --AND g.opera_cod = 4
            AND g.status = 2
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_transferencia_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_transferencia_reverso_liquidacion
Fecha creacion: Marzo 06, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de retiros por transferencia
para un folio dado
...
FUNCTION fn_ret_transferencia_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR42 ",
