...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR142.log")

   --LET g_proceso_cod = g_proceso_cod_ret_Ley73 -- retiro por Ley 73 cont
   --LET g_opera_cod   = g_opera_cod_ret_disp_preliquidacion  -- preliquidacion

     --WHENEVER SQLERROR CONTINUE
      LET v_s_qry = " EXECUTE PROCEDURE sp_ret_reverso_preliquidacion_ley73_cont(?,?)"
