...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   ELSE
      ...
      DISPLAY "Código SQL : ", v_i_resultado
      DISPLAY "Código ISAM: ", v_error_isam
   ...
   LET p_titulo = "Finalización de operación - RETIROS SOLO INFONAVIT (CONTINGENCIA) - PRELIQUIDACION"
