...
DEFINE p_pid              LIKE bat_ctr_operacion.pid,         # PID del proceso
   ...
   LET p_titulo = "Preliquidación restitución retiro genérico voluntarias"
   ...
   LET v_consulta = "EXECUTE FUNCTION fn_restitucion_retiros_genericos_voluntarias(?,?,?,?,?,?,?)"
