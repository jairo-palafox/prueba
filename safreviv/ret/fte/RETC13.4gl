...
Descrip: CONSULTA SALDOS INSUFICIENTES EN SOLICITUDES DE RETIRO POR DISPOSiCION
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario
   ...
   OPEN WINDOW w_consulta_saldos WITH FORM "RETC131"
   LET  v_ventana = UI.WINDOW.GETCURRENT()
   CALL v_ventana.SETTEXT("Consulta Saldos Insuficientes Disposicion")
   ...
   INPUT v_folio, v_afore, v_nss, v_variacion, v_f_inicial, v_f_final 
      ...
      BEFORE INPUT 
         ...
         SELECT a.*
         FROM   glo_folio a
         WHERE  a.proceso_cod = g_proceso_cod_ret_disposicion
         AND    a.status >= 1
         ORDER BY folio DESC
      ...
      ON ACTION ACCEPT
         ...
         LET v_query_agrupador = "\n SELECT DISTINCT b.folio                         ,",
                                 ...
                                 "\n AND gf.proceso_cod = ", g_proceso_cod_ret_disposicion,
                                 "\n AND gf.status >= 0                               "
         ...
         OPEN WINDOW w_detalle_consulta_saldos WITH FORM "RETC132"
         ...
         ATTRIBUTES ( UNBUFFERED )
            ...
            DISPLAY ARRAY v_arr_agrupador TO tbl_grupo_afore.*
               BEFORE ROW
                  ...
                  FOREACH cur_detalle INTO arr_reg_sds.folio,arr_reg_sds.id_solicitud,
                  arr_reg_sds.f_carga,arr_reg_sds.afore_cod,arr_reg_sds.afore_desc,
                  arr_reg_sds.nss,arr_reg_sds.nombre_trab,arr_reg_sds.paterno_trab,
                  arr_reg_sds.materno_trab,arr_reg_sds.aivs92_sol,arr_reg_sds.aivs97_sol,
                  arr_reg_sds.precio_fondo

                     -- se obtiene el saldo de la subcuenta de vivienda 92 de la tabla de insuficiencia
                     SELECT saldo_acciones,
                            saldo_pesos
                     INTO   arr_reg_sds.aivs92_sdo,
                            arr_reg_sds.aivs92_sdo_pesos
                     FROM   ret_his_saldo
                     WHERE  id_solicitud = arr_reg_sds.id_solicitud
                     AND    folio        = arr_reg_sds.folio
                     AND    subcuenta    = 8
                     
                     -- se obtiene el saldo de la subcuenta de vivienda 97 de la tabla de insuficiencia
                     SELECT saldo_acciones,
                            saldo_pesos
                     INTO   arr_reg_sds.aivs97_sdo,
                            arr_reg_sds.aivs97_sdo_pesos
                     FROM   ret_his_saldo
                     WHERE  id_solicitud = arr_reg_sds.id_solicitud
                     AND    folio        = arr_reg_sds.folio
                     AND    subcuenta    = 4
                     ...
                     SELECT saldo_acciones,
                            saldo_pesos
                     INTO   arr_reg_sds.aivsvol_sdo,
                            arr_reg_sds.aivsvol_sdo_pesos
                     FROM   ret_his_saldo
                     WHERE  id_solicitud = arr_reg_sds.id_solicitud
                     AND    folio        = arr_reg_sds.folio
                     AND    subcuenta    = 55
                     ...
                     IF ( arr_reg_sds.aivs92_sdo IS NULL ) THEN
                        LET arr_reg_sds.aivs92_sdo = 0
                        LET arr_reg_sds.aivs92_sdo_pesos = 0
                     ELSE
                        LET arr_reg_sds.aivs92_sdo_pesos = arr_reg_sds.aivs92_sdo * arr_reg_sds.precio_fondo
                     END IF


                     IF ( arr_reg_sds.aivs97_sdo IS NULL ) THEN
                        LET arr_reg_sds.aivs97_sdo = 0
                        LET arr_reg_sds.aivs97_sdo_pesos = 0
                     ELSE
                        LET arr_reg_sds.aivs97_sdo_pesos = arr_reg_sds.aivs97_sdo * arr_reg_sds.precio_fondo
                     END IF

                     IF ( arr_reg_sds.aivsvol_sdo IS NULL ) THEN
                        LET arr_reg_sds.aivsvol_sdo = 0
                        LET arr_reg_sds.aivsvol_sdo_pesos = 0
                     ELSE
                        LET arr_reg_sds.aivsvol_sdo_pesos = arr_reg_sds.aivsvol_sdo * arr_reg_sds.precio_fondo
                     END IF

                     LET arr_reg_sds.aivssum97vol_sdo_pesos = arr_reg_sds.aivs97_sdo_pesos + arr_reg_sds.aivsvol_sdo_pesos
                     LET arr_reg_sds.aivssum97vol_sdo       = arr_reg_sds.aivs97_sdo       + arr_reg_sds.aivsvol_sdo
                     
                     -- se calculan los pesos de las AIVs solicitadas
                     LET arr_reg_sds.aivs92_sol_pesos  = (arr_reg_sds.aivs92_sol * arr_reg_sds.precio_fondo)
                     LET arr_reg_sds.aivs97_sol_pesos  = (arr_reg_sds.aivs97_sol * arr_reg_sds.precio_fondo)
                     
                     -- se calculan las diferencias
                     LET arr_reg_sds.aivs92_dif        = arr_reg_sds.aivs92_sol       - arr_reg_sds.aivs92_sdo     
                     LET arr_reg_sds.aivs92_dif_pesos  = arr_reg_sds.aivs92_sol_pesos - arr_reg_sds.aivs92_sdo_pesos
                     
                     LET arr_reg_sds.aivs97_dif        = arr_reg_sds.aivs97_sol       - arr_reg_sds.aivssum97vol_sdo     
                     LET arr_reg_sds.aivs97_dif_pesos  = arr_reg_sds.aivs97_sol_pesos - arr_reg_sds.aivssum97vol_sdo_pesos
                     ...
                     IF v_variacion = 2 OR v_variacion = 3 THEN
                        LET v_aivs_diferencia = arr_reg_sds.aivs92_dif + arr_reg_sds.aivs97_dif
                     ...
                     IF v_es_valido THEN
                        ...
                        LET arr_reg_saldos[v_indice].v_aivs92_sol             = arr_reg_sds.aivs92_sol
                        LET arr_reg_saldos[v_indice].v_aivs97_sol             = arr_reg_sds.aivs97_sol
                        LET arr_reg_saldos[v_indice].v_aivs92_sdo             = arr_reg_sds.aivs92_sdo
                        LET arr_reg_saldos[v_indice].v_aivs92_sdo_pesos       = arr_reg_sds.aivs92_sdo_pesos
                        ...
                        LET arr_reg_saldos[v_indice].v_aivssum97vol_sdo       = arr_reg_sds.aivssum97vol_sdo
                        LET arr_reg_saldos[v_indice].v_aivssum97vol_sdo_pesos = arr_reg_sds.aivssum97vol_sdo_pesos
                        LET arr_reg_saldos[v_indice].v_aivs92_sol_pesos       = arr_reg_sds.aivs92_sol_pesos
                        LET arr_reg_saldos[v_indice].v_aivs97_sol_pesos       = arr_reg_sds.aivs97_sol_pesos
                        LET arr_reg_saldos[v_indice].v_aivs92_dif             = arr_reg_sds.aivs92_dif
                        LET arr_reg_saldos[v_indice].v_aivs92_dif_pesos       = arr_reg_sds.aivs92_dif_pesos
                        LET arr_reg_saldos[v_indice].v_aivs97_dif             = arr_reg_sds.aivs97_dif
                        LET arr_reg_saldos[v_indice].v_aivs97_dif_pesos       = arr_reg_sds.aivs97_dif_pesos
                        ...
                        LET arr_reg_saldos[v_indice].v_afore                  = arr_reg_sds.afore_cod ||" - "|| arr_reg_sds.afore_desc
                        LET arr_reg_saldos[v_indice].v_nombre_trabajador      = arr_reg_sds.nombre_trab CLIPPED||" "||arr_reg_sds.paterno_trab CLIPPED ||" "||arr_reg_sds.materno_trab CLIPPED

                        LET v_indice = v_indice + 1

                     END IF

                     INITIALIZE arr_reg_sds.* TO NULL
            ...
            ON ACTION Exportar
                ...
                LET v_nom_archivo = "DISP_", p_usuario_cod CLIPPED, "_", TODAY USING "yyyymmdd"
                ...
                LET v_s_detalle = TODAY USING "yyyymmdd", "|CVE AFORE|NSS|NOMBRE|AIVS 92 SOLIC|AIVS 97 SOLIC|PESOS 92 SOLIC|",
                                  "PESOS 97 SOLIC|AIVS 92 SALDO|AIVS 97 SALDO|AIVS VOL SALDO|SUM AIVS 97 Y VOL SALDO|PESOS 92 SALDO|PESOS 97 SALDO|",
                                  "PESOS VOL SALDO|SUM PESOS 97 Y VOL SALDO|AIVS 92 DIF|AIVS 97 DIF|PESOS 92 DIF|PESOS 97 DIF|"
                ...
                FOREACH cur_export INTO arr_reg_sds.folio,arr_reg_sds.id_solicitud,
                arr_reg_sds.f_carga,arr_reg_sds.afore_cod,arr_reg_sds.afore_desc,
                arr_reg_sds.nss,arr_reg_sds.nombre_trab,arr_reg_sds.paterno_trab,
                arr_reg_sds.materno_trab,arr_reg_sds.aivs92_sol,arr_reg_sds.aivs97_sol,
                arr_reg_sds.precio_fondo
                      ...
                      IF v_es_valido THEN
                        ...
                        LET arr_export[v_indice].v_f_carga                = arr_reg_sds.f_carga
                        LET arr_export[v_indice].v_nss                    = arr_reg_sds.nss
                        LET arr_export[v_indice].v_aivs92_sol             = arr_reg_sds.aivs92_sol
                        LET arr_export[v_indice].v_aivs97_sol             = arr_reg_sds.aivs97_sol
                        LET arr_export[v_indice].v_aivs92_sdo             = arr_reg_sds.aivs92_sdo
                        LET arr_export[v_indice].v_aivs92_sdo_pesos       = arr_reg_sds.aivs92_sdo_pesos
                        ...
                        LET arr_export[v_indice].v_aivssum97vol_sdo       = arr_reg_sds.aivssum97vol_sdo
                        LET arr_export[v_indice].v_aivssum97vol_sdo_pesos = arr_reg_sds.aivssum97vol_sdo_pesos
                        LET arr_export[v_indice].v_aivs92_sol_pesos       = arr_reg_sds.aivs92_sol_pesos
                        LET arr_export[v_indice].v_aivs97_sol_pesos       = arr_reg_sds.aivs97_sol_pesos
                        LET arr_export[v_indice].v_aivs92_dif             = arr_reg_sds.aivs92_dif
                        LET arr_export[v_indice].v_aivs92_dif_pesos       = arr_reg_sds.aivs92_dif_pesos
                        LET arr_export[v_indice].v_aivs97_dif             = arr_reg_sds.aivs97_dif
                        LET arr_export[v_indice].v_aivs97_dif_pesos       = arr_reg_sds.aivs97_dif_pesos
                        ...
                        LET arr_export[v_indice].v_afore                  = arr_reg_sds.afore_cod ||" - "|| arr_reg_sds.afore_desc
                        LET arr_export[v_indice].v_nombre_trabajador      = arr_reg_sds.nombre_trab CLIPPED||" "||arr_reg_sds.paterno_trab CLIPPED ||" "||arr_reg_sds.materno_trab CLIPPED

                        LET v_s_detalle = arr_reg_sds.afore_cod                                                          ,"|",
                                        arr_export[v_indice].v_nss                                           ,"|",
                                        arr_export[v_indice].v_nombre_trabajador                             ,"|",
                                        arr_export[v_indice].v_aivs92_sol USING "&&&&&&&&&.&&&&&&"           ,"|",
                                        arr_export[v_indice].v_aivs97_sol USING "&&&&&&&&&.&&&&&&"           ,"|",
                                        arr_export[v_indice].v_aivs92_sol_pesos USING "&&&&&&&&&.&&"         ,"|",
                                        arr_export[v_indice].v_aivs97_sol_pesos USING "&&&&&&&&&.&&"         ,"|",
                                        arr_export[v_indice].v_aivs92_sdo USING "&&&&&&&&&.&&&&&&"           ,"|",
                                        ...
                                        arr_export[v_indice].v_aivs92_sdo_pesos USING "&&&&&&&&&.&&"         ,"|",
                                        ...
                                        arr_export[v_indice].v_aivs92_dif USING "&&&&&&&&&.&&&&&&"           ,"|",
                                        arr_export[v_indice].v_aivs97_dif USING "&&&&&&&&&.&&&&&&"           ,"|",
                                        arr_export[v_indice].v_aivs92_dif_pesos USING "&&&&&&&&&.&&"         ,"|",
            ...
            ON ACTION reporte                      
               ...
               FOREACH cur_reporte INTO arr_reg_sds.folio,arr_reg_sds.id_solicitud,
                  arr_reg_sds.f_carga,arr_reg_sds.afore_cod,arr_reg_sds.afore_desc,
                  arr_reg_sds.nss,arr_reg_sds.nombre_trab,arr_reg_sds.paterno_trab,
                  arr_reg_sds.materno_trab,arr_reg_sds.aivs92_sol,arr_reg_sds.aivs97_sol,
                  arr_reg_sds.precio_fondo
                  ...
                  LET v_es_valido = FALSE
                     ...
                     IF v_es_valido THEN
                        ...
                        LET arr_reporte[v_indice].v_aivs92_sol             = arr_reg_sds.aivs92_sol
                        LET arr_reporte[v_indice].v_aivs97_sol             = arr_reg_sds.aivs97_sol
                        LET arr_reporte[v_indice].v_aivs92_sdo             = arr_reg_sds.aivs92_sdo
                        LET arr_reporte[v_indice].v_aivs92_sdo_pesos       = arr_reg_sds.aivs92_sdo_pesos
                        ...
                        LET arr_reporte[v_indice].v_aivssum97vol_sdo       = arr_reg_sds.aivssum97vol_sdo
                        LET arr_reporte[v_indice].v_aivssum97vol_sdo_pesos = arr_reg_sds.aivssum97vol_sdo_pesos
                        LET arr_reporte[v_indice].v_aivs92_sol_pesos       = arr_reg_sds.aivs92_sol_pesos
                        LET arr_reporte[v_indice].v_aivs97_sol_pesos       = arr_reg_sds.aivs97_sol_pesos
                        LET arr_reporte[v_indice].v_aivs92_dif             = arr_reg_sds.aivs92_dif
                        LET arr_reporte[v_indice].v_aivs92_dif_pesos       = arr_reg_sds.aivs92_dif_pesos
                        LET arr_reporte[v_indice].v_aivs97_dif             = arr_reg_sds.aivs97_dif
                        LET arr_reporte[v_indice].v_aivs97_dif_pesos       = arr_reg_sds.aivs97_dif_pesos
                        ...
                        LET arr_reporte[v_indice].v_afore                  = arr_reg_sds.afore_cod ||" - "|| arr_reg_sds.afore_desc
                        LET arr_reporte[v_indice].v_nombre_trabajador      = arr_reg_sds.nombre_trab CLIPPED||" "||arr_reg_sds.paterno_trab CLIPPED ||" "||arr_reg_sds.materno_trab CLIPPED
               ...
               IF ( fgl_report_loadCurrentSettings("../../ret/bin/RETC13.4rp") ) THEN 
               ...
               ELSE         
                  CALL fn_mensaje("Atención","No fue posible generar el reporte. No se encuentra la plantilla RETC13.4rp", "stop")
                  CONTINUE DIALOG
               END IF   
