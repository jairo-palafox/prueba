...
#Módulo        => RET                                                          #        
#Programa      => RETP390                                                      #
#Objetivo      => Programa carga de archivo SIAFF diaria. Para actualizar las  #
#                 solicitudes a 90 con codigo rechazo 66 y a 71.               #
...
DEFINE v_layout            LIKE cat_operacion.layout_cod,
       ...
       --Campos de la tabla ret_respuesta_siaff
   ...
   LET v_cadena_registros = p_usuario CLIPPED, ".", "RETP390.log"
   ...
   DISPLAY "Generando tabla temporal tmp_ret_respuesta_siaff"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_respuesta_siaff"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_respuesta_siaff (            ",
               "\n        des_ramo                 CHAR(100)    ,   ",
               "\n        des_unidad               CHAR(100)    ,   ",
               "\n        uni_folio                CHAR(12)     ,   ",
               "\n        archivo_envio            CHAR(250)    ,   ",
   ...
   WHILE ( v_ch_archivo.read([v_registro_archivo.*]) )
       ...
       IF v_reg_archivo > 0 THEN
           ...
           INSERT INTO tmp_ret_respuesta_siaff values (v_registro_archivo.*)
