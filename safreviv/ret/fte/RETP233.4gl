...
DEFINE p_pid                   LIKE bat_ctr_operacion.pid,         -- PID del proceso
   ...
   -- realizando restitucion de montos no pagados
   DISPLAY "==========================================================\n"   
   DISPLAY "Restitución de retiros no pagados"

   DISPLAY "FOLIO: ", p_folio
 
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_ap_voluntarias_restitucion(?)"

   PREPARE sid_restitucion FROM v_s_sql
   EXECUTE sid_restitucion USING p_folio 
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      LET p_mensaje = "ID Proceso  : ", p_pid, "\n", 
                      "Proceso      : RESTITUCIÓN RETIRO APORTACIONES VOLUNTARIAS\n",
      ...
      LET p_titulo = "Preliquidación Restitución Retiro Aportaciones Voluntarias "
