...
# 13 feb 2014. La tolerancia de sobregiro es 1 AIVs segun requerimiento PRODINF-159     #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
       ...
       ,v_s_comando           STRING --conmando de ejecución del reporte de rechazados
   ...
   --- LET p_max_aivs_sobregiro = 1 -- cambiado por requerimiento
   ...
   DISPLAY "Realizando preliquidación de retiros por Transferencia de recursos"
   DISPLAY "Diferencia máxima de AIVs aceptada: ", p_max_aivs_sobregiro
   
   -- se contruye el enuncionado SQL
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_preliquida_transferencia(?,?,?,?,?,?)"
   ...
   LET v_s_comando = "fglrun RETS21.42r ",p_folio ," ", p_usuario_cod, " 1 0"
   RUN v_s_comando

   DISPLAY "___________________________________________________________________________________"
   DISPLAY "Generando archivo de respuesta para TRM con registros aceptados: "
   LET v_s_comando = "fglrun RETS21.42r ",p_folio ," ", p_usuario_cod, " 0 0"
   RUN v_s_comando
   ...
   LET p_titulo = "Finalización de operación - RETIROS TRANSFERENCIA - PRELIQUIDACION"
