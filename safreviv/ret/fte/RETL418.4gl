...
#Modulo       => RET                                                                    #
#Programa     => RETL418                                                                #
#Objetivo     => Lanzador de la carga de archivo Ley 73 Anexo 1 cargo historico         #
#             => contracargos                                                           #
#Fecha inicio => Marzo 27, 2014                                                         #
#########################################################################################
IMPORT os
DATABASE safre_viv
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_ley73_anexo_1_contracargos -- Ley 73 Anexo 1 Contracargos
   LET g_opera_cod   = g_opera_ley73_anexo_1_contracargos_carga -- Carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo_ret(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL418",
...
DEFINE v_layout          LIKE cat_operacion.layout_cod,
   ...
   CALL STARTLOG(p_usuario CLIPPED||".RETL418.log")
...
display "inicio de before input"
         ...
         ON ACTION ACCEPT           
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETL418",
              ...
              WHERE  modulo_cod = 'ret'
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETE418.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
