...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_his_ley73(?,?,?,?,?)"
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : HISTORICO RETIRO LEY 73\n",
   ...
   LET p_titulo = "Finalización de operación - HISTORICO RETIRO LEY 73 - INTEGRACION"
