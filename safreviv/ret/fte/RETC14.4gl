...
#MODULO       => RET                                                                    #
#PROGRAMA     => RETC14                                                                 #
#OBJETIVO     => Consulta de retiros por disposicion de Recursos                        #
...
DEFINE cbx_tipo_retiro      ui.ComboBox, -- combo de tipo de retiro
   ...
   OPEN WINDOW w_consulta WITH FORM "RETC141"
   ...
   ATTRIBUTES ( UNBUFFERED )
      ...
      BEFORE INPUT
         ...
         DISPLAY "DISPOSICION" TO v_modalidad
         ...
         WHERE    modalidad_retiro = 5 -- disposiciones
         ORDER BY tpo_retiro
         ...
         SELECT a.folio
         FROM   glo_folio a
         WHERE  a.proceso_cod = g_proceso_cod_ret_disposicion -- Disposicion de recursos
         AND    a.status >= 0
         ORDER BY folio DESC
...
DEFINE v_tipo_retiro        LIKE ret_tipo_retiro.tpo_retiro,
   ...
   LET v_sql = "\n SELECT                 ",
               ...
               "\n AND a.folio = b.folio ",
               "\n AND b.proceso_cod = ", g_proceso_cod_ret_disposicion, -- Disposicion recursos
...
{   
   ...
   OPEN WINDOW w_consulta1 WITH FORM "RETC142"
...
{   
   ...
   OPEN WINDOW w_consultadetallada WITH FORM "RETC143"
...
DEFINE v_tipo_retiro        LIKE ret_tipo_retiro.tpo_retiro,
   ...
   LET v_sql = v_sql, "\n afi_derechohabiente b,",
                      ...
                      "\n AND   c.proceso_cod = 1502 ", -- Disposicion PMG
   ...
   DISPLAY "Query Liquidacion", v_sql
   ...
   OPEN WINDOW w_consultapreliq WITH FORM "RETC144"
