...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET v_marca_disposicion = 805      
   LET v_edo_maraca  = 0
   LET v_cod_rechazo = 0
   LET v_caus_marac  = 0


   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR22.log")
   ...
   EXECUTE prp_exec_sp_estatus USING p_i_folio,g_proceso_cod,v_marca_disposicion
