...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_Ley73_arch          --100 -- RETIRO FONDO DE AHORRO
   LET g_opera_cod   = g_opera_cod_ret_ley73_preliquidacion  --1  -- preliquidacion
  ...
  WHERE a.proceso_cod = b.proceso_cod
    ...
    AND b.status      = 0
   --DISPLAY "v_folio, g_proceso_cod -", v_folio, g_proceso_cod
  
   -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1310"
...
Ejecuta la preliquidacion de Retiro Ley 73
para un folio dado
  ...
  IF ( v_bandera = 0 ) THEN
     ...
     --DISPLAY "v_bandera", v_bandera
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                   "RETL131",v_nombre_archivo,p_usuario_cod) RETURNING v_i_resultado
    ...
    IF ( v_i_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP131 ",
