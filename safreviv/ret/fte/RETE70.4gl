...
#Modulo       => RET                                                                    #
#Programa     => RETE70                                                                 #
#Objetivo     => Invoca la carga de datos para retiros por fortalecimiento al credito   #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fortal_credito -- Retiro fortalecimiento al credito
   LET g_opera_cod   = g_opera_cod_ret_FC_carga -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETE70",
