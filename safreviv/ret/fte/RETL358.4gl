...
#                del archivo de Aclaraciones del fondo ahorro                           #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_aclara_fa           -- aclaraciones del fondo ahorro
   LET g_opera_cod   = g_opera_cod_integra_aclara_fa -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       l_i_indice         INT, -- indice del arrego de archivos pendientes
       l_i_tot_reg        INT , -- total de registros en archivo
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_valida_aclara_fa --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL3581"
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                "RETL110",v_archivo,p_usuario_cod) RETURNING r_resultado_opera
              
      IF( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP358 ",
