...
#Modulo       => RET                                                                    #
#Programa     => RETL320                                                                #
#Objetivo     => Invoca la carga de la notificacion de DAPS vencidos                    #
#Fecha inicio => Septiembre 17, 2014                                                         #
#########################################################################################
IMPORT os
DATABASE safre_viv
GLOBALS "RETG01.4gl"
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_not_daps_vencidos -- carga de notificacion de DAPS vencidos
   LET g_opera_cod   = g_opera_cod_not_dap_vencidos_carga -- carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo_ret(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL320",
...
Fecha creacion: Septiembre 19, 2014  
Autor: Ricardo Perez
...
display "inicio de before input"
         ...
         ON ACTION ACCEPT           
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETL320",
              ...
              WHERE  modulo_cod = 'ret'
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETE320.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
