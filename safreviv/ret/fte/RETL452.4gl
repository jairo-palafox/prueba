...
#Modulo       => RET                                                                    #
#Programa     => RETL452                                                                #
#Objetivo     => Lanzador del programa que genera el archivo de salida con              #
#                las solicitudes de Excepciones de Devolucion de la SSV                 #
#Fecha inicio => Agosto 22, 2017                                                        #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_excep_devol_ssv -- Excepciones de Devoluciones de la SSV
   LET g_opera_cod   = g_opera_excep_devol_ssv_respuesta -- generacion del archivo de salida para Tesoreria
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL4521"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_genera_salida(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_genera_salida
Fecha creacion: Agosto 22, 2017
Autor: Ricardo Pérez, EFP
Narrativa del proceso que realiza:
Ejecuta la generación del archivo para FICO de las Excepciones de 
Devolución del SSV
...
FUNCTION fn_genera_salida(p_folio, p_usuario_cod)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       r_resultado_opera   STRING   --codigo de error sfn_actualiza_opera_ini
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
             ...
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS452 ",
