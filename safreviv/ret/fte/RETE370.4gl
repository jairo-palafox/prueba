...
#Módulo          => RET                                                     #        
#Programa        => RETE370                                                 #
#Objetivo        => Programa carga de archivo de marca Z                    #
...
DEFINE p_nom_archivo       STRING,
   ...
   LET v_cadena_registros = p_usuario CLIPPED, ".", "RETE370.log"
   ...
   DISPLAY "Regresa de la funcion fn_monitorea_proceso"
   ...
   DISPLAY "Generando tabla temporal tmp_ret_det_marca_z"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_det_marca_z"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_det_marca_z (          ", 
               "\n      nss                     CHAR    (11),   ",
               "\n      causal_retiro           CHAR    (16),   ",
               "\n      curp                    CHAR    (18),   ",
               "\n      nombre_datamart         CHAR    (50),   ",
       ...
       IF v_reg_archivo > 3 THEN 
           ...
           INSERT INTO tmp_ret_det_marca_z 
                ...
                values (
                        ...
                        v_registro_archivo.causal_retiro,
                        v_registro_archivo.curp,
                        v_registro_archivo.nombre_datamart,
                        v_registro_archivo.sec_pension,
                        v_registro_archivo.tpo_movto,
                        v_registro_archivo.f_solicitud,
                        v_registro_archivo.regimen,
                        v_registro_archivo.semanas_cot,
                        v_registro_archivo.aivs_97,
                        v_registro_archivo.aivs_92,
                        v_registro_archivo.cve_afore);
   ...
   IF ( v_reg_archivo = (v_reg_aceptados + 3)) THEN
