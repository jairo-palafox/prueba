#Modulo        => RET                                                          #
#Programa      => RETL404                                                      #
#Objetivo      => Lanzador de integracion de archivo para solicitudes de       #
#                 de desmarca.                                                 #
...
MAIN
    ...
    LET g_proceso_cod   = g_archivo_solicitud_desmarca_procesar
    LET g_opera_cod     = g_archivo_solicitud_desmarca_procesar_integracion
    LET g_opera_cod_ant = g_archivo_solicitud_desmarca_procesar_carga
...
FUNCTION fn_drag_drop_integra()
    ...
    OPEN WINDOW w_actualiza_solicitud WITH FORM "RETL4041"
        DIALOG ATTRIBUTE(UNBUFFERED)
            ...
            ON ACTION ACCEPT
                ...
                FOR v_i_iter = 1 TO v_i_num_arch
                    ...
                    FROM safre_tmp:tmp_ret_ley73_cons_des_det
                END FOR
...
FUNCTION fn_integracion_lanzado(p_archivo)
    ...
    IF v_i_resultado = 0 THEN
        ...
        IF r_resultado_opera = 0 THEN
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/RETP402 ",
