...
#                retiro por Transferencia para rechazar casos especificos               #
...
DEFINE p_usuario_cod        LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
       ...
       v_resultado          SMALLINT -- resultado de la ejecucion del SQL
   ...
   LET g_proceso_cod = g_proceso_cod_ret_transferencia -- retiro por disposicion de recursos
   ...
   FROM  bat_ctr_proceso a,
         bat_ctr_operacion b
   WHERE a.pid = b.pid 
   AND   a.proceso_cod = g_proceso_cod -- transferencia
   AND   b.opera_cod   = g_opera_cod_ret_transf_preliquidacion -- preliquidacion
   ...
   IF ( g_pid IS NULL ) THEN
      LET v_cadena = "No existe un proceso de Retiros por Transferencia de Recursos ejecutándose en este momento,\n",
   ...
   OPEN WINDOW w_valida_manual WITH FORM "RETF311"
