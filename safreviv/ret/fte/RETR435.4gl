...
#Modulo       => RET                                                                    #
#Programa     => RETR143                                                                 #
#Objetivo     => Programa que ejecuta el sp de reverso de liquidación                #
#                de cargos SSV
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET v_marca_ley73 = 819      
   LET v_edo_maraca  = 0
   LET v_cod_rechazo = 0
   LET v_caus_marac  = 0

   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR435.log")

   DISPLAY "Iniciando rutina de reverso de liquidación..."
   ...
   --DISPLAY "Bandera > ", r_bandera, " < "
   -- si el reverso contable se ejecuto correctamente
   IF ( r_bandera = 0 ) THEN

      LET v_s_sql = " EXECUTE PROCEDURE sp_ret_rev_liquida_cargos_ssv(?,?)"
