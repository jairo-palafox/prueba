...
#                     de retiros genéricos Ley 73 rechazados por FICO          #
#Autor             =>                                                          #
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, # clave usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_ret_generico_ley73fico  # Restitucion retiro genérico amortización excedentes
