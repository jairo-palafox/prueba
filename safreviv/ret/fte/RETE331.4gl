...
#Modulo       => RET                                                                    #
#Programa     => RETE331                                                                #
#Objetivo     => Invoca la carga de datos del archivo CANINT                            #
#Fecha inicio => Febrero 17, 2015                                                       #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_valida_canint -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
       ...
       CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETE331",
