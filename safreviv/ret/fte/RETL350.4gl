...
#Modulo       => RET                                                                    #
#Programa     => RETL350                                                                #
#Objetivo     => Invoca la carga de la notificacion de TRAN_BUT_VAL                     #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_tran_but          -- carga de notificacion
   LET g_opera_cod   = g_opera_cod_valida_tran_bp  -- carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo_ret(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL350",
...
DEFINE v_layout          LIKE cat_operacion.layout_cod,
   ...
   CALL STARTLOG(p_usuario CLIPPED||".RETL350.log")
...
display "inicio de before input"
         ...
         ON ACTION ACCEPT           
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETL350",
              ...
              WHERE  modulo_cod = 'ret'
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETE350.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
