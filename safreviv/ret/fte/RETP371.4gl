...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_marca_z(?,?,?,?,?)"
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      DISPLAY v_mensaje
      DISPLAY "Integración Concluida" , v_error_isam

      CALL fn_actualiza_opera_fin(g_pid,g_proceso_cod,g_opera_cod)
                                  RETURNING r_bnd_fin_oper

      LET p_titulo = "Finalización de operación - MARCA Z - INTEGRACION"
