...
#                para retiro Traspasos fondo ahorro contingente                         #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   DEFINE v_count_ret       DECIMAL(10,0)
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_trasp  --100 -- RETIRO FONDO DE AHORRO TRASPASOS
   LET g_opera_cod   = g_opera_fondo_ahorro_trasp_preliquida   -- preliquidacion
  ...
  AND    b.status      = 0
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL4611"
   ...
   MENU    
      BEFORE MENU 
         ...
         AND    folio = v_folio
         DISPLAY "Los registros encontrados en la consulta son >", v_count_ret, "<"
         DISPLAY "Con las condiciones:"
         DISPLAY "Folio            >",v_folio, "<"
         DISPLAY "Estado Solicitud >", v_estado_solicitud, "<"
...
Ejecuta la preliquidacion de Retiro Traspasos Fondo ahorro
para un folio dado
...
DEFINE v_i_resultado     SMALLINT 
   ...
   IF ( v_bandera = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                     "RETL461",v_nombre_archivo,p_usuario_cod) RETURNING v_i_resultado
      ...
      IF ( v_i_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP461 ",
