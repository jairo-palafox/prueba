...
#                para retiro de traspaso fondo ahorro                                   #
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET g_pid         = p_pid      
   LET g_proceso_cod = p_proceso_cod --retiros de fondo ahorro traspaso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_fondo_ahorro_trasp(?,?,?,?,?)"
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                      "Proceso      : RETIRO POR TRASPASO FONDO AHORRO\n",
...
--      RUN v_s_comando
      ...
      LET p_titulo = "Finalización de operación - RETIRO TRASPASOS FONDO AHORRO - INTEGRACION"
