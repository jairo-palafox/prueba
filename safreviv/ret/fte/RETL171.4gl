...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1711"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida_ret_disposicion_pmg(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquida_ret_disposicion_pmg
...
FUNCTION fn_preliquida_ret_disposicion_pmg(p_folio, p_usuario_cod)
       ...
       IF ( v_i_resultado = 0 ) THEN
         ...
         RETURNING r_resultado_opera
       	IF (r_resultado_opera  = 0) THEN   
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP171 ",
