...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   DISPLAY "Realizando preliquidación de retiros por webservices"
   
   -- se contruye el enuncionado SQL
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_preliquida_ws(?,?,?,?,?,?)"
   
   -- se prepara la ejecucion del stored procedure para la integracion
   PREPARE sid_preliqws FROM v_s_sql
   
   -- se ejecuta el stored procedure
   EXECUTE sid_preliqws USING p_usuario_cod, p_folio, p_nombre_archivo, g_pid,
                              p_proceso_cod, p_max_aivs_sobregiro
   ...
   LET p_titulo = "Finalización de operación - RETIROS WS - PRELIQUIDACION"
