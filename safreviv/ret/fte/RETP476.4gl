...
END RECORD,
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".RETP476.log")
   ...
   AND    A.modalidad_retiro = 2 -- listos para consulta de pago FICO del Fondo de Ahorro
   ...
   ELSE -- se ejecuta la consulta de pago FICO
    ...
    cod_rechazo
      ...
      AND    modalidad_retiro = 2 -- enviadas a tesoreria, SOLO CONSIDERA LAS DEL FONDO DE AHORRO
   ...
   END IF
      ...
      LET p_mensaje = "RETIRO FONDO DE AHORRO - CONSULTA DE PAGO SACI-FICO."
                           
      -- se crea el titulo del mensaje
      LET p_titulo = "Finalización de operación - RETIRO FONDO DE AHORRO - CONSULTA PAGO SACI-FICO"
