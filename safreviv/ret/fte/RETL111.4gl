...
#                para retiro fondo ahorro  CONTINGENCIA                                 #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch          --100 -- RETIRO FONDO DE AHORRO
...
DEFINE v_i_resultado     SMALLINT 
   ...
   IF ( v_bandera = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                     "RETL110",v_nombre_archivo,p_usuario_cod) RETURNING v_i_resultado
