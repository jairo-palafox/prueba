...
#Modulo        => RET                                                          #
#Programa      => RETL391                                                      #
#Objetivo      => Lanzador de integracion de archivo SIAFF diario. Para        #
...
MAIN
    ...
    CALL STARTLOG (g_usuario_cod CLIPPED||".RETL391.log")

    --Se asigna proceso y operacion
    LET g_proceso_cod = 1570
    LET g_opera_cod   = 2
...
FUNCTION fn_drag_drop_integra()
    ...
    OPEN WINDOW w_actualiza_solicitud WITH FORM "RETL3911"
...
FUNCTION fn_integracion_lanzado(p_archivo)
    ...
    IF v_i_resultado = 0 THEN
        ...
        IF r_resultado_opera = 0 THEN
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/RETP391 ",
