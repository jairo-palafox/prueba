...
#Modulo       => RET                                                                    #
#Programa     => RETL261                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de Retiros por amortización     #
#                excedente
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_amort_excedentes -- retiros por disposicion de recursos
   LET g_opera_cod   = g_opera_cod_ret_amort_ex_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL2611"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_amort_excedente_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_amort_excedente_reverso_liquidacion
Fecha creacion: Octubre 08, 2013
Autor: Esteban Sánchez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de una liquidación de retiros por amortizaciones
excedentes para un folio dado
...
FUNCTION fn_ret_amort_excedente_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR261 ",
