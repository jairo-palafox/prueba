...
#MODULO       => RET                                                                    #
#PROGRAMA     => RETC463                                                                #
#OBJETIVO     => Consulta de solicitudes de retiro del Fondo de Ahorro                  #
...
DEFINE v_tipo_retiro         LIKE ret_tipo_retiro.tpo_retiro,
   ...
   FOREACH cur_solicitudesdet INTO v_r_despliegue.*
      ...
      LET v_arr_despliegue[v_indice].tanto_normal         = v_r_despliegue.tanto_normal
      LET v_arr_despliegue[v_indice].tanto_adicional      = v_r_despliegue.tanto_adicional
      LET v_arr_despliegue[v_indice].total_devolucion     = v_r_despliegue.tanto_normal + v_r_despliegue.tanto_adicional
...
--      END IF 
      ...
      LET v_arr_despliegue[v_indice].total_devolucion = v_arr_despliegue[v_indice].tanto_normal +
                                                        v_arr_despliegue[v_indice].tanto_adicional
      LET v_causal = 0
      ...
      LET v_total_tanto_normal     = v_total_tanto_normal     + v_arr_despliegue[v_indice].tanto_normal
   ...
   OPEN WINDOW w_consultadetallada WITH FORM "RETC4803"
      ...
      ON ACTION Exportar
           ...
           FOR v_conteo = 1 TO v_arr_despliegue.getLength()
               LET v_s_detalle = v_arr_despliegue[v_conteo].id_solicitud                           ,"|",
                                 ...
                                 v_arr_despliegue[v_conteo].tanto_normal USING "&&&&&&&&&.&&"      ,"|",
                                 v_arr_despliegue[v_conteo].tanto_adicional USING "&&&&&&&&&.&&"   ,"|",
