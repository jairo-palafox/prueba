...
#Módulo          => RET                                                     #        
#Programa        => RETE418                                                 #
#Objetivo        => Programa carga de archivo Ley 73 Anexo 1 cargo historico#
#                => para aplicar contracargos para eliminar el doble abono  #
#Fecha Inicio    => 12 SEPTIEMBRE 2016                                      #
#############################################################################
DATABASE safre_viv
GLOBALS 
...
DEFINE p_nom_archivo       STRING,
       ...
       v_registro_archivo  RECORD    -- registro del archivo
        id_consecutivo         SMALLINT ,
        nss                    CHAR(11), 
        monto                  DECIMAL(15,2), 
        num_operacion          SMALLINT ,  
   ...
   LET v_cadena_registros = p_usuario CLIPPED, ".", "RETE311.log"
   ...
   DISPLAY "Generando tabla temporal tmp_ret_ley73_contracargo_his_anexo1"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_ley73_contracargo_his_anexo1"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_ley73_contracargo_his_anexo1 (",
               "\n id_consecutivo         SMALLINT,       ",
               "\n nss                    CHAR(11),       ",
               "\n monto                  DECIMAL(15,2),  ",
               "\n num_operacion          SMALLINT,       ",
   ...
   WHILE ( v_ch_archivo.read([v_registro_archivo.*]) )
      ...
      DISPLAY "Registro leido (NSS): ", v_registro_archivo.*
         ...
         INSERT INTO tmp_ret_ley73_contracargo_his_anexo1 values (v_registro_archivo.*)
