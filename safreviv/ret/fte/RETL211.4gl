...
#                de la carga de datos historicos de retiro Ley 73                       #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_carga_his_ley73 -- historico de retiro ley 73
   LET g_opera_cod   = g_opera_cod_ret_his_ley73_integracion -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL2111"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_det_his_ley73"
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros",
              ...
              " de datos Historicos de Retiro Ley 73?",
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF (  r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP211 ",
