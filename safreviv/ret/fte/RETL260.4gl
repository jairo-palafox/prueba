...
#Modulo       => RET                                                                    #
#Programa     => RETL260                                                                 #
#Objetivo     => Programa lanzador del reverso de la preliquidacion de retiros 
#                de amortización de excedentes
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_amort_excedentes -- retiros por amortizaciones excedentes
   LET g_opera_cod   = g_opera_cod_ret_amort_ex_preliquidacion -- preliquidacion
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL2601"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         SELECT a.nombre_archivo, g.folio
           FROM glo_folio g LEFT OUTER JOIN glo_ctr_archivo a
             ON a.folio = g.folio
          WHERE g.proceso_cod = g_proceso_cod_ret_amort_excedentes
            AND g.status = 1
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_amort_excedente_reverso_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_amort_excedente_reverso_preliquidacion
Fecha creacion: Octubre 08, 2013
Autor: Esteban Sánchez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros por amortizaciones excedentes
para un folio dado
...
FUNCTION fn_ret_amort_excedente_reverso_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN     
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR260 ",
