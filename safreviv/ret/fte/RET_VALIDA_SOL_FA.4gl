...
{  
  ...
  -- se abre la ventana
  OPEN WINDOW w1 WITH FORM "RET_VALIDA_SOL_FA01"
...
{     
  ...
  ATTRIBUTE (UNBUFFERED, WITHOUT DEFAULTS)
     ...
     ON ACTION Accept
        CALL fn_ret_fa_valida_solicitud(v_nss, v_rfc)
{                       v_causal_ref      ,
                       v_id_beneficiario ,
                       v_nombre_benef    ,
                       v_ap_paterno_benef,
           ...
           ELSE
              ...
              ELSE
                 ...
                 CASE r_cod_rechazo
                    ...
                    -- NSS/RFC no es unico
                    WHEN 100
                       LET v_cadena = v_cadena, "La combinación NSS/RFC devuelve más de un resultado en la consulta"
