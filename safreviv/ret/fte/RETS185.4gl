...
#                    PMG que incluye registros aceptados y rechazados                        #
#Modificado                                                                                  #
...
# Ivan Vega      14/Feb/2014 - Se agregan AIVs aceptadas viv92/viv97 para los casos cuando   #
...
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- nombre del usuario        
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".RETS185.log")
...
DEFINE p_folio                      LIKE glo_folio.folio,
       ...
       r_tmp_ret_det_disposicion_pmg    RECORD 
          ...
          motivo_rech1                CHAR(3),
          motivo_rech2                CHAR(3),
          -- 14feb2014. Se agregan estos 2 campos
       ...
       END RECORD,
       vr_ret_disposicion_rch RECORD LIKE ret_disposicion_rch.* -- registro de rechazos
...
DEFINE v_s_encabezado         STRING,
   ...
   WHERE  proceso_cod = g_proceso_cod_ret_disposicion_pmg 
   AND    folio = p_folio
   ...
   IF ( p_incluye_rechazos ) THEN
      ...
      LET v_v_nom_archivo = v_v_nom_archivo, "PRTFT.DP.I04002.S", v_archivo_original[3,8], ".RPDISPINF.C", v_archivo_original[10,12]
      LET v_v_nom_archivo_copia = v_v_nom_archivo_copia, "PRTFT.DP.I04002.S.RPDISPINF"
   ELSE
      -- solo aceptados
      LET v_v_nom_archivo = v_v_nom_archivo, "NMRFRET.DSPRM.DISPINPM.V", v_archivo_original[3,8]
      LET v_v_nom_archivo_copia = v_v_nom_archivo_copia, "NMRFRET.DSPRM.DISPINPM.V "
   END IF
   ...
   LET r_tmp_ret_cza_dispo.filler        = 355 SPACES
   ...
   LET ls_sql = "DROP TABLE IF EXISTS tmp_ret_det_disposicion_pmg;",
                    "\n CREATE TABLE tmp_ret_det_disposicion_pmg (",
                    "\nid_solicitud         DECIMAL(9,0),     ",
                    "\ntpo_registro         CHAR(2),          ",
                    "\nid_servicio          CHAR(2),          ",
                    "\nid_operacion         CHAR(2),          ",
                    ...
                    "\nmotivo_rech1         CHAR(3),          ",
                    "\nmotivo_rech2         CHAR(3),          ",
                    "\naiv97_con_dif        DECIMAL(14,0),    ", -- 14feb2014. Se agregan estos dos campos 
   ...
   INTO 
      r_tmp_ret_det_disposicion_pmg.id_solicitud      ,
   	  v_id_derechohabiente                        ,
   	  v_id_ret_matriz_derecho                     ,
   	  r_tmp_ret_det_disposicion_pmg.sec_pension       ,
   	  r_tmp_ret_det_disposicion_pmg.curp              ,
   	  r_tmp_ret_det_disposicion_pmg.nombre_afore      ,
      r_tmp_ret_det_disposicion_pmg.paterno_afore     ,
      r_tmp_ret_det_disposicion_pmg.materno_afore     ,
      r_tmp_ret_det_disposicion_pmg.f_inicio_pension  , 
      r_tmp_ret_det_disposicion_pmg.f_emision_resol   ,
      r_tmp_ret_det_disposicion_pmg.f_solicitud_trab  ,
      r_tmp_ret_det_disposicion_pmg.porc_valuacion    ,  
      r_tmp_ret_det_disposicion_pmg.sem_cotizadas     ,  
      r_tmp_ret_det_disposicion_pmg.cve_doc_probatorio, 
      r_tmp_ret_det_disposicion_pmg.f_nacimiento      , 
      r_tmp_ret_det_disposicion_pmg.aseguradora       , 
      r_tmp_ret_det_disposicion_pmg.actuario_autor    , 
      r_tmp_ret_det_disposicion_pmg.num_reg_ppp       , 
      r_tmp_ret_det_disposicion_pmg.periodo_pago      , 
      r_tmp_ret_det_disposicion_pmg.aiv97             , 
      r_tmp_ret_det_disposicion_pmg.aiv92             , 
      r_tmp_ret_det_disposicion_pmg.consec_trab       , 
      r_tmp_ret_det_disposicion_pmg.fondo_subcta_viv72, 
      r_tmp_ret_det_disposicion_pmg.estatus_subcta    , 
      r_tmp_ret_det_disposicion_pmg.cve_afore         , 
      r_tmp_ret_det_disposicion_pmg.motivo_rech1
   
       --se extrae el número de seguridad social 
   	  SELECT nss
   	  INTO   r_tmp_ret_det_disposicion_pmg.nss
      FROM   afi_derechohabiente
      WHERE  id_derechohabiente = v_id_derechohabiente
       
      --se asignan variables segun  layout 
      LET r_tmp_ret_det_disposicion_pmg.tpo_registro      = "03"
      LET r_tmp_ret_det_disposicion_pmg.id_servicio       = "04"  
      LET r_tmp_ret_det_disposicion_pmg.id_operacion      = "80" -- PMG
      LET r_tmp_ret_det_disposicion_pmg.acciones_ret97    = 0
      LET r_tmp_ret_det_disposicion_pmg.acciones_cv       = 0
      LET r_tmp_ret_det_disposicion_pmg.acciones_cuotsol  = 0
      LET r_tmp_ret_det_disposicion_pmg.filler1           = 14 SPACES
      LET r_tmp_ret_det_disposicion_pmg.acciones_ret92    = 0
      LET r_tmp_ret_det_disposicion_pmg.filler2           = 8 SPACES
      LET r_tmp_ret_det_disposicion_pmg.filler3           = 12 SPACES

      -- si no esta rechazado
      IF ( r_tmp_ret_det_disposicion_pmg.motivo_rech1 = 0 ) THEN
         LET r_tmp_ret_det_disposicion_pmg.result_operacion  = "01"
         LET r_tmp_ret_det_disposicion_pmg.motivo_rech1 = "000"
      ELSE
         LET r_tmp_ret_det_disposicion_pmg.result_operacion  = "02"
         LET r_tmp_ret_det_disposicion_pmg.motivo_rech1 = r_tmp_ret_det_disposicion_pmg.motivo_rech1 USING "&&&"
      END IF
      LET r_tmp_ret_det_disposicion_pmg.motivo_rech2      = "000"
      ...
      SELECT tpo_retiro    ,
             ...
             tpo_pension   ,
             tpo_prestacion
      INTO  r_tmp_ret_det_disposicion_pmg.tpo_retiro     ,
            r_tmp_ret_det_disposicion_pmg.regimen        ,
            r_tmp_ret_det_disposicion_pmg.tpo_seguro     ,
            r_tmp_ret_det_disposicion_pmg.tpo_pension    ,
            r_tmp_ret_det_disposicion_pmg.tpo_prestacion  
      FROM  ret_matriz_derecho
      WHERE id_ret_matriz_derecho = v_id_ret_matriz_derecho
          
      --- se reinician las diferencias
      LET r_tmp_ret_det_disposicion_pmg.aiv97_con_dif = 0
      LET r_tmp_ret_det_disposicion_pmg.aiv92_con_dif = 0
      ...
      INTO   r_tmp_ret_det_disposicion_pmg.aiv97_con_dif
      FROM   ret_his_saldo
      WHERE  id_solicitud    = r_tmp_ret_det_disposicion_pmg.id_solicitud
      ...
      SELECT NVL(saldo_acciones * 1000000,0)
      INTO   r_tmp_ret_det_disposicion_pmg.aiv92_con_dif
      FROM   ret_his_saldo
      WHERE  id_solicitud    = r_tmp_ret_det_disposicion_pmg.id_solicitud
      ...
      IF ( r_tmp_ret_det_disposicion_pmg.aiv92_con_dif <> 0 OR r_tmp_ret_det_disposicion_pmg.aiv97_con_dif <> 0 ) THEN
         -- se calcula la diferencia
         LET v_dif_viv92 = (r_tmp_ret_det_disposicion_pmg.aiv92 - r_tmp_ret_det_disposicion_pmg.aiv92_con_dif) / 1000000
         LET v_dif_viv97 = (r_tmp_ret_det_disposicion_pmg.aiv97 - r_tmp_ret_det_disposicion_pmg.aiv97_con_dif) / 1000000
...
--- ***               LET r_tmp_ret_det_disposicion_pmg.result_operacion = "03"
--- ***               LET r_tmp_ret_det_disposicion_pmg.motivo_rech1     = "767" -- viv97
--- ***               LET r_tmp_ret_det_disposicion_pmg.motivo_rech2     = "766" -- viv92
--- ***            ELSE
--- ***               -- se revisa si fue viv92
--- ***               IF ( v_dif_viv92 > 0 AND v_dif_viv92 <= 1 ) THEN
--- ***                  LET r_tmp_ret_det_disposicion_pmg.result_operacion = "03"
--- ***                  LET r_tmp_ret_det_disposicion_pmg.motivo_rech1     = "766" -- viv92
--- ***               ELSE
--- ***                  -- fue viv97
...
--- ***         END IF
      ...
      INSERT INTO tmp_ret_det_disposicion_pmg VALUES (r_tmp_ret_det_disposicion_pmg.*)
   ...
   IF ( p_incluye_rechazos ) THEN
      ...
      INTO
         r_tmp_ret_det_disposicion_pmg.id_solicitud        ,
         r_tmp_ret_det_disposicion_pmg.nss                 ,
         r_tmp_ret_det_disposicion_pmg.curp                ,
         r_tmp_ret_det_disposicion_pmg.nombre_afore        ,
         r_tmp_ret_det_disposicion_pmg.paterno_afore       ,
         r_tmp_ret_det_disposicion_pmg.materno_afore       ,
         r_tmp_ret_det_disposicion_pmg.sec_pension         ,
         r_tmp_ret_det_disposicion_pmg.tpo_retiro          ,
         r_tmp_ret_det_disposicion_pmg.regimen             ,
         r_tmp_ret_det_disposicion_pmg.tpo_seguro          ,
         r_tmp_ret_det_disposicion_pmg.tpo_pension         ,
         r_tmp_ret_det_disposicion_pmg.tpo_prestacion      ,
         ...
         r_tmp_ret_det_disposicion_pmg.consec_trab         ,
         r_tmp_ret_det_disposicion_pmg.fondo_subcta_viv72  ,
         r_tmp_ret_det_disposicion_pmg.diagnostico_reg     ,
         r_tmp_ret_det_disposicion_pmg.estatus_subcta      ,
         r_tmp_ret_det_disposicion_pmg.cve_afore           ,
         r_tmp_ret_det_disposicion_pmg.result_operacion    ,
         r_tmp_ret_det_disposicion_pmg.motivo_rech1        ,
         r_tmp_ret_det_disposicion_pmg.motivo_rech2        
           
         --se asignan variables segun  layout 
         LET r_tmp_ret_det_disposicion_pmg.tpo_registro      = "03"
         LET r_tmp_ret_det_disposicion_pmg.id_servicio       = "04"  
         LET r_tmp_ret_det_disposicion_pmg.id_operacion      = "80"
         LET r_tmp_ret_det_disposicion_pmg.acciones_ret97    = 0
         LET r_tmp_ret_det_disposicion_pmg.acciones_cv       = 0
         LET r_tmp_ret_det_disposicion_pmg.acciones_cuotsol  = 0
         LET r_tmp_ret_det_disposicion_pmg.filler1           = 14 SPACES
         ...
         LET r_tmp_ret_det_disposicion_pmg.result_operacion  = "02"
         LET r_tmp_ret_det_disposicion_pmg.motivo_rech1      = r_tmp_ret_det_disposicion_pmg.motivo_rech1 USING "&&&"
         LET r_tmp_ret_det_disposicion_pmg.motivo_rech2      = r_tmp_ret_det_disposicion_pmg.motivo_rech2 USING "&&&"
   ...
   SELECT *
   FROM   tmp_ret_det_disposicion_pmg
   ORDER BY cve_afore, nss

   LET v_i_contador_registros = 0
   
   FOREACH cur_temporal INTO r_tmp_ret_det_disposicion_pmg.*
   
      --se forma el detalle a escribir en el archivo   
      LET v_f_inicio_pension = r_tmp_ret_det_disposicion_pmg.f_inicio_pension USING "yyyymmdd"
      LET v_f_resolucion     = r_tmp_ret_det_disposicion_pmg.f_emision_resol  USING "yyyymmdd"
      LET v_f_nacimiento     = r_tmp_ret_det_disposicion_pmg.f_nacimiento     USING "yyyymmdd"
      LET v_f_solicitud_trab = r_tmp_ret_det_disposicion_pmg.f_solicitud_trab USING "yyyymmdd"
      ...
      LET v_s_detalle = r_tmp_ret_det_disposicion_pmg.tpo_registro      ,
                        r_tmp_ret_det_disposicion_pmg.id_servicio       ,
                        r_tmp_ret_det_disposicion_pmg.id_operacion      ,
                        r_tmp_ret_det_disposicion_pmg.nss               ,
                        r_tmp_ret_det_disposicion_pmg.curp              ,
   	                    r_tmp_ret_det_disposicion_pmg.nombre_afore      ,
                        r_tmp_ret_det_disposicion_pmg.paterno_afore     ,
                        ...
                        v_f_inicio_pension                          ,
                        v_f_resolucion                              ,
                        r_tmp_ret_det_disposicion_pmg.porc_valuacion USING "&&&&&",
                        r_tmp_ret_det_disposicion_pmg.sem_cotizadas  USING "&&&&" ,
                        v_f_solicitud_trab                          ,
                        r_tmp_ret_det_disposicion_pmg.cve_doc_probatorio,
                        v_f_nacimiento                              ,
                        r_tmp_ret_det_disposicion_pmg.aseguradora       ,
                        r_tmp_ret_det_disposicion_pmg.actuario_autor    ,
                        r_tmp_ret_det_disposicion_pmg.num_reg_ppp       ,
                        r_tmp_ret_det_disposicion_pmg.periodo_pago     USING "&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.acciones_ret97   USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.acciones_cv      USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.acciones_cuotsol USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.filler1           ,
                        r_tmp_ret_det_disposicion_pmg.acciones_ret92   USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.filler2           ,
                        r_tmp_ret_det_disposicion_pmg.aiv97            USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.aiv92            USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.consec_trab      USING "&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.fondo_subcta_viv72 USING "&&&&&&&&&&&&&&",
                        r_tmp_ret_det_disposicion_pmg.diagnostico_reg   ,
                        r_tmp_ret_det_disposicion_pmg.estatus_subcta    ,
                        r_tmp_ret_det_disposicion_pmg.filler3           ,                       
                        r_tmp_ret_det_disposicion_pmg.result_operacion  ,
                        r_tmp_ret_det_disposicion_pmg.cve_afore        USING "&&&",
                        r_tmp_ret_det_disposicion_pmg.motivo_rech1      ,
                        r_tmp_ret_det_disposicion_pmg.motivo_rech2
   ...
   IF (p_es_previo = 0) THEN
       ...
       IF ( p_incluye_rechazos ) THEN
          ...
          LET v_archivo_transfer = v_c_ruta_env_acr CLIPPED, "/../transfer/PRTFT.DP.I04002.S", v_archivo_original[3,8], ".RPDISPINF.GDG"
       ...
       ELSE -- generando copia para TRM
          -- ruta del archivo en transfer
          LET v_archivo_transfer = v_c_ruta_env_acr CLIPPED, "/../transfer/NMRFRET.DSPRM.DISPINPM.F", v_archivo_original[3,8]
          DISPLAY "\nGenerando copia en directorio transfer: ", v_archivo_transfer
       ...
       IF ( NOT  p_incluye_rechazos ) THEN
           ...
           DISPLAY "\n Se ejecuta Script >sh /opt/Interpel/Scripts/DISPPMG_SYSR.sh<"

           LET v_ejecuta_sh = " sh /opt/Interpel/Scripts/DISPPMG_SYSR.sh"
           RUN v_ejecuta_sh
       END IF
