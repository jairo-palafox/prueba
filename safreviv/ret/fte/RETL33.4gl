...
#                las solicitudes por Transferencia liquidadas para ser enviado          #
#                a Tesoreria                                                            #
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_transf_salida_tesoreria -- generacion del archivo de salida para Tesoreria
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL331"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_genera_salida_ret_transferencia(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_genera_salida_ret_transferencia
...
FUNCTION fn_genera_salida_ret_transferencia(p_folio, p_usuario_cod)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
             ...
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS02 ",
