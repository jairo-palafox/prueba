DROP FUNCTION IF EXISTS fn_ret_preliquida_solo_infonavit_ws;
CREATE FUNCTION fn_ret_preliquida_solo_infonavit_ws(v_folio_liquida  DECIMAL(10,0),
...
DEFINE v_valor_fondo           DECIMAL(19,14);
   ...
   -- se valida que al menos se haya preliquidado un registro
   IF ( v_bnd_preli < 1 ) THEN
      LET v_sql_error = 25;
      LET v_isam_error = 0;
      LET v_mensaje = "ERROR. No se preliquido ninguna solicitud.";
   END IF;
