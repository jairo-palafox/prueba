...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_bp(?,?,?,?,?)"
   
   -- se prepara la ejecucion del stored procedure para la integracion
   PREPARE sid_integradeo FROM v_s_sql

   DISPLAY "fn_ret_integra_bp "
   ...
   EXECUTE sid_integradeo USING p_usuario_cod, p_folio, g_pid, p_proceso_cod, '1504'
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : NOTIFICACION TRAN_BP_INT \n",
   ...
   LET p_titulo = "Finalización de operación - NOTIFICACION TRAN_BP_INT - INTEGRACION"
