...
#                generar sus reverso de integración de retiros por fondo ahorro         #
#                 contingencia                                                          #
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
       ...
       ,v_folio               LIKE ret_preliquida72.folio_liquida
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch -- retiros por fondo ahorro contingencia
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1201"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_fondo_ahorro_cont_reverso_integracion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_fondo_ahorro_cont_reverso_integracion
...
de retiros por fondo ahorro contingencia
...
FUNCTION fn_ret_fondo_ahorro_cont_reverso_integracion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   DISPLAY "PID: ", g_pid
   LET v_valor = fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod)
   DISPLAY v_valor
   ...
   IF ( v_valor = 0 ) THEN
      ...
      DISPLAY "que paso"
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR120 ",
   ...
   ELSE
      ...
      CALL fn_recupera_inconsis_opera(v_valor) RETURNING v_mensaje
