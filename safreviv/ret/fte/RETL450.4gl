...
#                de las excepciones de devolucion del SSV                               #
#Fecha inicio => Noviembre 27, 2017                                                        #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_excep_devol_ssv -- Excepciones devolución SSV
   LET g_opera_cod   = g_opera_excep_devol_ssv_preliquida -- preliquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL4501"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquida
Fecha creacion: Noviembre 17, 2017
Autor: Ricardo Pérez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de de las excepciones de la devolución del SSV
para un folio dado
...
FUNCTION fn_preliquida(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF ( r_resultado_opera  = 0 ) THEN   
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP450 ",
