...
#                para retiro de Ley 73 por web services                                 #
#Fecha inicio => Noviembre 11, 2013                                                      #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_ley73_ws  -- Retiro ley 73 ws
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL251"

   MENU    
      BEFORE MENU 
         -- se cuentan las solicitudes
         SELECT COUNT(*) --NVL(COUNT(*),0) 
         INTO   v_count_ret
...
Ejecuta la preliquidacion de Retiro por ley 73
para un folio dado
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL25","NA",p_usuario_cod)
         RETURNING v_resultado
      
         -- se invoca la ejecucion del programa lanzado
         LET v_s_comando = "nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP25 ",
