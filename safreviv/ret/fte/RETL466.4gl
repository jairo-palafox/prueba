...
#                del detalle de retiro de Ley 73                                  #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_ret_resp_notifica_grupo_integra    -- integracion
   LET g_opera_cod_carga = g_opera_ret_resp_notifica_grupo_carga  -- carga
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL4661"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_resp_notif_detalle"
      ...
      --ON ACTION ACCEPT
         ...
         CALL fn_ventana_confirma("Retiros",
              ...
              " de Respuesta de Notificación de Pago Grupos 2, 3 y 4?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           CALL fn_ret_ejecuta_integracion_respuesta(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_respuesta
...
FUNCTION fn_ret_ejecuta_integracion_respuesta(p_usuario_cod, v_nombre_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                  "RETL466",v_nombre_archivo,p_usuario_cod) RETURNING r_resultado_opera
                 
      IF ( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP466 ",
