...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch -- retiros por fondo de ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoahorro_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1221"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR122 ",
