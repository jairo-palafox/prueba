...
#Fecha inicio => Septiembre 21, 2014                                                    #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_notif_daps_vencidos(?,?,?,?,?)"
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : NOTIFICACION DAPS VENCIDOS\n",
   ...
   LET p_titulo = "Finalización de operación - NOTIFICACION DAPS VENCIDOS - INTEGRACION"
