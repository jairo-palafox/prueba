...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_ley73_cargo_ssv_siaff         -- g_proceso_ley73_cargo_ssv_siaff
   LET g_opera_cod   = g_opera_ley73_cargo_ssv_siaff_preliquida -- preliquidacion
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL4341"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_reverso_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_reverso_preliquidacion
Fecha creacion: Junio 19, 2017
======================================================================
}
FUNCTION fn_ret_reverso_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( r_bnd_bandera =  0 ) THEN     
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR434 ",
