...
#                del detalle de retiro por transferencia                                #
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_ret_transf_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL302"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
        ...
        IF ( v_respuesta = 1 ) THEN
           CALL fn_ret_ejecuta_integracion_transferencia(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_transferencia
Fecha creacion: Marzo 02, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de retiros por transferencia
para un folio dado
...
FUNCTION fn_ret_ejecuta_integracion_transferencia(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP30 ",
