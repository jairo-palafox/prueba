...
#Modulo        => RET                                                          #
#Programa      => RETL382                                                      #
#Objetivo      => Invoca la carga de archivo de respuesta SIAFF.               #
...
MAIN
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo_ret(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL382",
...
DEFINE v_layout          LIKE cat_operacion.layout_cod,
   ...
   CALL STARTLOG(p_usuario CLIPPED||".RETL382.log")
      ...
      --DISPLAY "inicio de before input"
         ...
         ON ACTION ACCEPT           
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETL382",
              ...
              WHERE  modulo_cod = 'ret'
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETP382.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
