...
#Modulo       => RET                                                                    #
#Programa     => RETL82                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de Retiros por fortalecimiento  #
#                al credito                                                             #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_FC_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL821"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_FC_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_FC_reverso_liquidacion
Fecha creacion: Marzo 08, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de retiros por fortalecimiento al credito
para un folio dado
...
FUNCTION fn_ret_FC_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR82 ",
