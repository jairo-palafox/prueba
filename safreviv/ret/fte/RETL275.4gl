...
#                     de archivo enviado para pago por DAP                      #
...
DEFINE v_tipo_proceso    SMALLINT,   -- Forma como ejecutara el programa 
   ...
   LET g_proceso_cod   = g_proceso_cod_ret_resp_archiv_fico_DAP -- respuesta de FICO pago por DAP
   LET g_opera_cod     = g_opera_cod_integra_respuesta_fico_dap -- integracion
   LET g_opera_cod_ant = g_opera_cod_valida_respuesta_fico_dap -- carga
...
DEFINE l_arr_arch_pend    DYNAMIC ARRAY OF VARCHAR(100), -- Archivos pendientes 
   ...
   OPEN WINDOW w_inte_fico WITH FORM "RETL2751"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         IF r_bandera = 0 THEN  
            ...
            CALL fn_actualiza_opera_ini (v_max_pid,g_proceso_cod,g_opera_cod,g_folio,"RETP275",l_v_arch_proceso,v_usuario)
