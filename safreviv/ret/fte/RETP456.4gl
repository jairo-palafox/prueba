...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_oficios_rojos(?,?,?,?,?)"
   ...
   LET p_titulo = "Finalización de operación - OFICIOS ROJOS - INTEGRACION"
