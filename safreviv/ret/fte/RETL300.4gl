...
#                     de retiros genéricos rechazados por FICO                 #
#Autor             =>                                                          #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_rechazo_fico     # 1540 Restitución de rechazo fico
   ...
   LET v_consulta = "     SELECT NVL(COUNT(*),0)", 
                    ...
                    "  \n AND  cod_rechazo = 64",
                    "  \n AND modalidad_retiro = 9" # 9 =  amortización excedente
   PREPARE prp_conteo_solicitudes FROM v_consulta
  
   # se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM g_reg_modulo.ruta_exp CLIPPED||"/RETL3001"
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, # usuario que ejecuta el programa
   ...
   IF ( v_estado_operacion = 0 ) THEN
      ...
      IF ( v_bandera = 0 ) THEN
         ...
         IF( v_bandera = 0 ) THEN
            LET v_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP295 ",
