...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_disposicion_pmg -- retiro por disposicion de recursos
...
DEFINE p_usuario_cod           LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_captura_montos WITH FORM "RETF1701"
   ...
   LET v_continuar = TRUE
     ...
     ATTRIBUTES ( UNBUFFERED )
        ...
        ON ACTION ACCEPT
           ...
           IF ( v_diferencia > g_tolerancia_max_pmg ) THEN           
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   --IF ( fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR185 ",
