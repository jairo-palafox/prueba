...
#Modulo            =>                                                          #
#Programa          => RETL297                                                  #
#Objetivo          => Programa lanzador para le preliquidación de restitución  #
#                     de retiros genéricos voluntarias                         #
#Autor             =>                                                          #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_ret_generico_volunarias   # 1537 Restitucion retiro voluntarias
   ...
   LET v_consulta = "  SELECT NVL(COUNT(*),0)", 
                    ...
                    "     AND modalidad_retiro = 10" # 10 = voluntarias
   PREPARE prp_conteo_solicitudes FROM v_consulta
  
   # se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM g_reg_modulo.ruta_exp CLIPPED||"/RETL2971"
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, # usuario que ejecuta el programa
   ...
   IF ( v_estado_operacion = 0 ) THEN
      ...
      IF ( v_bandera = 0 ) THEN
         ...
         IF( v_bandera = 0 ) THEN
            LET v_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP297 ",
