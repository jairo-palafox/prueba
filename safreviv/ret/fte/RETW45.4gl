...
# Ricardo Perz    20161101   Se crea nueva version para ADAI
###############################################################################
...
DEFINE ret_marcaje RECORD 
         ...
         arr_mod_retiro DYNAMIC ARRAY OF RECORD    
           ...
           grupo_ley73   SMALLINT  -- Indica el grupo que se marcará
         END RECORD
       END RECORD
-- =======================================================
...
DEFINE v_resultado        INTEGER, -- recibe el resultado de la ejecucion del servicio 
  ...
  LET v_ruta_log = v_ruta_ejecutable CLIPPED, "/RETW45."
  ...
  DISPLAY "Iniciando servidor de Marcaje para retiro generico Version 161101..."
...
DEFINE generaWSDL           SMALLINT,
  ...
  TRY
    -- =============================
    -- se crea el servicio
    LET serv = com.WebService.CreateWebService("sol_marca_amort_excedente", v_service_NameSpace)
