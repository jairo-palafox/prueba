...
#                de la notificacion de TRAN_BP_INT                                      #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_tran_bp             -- Notificacion 
   
   LET g_opera_cod   = g_opera_cod_integra_tran_bp   -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n WHERE proceso_cod = ", g_proceso_cod
                    ,"\n   AND opera_cod   = ", g_opera_cod_valida_tran_bp --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL3491"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_tran_bp_val"
...
Ejecuta la integracion de carga de las notificaciones de TRAN_BP_INT
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF (  r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP349 ",
