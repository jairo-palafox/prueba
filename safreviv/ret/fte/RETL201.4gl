...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_aj_manual -- retiros por fondo de ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoAho_manual_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL2010"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_fondo_ahorro_cont_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_fondo_ahorro_cont_reverso_liquidacion
Fecha creacion: Octubre 04 , 2012
Autor: Erick Rodriguez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de una devolucion de retiros por fondo de ahorro 
...
FUNCTION fn_ret_fondo_ahorro_cont_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR201 ",
