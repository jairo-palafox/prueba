...
#                del detalle de retiro por fortalecimiento al credito                   #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fortal_credito -- fortalecimiento al credito
   LET g_opera_cod   = g_opera_cod_ret_FC_integracion -- integracion
   ...
   CALL fn_drgandrop_integra_tipoN(p_usuario_cod)
END MAIN

FUNCTION fn_drgandrop_integra_tipoN(p_usuario_cod)
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_ret_FC_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL702"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros",
              ...
              " de Retiros por fortalecimiento al crédito?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           CALL fn_ret_ejecuta_integracion_FC(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_FC
Fecha creacion: Marzo 08, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de retiros por fortalecimiento al credito
para un folio dado
...
FUNCTION fn_ret_ejecuta_integracion_FC(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP70 ",
