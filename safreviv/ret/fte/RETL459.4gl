...
#Modulo       => RET                                                           #
#Programa     => RETL459                                                       #
#Objetivo     => Invoca la carga de datos para retiros fondo ahorro traspasos  #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_trasp -- Retiro por fondo ahorro traspasos
   LET g_opera_cod   = g_opera_fondo_ahorro_trasp_carga -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL459",
