...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_ssv(?,?,?,?,?)"
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : CARGOS DE LA SSV APLICADOS VIA SIAFF\n",
   ...
   LET p_titulo = "Finalización de operación - CARGOS A LA SSV APLICADOS VIA SIAFF - INTEGRACION"
