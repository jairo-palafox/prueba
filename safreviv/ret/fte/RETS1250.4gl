...
DEFINE p_folio        LIKE glo_folio.folio,
   ...
   ELSE -- se ejecuta la generación de archivo
      ...
      FOREACH cur_ret_generico INTO v_id_derechohabiente       ,
         ...
         -- Se busca el tipo de beneficiario para saber si entro por Jurídico
         -- Se busca con el servicio expuesto por CRM de BuscaCaso, si entro por Jurídico solo del medio de entrega 3 (CRM)
