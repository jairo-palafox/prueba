...
#Modulo       => RET                                                                    #
#Programa     => RETL438                                                                #
#Objetivo     => Programa que lanza el proceso de integración del archivo               #
#                de Disferencias SSV Pensionados                                        #
#Fecha inicio => Junio 21, 2017                                                       #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_det_dif_ssv_pensionado -- Diferencias SSV Pensionados
   LET g_opera_cod   = g_opera_dif_ssv_pensionados_integra -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_dif_ssv_pensionados_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL4382"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_dif_ssv_pensionado"
...
FUNCTION fn_ret_ejecuta_integracion(p_usuario_cod, v_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                "RETL438",v_archivo,p_usuario_cod) RETURNING r_resultado_opera
              
      IF( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP438 ",
