...
#Modulo       => RET                                                                    #
#Programa     => RETL143                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de cargos de SSV
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod =  g_proceso_ley73_cargo_ssv_siaff -- retiros por fondo de ahorro
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL4351"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_reverso_liquidacion
Fecha creacion: Junio 19, 2017

======================================================================
}
FUNCTION fn_ret_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR435 ",
