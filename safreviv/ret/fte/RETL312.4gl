...
#                de la carga de Anexo 1 de retiro Ley 73 de cargos historicos           #
#Fecha inicio => Marzo 28, 2014                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ley73_anexo1_cargo_historico -- cargos historicos de Anexo 1 Ley73
   LET g_opera_cod   = g_opera_cod_ret_ley73_a1ch_integracion -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL3121"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_ley73_cargo_his_anexo1"
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros",
              ...
              " de Retiro Ley 73 Anexo 1 Cargos históricos?",
...
ley 73 Anexo 1 cargos historicos
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF (  r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP312.42r ",
