...
MAIN
    ...
    LET v_proceso_cod = g_desmarca_procesar_indicador_pendient
    LET v_opera_cod   = g_opera_desmarca_procesar_indicador_pendiente
    ...
    -- Log del proceso
    CALL STARTLOG(p_usuario_cod CLIPPED||".RETL413.log")    
    ...
    IF v_i_resultado = 0 THEN
        ...
        IF r_resultado_opera = 0 THEN
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP413 ",
