...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_ley73(?,?,?,?,?)"
   ...
   IF ( v_i_resultado = 0 OR v_error_isam = 1000 ) THEN --CAMBIO PRODINF 473 que los que no tengan error sigan el proceso
      IF v_error_isam = 1000 THEN
		LET p_mensaje = p_mensaje || "\n\nEl proceso de Integración ha finalizado pero con errores de validación...\nCONTINUARA EL PROCESO PARA LOS REGISTROS QUE NO TIENEN ERRORES"
	  END IF 
	  -- Cierra la operación
      ...
      LET p_titulo = "Finalización de operación - RETIRO LEY 73 - INTEGRACION"
