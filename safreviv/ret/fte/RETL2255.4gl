...
#                las solicitudes de retiro del Fondo de Ahorro                          #
#                para ser enviado a Tesoreria                                           #
#Fecha inicio => Marzo 26, 2019                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_envio_fico_fa             -- retiro por fondo ahorro
   LET g_opera_cod   = g_opera_cod_envia_archivos_fico          -- generacion del archivo de salida para Tesoreria
   ...
   SELECT b.ruta_listados
    ...
    LET v_sql= "\nSELECT rs.modalidad_retiro, rm.des_larga,COUNT(*)",
               ...
               "\nAND rm.modalidad_retiro   = 2",  -- Fondo de Ahorro
               "\nAND ps.id_solicitud   = rs.id_solicitud",
               "\nGROUP BY 1,2"
  ...
  LET v_indice = 1
   ...
   OPEN WINDOW w_genera_archivo WITH FORM "RETL22551"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL2255","NA",p_usuario_cod)
         RETURNING v_resultado
         
                                       
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS2250 ",
