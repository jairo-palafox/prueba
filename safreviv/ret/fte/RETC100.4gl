...
DEFINE p_usuario_cod            LIKE seg_usuario.usuario_cod, -- clave del usuario
   ...
   OPEN WINDOW w_consulta_datamart WITH FORM "RETC1001"
   ...
   ATTRIBUTES (UNBUFFERED, ACCEPT = FALSE)
      ...
      ON ACTION consultar
         ...
         IF ( (v_nss               IS NULL) AND
            ...
            CALL fn_mensaje("Atención","Debe capturar al menos un criterio de búsqueda","bn_about")
            CONTINUE INPUT
         END IF
...
DEFINE 
   ...
   OPEN WINDOW w_carga_datamart WITH FORM "RETC1002"
...
DEFINE 
   ...
   OPEN WINDOW w_detalle_datamart WITH FORM "RETC1003"
