...
#                     AMORTIZACIONES EXCEDENTES SIN DAP                       #
#FECHA INICIO      => 25-ABR-2017                                             #
###############################################################################
...
DEFINE v_resultado       INTEGER, -- recibe el resultado de la ejecucion del servicio 
    ...
    LET v_ruta_log = v_ruta_ejecutable CLIPPED, "/RETW48."
...
DEFINE v_urn                STRING -- URN
    ...
    TRY
        -- =============================
        -- se crea el servicio
        LET v_webservice = com.WebService.CreateWebService("retiroSaldosDisponiblesAmortExcedSinDap", v_service_NameSpace)

        -- =============================
        -- Publicacion de las funciones

        -- fn_retiro 
        LET op = com.WebOperation.CreateDOCStyle("fn_ret_saldos_disponibles","fn_ret_saldos_disponibles",ws_ret_cons_saldos_disponibles_in,ws_ret_cons_saldos_disponibles_out)
        ...
        CALL v_webservice.publishOperation(op, "fn_ret_saldos_disponibles")
...
======================================================================
Clave: 
Nombre: fn_ret_saldos_disponibles_amort_exced_sin_dap
Fecha creacion: Marzo 22, 2013
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Funcion principal del WS que consulta los saldos disponibles para retiros de Amortizaciones Excedentes sin DAP
...
FUNCTION fn_ret_saldos_disponibles()
