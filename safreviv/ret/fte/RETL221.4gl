...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   END IF
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETL221.log")

   LET g_proceso_cod = g_proceso_cod_ret_webservice -- retiro por webservices
   LET g_opera_cod   = g_opera_cod_ret_ws_liquidacion -- liquidacion
