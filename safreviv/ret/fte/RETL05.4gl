...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro          -- RETIRO FONDO DE AHORRO
   LET g_opera_cod   = g_opera_cod_ret_fondoAho_preliquidacion -- preliquidacion
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL05","NA",p_usuario_cod)
