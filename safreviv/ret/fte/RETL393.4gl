...
DEFINE v_rest_valida    SMALLINT,
   ...
   LET g_proceso_cod = g_proceso_restitucion_rechazo_siaff     # 1571 Restitucion retiro  ley 73
   LET g_opera_cod   = g_opera_cod_preliquida_restitucion_rechazo_siaff # 1    Preliquidacion
...
--                    "   AND cod_rechazo      = 66   ",
--                    "   AND modalidad_retiro = 3    " # 3 =  Retiro genérico Ley 73
   PREPARE prp_conteo_solicitudes FROM v_consulta
  
   # se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM g_reg_modulo.ruta_exp CLIPPED||"/RETL3931"
