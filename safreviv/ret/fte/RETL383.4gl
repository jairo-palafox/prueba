...
#Modulo        => RET                                                          #
#Programa      => RETL383                                                      #
#Objetivo      => Lanzador de integracion de archivo SIAFF.                    #
...
MAIN
    ...
    CALL STARTLOG (g_usuario_cod CLIPPED||".RETL383.log")
...
FUNCTION fn_drag_drop_integra()
    ...
    OPEN WINDOW w_actualiza_solicitud WITH FORM "RETL3831"
...
FUNCTION fn_integracion_lanzado(p_archivo)
    ...
    IF v_i_resultado = 0 THEN
        ...
        IF r_resultado_opera = 0 THEN
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/RETP383 ",
