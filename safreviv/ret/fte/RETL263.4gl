...
#                generar sus reverso de integración de retiros por SPESS
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL2631"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   DISPLAY "g_pid",g_pid
   -- LET v_resultado = fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod) -- Benjamin solicitó se quite esta validacion 
   LET v_resultado = 0
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR263 ",
