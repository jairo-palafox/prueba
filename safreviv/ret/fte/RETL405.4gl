...
#Modulo       => RET                                                           #
#Programa     => RETL405                                                       #
#Objetivo     => Programa que ejecuta Funcionalidad para generación de archivo #
#Fecha inicio => Noviembre 25, 2012                                            #
################################################################################
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod     = g_proceso_carga_multinss     -- Proceso de carga por multinss
   LET g_opera_cod       = g_opera_cod_multiNSS_integra -- Integracion de archivo
   LET g_opera_cod_carga = g_opera_cod_multiNSS_valida  -- Validación de archivo
   ...
   CALL fn_drgandrop_integra_multinss(p_usuario_cod)
END MAIN

FUNCTION fn_drgandrop_integra_multinss(p_usuario_cod)
    DEFINE
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n WHERE proceso_cod = ", g_proceso_cod
                    ,"\n   AND opera_cod   = ", g_opera_cod_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL4051"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_multinss"
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros",
              "¿Desea realizar la consulta por MultiNSS?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           CALL fn_ret_ejecuta_integracion_MultiNSS(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_MultiNSS
Fecha creacion: Noviembre 25, 2015
Autor: Luis Felipe Prieto, EFP
Narrativa del proceso que realiza:
Ejecuta la integración por multiNSS para generar reporte de consulta especial
...
FUNCTION fn_ret_ejecuta_integracion_MultiNSS(p_usuario_cod, v_nombre_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                  "RETL405",v_nombre_archivo,p_usuario_cod) RETURNING r_resultado_opera
                 
      IF ( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP405 ",
         ...
         CALL fn_mensaje("Atención",
                         ...
                         "information")
      ELSE                   
         -- no se puede iniciar la operacion
