...
#Modulo       => RET                                                                    #
#Programa     => RETL210                                                                #
#Objetivo     => Invoca la carga de datos para historico de retiros Ley 73              #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_carga_his_ley73 -- carga de historico de ley 73
   LET g_opera_cod   = g_opera_cod_ret_his_ley73_carga -- carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL210",
