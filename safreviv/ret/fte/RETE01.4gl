...
#Modulo       => RET                                                                    #
#Programa     => RETE01                                                                 #
#Objetivo     => Invoca la carga de datos para retiros por disposicion de recursos      #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_disp_carga -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
         ...
         --CALL fn_inicializa_proceso(g_pid,g_proceso_cod,g_opera_cod,0,"RETE01","",
         --                     p_usuario_cod) RETURNING v_rest_valida 
         --IF ( v_rest_valida = 0)THEN
            -- Inicia proceso de carga de archivo mismo que inicia la cadena de proceso
            CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETE01",
