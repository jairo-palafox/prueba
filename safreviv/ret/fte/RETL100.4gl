...
#Modulo            => RETL                                         #
#Programa          => RETL100                                       #
#Objetivo          => Lanzador de la integracion de la carga       #
#                     inicial de retiros SPESS                     #
...
MAIN
   DEFINE p_v_usuario       LIKE seg_usuario.usuario,-- usuario firmado al sistema
          ...
          v_arr_integrados  DYNAMIC ARRAY OF RECORD -- arreglo que contiene los archivos integrados
             ...
             tot_ap           INTEGER,
             ap_pat           DECIMAL(18,0),
             suma_am          DECIMAL(18,0),
             suma_aivs        DECIMAL(18,0)
          END RECORD,
          ...
          v_ruta_vacia      STRING,
          v_suma_ap_pat     DECIMAL(16,0),
          v_suma_am         DECIMAL(16,0),
          v_suma_aivs       DECIMAL(16,0)
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".RETL100.log")
   ...
   LET v_i_proceso_cod   = g_proceso_cod_ret_carga_spes -- carga inicial de retiros SPESS
   LET v_i_opera_cod     = g_opera_cod_ret_integra_spes_carga -- integracion
   LET v_i_opera_cod_ant = g_opera_cod_ret_carga_spes_carga -- carga
   ...
   OPEN WINDOW w_inte_acred WITH FORM "RETL1001"
         ...
         ON ACTION ACCEPT
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               LET v_v_nomArch_proc = v_arr_arch_int[v_i_iter]
                ...
                LET v_arr_integrados[v_i_iter].ap_pat           = v_suma_ap_pat
                LET v_arr_integrados[v_i_iter].suma_am          = 0
                LET v_arr_integrados[v_i_iter].suma_aivs        = 0
