...
#Modulo            => RET                                                      #
#Programa          => RETL2257                                                 #
#Objetivo          => Programa lanzador para integrar archivos de respuesta    #
#                     FICO del Fondo de Ahorro                                 #
...
DEFINE v_tipo_proceso    SMALLINT,   -- Forma como ejecutara el programa 
   ...
   LET g_proceso_cod = g_proceso_archivos_respuesta_fico_fa
...
DEFINE l_arr_arch_pend    DYNAMIC ARRAY OF VARCHAR(100), -- Archivos pendientes 
   ...
   OPEN WINDOW w_inte_fico WITH FORM "RETL22571"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         IF r_bandera = 0 THEN  
            ...
            CALL fn_actualiza_opera_ini (v_max_pid,g_proceso_cod,g_opera_cod,g_folio,"RETP2257",l_v_arch_proceso,v_usuario)
