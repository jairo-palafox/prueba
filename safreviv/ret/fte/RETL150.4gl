...
#                del retiro contingente solo infonavit                                  #                                #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_solo_inf_arch -- retiro contingente solo infonavit
   ...
   CALL fn_drgandrop_integra_transf(p_usuario_cod)
END MAIN

FUNCTION fn_drgandrop_integra_transf(p_usuario_cod)
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_ret_conting_solo_inf_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL1501"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros", "¿Desea ejecutar el proceso de Integración de Carga de Archivo\n"||
              " de Retiros Sólo Infonavit CONTINGENTE?",
              "quest") RETURNING v_respuesta

        IF ( v_respuesta = 1 ) THEN
           CALL fn_ret_ejecuta_integracion_sinf_contingente(l_arr_integrados[l_i_iter].nom_archivo, p_usuario_cod)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_sinf_contingente
Fecha creacion: Marzo 02, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de retiros contingente solo infonavit
para un folio dado
...
FUNCTION fn_ret_ejecuta_integracion_sinf_contingente(p_nombre_archivo, p_usuario_cod)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       v_archivo          STRING, 
       r_resultado_opera  SMALLINT  --coodigo de error fn_actualiza_opera_ini

       LET v_folio = 0
       LET v_archivo = p_nombre_archivo
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
            ...
            LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP150 ",
