...
#
FUNCTION fn_marcaje_ley73(p_nss, p_caso_adai, p_cuenta_clabe, p_ind_marca, p_cod_rechazo, p_grupo, p_medio_entrega, p_usuario)
  DEFINE	p_nss		STRING
  ...
  LET fn_marcaje_ley73Request.usuario = p_usuario
...
FUNCTION fn_marcaje_ley73_g()
  ...
  IF retiroMarcaLey73_retiroMarcaLey73PortTypeEndpoint.Address.Uri IS NULL THEN
    IF ( FGL_GETENV("URL_RETWS_MARCA_LEY73") ) THEN
       LET retiroMarcaLey73_retiroMarcaLey73PortTypeEndpoint.Address.Uri = FGL_GETENV("URL_RETWS_MARCA_LEY73")
    ELSE
       DISPLAY "ERROR: No se encuentra la variable de entorno URL_RETWS_MARCA_LEY73 o esta vacia"
       EXIT PROGRAM
    END IF
  END IF
