...
#                del archivo de Marca Z                                                 #
#Fecha inicio => Mayo 15, 2015                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_marca_z           -- marca Z
   LET g_opera_cod   = g_opera_cod_integra_marca_z -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL3711"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_det_marca_z"
      ...
      ON ACTION integrar
         ...
         IF ( v_respuesta = 1 ) THEN
            CALL fn_ret_ejecuta_integracion_marca_z(p_usuario_cod, l_v_arch_proceso)
            EXIT DIALOG
         END IF
   END DIALOG
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_marca_z
...
FUNCTION fn_ret_ejecuta_integracion_marca_z(p_usuario_cod, v_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                "RETL371",v_archivo,p_usuario_cod) RETURNING r_resultado_opera
              
      IF( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP371 ",
