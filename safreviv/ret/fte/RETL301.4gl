...
#                     de retiros rechazos FICO              #
#Autor             =>                                                          #
#Fecha inicio      => 30 Octubre 2013                                          #
################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, # clave usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_rechazo_fico  # Restitucion retiro genérico amortización excedentes
