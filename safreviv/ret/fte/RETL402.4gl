...
MAIN
    ...
    LET g_proceso_cod   = g_archivo_solicitud_marca_procesar
    LET g_opera_cod     = g_archivo_solicitud_marca_procesar_integracion
    LET g_opera_cod_ant = g_archivo_solicitud_marca_procesar_carga
...
FUNCTION fn_drag_drop_integra()
    ...
    OPEN WINDOW w_actualiza_solicitud WITH FORM "RETL4021"
        DIALOG ATTRIBUTE(UNBUFFERED)
            ...
            ON ACTION ACCEPT
                ...
                FOR v_i_iter = 1 TO v_i_num_arch
                    ...
                    FROM safre_tmp:tmp_ret_ley73_cons_mar_det
                END FOR
