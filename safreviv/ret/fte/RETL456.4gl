...
#Modulo            => RET                                                       #
#Programa          => RETL456                                                   #
#Objetivo          => Programa lanzador para integrar archivos de Oficios Rojos #
...
DEFINE v_tipo_proceso    SMALLINT,   -- Forma como ejecutara el programa 
   ...
   LET g_opera_cod     = g_opera_oficios_rojos_integra -- integracion
   LET g_opera_cod_ant = g_opera_oficios_rojos_carga -- carga
...
DEFINE l_arr_arch_pend    DYNAMIC ARRAY OF VARCHAR(100), -- Archivos pendientes 
   ...
   OPEN WINDOW w_inte_fico WITH FORM "RETL4561"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION accept
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT COUNT(*)",
                              "\n FROM safre_tmp:tmp_ret_oficios_rojos"
      ...
      ON ACTION integrar
         ...
         IF r_bandera = 0 THEN  
            ...
            CALL fn_actualiza_opera_ini (v_max_pid,g_proceso_cod,g_opera_cod,g_folio,"RETP456",l_v_arch_proceso,v_usuario)
