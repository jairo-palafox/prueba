...
CONSTANT c_folio = 0
   ...
   CALL STARTLOG(p_usuario CLIPPED||".RETGE01.log")
   ...
   LET v_forma = v_ruta_ejecutable CLIPPED, "/RETGE011"
      ...
      INPUT BY NAME v_nom_archivo ATTRIBUTES (UNBUFFERED, ACCEPT = FALSE, CANCEL = FALSE)
         ...
         ON ACTION ACCEPT
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETGE01",
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETGE02.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
