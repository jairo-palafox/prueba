...
#Modulo            =>                                                          #
#Programa          => RETL457                                                  #
#Objetivo          => Programa lanzador para la preliquidación de la           #
#                     restitución de las Excepciones de la Devolución del SSV  #
#Autor             =>                                                          #
#Fecha inicio      => Septiembre 12, 2017                                      #
################################################################################
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_excep_devol_ssv_restitucion     # 1593 Restitucion de las excepciones de la devolucion del ssv
   LET g_opera_cod   = g_opera_restitucion_excep_devol_ssv_preliquida # 1    Preliquidacion
   ...
   LET v_consulta = "  SELECT NVL(COUNT(*),0)", 
                    ...
                    "   AND cod_rechazo IN (64,65)      "
                    
   PREPARE prp_conteo_solicitudes FROM v_consulta
  
   # se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM g_reg_modulo.ruta_exp CLIPPED||"/RETL4571"
...
#Descripcion       =>                                                          #
#Autor             =>                                                          #
#Fecha inicio      => 12 de Septiembre de 2017                                 #
################################################################################
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, # usuario que ejecuta el programa
   ...
   IF ( v_estado_operacion = 0 ) THEN
      ...
      IF ( v_bandera = 0 ) THEN
         ...
         IF( v_bandera = 0 ) THEN
            LET v_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP457 ",
