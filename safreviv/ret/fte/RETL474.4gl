...
#                resultado de la consulta de pago de solicitudes hacia Jurídico         #
#                de los Beneficiarios de una Disposición del Saldo de la Subcuenta      #
#                Vivienda                                                               #
#Fecha inicio => Octubre 23, 2018                                                       #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod        LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_notifica_beneficiarios -- Notifica pago de beneficiarios a Jurídico de la DSSV
   LET g_opera_cod   = g_opera_ret_notifica_beneficiarios -- consulta de solicitudes pagadas FICO
   ...
   OPEN WINDOW w_consulta WITH FORM "RETL4741"
...
--   WHERE  estado_solicitud IN (71, 210) -- pagadas y con cuenta por pagar cancelada
  --AND (cod_rechazo = 64 )
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL474","NA",p_usuario_cod)
         RETURNING v_resultado
      
         -- se invoca la ejecucion del programa lanzado
         LET v_s_comando = "nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP474 ",
