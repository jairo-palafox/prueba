...
#MODULO       => RET                                                                    #
#PROGRAMA     => RETC54                                                                 #
#OBJETIVO     => Consulta de retiros tipo N                                             #
...
DEFINE cbx_tipo_retiro      ui.ComboBox, -- combo de tipo de retiro
   ...
   OPEN WINDOW w_consulta WITH FORM "RETC541"
   ...
   ATTRIBUTES ( UNBUFFERED )
      ...
      BEFORE INPUT
         ...
         WHERE    modalidad_retiro = 4 -- tipo N
         ORDER BY tpo_retiro
         ...
         SELECT a.folio
         FROM   glo_folio a
         WHERE  a.proceso_cod = g_proceso_cod_ret_tipo_N -- tipo N
         AND    a.status >= 0
         ORDER BY folio DESC
...
{         
         ...
         SELECT *
         FROM   ret_rechazo
         WHERE  cod_rechazo IN (49,5,597,961,599,598,600,100,201,758,759,760,763,768,766)
...
--               "\n AND d.tpo_retiro = e.tpo_retiro ",
               "\n AND a.id_decreto         = c.id_decreto         ",
               "\n AND a.folio = b.folio ",
               "\n AND b.proceso_cod = ", g_proceso_cod_ret_tipo_N, -- Tipo N
...
--   END IF
   ...
   LET v_sql = "\n SELECT                 ",
               "\n 1                 ,    ",
               "\n e.tpo_retiro,    ",
               "\n e.tpo_retiro || ' - ' || e.des_corta,    ",
               "\n COUNT(*)          ,    ",
               "\n a.folio           ,    ",
               "\n SUM(a.aivs_viv92) ,    ",
               "\n SUM(0)      ",
               "\n FROM ret_tipo_n_rch      a,",
               "\n      glo_folio       b,",
               "\n      ret_tipo_retiro e ",
               "\n WHERE a.f_resolucion BETWEEN '", v_fecha_inicio, "' AND '", v_fecha_fin, "'",
...
{   
   ...
   OPEN WINDOW w_consulta1 WITH FORM "RETC542"
...
DEFINE v_tipo_retiro        LIKE ret_tipo_retiro.tpo_retiro,
       ...
       v_mes_en_texto         CHAR(2),
       v_ano_en_texto         CHAR(4),
       v_fecha_valuacion_nueva CHAR(10)
   ...
   LET v_sql = "\n SELECT                                            ",
               ...
               "\n FROM ret_tipo_n           a                       ",
               "\n      LEFT OUTER JOIN ret_matriz_derecho   e       ",
               "\n                   ON a.id_ret_matriz_derecho = e.id_ret_matriz_derecho,       ",
               "\n      afi_decreto          b,                      ",
...
{   
   ...
   OPEN WINDOW w_consultadetallada WITH FORM "RETC543"
...
DEFINE v_tipo_retiro        LIKE ret_tipo_retiro.tpo_retiro,
   ...
   LET v_sql = v_sql, "\n afi_decreto b,",
                      ...
                      "\n AND   c.proceso_cod = ", g_proceso_cod_ret_tipo_N, -- Tipo N
   ...
   OPEN WINDOW w_consultapreliq WITH FORM "RETC544"
