...
#MODULO       => RET                                                                    #
#PROGRAMA     => RETC03                                                                 #
#OBJETIVO     => PROGRAMA DE CONSULTA GENERAL DISPOSICION                               #
...
--realiza la carga de los registros  al array de la tabla de solicitud
FUNCTION fn_solicitud_disposicion(p_estado, p_rechazo ,p_con_ini , p_con_fin) 
 ...
 LET v_cont = v_cont + 1
  ...
  LET v_query =  "\n SELECT rd.id_solicitud,rd.id_derechohabiente,' ',",
                        "\n rcd.f_carga,rd.folio,importe_viv72,rd.aivs_viv92,rd.aivs_viv97,",
                        "\n ' ',rd.estado_solicitud,rd.cod_rechazo_1,' ',rd.id_ret_matriz_derecho",
                        "\n FROM ret_disposicion_rch  rd,",
                        "\n      ret_cza_disposicion_rch rcd",
                        "\n WHERE (rd.estado_solicitud = ? or '0' = ?)",
                        "\n   AND rd.folio = rcd.folio",
                        "\n   AND (rd.cod_rechazo_1 = ? OR '0' = ?",
                        "\n   OR rd.cod_rechazo_2 = ? ",
                        "\n   OR rd.cod_rechazo_3 = ? )",
                        "\n   AND rcd.f_carga between ? and ?" , 
                        "\n   AND (rd.id_derechohabiente = ?",
  ...
  FOREACH cur_disposicion_rch USING p_estado,p_estado
