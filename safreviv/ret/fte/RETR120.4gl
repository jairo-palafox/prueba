...
#                para retiros por fondo de ahorro
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR120.log")

   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_arch -- devolucion de operaciones
   LET g_opera_cod   = g_opera_cod_ret_fondoahorro_integracion  -- integracion

   DISPLAY "Ejecutando reverso de integración..."
   
   LET v_ls_SqlQry = "EXECUTE PROCEDURE sp_ret_rev_int_fondo_ahorro_cont(?)"
