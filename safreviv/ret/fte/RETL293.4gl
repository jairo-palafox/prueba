...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_ret_generico_ley73        # 1535 Restitucion retiro ley 73
   ...
   LET v_consulta = "  SELECT COUNT(*)", 
                    ...
                    "     AND modalidad_retiro = 3" # 3 = ley73
   DISPLAY "La consulta ", v_consulta
   PREPARE prp_conteo_solicitudes FROM v_consulta
  
   # se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM g_reg_modulo.ruta_exp CLIPPED||"/RETL2931"
      ...
      MENU  
         BEFORE MENU
            ...
            DISPLAY "Valores... v_estado_solicitud ", v_estado_solicitud
            DISPLAY ".......... v_countador_ret ", v_countador_ret
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, # usuario que ejecuta el programa
   ...
   IF ( v_estado_operacion = 0 ) THEN
      ...
      IF ( v_bandera = 0 ) THEN
         ...
         IF( v_bandera = 0 ) THEN
            LET v_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP293 ",
