...
#Modulo            => RET                                                     #
#Programa          => RETC71                                                  #
#Objetivo          => CONSULTA DE PRELIQUIDACION DE RETIROS FORTALECIMIENTO   #
#                     AL CREDITO
#Fecha Inicio      =>                                                         #
###############################################################################
DATABASE safre_viv
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fortal_credito -- retiros por fortalecimiento al credito
