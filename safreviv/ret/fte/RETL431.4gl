...
#                del archivo para consulta de detalle de los cargos SSV                 #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_det_cargo_ssv_consulta -- Detalle Consulta Cargos SSV
   LET g_opera_cod   = g_opera_det_cargo_ssv_consulta_integra -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_det_cargo_ssv_consulta_carga --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "RETL1102"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_s_qryTxt = "\n SELECT count(*)"
                            ,"\n FROM safre_tmp:tmp_ret_det_cargo_ssv"
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Retiros",
              "¿Desea ejecutar el proceso de Integración de Carga de Archivo\n"||" de Detalle para Consulta de Cargos SSV?",
              "quest") RETURNING v_respuesta

         IF ( v_respuesta = 1 ) THEN
            CALL fn_ret_ejecuta_integracion_detalle_consulta_cargos(p_usuario_cod, l_v_arch_proceso)
            EXIT DIALOG
         END IF
   END DIALOG
...
======================================================================
Clave: 
Nombre: fn_ret_ejecuta_integracion_detalle_consulta_cargos
Fecha creacion: Junio 16, 2017
...
FUNCTION fn_ret_ejecuta_integracion_detalle_consulta_cargos(p_usuario_cod, v_archivo)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,
                                "RETL431",v_archivo,p_usuario_cod) RETURNING r_resultado_opera
              
      IF( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP431 ",
