...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_preliquida_his_ley73(?,?,?,?,?)"
   ...
   LET p_titulo = "Finalización de operación - RETIROS ANEXO 1 LEY7 3 - PRELIQUIDACION"
