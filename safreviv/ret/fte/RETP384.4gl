...
#Modulo        => RET                                                          #
#Programa      => RETP384                                                      #
#Ojetivo       => Programa lanzado de la preliquidacion del archivo de SIAFF.  #
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   DISPLAY "Realizando preliquidación de Cargos Tesofe"
   
   -- se contruye el enuncionado SQL
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_preliquida_cargos_tesofe(?,?,?,?,?)"
   ...
   LET p_titulo = "Finalización de operación - RETIROS LEY 73 CARGOS TESOFE - PRELIQUIDACION"
