...
#Modulo            =>                                                          #
#Programa          => RETL305                                                  #
#Objetivo          => Programa lanzador para de la liquidación de restitución  #
#                     de retiros rechazos FICO de fondo de ahorro              #
#Autor             =>                                                          #
#Fecha inicio      => 06 Noviembre 13                                          #
################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, # clave usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_restitucion_ret_generico_72fico  # Restitucion rechazo FICO fondo de ahorro
   LET g_opera_cod   = g_opera_cod_liquida_rechazo_fico # Liquidación
