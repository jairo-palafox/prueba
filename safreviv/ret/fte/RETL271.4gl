...
#                pagadas via DAP y/o transferencia interbancaria a traves de FICO       #
#                                                                                       #
#Fecha inicio => Octubre 14, 2013                                                       #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod        LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_consulta_pago_fico_ret_generico -- consulta a FICO
   LET g_opera_cod   = g_opera_cod_ret_gen_consulta_pagos_fico -- consulta de solicitudes pagadas FICO
   ...
   OPEN WINDOW w_consulta WITH FORM "RETL2711"
   ...
   AND    A.modalidad_retiro = 9  --- Solo se consideran las solicitudes de Amortizaciones Excedentes
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL271","NA",p_usuario_cod)
         RETURNING v_resultado
      
         -- se invoca la ejecucion del programa lanzado
         LET v_s_comando = "nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP271 ",
