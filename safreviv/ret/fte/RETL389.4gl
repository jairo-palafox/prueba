...
#                las solicitudes de retiro ley 73, parcialidades                        #
#Fecha inicio => Septiembre de 2015                                                     #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   WHERE  proceso_cod = g_proceso_cod
    ...
    --Obtiene el número de solcitudes por modalidad
    LET v_sql= "\nSELECT rs.modalidad_retiro, rm.des_larga,COUNT(*)",
               "\nFROM   ret_solicitud_generico rs, ret_modalidad_retiro rm,",
               "\n       ret_ctr_parcial rcp",
               "\nWHERE  rcp.estado_solicitud        = 60",
               "\nAND    rm.modalidad_retiro        = 11",-- rs.modalidad_retiro",
               "\nAND    rcp.id_solicitud           = rs.id_solicitud",
  ...
  LET v_indice = 1
   ...
   OPEN WINDOW w_genera_archivo WITH FORM "RETL3891"
...
Fecha creacion: Septiembre de 2015
Narrativa del proceso que realiza:
Genera el archivo de salida de parcialidades.
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET v_resultado = fn_valida_operacion(g_pid,g_proceso_cod,g_opera_cod)
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL389","NA",p_usuario_cod)
         RETURNING v_resultado
         
                                       
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS389 ",
