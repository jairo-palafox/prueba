...
#########################################################################################
#Modulo       => RET                                                                    #
#Programa     => RETL123_FAC                                                            #
#Objetivo     => Lanzador del reverso de la carga de archivo de retiros por Fondo de    #
#                ahorro Contingente para layout combinado PRODINF-354                   #
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro_comb  -- retiros por fondo de ahorro
   LET g_opera_cod   = g_opera_cod_ret_fondoahorro_carga_comb -- carga de archivo
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL3271"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         DECLARE cur_archivos_comb CURSOR FOR
         ...
         FOREACH cur_archivos_comb INTO v_r_glo_ctr_archivo.*
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_fondo_ahorro_cont_reverso_carga_comb(v_nombre_archivo, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_fondo_ahorro_cont_reverso_carga_comb
Fecha creacion: Enero 19, 2015
Autor: Lourdes Padilla, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la carga de archivo combinado
de retiros por disposicion de recursos PRODINF-354
...
FUNCTION fn_ret_fondo_ahorro_cont_reverso_carga_comb(v_nombre_archivo, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   -- no se tiene folio en esta operacion       
   LET p_folio = 0
   ...
   AND    opera_cod = g_opera_cod_ret_fondoahorro_integracion
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR327 ",
