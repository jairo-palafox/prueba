...
DEFINE v_resultado       INTEGER, -- recibe el resultado de la ejecucion del servicio 
    ...
    LET v_ruta_log = v_ruta_ejecutable CLIPPED, "/RETW30."
...
DEFINE v_urn                STRING -- URN
    ...
    TRY
        -- =============================
        -- se crea el servicio
        LET v_webservice = com.WebService.CreateWebService("retiroSaldosDisponibles", v_service_NameSpace)
...
======================================================================
Clave: 
Nombre: fn_ret_saldos_disponibles
Fecha creacion: Marzo 22, 2013
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
