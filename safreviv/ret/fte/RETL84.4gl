...
#                por fortalecimiento al credito                                         #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_FC_salida_tesoreria -- archivo de salida para tesoreria
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL841"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_FC_reverso_archivo_salida(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_FC_reverso_archivo_salida
Fecha creacion: Marzo 01, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la creacion de archivo de retiros por fortalecimiento
al credito para Tesoreria para un folio dado
...
FUNCTION fn_ret_FC_reverso_archivo_salida(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR84 ",
