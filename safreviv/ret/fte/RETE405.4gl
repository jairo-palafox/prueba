...
#Modulo        => RET                                                          #
#Programa      => RETL405                                                      #
#Ojetivo       => Generación de archivo plano vía multiNSS                     #
#Fecha inicio  => 24 de Noviembre, 2015.                                       #
################################################################################
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_multiNSS_valida  -- Validación de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN         
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL405",
