...
#                retiro por Disposiciones para rechazar casos especificos               #
#Fecha inicio => Julio 29, 2013                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod        LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_disp_preliquidacion -- preliquidacion
   ...
   AND   b.opera_cod   = g_opera_cod_ret_disp_preliquidacion -- preliquidacion
   ...
   IF ( g_pid IS NULL ) THEN
      LET v_cadena = "No existe un proceso de Retiros por Disposición de Recursos ejecutándose en este momento,\n",
   ...
   OPEN WINDOW w_valida_manual WITH FORM "RETF111"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         AND    a.nss                = v_nss
         AND    b.cod_rechazo        = 0 -- solo solicitudes que no fueron rechazadas
