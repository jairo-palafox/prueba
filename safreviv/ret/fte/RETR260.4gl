...
#                de retiros de amortizaciones excedentes
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET p_marca          = g_marca_ret_amort_excedente

   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR260.log")

   LET v_s_qry = " EXECUTE PROCEDURE sp_ret_reverso_preliquidacion_amort_excedente(?,?,?)"
