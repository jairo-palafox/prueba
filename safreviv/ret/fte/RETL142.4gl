...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_Ley73_arch         -- retiros por Ley 73 cont
   LET g_opera_cod   = g_opera_cod_ret_ley73_preliquidacion -- preliquidacion
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1421"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_ley73_reverso_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_ley73_reverso_preliquidacion
Fecha creacion: Octubre 09, 2012
Autor: Erick Rodriguez, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros por Ley 73 cont
para un folio dado
...
FUNCTION fn_ret_ley73_reverso_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       p_folio           LIKE glo_folio.folio, -- folio para preliquidar
       v_s_comando       STRING, -- cadena con una instruccion de consola
       v_nombre_archivo  LIKE glo_ctr_archivo.nombre_archivo -- nombre del archivo
       ,r_bnd_bandera    SMALLINT
   ...
   LET v_nombre_archivo = "NA"
    LET r_bnd_bandera = fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod)
   DISPLAY r_bnd_bandera  
   -- se verifica si se puede continuar con la operacion
   IF ( r_bnd_bandera =  0 ) THEN     
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR142 ",
