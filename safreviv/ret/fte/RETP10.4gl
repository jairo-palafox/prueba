...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   CALL fn_genera_folio(g_proceso_cod, g_opera_cod, p_usuario_cod)
      ...
      -- Inicio operacion.
      -- se copia al lanzador 25 de Mayo de 2012 
      --IF (fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,"RETP10",
      --                           "NA",p_usuario_cod) = 0) THEN
            ...
            LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_disposicion_recursos(?,?,?,?,?,?)"
            
            -- se prepara la ejecucion del stored procedure para la integracion
            PREPARE sid_integradeo FROM v_s_sql
            
            -- se ejecuta el stored procedure
            EXECUTE sid_integradeo USING p_usuario_cod, p_folio, p_nombre_archivo, g_pid, p_proceso_cod,p_marca
               ...
               LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                               "Proceso      : RETIRO POR DISPOSICIÓN DE RECURSOS\n",
               ...
               IF ( v_i_resultado = 0 )THEN
                  ...
                  LET v_s_comando = "fglrun RETS11.42r ",p_folio ," ", p_usuario_cod, " 1 1"
                  RUN v_s_comando

                  DISPLAY "___________________________________________________________________________________"
                  DISPLAY "Generando archivo de respuesta para TRM con registros aceptados: "
                  LET v_s_comando = "fglrun RETS11.42r ",p_folio ," ", p_usuario_cod, " 0 1"
                  RUN v_s_comando
               ...
               LET p_titulo = "Finalización de operación - RETIROS DISPOSICION - INTEGRACION"
