...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      LET p_titulo = "Finalización de operación - Detalle Consulta Cargos SSV - INTEGRACION"
      
      CALL fn_display_proceso(1, "INTEGRACION")

   ELSE 
      -- se complementa el mensaje
      LET p_mensaje = p_mensaje || "El proceso de Integración ha finalizado pero con errores."                                    
      DISPLAY v_mensaje
      DISPLAY p_mensaje
