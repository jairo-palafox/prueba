...
MAIN
   ...
   LET v_proceso_cod = 1522
   LET v_opera_cod = 2
   LET v_usuario = 'safreviv'
   LET v_folio = 1
   LET v_nom_archivo = ARG_VAL(1)
   ...
   ELSE
      ...
      ELSE
         # Inicia operación
         CALL fn_actualiza_opera_ini(v_pid,v_proceso_cod,v_opera_cod,v_folio,"RETMP02",
         ...
         ELSE
            ...
            ELSE
               ...
               DISPLAY "Se ha enviado la integración."
               DISPLAY "Podrá revisar el resultado en el monitor de ejecución de procesos"
            END IF
         END IF
      END IF
   END IF
