...
#                del detalle de retiro contingente solo infonavit                       #
#Fecha inicio => Marzo 22, 2012                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_ret_conting_solo_inf_preliquidacion -- preliquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL1511"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida_ret_contingente_solo_inf(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquida_ret_contingente_solo_inf
Fecha creacion: Marzo 02, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de retiros contingente solo infonavit
para un folio dado
...
FUNCTION fn_preliquida_ret_contingente_solo_inf(p_folio, p_usuario_cod)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
             ...
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP151 ",
