...
DEFINE  p_s_titulo       STRING -- titulo de la ventana
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".RETR201.log")
   ...
   IF v_estatus = 0 THEN
      ...
      CALL fn_reverso_liquidacion_fondo72(p_folio)
   ...
   IF v_estatus = 0 THEN  
      ...
      PREPARE prp_cam_stat_liquidacion FROM "EXECUTE PROCEDURE sp_status_retiro_fondo_ahorro_acti_manual( ?, ?, ?, ?, ?)"
