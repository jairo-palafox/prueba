...
#                de datos historicos de Retiro Ley 73 Contracargos                      #
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET g_pid         = p_pid      
   LET g_proceso_cod = p_proceso_cod -- datos historicos retiro ley 73
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_integra_his_ley73_contra(?,?,?,?,?)"
   ...
   LET p_mensaje = "ID Proceso   : ", g_pid, "\n", 
                   "Proceso      : HISTORICO RETIRO LEY 73 CONTRACARGOS\n",
   ...
   LET p_titulo = "Finalización de operación - HISTORICO RETIRO LEY 73 CONTRACARGOS - INTEGRACION"
