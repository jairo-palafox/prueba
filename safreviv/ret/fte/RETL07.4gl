...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_fondo_ahorro          --100 -- RETIRO Fondo ahorro
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETR030"
...
DEFINE v_program         varchar(50) 
   ...
   SELECT pid
    ...
    WHERE proceso_cod = g_proceso_cod
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR03 ",
