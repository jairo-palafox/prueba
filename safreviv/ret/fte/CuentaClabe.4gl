GLOBALS "ret_cuenta_clabe.inc" -- saldo prelimminar PROCESAR
...
DEFINE v_resultado SMALLINT
  ...
  LET ns1notificacionCuentaClabeRequest.cuerpo.grupoTrabajador                      = "0101" -- tns3alfanumerico_4_no_especiales ATTRIBUTE(XMLName="grupoTrabajador",XMLNamespace=""),
  LET ns1notificacionCuentaClabeRequest.cuerpo.secuenciaPension                     = "01" -- tns3alfanumerico_2_no_especiales ATTRIBUTE(XMLName="secuenciaPension",XMLNamespace=""),
  ...
  LET ns1notificacionCuentaClabeRequest.cuerpo.semanasCotizadas                     = "1500" -- tns3alfanumerico_4_numerico ATTRIBUTE(XMLName="semanasCotizadas",XMLNamespace=""),
  ...
  LET ns1notificacionCuentaClabeRequest.cuerpo.curpBeneficiario                     = "LEMR420215HNECNY05" -- tns3curp ATTRIBUTE(XMLName="curpBeneficiario",XMLNamespace=""),
  LET ns1notificacionCuentaClabeRequest.cuerpo.claveSiefore1                        = "02" -- tns3alfanumerico_2_numerico ATTRIBUTE(XMLName="claveSiefore1",XMLNamespace="",XMLOptional),
  LET ns1notificacionCuentaClabeRequest.cuerpo.claveRetiro92Siefore1                = 0.0 -- tns3numerico_13_2 ATTRIBUTE(XMLName="claveRetiro92Siefore1",XMLNamespace="",XMLOptional),
  LET ns1notificacionCuentaClabeRequest.cuerpo.claveRetiro97Siefore1                = 0.0 -- tns3numerico_13_2 ATTRIBUTE(XMLName="claveRetiro97Siefore1",XMLNamespace="",XMLOptional),
  ...
  LET ns1notificacionCuentaClabeRequest.cuerpo.claveSiefore2                        = "12" -- tns3alfanumerico_2_numerico ATTRIBUTE(XMLName="claveSiefore2",XMLNamespace="",XMLOptional),
  LET ns1notificacionCuentaClabeRequest.cuerpo.claveRetiro92Siefore2                = 0.0 -- tns3numerico_13_2 ATTRIBUTE(XMLName="claveRetiro92Siefore2",XMLNamespace="",XMLOptional),
  LET ns1notificacionCuentaClabeRequest.cuerpo.claveRetiro97Siefore2                = 0.0 -- tns3numerico_13_2 ATTRIBUTE(XMLName="claveRetiro97Siefore2",XMLNamespace="",XMLOptional),
  ...
  LET ns1notificacionCuentaClabeRequest.cuerpo.importeNetoDepositadoClaveSiefore2   = 0.0 -- tns3numerico_13_2 ATTRIBUTE(XMLName="importeNetoDepositadoClaveSiefore2",XMLNamespace="",XMLOptional),
  LET ns1notificacionCuentaClabeRequest.cuerpo.importeNetoDepositadoSiefores        = 0.0 -- tns3numerico_13_2 ATTRIBUTE(XMLName="importeNetoDepositadoSiefores",XMLNamespace="",XMLOptional),
