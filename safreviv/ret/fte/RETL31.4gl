...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL311"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         FROM glo_ctr_archivo a,
              glo_folio b
         WHERE a.proceso_cod = g_proceso_cod -- retiros por disposicion de recursos
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_preliquida_ret_transferencia(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquida_ret_transferencia
...
FUNCTION fn_preliquida_ret_transferencia(p_folio, p_usuario_cod)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          RETURNING r_resultado_opera
             ...
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETP31 ",
