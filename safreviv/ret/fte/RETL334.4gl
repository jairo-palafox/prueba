...
#Modulo       => RET                                                                    #
#Programa     => RETL334                                                                #
#Objetivo     => Lanzador del reverso de la carga de archivo CANINT                     #
#Fecha inicio => Febrero 265, 2015                                                      #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_canint -- retiros fortalecimiento al credito
   LET g_opera_cod   = g_opera_cod_valida_canint -- carga de archivo
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "RETL3341"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_ret_CANINT_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_ret_CANINT_reverso_carga_archivo
Fecha creacion: Febrero 26, 2015
Autor: Ricardo Perez
Narrativa del proceso que realiza:
Ejecuta el reverso de la carga del archivo CANINT
...
FUNCTION fn_ret_CANINT_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   AND    opera_cod = g_opera_cod_integra_canint
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETR334 ",
