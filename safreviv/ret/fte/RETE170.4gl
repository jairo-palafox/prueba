...
#Modulo       => RET                                                                    #
#Programa     => RETE170                                                                 #
#Objetivo     => Invoca la carga de datos para retiros por disposicion de recursos pmg      #
#Fecha inicio => Octubre 18, 2012                                                       #
#########################################################################################
DATABASE safre_viv
GLOBALS "RETG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_disposicion_pmg -- Retiro por disposicion de recursos pmg
   LET g_opera_cod   = g_opera_cod_ret_pmg_carga -- recepcion de archivo   
   ...
   IF ( v_rest_valida = 0 ) THEN
            ...
            CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "RETE170",
