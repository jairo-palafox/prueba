...
# Server:  http://192.168.1.61:80/CuentaCLABE/ProxyServices/CuentaCLABE
#-------------------------------------------------------------------------------
...
FUNCTION notificacionCuentaClabe_g()
  ...
  IF CuentaCLABE_CuentaCLABEPortEndpoint.Address.Uri IS NULL THEN
    LET CuentaCLABE_CuentaCLABEPortEndpoint.Address.Uri = "http://192.168.1.61:80/CuentaCLABE/ProxyServices/CuentaCLABE"
  END IF
