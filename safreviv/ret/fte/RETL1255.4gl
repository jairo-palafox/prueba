...
#                las solicitudes de retiro de Ley 73                                    #
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_ret_envio_fico_ssv             -- Devolución del Saldo de Vivienda
  ...
  LET v_indice = 1
   ...
   OPEN WINDOW w_genera_archivo WITH FORM "RETL12551"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         -- inicia la operacion
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"RETL1255","NA",p_usuario_cod)
         RETURNING v_resultado
         
                                       
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/RETS1250 ",
