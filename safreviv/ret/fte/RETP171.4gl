...
# 02 Dici 2013. La tolerancia de sobregiro es 1 AIVs                                    #
#########################################################################################
IMPORT os
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
       ...
       ,p_movimiento_sobregiro SMALLINT
   ...
   LET p_marca          = 808 --retiro pmg
   LET p_movimiento     = 822 --retiro pmg
   LET p_movimiento_sobregiro = 852 -- sobregiro de PMG
   ...
   DISPLAY "Realizando preliquidación de retiros PMG"
   ...
   LET v_s_comando = "fglrun RETS185.42r ",p_folio ," ", p_usuario_cod, " 1 0"
   RUN v_s_comando

   DISPLAY "___________________________________________________________________________________"
   DISPLAY "Generando archivo de respuesta para TRM con registros aceptados: "
   LET v_s_comando = "fglrun RETS185.42r ",p_folio ," ", p_usuario_cod, " 0 0"
   RUN v_s_comando
   ...
   LET p_titulo = "Finalización de operación - RETIROS PMG - PRELIQUIDACION"
