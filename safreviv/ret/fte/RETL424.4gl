...
#Modulo       => RET                                                                    #
#Programa     => RETL424                                                                #
#Objetivo     => Lanzador de la carga del archivo de los cargos aplicados de SSV        #
#             => via SIAFF                                                              #
#Fecha inicio => OCTRUBRE 7, 2016                                                       #
#########################################################################################
IMPORT os
DATABASE safre_viv
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_ley73_cargo_ssv_siaff -- Anexo 1 Cargos aplicados via SIAFF de SSV
   LET g_opera_cod   = g_opera_ley73_cargo_ssv_siaff_carga -- Carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo_ret(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL424",
...
DEFINE v_layout          LIKE cat_operacion.layout_cod,
   ...
   CALL STARTLOG(p_usuario CLIPPED||".RETL424.log")
   ...
   OPEN WINDOW w_RETGE01 WITH FORM v_forma ATTRIBUTES (TEXT = v_nom_ventana)
      ...
      DISPLAY "Con los parámetros "
      DISPLAY "Proceso        >", p_proceso, "<"
      DISPLAY "Operacion      >", p_operacion, "<"
      DISPLAY "v_cb_archivo   >", v_cb_archivo, "<"
      DISPLAY "v_extension    >", v_extension, "<"
      DISPLAY "g_ruta_rescate >", g_ruta_rescate, "<"
...
display "inicio de before input"
         ...
         ON ACTION ACCEPT           
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETL424",
              ...
              WHERE  modulo_cod = 'ret'
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETE424.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
