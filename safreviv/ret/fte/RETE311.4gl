...
DEFINE p_nom_archivo       STRING,
       ...
       v_registro_archivo  RECORD    -- registro del archivo
        ...
        mec_ent_recursas       CHAR(1),  
        origen                 CHAR(6),  
        nombre                 CHAR(150),
        tpo_proceso            CHAR(3),  
        ejercicio_fiscal_fico  CHAR(4),  
        entidad_federativa     CHAR(2),  
        doc_pago_fico          CHAR(10), 
        acreedor               CHAR(10)  
      END RECORD,
   ...
   DISPLAY "Generando tabla temporal tmp_ret_ley73_cargo_his_anexo1"

   -- cambio a base de datos temporal
   DATABASE safre_tmp

   -- se regenera la tabla temporal
   LET v_sql = "\nDROP TABLE IF EXISTS tmp_ret_ley73_cargo_his_anexo1"
   ...
   LET v_sql = "\nCREATE TABLE tmp_ret_ley73_cargo_his_anexo1 (",
               "\n nss                    CHAR(11),  ",
               "\n importe                CHAR(13),  ",
               "\n f_pago                 CHAR(8),   ",
               "\n cve_banco              CHAR(5),   ",
   ...
   WHILE ( v_ch_archivo.read([v_registro_archivo.*]) )
      ...
      DISPLAY "Registro leido (NSS): ", v_registro_archivo.nss
         ...
         INSERT INTO tmp_ret_ley73_cargo_his_anexo1 values (v_registro_archivo.*)
