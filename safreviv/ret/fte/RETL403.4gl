...
MAIN
    ...
    LET v_pid         = 0
    LET v_proceso_cod = g_archivo_solicitud_desmarca_procesar
    LET v_opera_cod   = g_archivo_solicitud_desmarca_procesar_carga
