...
#                de las notificaciones de DAPS vencidos                                 #
...
DEFINE p_pid                  LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   DISPLAY "Realizando preliquidación de notificacion de DAPS vencidos"
   
   -- se contruye el enuncionado SQL
   LET v_s_sql = "EXECUTE FUNCTION fn_ret_preliquida_not_dap_vencido(?,?,?,?,?)"
   ...
   LET p_titulo = "Finalización de operación - NOTIFICACION DAPS VENCIDOS - PRELIQUIDACION"
