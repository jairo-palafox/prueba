...
#Modulo       => RET                                                                    #
#Programa     => RETL439                                                                #
#Objetivo     => Lanzador de la carga del archivo del revolvente SIAFF                  #
#Fecha inicio => JULIO 10, 2017                                                         #
#########################################################################################
IMPORT os
DATABASE safre_viv
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_det_revolvente_siaff -- Indicadores Revolvente SIAFF
   LET g_opera_cod   = g_opera_revolvente_siaff_carga -- Carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo_ret(g_pid, g_proceso_cod, g_opera_cod, 2, "RETL439",
...
DEFINE v_layout          LIKE cat_operacion.layout_cod,
   ...
   CALL STARTLOG(p_usuario CLIPPED||".RETL439.log")
...
display "inicio de before input"
         ...
         ON ACTION ACCEPT           
            ...
            IF ( fn_verifica_permisos_archivo(g_ruta_rescate ,v_nom_archivo) ) THEN
               ...
               --  Inicia operación
               CALL fn_actualiza_opera_ini(p_pid,p_proceso,p_operacion,c_folio,"RETL439",
              ...
              WHERE  modulo_cod = 'ret'
               ...
               -- Construye comando
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/RETE439.42r "
                                              ,p_usuario," "
                                              ,v_aux_pid," "
                                              ,v_aux_proc," "
                                              ,v_aux_opera
