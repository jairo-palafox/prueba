...
DEFINE g_pid                   LIKE bat_ctr_proceso.pid     # ID del proceso
       --se cometna por inclución de archio de variables globales 
       --Rubén Haro Castro  19 de Julio de 2012
...
Narrativa del proceso que realiza:
 Esta función carga un archivo del proceso de "Traspaso INFONAVIT-AFORE"
     ...
     --CALL fn_mensaje("Traspaso INFONAVIT-AFORE",r_resultado_opera,"about")
      IF(r_resultado_opera = 0)THEN
         ...
         IF NOT(r_bnd_carga)THEN
            CALL fn_mensaje("Traspaso INFONAVIT-AFORE","Se ha cancelado la carga de información","about")
         END IF
      ELSE
