...
#Modulo       => TIA                                                                    #
#Programa     => TIAL07                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de registro de pagos TIA        #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_tia -- Reistro de pagos TIA
   LET g_opera_cod   = g_opera_cod_tia_liquidacion -- liquidacion
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "TIAL071"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_tia_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_tia_reverso_liquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de TIA
...
FUNCTION fn_pag_tia_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado = 0 ) THEN
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/TIAR03 ",
