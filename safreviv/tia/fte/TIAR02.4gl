...
#                de registro de pagos Traspaso Infonavit - Afore                        #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".TIAR02.log")

   LET v_s_qry = " EXECUTE PROCEDURE sp_tia_reverso_preliquidacion(?,?)"
