...
DEFINE v_bnd_fin_proceso SMALLINT,
   ...
   CALL fn_guarda_historicos_garantia_em(p_num_folio) RETURNING v_error
   ...
   LET p_titulo = "Finalización de operación - GARANTÍA DE ESTADOS Y MUNICIPIOS - Integración"
...
{ ==========================================================================
Clave:  fn_guarda_historicos_garantia_em
Nombre: fn_guarda_historicos_garantia_em
Fecha creacion: 04 Junio 2013     
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
 Ejecuta el Stored Procedure que realiza el proceso de integracion de los
 datos cargados de garantia de estados y municipios
...
============================================================================}
FUNCTION fn_guarda_historicos_garantia_em(p_folio)
DEFINE p_folio         DECIMAL(9),
   ...
   LET v_consulta = "EXECUTE PROCEDURE sp_registro_historicos_gem(?,?,?)"
