...
#Modulo            =>                                                         #
#Programa          =>                                                         #
#Objetivo          => CONSULTA DE PRELIQUIDACION DE LIQUIDACION DE PAGOS      #
#Fecha Inicio      =>                                                         #
###############################################################################
DATABASE safre_viv
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   CALL fn_consulta_preliq(p_usuario_cod, g_proceso_cod_pag_registro_pagos_LQINFO, g_opera_cod_pag_preliquidacion)
END MAIN