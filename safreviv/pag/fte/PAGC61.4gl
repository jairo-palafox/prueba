...
#Modulo       => PAG                                                           #
#Programa     => PAGC61                                                        #
#Objetivo     => Consulta de integración de aportaciones voluntarias           #
...
DEFINE p_tipo_ejecucion SMALLINT, # forma como ejecutara el programa
   ...
   CALL fn_consulta_folio_vol()

END MAIN

{ ==============================================================================
Clave: PAGC61
Nombre: fn_consulta_folio_vol
Fecha creacion: 17 Abril del 2013
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
Realiza la consulta de datos cargados de Reg. de Pagos de aportaciones 
voluntarias
...
FUNCTION fn_consulta_folio_vol()
DEFINE v_folio DECIMAL(9,0) # folio a consultar
       
   OPEN WINDOW w_consulta_folio WITH FORM v_ruta_ejecutable CLIPPED||"/PAGC611"
...
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
Consulta los datos cargados de Reg. Pagos aportaciones voluntarias para un 
folio dado
...
DEFINE p_folio  DECIMAL(9,0), # folio
       v_cifras RECORD
        ...
        v_sum_imp_ap_vol  DECIMAL(22,2) # sumatorio de importe
       END RECORD
   ...
   OPEN WINDOW w_consulta WITH FORM v_ruta_ejecutable CLIPPED||"/PAGC612"
      DISPLAY v_cifras.v_total_registros TO total_registros
      DISPLAY v_cifras.v_sum_imp_ap_vol  TO imp_ap_vol
...
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
Obtener los datos necesarios para emitir el reporte de aportaciones voluntarias
...
DEFINE p_folio                 INTEGER,
    ...
    IF( fgl_report_loadCurrentSettings("PAGC61.4rp") )THEN
    ...
    START REPORT rpt_carga_aportaciones_vol TO XML HANDLER v_manejador_rpt
       OUTPUT TO REPORT rpt_carga_aportaciones_vol(p_cifras.*, 
                                                   p_folio, 
                                                   v_nombre_usuario, 
                                                   v_nombre_archivo)                                                                
    FINISH REPORT rpt_carga_aportaciones_vol
...
================================================================================
Clave: PAGC61
Nombre: rpt_carga_aportaciones_vol
Fecha creacion: 17 Abril del 2013
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
Genera reporte de aportaciones voluntarias
...
REPORT rpt_carga_aportaciones_vol(p_cifras, p_folio, p_nombre_usuario, p_nombre_archivo)
