...
#Modulo            =>                                                            #
#Programa          =>                                                            #
#Objetivo          => CONSULTA DE PRELIQUIDACION DE FONDO ANTERIOR               # 
#Fecha Inicio      =>                                                            #
##################################################################################
DATABASE safre_viv
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   CALL fn_consulta_preliq_fondo72(p_usuario_cod, g_proceso_cod_pag_registro_pagos_fa, g_opera_cod_pag_preliquidacion)
END MAIN