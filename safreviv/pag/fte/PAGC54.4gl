...
#Modulo       => PAG                                                                    #
#Programa     => PAGC54                                                                 #
#Objetivo     => Consulta de cifras control de Reg. Pagos Fondo Anterior                #
#Autor        => Ivan Vega                                                              #
#Fecha inicio => Febrero 15, 2013                                                       #
#########################################################################################
DATABASE safre_viv
...
DEFINE p_tipo_ejecucion     SMALLINT                     -- forma como ejecutara el programa
   ...
   -- se abre la ventana
   OPEN WINDOW w_consulta WITH FORM "PAGC541"
...
{ ======================================================================
Nombre: f_consulta_cc_fa
Fecha creacion: Febrero 15, 2013
Autor: Ivan Vega
Narrativa del proceso que realiza:
Realiza una consulta sobre las cifras control de Pagos de Fondo Anterior
...
FUNCTION f_consulta_cc_fa(p_folio)
DEFINE    p_folio                 LIKE glo_folio.folio, -- folio de consulta
   ...
   LET v_sql = "\nSELECT   result_operacion,", -- resultado para agrupar por rechazados y aceptados
               ...
               "\n         SUM(imp_ap_fa)   ", -- aportacion de FA
               "\nFROM     pag_det_fa       ", -- tabla de detalle de fortalecimiento al credito
               "\nWHERE    folio =          ", p_folio,
   ...
   OPEN WINDOW w_resultados WITH FORM "PAGC542"
   ...
   ATTRIBUTES ( UNBUFFERED )
      ...
      ON ACTION reporte
         ...
         IF ( fgl_report_loadCurrentSettings("PAGC54.4rp") ) THEN
            LET v_handler = fgl_report_commitCurrentSettings() -- commit the file settings
         ELSE
            CALL fn_mensaje("Error","No se encuentra la plantilla PAGC54.4rp. No se puede emitir el reporte","stop")
            CONTINUE DISPLAY
         END IF
