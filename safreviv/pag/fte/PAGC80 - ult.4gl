...
---==================================================================================
         ...
         --  Busca  el pago como aclaratorio 
            ...
            FOREACH c_pag INTO v_bim_pago,
               ...
               SELECT COUNT(*)
                ...
                WHERE folio_liquida = v_folio
                  ...
                  AND movimiento        IN (1,61,221,41,51,81,451) 
            ...
            DISPLAY "bimestre_pago:", v_bim_pago
            DISPLAY "bimestre_pago_non:", v_bim_pago_non
            DISPLAY "bimestre_pago_par:", v_bim_pago_par
            DISPLAY "nss:", v_nss
            DISPLAY "fecha_pago:", v_fecha_pago
            DISPLAY "nrp:", v_nrp
         ...
         ELSE 
            ...
            IF v_existe_pago = 1 THEN
               ...
               IF v_ejecuta_busqueda = 0 AND v_pago_no_exitoso = 0 THEN
                  ...
                  NEXT FIELD v_nss
               ELSE
                  DISPLAY "Existe en SAFRE en no exitoso"
