...
#                carga de archivo de registro de pagos garantia de estados y   #
#                municipios                                                    #
#Fecha inicio => 06 Junio del 2013                                             #
################################################################################
DATABASE safre_viv
GLOBALS "PAGG01.4gl"
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod,        # clave del usuario firmado
   ...
   LET v_consulta = "EXECUTE PROCEDURE sp_pag_gem_rev_integracion(?,?)"
   PREPARE prp_reverso_integracion_gem FROM v_consulta
   EXECUTE prp_reverso_integracion_gem USING p_d_folio,
                                             g_proceso_cod
                                        INTO r_bandera, 
                                             v_error_isam, 
                                             v_mensaje
