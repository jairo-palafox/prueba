...
#Modulo       => PAG                                                           #
#Programa     => PAGL73                                                        #
#Objetivo     => Programa lanzador del proceso de preliqudiación de registro   #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM g_ruta_bin CLIPPED ||"/PAGL731"
       ...
       FROM cmb_folio ATTRIBUTES (UNBUFFERED)
         ...
         BEFORE INPUT
            ...
            SELECT proceso_desc
              INTO v_proceso_desc
              FROM cat_proceso
             WHERE proceso_cod = g_proceso_cod_pag_registro_pagos_gem
            ...
            FOREACH cur_folios USING g_proceso_cod_pag_registro_pagos_gem
                                INTO v_glo_folio
         ...
         ON ACTION ACCEPT
            ...
            SELECT COUNT(*)
              ...
              FROM glo_folio
             WHERE folio = v_folio
               AND proceso_cod = g_proceso_cod_pag_registro_pagos_gem
            ...
            CALL fn_gem_ejecuta_preliquidacion(v_folio, p_usuario_cod)
            EXIT INPUT
...
{===============================================================================
Clave: 
Nombre: fn_gem_ejecuta_preliquidacion
Fecha creacion: 04 Junio 2013
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
 Ejecuta la preliquidacion de registro de pagos para garantia de estados
 y municipios
Registro de modificaciones:
Autor           Fecha                   Descrip. cambio

================================================================================}
FUNCTION fn_gem_ejecuta_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod,        # usuario que ejecuta el programa
   ...
   CALL fn_recupera_arch_cargado(g_proceso_cod_pag_registro_pagos_gem, 1)  # 1 --> obtiene el nombre de archivo 
   ...
   IF ( v_error = 0 ) THEN
       ...
       LET v_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/PAGP73 ",p_usuario_cod, " ",
                                                                           g_pid  , " " ,
                                                                           g_proceso_cod_pag_registro_pagos_gem , " " ,
                                                                           g_opera_cod_pag_preliquidacion ," ",
                                                                           p_folio ," ",
                       ...
                       " 1>",g_ruta_listados CLIPPED,"/nohup:",g_pid USING "&&&&&",":",
                                                               g_proceso_cod_pag_registro_pagos_gem USING "&&&&&",":",
