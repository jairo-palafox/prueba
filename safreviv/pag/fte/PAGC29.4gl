...
-- Fecha inicio  => 27 de Septiembre de 2018.
-- Requerimiento =>
-----------------------------------------------------------------------------------------
...
--            id_referencia            LIKE cta_his_pagos.id_referencia,
   ...
   OPEN WINDOW w_consulta_registros WITH FORM "../../pag/bin/PAGC291"
      ...
      INPUT v_nss FROM ed_nss ATTRIBUTES(UNBUFFERED, WITHOUT DEFAULTS)
         ...
         ON ACTION ACCEPT
          ...
          ON ACTION CANCEL
             ...
             EXIT INPUT
      END INPUT
   ELSE    -- se recibieron los parametros
...
--            id_referencia            LIKE cta_his_pagos.id_referencia,
     ...
     OPEN WINDOW w_complementarios WITH FORM "../../pag/bin/PAGC292"
     LET  v_ventana = UI.WINDOW.GETCURRENT()
...
--      	   DISPLAY  arr_registros.localiza_trabajador   TO localiza_trabajador 
   ...
   IF INT_FLAG = 1 THEN  
      ...
      IF fgl_report_loadCurrentSettings("../../pag/bin/PAGC29.4rp") THEN 
      ...
      ELSE         
         DISPLAY "No fue posible generar el reporte. No se encuentra la plantilla PAGC29.4rp"
         EXIT PROGRAM 
      END IF
