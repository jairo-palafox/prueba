...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   --LET g_proceso_cod = 1403 -- Solo INFONAVIT
   --LET g_opera_cod   = 3 -- preliquidacion

   -- se obtiene el PID del proceso
   CALL fn_max_pid(g_proceso_cod_pag_registro_pagos_SINF, g_opera_cod_pag_preliquidacion)
                   RETURNING g_pid

   -- se obtienen las rutas de control del modulo
   CALL fn_rutas('pag') RETURNING g_ruta_bin, g_ruta_listados
   CALL fn_rutas('bat') RETURNING v_query, g_ruta_listados
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         FROM cat_proceso
         WHERE
            proceso_cod = g_proceso_cod_pag_registro_pagos_SINF
         ...
         LET v_query = "SELECT * \n ",
                       "FROM   glo_folio \n ",
                       "WHERE  proceso_cod = ",g_proceso_cod_pag_registro_pagos_SINF," \n ",
                       "AND    status = 0 \n ",
                       "ORDER BY 1 DESC"
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_soloInfonavit_ejecuta_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_soloInfonavit_ejecuta_preliquidacion
Fecha creacion: Enero 31, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de registro de pagos Solo infonavit
para un folio dado
...
FUNCTION fn_soloInfonavit_ejecuta_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   CALL fn_recupera_arch_cargado(g_proceso_cod_pag_registro_pagos_SINF, g_opera_cod_pag_preliquidacion) 
   ...
   CALL fn_valida_operacion(g_pid,g_proceso_cod_pag_registro_pagos_SINF,g_opera_cod_pag_preliquidacion) RETURNING v_si_codigo
   ...
   IF ( v_si_codigo = 0 ) THEN
   	  ...
   	  CALL fn_actualiza_opera_ini(g_pid
                                 ,g_proceso_cod_pag_registro_pagos_SINF
     ...
     IF (v_estatus  = 0) THEN 
       ...
       LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/PAGP15 ",
                           p_usuario_cod, " ",
                           g_pid  , " " ,
                           g_proceso_cod_pag_registro_pagos_SINF , " " ,
                           g_opera_cod_pag_preliquidacion ," ",
                           ...
                           "/nohup:",g_pid        USING "&&&&&",":",
                           g_proceso_cod_pag_registro_pagos_SINF USING "&&&&&",":",
