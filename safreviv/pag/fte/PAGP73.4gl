...
DEFINE p_num_folio     DECIMAL(9),
   ...
   IF ( NUM_ARGS() > 0 ) THEN
      ...
      CALL fn_ejecuta_preliquidacion_garantia_em(p_num_folio,p_usuario_cod) RETURNING v_error
      ...
      LET p_titulo = "Finalización de operación - GARANTIA DE ESTADOS Y MUNICIPIOS - Preliquidación"
...
{ ==========================================================================
Clave:  fn_ejecuta_preliquidacion_garantia_em
Nombre: fn_ejecuta_preliquidacion_garantia_em
Fecha creacion: 05 Junio 2013     
Autor: Hugo Ramírez
Narrativa del proceso que realiza:
 Ejecuta el Stored Procedure que realiza el proceso de preliquidacion de
 registro de Pagos de garantia de estados y municipios
...
============================================================================}
FUNCTION fn_ejecuta_preliquidacion_garantia_em(p_folio,p_usuario)
DEFINE p_folio         LIKE glo_folio.folio,
   ...
   LET v_consulta = "EXECUTE PROCEDURE sp_preliquida_gem(?,?)"
