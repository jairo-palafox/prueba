...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".PAGR16.log")

   -- se ejecuta el SP de reverso de integracion de SINFO  
   LET v_ls_SqlQry = "EXECUTE PROCEDURE sp_pag_sinfo_rev_integracion(?)"
   ...
   IF ( r_bandera = 0 ) THEN
      ...
      CALL fn_reversa_operacion(g_pid,g_proceso_cod_pag_registro_pagos_SINF,g_opera_cod_pag_carga)
                                RETURNING r_bandera
