...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # Clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".PAGL15.log")

   --LET g_proceso_cod = 1403 # Registro de pagos sólo INFONAVIT
   --LET g_opera_cod   = 4 # LIQUIDACION solo INFONAVIT
   LET g_operacion   = 2 # Liquidar
   
   CALL fn_liquida(p_usuario_cod, g_proceso_cod_pag_registro_pagos_SINF, g_opera_cod_pag_liquidacion, g_operacion)
