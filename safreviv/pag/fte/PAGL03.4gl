...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   --LET g_proceso_cod = 1405 -- FORTALECIMIENTO DE CRÉDITO
   --LET g_opera_cod   = 3 -- preliquidacion

   -- se obtiene el PID del proceso
   CALL fn_max_pid(g_proceso_cod_pag_registro_pagos_fc, g_opera_cod_pag_preliquidacion)
                   RETURNING g_pid
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         FROM cat_proceso
         WHERE
            proceso_cod = g_proceso_cod_pag_registro_pagos_fc
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   CALL fn_recupera_arch_cargado(g_proceso_cod_pag_registro_pagos_fc, 1)  # 1 --> obtiene el nombre de archivo 
   ...
   CALL fn_valida_operacion(g_pid,g_proceso_cod_pag_registro_pagos_fc,g_opera_cod_pag_preliquidacion) RETURNING v_si_codigo
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/PAGP02 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod_pag_registro_pagos_fc , " " ,
                          g_opera_cod_pag_preliquidacion ," ",
