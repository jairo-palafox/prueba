...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".PAGR18.log")
   ...
   --CALL fn_reverso_liquidacion(p_i_folio) RETURNING r_bandera
   
   -- se ejecuta el SP de reverso
   LET v_s_sql = " EXECUTE PROCEDURE sp_pag_sinfo_rev_liquidacion(?,?)"
