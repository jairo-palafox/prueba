...
#Modulo       => PAG                                                                    #
#Programa     => PAGL34                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de registro de pagos SAR92      #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_pag_registro_pagos_sar92 -- registro pagos pagos_sar92
  ...
  { -- se obtiene el PID del proceso
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "PAGL341"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_SAR92_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_SAR92_reverso_liquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de SAR92
...
FUNCTION fn_pag_SAR92_reverso_liquidacion(p_folio, p_usuario_cod)
   ...
   IF ( v_resultado = 0 ) THEN
    ...
    -- se obtiene el pid en base al folio seleccionado
     ...
     IF ( v_resultado = 0 ) THEN
       ...
       LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/PAGR15 ",
