...
#                archivo de Fortalecimiento de Crédito                                  #
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".PAGR01.log")

   -- se ejecuta el SP de reverso de integracion de FC  
   LET v_ls_SqlQry = "EXECUTE PROCEDURE sp_pag_fc_rev_integracion(?)"
   ...
   IF ( r_bandera = 0 ) THEN
      ...
      CALL fn_reversa_operacion(g_pid,g_proceso_cod_pag_registro_pagos_fc,g_opera_cod_pag_carga)
                                RETURNING r_bandera
