...
DEFINE p_usuario             LIKE seg_usuario.usuario,# usuario firmado al sistema
   ...
   EXECUTE prp_unq_pid_batCtrProc USING g_proceso_cod_pag_registro_pagos_av3 
                                  INTO v_pid
   ...
   FOREACH cur_archivos_val USING g_proceso_cod_pag_registro_pagos_av3,
   ...
   OPEN WINDOW vtna_integra_av WITH FORM v_ruta_ejecutable CLIPPED ||"/PAGL621-3"
