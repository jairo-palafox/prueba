...
#Modulo       => PAG                                                                    #
#Programa     => PAGL37                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de registro de pagos SINF       #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_pag_registro_pagos_SINF -- registro pagos Sólo Infonavit
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "PAGL371"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_SINF_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_SINF_reverso_liquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de SINF
...
FUNCTION fn_pag_SINF_reverso_liquidacion(p_folio, p_usuario_cod)
    ...
    -- se obtiene el pid en base al folio seleccionado
     SELECT pid 
      ...
      IF ( v_resultado = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/PAGR18 ",
