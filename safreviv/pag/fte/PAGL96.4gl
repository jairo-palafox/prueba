...
GLOBALS
   DEFINE 
      g_pid          LIKE bat_ctr_operacion.pid,   --  ID del proceso
...
MAIN
   ...
   LET g_proceso_cod = g_proceso_reg_pag_svt       -- Reistro de pagos LQINFO
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "PAGL961"
...
FUNCTION fn_pag_lqinfo_reverso_liquidacion(p_folio, p_usuario_cod)
  ...
  IF v_resultado = 0 THEN
     ...
     IF v_resultado = 0 THEN
       ...
       LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/PAGR92 ",
