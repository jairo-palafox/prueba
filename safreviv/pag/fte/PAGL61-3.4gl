...
#                de aportaciones voluntarias 1                                 #
#Fecha inicio => 21 Enero de 2015                                              #
################################################################################
DATABASE safre_viv
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, --Clave de usuario
   ...
   LET v_estatus = fn_valida_operacion(0, g_proceso_cod_pag_registro_pagos_av3, g_opera_cod_pag_carga)
