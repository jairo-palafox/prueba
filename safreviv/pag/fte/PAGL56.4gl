...
DEFINE p_usuario_cod          LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_pag_registro_pagos_fa -- FORTALECIMIENTO DE CRÉDITO 
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "PAGL561"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_fc_reverso_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_fc_reverso_preliquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la preliquidacion de FC
...
FUNCTION fn_pag_fc_reverso_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
  ...
  SELECT a.nombre_archivo
   ...
   LET v_cod_salida = fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod)
   ...
   IF ( v_cod_salida = 0 ) THEN     
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/PAGR56 ",
