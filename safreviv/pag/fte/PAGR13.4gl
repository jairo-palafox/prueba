--=============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 08 Agosto 2012
--=============================================================================
#########################################################################################
#Modulo       => PAG                                                                    #
#Programa     => PAGR13                                                                 #
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".PAGR13.log")

   -- se ejecuta el SP de reverso de integracion de SAR92  
   LET v_ls_SqlQry = "EXECUTE PROCEDURE sp_pag_sar92_rev_integracion(?)"
   ...
   IF ( r_bandera = 0 ) THEN
      ...
      CALL fn_reversa_operacion(g_pid,g_proceso_cod_pag_registro_pagos_sar92,g_opera_cod_pag_carga)
                                RETURNING r_bandera
