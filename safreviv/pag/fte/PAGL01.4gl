...
#                preliquidacion de fortalecimiento de creditos                          #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod,
   ...
   CALL fn_carga_archivo_fortalecimiento(p_usuario_cod, p_tpo_ejecucion, p_cad_ventana)
END MAIN

{ ==========================================================================
Clave:  fn_carga_archivo_fortalecimiento
Nombre: fn_carga_archivo_fortalecimiento
Fecha creacion: 14 de Junio de 2012
Autor: Rubén Haro Castro
Narrativa del proceso que realiza:
Esta función carga un archivo del proceso de "FORTALECIMIENTO"
...
============================================================================}
FUNCTION fn_carga_archivo_fortalecimiento(p_usuario_cod, p_tpo_ejecucion, p_cad_ventana)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, --Clave de usuario
   ...
   --LET g_proceso_cod               = 1405 -- liquidacion de pagos
   ...
   LET v_estatus = fn_valida_operacion(0,g_proceso_cod_pag_registro_pagos_fc,g_opera_cod_pag_carga)
   IF ( v_estatus = 0 ) THEN
      ...
      LET v_cadena_proc  = g_proceso_cod_pag_registro_pagos_fc USING "&&&&&"
      --LET v_cadena_opera = g_opera_cod_pag_integracion USING "&&&&&"
     
      CALL fn_display_proceso(0,"CARGA")
      
      CALL fn_carga_archivo(g_pid, g_proceso_cod_pag_registro_pagos_fc, g_opera_cod_pag_carga, p_tpo_ejecucion,"PAGL10",v_comando, p_usuario_cod, TRUE)
