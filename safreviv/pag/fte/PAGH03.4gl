...
#                del archivo de historico anual ADS                                     #
...
MAIN
   ...
   LET v_query = "EXECUTE FUNCTION fn_pag_integra_his_an_ads(?,?)"
   ...
   CASE
      WHEN (SQLCA.SQLCODE = 0)
         IF v_resultado_fn = 0 THEN
            ...
            UPDATE safre_tmp:tmp_archivos_an_ads SET estado = ESTADO_ARCHIVO_INTEGRADO
         ...
         ELSE
            ...
            UPDATE safre_tmp:tmp_archivos_an_ads SET estado = ESTADO_ARCHIVO_ERROR
            WHERE nombre = p_nombre_archivo
...
PRIVATE FUNCTION fn_procesa_archivo_pendiente()
   ...
   WHENEVER ERROR CONTINUE
      ...
      LET v_query = "SELECT FIRST 1 ",
                        "nombre ",
                     "FROM safre_tmp:tmp_archivos_an_ads ",
                     "WHERE estado = ? "
      ...
      IF v_nombre IS NOT NULL THEN
         ...
         DISPLAY "=========================================================="
         LET v_comando = "echo '", v_nombre CLIPPED, "' >> ", v_ruta_rescate CLIPPED,  "/acuse.haads"
         RUN v_comando
      END IF
   WHENEVER ERROR STOP
