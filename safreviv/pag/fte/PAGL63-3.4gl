...
GLOBALS
    DEFINE g_proceso_cod_pag_registro_pagos_av3 SMALLINT
END GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod_pag_registro_pagos_av3 = 1412;
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM g_ruta_bin CLIPPED ||"/PAGL631-3"
       ...
       FROM cmb_folio ATTRIBUTES (UNBUFFERED)
         ...
         BEFORE INPUT
            ...
            SELECT proceso_desc
              INTO v_proceso_desc
              FROM cat_proceso
             WHERE proceso_cod = g_proceso_cod_pag_registro_pagos_av3
            ...
            FOREACH cur_folios USING g_proceso_cod_pag_registro_pagos_av3
                                INTO v_glo_folio
         ...
         ON ACTION ACCEPT
            ...
            SELECT COUNT(*)
              ...
              FROM glo_folio
             WHERE folio = v_folio
               AND proceso_cod = g_proceso_cod_pag_registro_pagos_av3
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod,        # usuario que ejecuta el programa
   ...
   CALL fn_recupera_arch_cargado(g_proceso_cod_pag_registro_pagos_av3, 1)  # 1 --> obtiene el nombre de archivo 
   ...
   CALL fn_valida_operacion(g_pid,
                            g_proceso_cod_pag_registro_pagos_av3,
   ...
   IF ( v_error = 0 ) THEN
      ...
      LET v_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/PAGP63 ",p_usuario_cod, " ",
                      ...
                      " 1>",g_ruta_listados CLIPPED,"/nohup:",g_pid USING "&&&&&",":",
                                                              g_proceso_cod_pag_registro_pagos_av3 USING "&&&&&",":",
