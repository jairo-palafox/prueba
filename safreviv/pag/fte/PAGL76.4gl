...
#Modulo       => PAG                                                           #
#Programa     => PAGL76                                                        #
#Objetivo     => Programa lanzador del reverso de preliqudiación de registro de#
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   OPEN WINDOW vtna_revesa_preliquidacion WITH FORM v_rutas_pag.v_ruta_ejecutable CLIPPED||"/PAGL761"
...
Narrativa del proceso que realiza:
 Ejecuta el reverso de la preliquidacion de garantia de estados y municipios
