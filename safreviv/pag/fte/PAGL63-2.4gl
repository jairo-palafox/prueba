...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM g_ruta_bin CLIPPED ||"/PAGL631-2"
       ...
       FROM cmb_folio ATTRIBUTES (UNBUFFERED)
         ...
         BEFORE INPUT
            ...
            SELECT proceso_desc
              INTO v_proceso_desc
              FROM cat_proceso
             WHERE proceso_cod = g_proceso_cod_pag_registro_pagos_av2
            ...
            FOREACH cur_folios USING g_proceso_cod_pag_registro_pagos_av2
                                INTO v_glo_folio
         ...
         ON ACTION ACCEPT
            ...
            SELECT COUNT(*)
              ...
              FROM glo_folio
             WHERE folio = v_folio
               AND proceso_cod = g_proceso_cod_pag_registro_pagos_av2
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod,        # usuario que ejecuta el programa
   ...
   CALL fn_recupera_arch_cargado(g_proceso_cod_pag_registro_pagos_av2, 1)  # 1 --> obtiene el nombre de archivo 
