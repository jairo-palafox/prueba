--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 04/06/2012
--==============================================================================
...
#                pagos de garantias de estados y municipios                    #
...
DEFINE p_usuario             LIKE seg_usuario.usuario,# usuario firmado al sistema
       ...
       v_detalle_archivo  DYNAMIC ARRAY OF RECORD           # arreglo que contiene los archivos integrados
         ...
         imp_gar_gem      DECIMAL(12,2)
       END RECORD,
       v_imp_gar_gem_aux    DECIMAL(12,2),
   ...
   EXECUTE prp_unq_pid_batCtrProc USING g_proceso_cod_pag_registro_pagos_gem 
                                  INTO v_pid
   ...
   FOREACH cur_archivos_val USING g_proceso_cod_pag_registro_pagos_gem,
   ...
   OPEN WINDOW vtna_integra_av WITH FORM v_ruta_ejecutable CLIPPED ||"/PAGL721"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            FOR v_indice = 1 TO v_contador_archivos
                ...
                INTO   v_detalle_archivo[v_indice].total_registros,
                       v_imp_gar_gem_aux
                FROM  safre_tmp:tmp_pag_det_fondo

                LET v_detalle_archivo[v_indice].imp_gar_gem = v_imp_gar_gem_aux / 100
            END FOR
         ...
         ON ACTION integrar
            ...
            IF( v_resultado = 0 )THEN
               ...
               LET v_comando = " nohup time fglrun ",v_ruta_ejecutable CLIPPED,"/PAGP72 ",p_usuario, " ",
                                                                                          v_pid, " ",
                                                                                          g_proceso_cod_pag_registro_pagos_gem, " ",
                                                                                          g_opera_cod_pag_integracion, " ",
                                                                                          v_folio, " ",
