...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # clave del usuario firmado
   ...
   LET g_proceso_cod = 1410 # Aportaciones voluntarias
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM v_rutas_pag.v_ruta_ejecutable CLIPPED||"/PAGL671"
...
Ejecuta el reverso de la liquidacion de aportaciones voluntarias
