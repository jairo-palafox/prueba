...
#Modulo       => PAG                                                                    #
#Programa     => PAGL40                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de registro de pagos FC         #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
 ...
 {  SELECT MAX(pid)
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "PAGL401"
   ...
   SELECT pid 
    ...
    WHERE proceso_cod =  g_proceso_cod
     ...
     IF ( v_resultado = 0 ) THEN
        ...
        LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/PAGR03 ",
