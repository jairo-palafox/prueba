...
-- Modulo        => PAG
-- Programa      => PAGR90
-- Objetivo      => Reverso carga de archivo
...
MAIN
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".PAGR90.log")

   DISPLAY "Ejecutando rutina de reverso de Integración de CAmbivit..."
   -- se ejecuta el SP de reverso de integracion de CambiVit  
   LET v_ls_SqlQry = "EXECUTE PROCEDURE sp_rev_integracion_cvt(?)"
