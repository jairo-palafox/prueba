--===============================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 03/08/2012
--===============================================================

#########################################################################################
#Modulo       => DPE                                                                    #
#Programa     => DPEL26                                                                 #
#Objetivo     => Programa lanzador para el reverso de la integración de archivo PROCESAR# 
#Fecha inicio => Agosto 03, 2012                                                        #
#########################################################################################
GLOBALS "DPEG01.4gl"
GLOBALS
...
#OBJETIVO: Ejecutar reverso de integración respuesta PROCESAR
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER17 ",
      ...
      CALL fn_mensaje("Atención","Se ha enviado el reverso de la Integración.\n"||
                      "Puede revisar el avance en el monitor de ejecución de procesos"
                      ,"information")
   ELSE
