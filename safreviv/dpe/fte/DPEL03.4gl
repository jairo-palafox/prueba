...
#Modulo       => DPE                                                           #
#Programa     => DPEL03                                                        #
#Objetivo     => Programa lanzador de la preliquidación de Devolucion de Pagos #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DPEL030"
   ...
   FROM  cmb_folio ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dpe_ejecuta_preliquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
#OBJETIVO: Ejecutar el proceso de preliquidación del folio integrado
FUNCTION fn_dpe_ejecuta_preliquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,"DPEL03","",p_usuario_cod)
           RETURNING r_bnd_fin_oper
      IF (r_bnd_fin_oper = 0) THEN 
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPEP02 ",
