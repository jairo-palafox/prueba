...
#Modulo      => DPE                                                            #
#Programa    => DPEL40                                                         #
#Objetivo    => Lanzador para ejecutar el reverso de la validación del archivo #
#            => que PROCESAR envia como acuse después de que recibio el        #
#            => archivo que se genero en SACI                                  #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = 3  -- carga archivo
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "DPEL400"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         DECLARE cur_archivos CURSOR FOR prp_consulta
DISPLAY v_QryTxt            
         LET v_i_conArch = 0
...
#OBJETIVO: Ejecuta la reverso de carga de archivo segun archivo modulo DPE
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER24 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
