--===============================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 1/05/2012
--===============================================================
...
MAIN
   ...
   LET g_opera_cod   = g_opera_cod_dpe_integracion  -- integracion
DISPLAY g_proceso_cod, g_opera_cod
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "DPEL180"
   ...
   INPUT v_folio WITHOUT DEFAULTS FROM cmb_folio ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dpe_reverso_integracion_INFONAVIT(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_dpe_reverso_integracion_INFONAVIT
Fecha creacion: 01/05/2012
Narrativa del proceso que realiza:
Ejecuta reverso preliquidacion de una devolucion por errores de operacion
para un folio dado solo INFONAVIT
======================================================================
}
FUNCTION fn_dpe_reverso_integracion_INFONAVIT(p_folio, p_usuario_cod)
   ...
   IF ( v_si_codigo = 0 ) THEN      
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER11 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
