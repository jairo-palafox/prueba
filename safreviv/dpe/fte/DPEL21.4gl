...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DPEL210"
               ...
               SELECT COUNT(*)
                ...
                WHERE estado_solicitud = 5
                  ...
                  IF v_count_estado = 0 THEN
                     ...
                     CALL fn_dpe_ejecuta_generacion_archivo_creditos(v_folio, p_usuario_cod)
                     EXIT INPUT
                  ELSE
                     CALL fn_mensaje("Atención","El folio ya se utilizo para generar un archivo","info")
                     EXIT INPUT                
                  END IF
...
======================================================================
Clave: 
Nombre: fn_dpe_ejecuta_generacion_archivo_creditos
Fecha creacion: 03/05/2012
Narrativa del proceso que realiza:
Ejecuta el proceso que genera el archivo de salida para DPE solo INFONAVIT
======================================================================
}
FUNCTION fn_dpe_ejecuta_generacion_archivo_creditos(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"DPEL21",
                                 "",p_usuario_cod)
      RETURNING r_bnd_fin_oper
      
      IF (r_bnd_fin_oper = 0) THEN
      
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPES02 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
