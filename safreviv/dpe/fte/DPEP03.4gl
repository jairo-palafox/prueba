--===============================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 25/04/2012
--===============================================================
...
#                para la devolucion pagos indebidos o en exceso solo INFONAVIT          #
...
DEFINE p_pid                       LIKE bat_ctr_operacion.pid -- PID del proceso
   ...
   LET v_s_sql = "EXECUTE FUNCTION fn_pre_integra_credito(?, ?, ?)"
   ...
   CASE
      ...
      LET v_s_sql = "EXECUTE FUNCTION fn_dpe_integra_det_credito(?, ?, ?, ?, ?) "
