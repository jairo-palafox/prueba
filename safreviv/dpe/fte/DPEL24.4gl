...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DPEL240"
   ...
   FROM  cmb_folio ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dpe_reverso_genera_archivo(v_folio, p_usuario_cod)
         EXIT INPUT
...
#OBJETIVO: Ejecutar el reverso de la generación del archivo de salida
FUNCTION fn_dpe_reverso_genera_archivo(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN 
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER15 ",
