...
#Modulo       => DPE                                                                    #
#Programa     => DPEL19                                                                 #
#Objetivo     => Programa que interfaz de usuario para capturar folio preliquidado para #
#                generar sus reverso de preliquidado a integrado solo INFONAVIT.        #
...
DISPLAY g_proceso_cod, g_opera_cod
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "DPEL190"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dpe_reverso_preliquidacion_INFONAVIT(v_folio, p_usuario_cod, v_r_glo_ctr_archivo.nombre_archivo)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_dpe_reverso_preliquidacion_INFONAVIT
Fecha creacion: 01/05/2012
Narrativa del proceso que realiza:
Ejecuta reverso de preliquidacion de modulo DPE solo INFONAVIT
======================================================================
}
FUNCTION fn_dpe_reverso_preliquidacion_INFONAVIT(p_folio, p_usuario_cod, v_nombre_archivo)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER12 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
