...
#Modulo      => DPE                                                            #
#Programa    => DPEL39                                                         #
#Objetivo    => Programa lanzador de la integración del archivo que PROCESAR   #
...
-- se recupera la clave de usuario desde parametro 
   ...
   LET g_opera_cod   = 3 -- Integración del archivo acuse de PROCESAR
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "\n SELECT nombre_archivo, f_actualiza"
                    ...
                    ,"\n WHERE proceso_cod = ",g_proceso_cod
                    ,"\n   AND opera_cod  =2"--g_opera_cod que tiene la carga 
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
           ...
           LET v_s_qry = "\n SELECT COUNT(*)",
                         "\n   FROM TABLE(MULTISET(",
                         "\n                        SELECT DISTINCT reg_patronal, periodo_pago",
                         "\n                          FROM safre_tmp:tmp_det_devolucion_dpe))"
...
======================================================================
Clave: 
Nombre: fn_dpe_ejecuta_integracion
Fecha creacion: Enero 02, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de una devolucion de pagos indebidos de PROCESAR
...
#OBEJTIVO:Obtiene la descripcion del error de la validacion y la muestra en mensaje para suario. 
