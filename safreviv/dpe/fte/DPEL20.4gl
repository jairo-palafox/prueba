...
#                generar sus reverso de liquidado a preliquidado solo INFONAVIT.        #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   IF v_count_estado = 0 THEN
      ...
      OPEN WINDOW w_folio_preliquida WITH FORM "DPEL200"
      ...
      ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            CALL fn_dpe_reverso_liquidacion_INFONAVIT(v_folio, p_usuario_cod)
            EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_dpe_reverso_liquidacion_INFONAVIT
Fecha creacion: 01/05/2012
Narrativa del proceso que realiza:
Ejecuta la reverso preliquidacion de una devolucion por pagos indebidos
 o en exceso para un folio dado solo INFONAVIT
======================================================================
}
FUNCTION fn_dpe_reverso_liquidacion_INFONAVIT(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado_poliza = 0 ) THEN
      ...
      IF ( fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER13 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
