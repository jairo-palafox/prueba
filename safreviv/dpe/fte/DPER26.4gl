...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   END IF
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".DPER26.log")

   LET g_proceso_cod = g_proceso_cod_dpe_procesar_gen -- PROCESAR
   LET g_opera_cod   = 2  -- carga
   ...
   LET p_titulo = "Finalización de proceso - REVERSO 1a VALIDACION ACUSE PROCESAR"
   
   LET p_mensaje = "Finalización de proceso - REVERSO  1a VALIDACION ACUSE PROCESAR","\n",
                  "#\n",
