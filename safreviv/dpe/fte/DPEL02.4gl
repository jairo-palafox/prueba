...
#Modulo       => DPE                                                           #
#Programa     => DPEL02                                                        #
#Objetivo     => Programa lanzador de la integracion de Devolucion de Pagos    #
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_inte_devol WITH FORM "DPEL020"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod,
   ...
   IF ( v_i_resultado = 0 ) THEN  	  
   	   -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"DPEL02","",p_usuario_cod)
           RETURNING r_bnd_fin_oper
      IF (r_bnd_fin_oper = 0) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPEP01" CLIPPED," ",
