...
#Modulo       => DPE                                                           #
#Programa     => DPEL36                                                        #
#Objetivo     => Programa lanzador para reversar la liquidación del proceso    #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   IF v_count_estado = 0 THEN
      ...
      OPEN WINDOW w_folio_preliquida WITH FORM "DPEL360"
      ...
      ATTRIBUTES (UNBUFFERED)
         ...
         BEFORE INPUT
            ...
            DECLARE cur_folios CURSOR FOR 
                                       SELECT DISTINCT a.nombre_archivo, 
                                                       g.folio
                                       FROM   glo_folio g, 
                                              glo_ctr_archivo a, 
                                              dpe_sol_creditos d
         ...
         ON ACTION ACCEPT
            ...
            CALL fn_dpe_reverso_liquidacion_creditos(v_folio, p_usuario_cod)
            EXIT INPUT
   ...
   ELSE
      CALL fn_mensaje("Atención",
                    "Necesita reversar una operación previa","info")
   END IF   
END MAIN

#OBJETIVO: Ejecutar el lanzado del reverso de la liquidación.
FUNCTION fn_dpe_reverso_liquidacion_creditos(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado_poliza = 0 ) THEN
      ...
      IF ( fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER22 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
