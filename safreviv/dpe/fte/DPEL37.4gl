...
#Modulo       => DPE                                                           #
#Programa     => DPERL37                                                       #
#Objetivo     => Programa lanzador para reversar el archivo de salida créditos #  
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "DPEL370"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dpe_reverso_genera_archivo_creditos(v_folio, p_usuario_cod)
         EXIT INPUT
...
#OBJETIVO: Ejecuta la reverso generacion de archivo DPE CRÉDITOS. 
FUNCTION fn_dpe_reverso_genera_archivo_creditos(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER23 ",
