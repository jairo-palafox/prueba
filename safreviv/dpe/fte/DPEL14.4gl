...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_inte_devol WITH FORM "DPEL140"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET l_i_tot_reg = 0
            LET v_s_qry = "\n SELECT COUNT(*)",
                          "\n FROM   safre_tmp:tmp_det_credito_hip_sol"
           ...
           LET v_s_qry = "   SELECT SUM(aportacion_registrada), 
                                    SUM(amortiza_registrada)",
                         "\n FROM   safre_tmp:tmp_det_credito_hip_sol"
           ...
           LET v_s_qry =
               ...
               "\n  FROM safre_tmp:tmp_cza_credito_hip_sol"
           ...
           EXECUTE Prpr_Procedurefecha USING g_proceso_cod,
                                             v_f_gen_archivo 
           INTO v_resultado,
                v_date_gen_archivo;
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          ...
          -- Inicio operacion.
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"DPEL14",
                                    "",p_usuario_cod)
         ...
         IF (r_bnd_fin_oper = 0) THEN
          ...
          LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPEP03 ",
                            p_usuario_cod, " ",
                            g_pid  , " " ,
                            g_proceso_cod , " " ,
                            g_opera_cod ," ",
