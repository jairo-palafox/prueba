...
Autor: José Trinidad Soto Ortega, EFP
...
FUNCTION fn_genera_consulta_rechazo(p_usuario_cod)
   ...
   CALL v_cbx_folios.clear()
         ...
         --CALL v_cbx_registros.addItem(10, "10 Error.Validación")
...
DISPLAY "REGISTRO QUE ENVIA ", p_registro   
   ...
   CALL LLenaArryRegistros(p_registro, p_folio) RETURNING v_si_indice --Llamada a función que obtiene los registros 
         ...
         FOREACH Crs_ObtRegistros INTO rec_tipo_reg.tipo_registro,
            ...
            CASE rec_tipo_reg.tipo_registro
            	...
            	--WHEN '10'
            		 ...
            		 --LET v_ar_registro[li_pos].v_c_desc_registro = "Errores de validación"
            END CASE
