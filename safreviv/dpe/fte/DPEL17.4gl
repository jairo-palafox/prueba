...
#Modulo       => DPE                                                                    #
#Programa     => DPEL17                                                                 #
#Objetivo     => Programa que interfaz de usuario para capturar folio cargado de archivo#
#                para generar su reverso de carga a nuevo proceso. solo INFONAVIT       #
...
MAIN
   ...
   LET g_opera_cod   = g_opera_cod_dpe_carga  -- carga archivo
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "DPEL170"
   ...
   -- se captura el folio
   INPUT v_nombre_archivo WITHOUT DEFAULTS FROM cmb_archivo ATTRIBUTES (UNBUFFERED)
      BEFORE INPUT
...
======================================================================
Clave: 
Nombre: fn_dpe_reverso_carga_archivo
Fecha creacion: 01/05/2012
Narrativa del proceso que realiza:
Ejecuta la reverso de carga de archivo segun archivo modulo DPE
solo INFONAVIT
======================================================================
}
FUNCTION fn_dpe_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER10 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
                          p_folio ," ",ASCII(34),
                          v_nombre_archivo ,ASCII(34)," ",
   ...
   ELSE
      CALL fn_recupera_inconsis_opera(v_si_codigo)
         RETURNING v_s_comando
