--===============================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 30/08/2012
--===============================================================

################################################################################
#Modulo       => DPE                                                           #
#Programa     => DPEL17                                                        #
#Objetivo     => Programa lanzado de reverso de carga de archivo créditos      #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "DPEL330"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   -- Si resultado = 0 
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER19 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
