...
#Modulo       => DPE                                                                    #
#Programa     => DPEL25                                                                 #
#Objetivo     => Programa lanzador que ejecuta el reverso del archivo de PROCESAR       #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "DPEL250"
...
#OBJETIVO: Ejecutar el lanzado del reverso de carga de archivo de respuesta PROCESAR
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DPER16 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
