...
#Modulo            => CTA                                                     #
#Programa          => CTAP06                                                  #
#Objetivo          => PROGRAMA PARA AGREGAR LAS APERTURAS DEL DIA ANTERIOR A  #
#                     LA TABLA DE SALDOS PARA EL ARCHIVO DE PRECALIFICACION   #
#Fecha Inicio      => 31-MAYO-2013                                            #
###############################################################################
DATABASE safre_viv
...
MAIN
   ...
   ELSE
      IF v_estado_ant = 2 THEN
         DISPLAY "El proceso no se puede ejecutar porque las cuentas aperturadas el dia ", v_fcorte USING 'dd-mm-yyyy', " ya fueron agregadas"
         CALL fn_error_opera(p_pid,p_proceso_cod,p_opera_cod) 
         RETURNING r_resultado_opera
      ELSE   
         ...
         DISPLAY "Agregando las cuentas..."
         WHENEVER ERROR CONTINUE
            LET v_fn_genera_saldo_preca = "EXECUTE FUNCTION fn_agrega_delta_preca()"
            ...
            IF SQLCA.SQLCODE <> 0 THEN
               DISPLAY "Ocurrio un ERROR al intentar agregar las cuentas aperturadas para precalificacion: "
         ...
         DISPLAY " termina la ejecucion de la funcion que agrega las cuentas aperturadas"
         ...
         IF v_resultado = 1 THEN
            # Finaliza la operacion de generacion del archivo
				...
				DISPLAY "*******************************************************************"
				DISPLAY ""
				DISPLAY "Termino el proceso que agrega las cuentas aperturadas para Precalificacion"
				DISPLAY " FECHA              : ",TODAY USING 'dd-mm-yyyy'
				DISPLAY " HORA               : ",TIME(CURRENT)
				DISPLAY ""
				DISPLAY "*******************************************************************"
         ...
         ELSE
				DISPLAY "*******************************************************************"
				DISPLAY ""
            DISPLAY "Ocurrio un ERROR al intentar agregar las nuevas cuentas a la tabla de saldos"
				DISPLAY " FECHA              : ",TODAY USING 'dd-mm-yyyy'
				DISPLAY " HORA               : ",TIME(CURRENT)
				DISPLAY ""
				DISPLAY "*******************************************************************"
