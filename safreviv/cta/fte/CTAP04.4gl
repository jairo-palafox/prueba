...
#Modulo            => CTA                                                     #
#Programa          => CTAP04                                                  #
#Objetivo          => PROGRAMA PARA LA TABLA DE SALDOS PARA EL ARCHIVO DEL    #
#                     AREA DE PRECALIFICACION                                 #
      ...
      ELSE   
         ...
         IF v_resultado = 1 THEN
            # Finaliza la operacion de generacion del archivo
				...
				DISPLAY "*******************************************************************"
				DISPLAY ""
				DISPLAY "Termino la preparacion del saldo para Precalificacion"
				DISPLAY " FECHA              : ",TODAY USING 'dd-mm-yyyy'
				DISPLAY " HORA               : ",TIME(CURRENT)
				DISPLAY ""
				DISPLAY "*******************************************************************"
            ...
            #se inicializa el proceso para generar el archivo de Precalificacion
