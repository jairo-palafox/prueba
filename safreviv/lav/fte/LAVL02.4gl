...
#Modulo       => LAV                                                           #
#Programa     => LAVP02                                                        #
#Objetivo     => Lanzador integración archivo precio dólar                     #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, 
   ...
   CALL fn_drgandrop_valida_precio_dolar(p_usuario_cod)

END MAIN

FUNCTION fn_drgandrop_valida_precio_dolar(p_usuario_cod)
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   OPEN WINDOW w_val_precio WITH FORM "LAVL021"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
        ...
        IF v_respuesta = 1 THEN
           CALL fn_lav_ejecuta_validacion(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF

   END DIALOG

CLOSE WINDOW w_val_precio
END FUNCTION -- fn_drgandrop_valida_precio_dolar

#OBJETIVO: Ejecutar el programa lanzador de la validación de datos 
FUNCTION fn_lav_ejecuta_validacion(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       p_nombre_archivo LIKE glo_ctr_archivo.nombre_archivo, -- nombre dle archivo
       v_s_comando      STRING, -- cadena con una instruccion de consola
       r_bnd_val_opera  INTEGER, -- resultado del proceso
       v_mensaje        STRING,
   ...
   IF ( r_bnd_val_opera = 0 ) THEN
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"LAVL02","",p_usuario_cod)
      ...
      IF (r_bnd_opera_ini = 0) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/LAVP01 ",
         ...
         RUN v_s_comando
         CALL fn_mensaje("Atención",
              "Se ha enviado la validación del archivo. \n"||
      ...
      ELSE
       ...
       END IF     
   ELSE
      CALL fn_recupera_inconsis_opera(r_bnd_val_opera) 
           RETURNING v_mensaje
   END IF
END FUNCTION -- fn_lav_ejecuta_validacion