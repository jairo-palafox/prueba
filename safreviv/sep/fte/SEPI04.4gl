...
#Modulo            =>SEPE                                          #
#Programa          =>SEPI04                                        #
#Objetivo          =>Reporte de integracion de operacion 40        # 
...
MAIN
   ...
   LET v_v_nom_reporte = p_v_usuario CLIPPED, "-SEPL04-", p_d_pid USING "&&&&&", "-", p_i_proceso_cod USING "&&&&&", "-", p_i_opera_cod USING "&&&&&"
   ...
   ELSE}
         ...
         IF fgl_report_loadCurrentSettings(r_ruta_bin CLIPPED||"/SEPI041.4rp") THEN
        ...
        --DISPLAY "folio = ",p_d_folio 
         ...
         LET v_consulta = " SELECT case estado when 10 THEN 3 ELSE 4 end case, det02.tipo_movimiento, invadido, asociado,",
