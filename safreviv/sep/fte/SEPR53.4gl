...
#Modulo            => SEP                                                      #
#Programa          => SEPR53                                                   #
#Objetivo          => Batch reverso de validación compensación deudor          #
...
DEFINE v_proceso_desc LIKE cat_proceso.proceso_desc,
   ...
   # Reversa validacion compensacion deudor
   ...
   CALL fn_correo_proceso(p_pid_rev, 
                          ...
                          p_opera_cod_rev, 
                          '', # Archivo adjunto
                          'Finalización de operación - '||v_proceso_desc CLIPPED||' - Reverso de validación Compensación deudor',
                          v_mensaje
                          )
