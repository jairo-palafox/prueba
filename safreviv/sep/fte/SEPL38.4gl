...
#Modulo            => SEP                                                      #
#Programa          => SEPL38                                                   #
#Objetivo          => Reverso liquidacion operacion 28                         #
...
DEFINE v_count_detalle INTEGER,
   ...
   LET v_proceso_cod_rev = 2221 # reverso de liquidacion de operacion 28
   ...
   OPEN WINDOW vtna_reversa_folio WITH FORM v_ruta_bin CLIPPED||"/SEPL381"
         ...
         ON ACTION reverso            
            ...
            IF ( v_confirma ) THEN
                ...
                IF ( r_res_opera = 0 ) THEN
                   ...
                   LET v_comando = "nohup fglrun ",v_ruta_bin CLIPPED,"/SEPR38.42r ",
