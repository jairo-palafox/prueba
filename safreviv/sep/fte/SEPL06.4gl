...
#Modulo            => SEP                                                     #
#Programa          => SEPL34                                                  #
#Objetivo          => LIQUIDACION DE OPERACION 40                             #
#Autor             => Alexandro Hollmann, EFP                                 #
#Fecha Inicio      => 16/Mayo/2018                                            #
###############################################################################
DATABASE safre_viv
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".SEPL06.log")

   LET g_proceso_cod = 2237 -- liquidacion de operacion 28
