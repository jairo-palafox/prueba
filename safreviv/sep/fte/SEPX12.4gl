...
DEFINE v_consulta         STRING,
   ...
   PREPARE prp_crea_tbl_tmp FROM "CREATE TEMP TABLE sep_diag_tmp_inconsistencias_val(mensaje CHAR(254))"
   EXECUTE prp_crea_tbl_tmp

   LET v_consulta = "EXECUTE PROCEDURE sp_sep_valida_diagnostico_op27()"
   ...
   SELECT COUNT(*) 
     INTO v_conteo_inc
     FROM sep_diag_tmp_inconsistencias_val
    WHERE 1 = 1
