...
#Modulo            => SEP                                                      #
#Programa          => SEPL53                                                   #
#Objetivo          => Reverso validacion compensación deudor                   #
...
DEFINE p_usuario_cod   LIKE seg_usuario.usuario, # usuario logeado
   ...
   LET v_proceso_cod_rev = v_proc_reverso_val_compensacion_deudor  # reverso de validación compensación deudor
   LET v_opera_cod_rev   = v_opera_reverso_val_compensacion_deudor  # reverso de validación compensación deudor
   LET v_proceso_cod = v_proc_compensacion_deudor          # compensación deudor
   LET v_opera_cod   = v_opera_carga_compensacion_deudor   # validación de compensación deudor

   
   LET v_folio = 0      # Se indica folio 0 para que el proceso de historico genere un nuevo folio
   LET v_programa_cod = "SEPL53"
   ...
   OPEN WINDOW vtna_reversa_folio WITH FORM v_ruta_bin CLIPPED||"/SEPL531"
         ...
         ON ACTION reverso            
            ...
            IF(v_confirma)THEN
                ...
                IF(r_res_opera = 0)THEN
                   ...
                   LET v_comando = "nohup fglrun ",v_ruta_bin CLIPPED,"/SEPR53.42r ",
                                                   p_usuario_cod, " ",
                                                   v_pid_rev, " ",
                                                   v_proceso_cod_rev," ",
                                                   v_opera_cod_rev," ",
