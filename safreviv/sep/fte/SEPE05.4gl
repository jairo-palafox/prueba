...
#Módulo          => SEP                                                        #
#Programa        => SEPE33                                                     #
#Objetivo        => Programa de preliquidación de op 40                        #
...
DEFINE p_folio       LIKE glo_folio.folio,
   ...
   IF(NUM_ARGS() > 0)THEN
      ...
      IF(r_error = 0)THEN
         ...
         DISPLAY "\nFOLIO DE OPERACIÓN 40 PROCESADO: ",p_folio
         ...
         LET v_comando = "nohup fglrun ",r_ruta_ejecutable CLIPPED,"/SEPI05.42r "
      ...
      LET p_titulo = "Finalización de operación - Op. 40 - Preliquidación"
...
#Módulo          => SEP                                                        #
#Programa        => SEPE33                                                     #
#Objetivo        => Ejecucion de SP de preliquidación de op 40                 #
#Fecha Inicio    => Junio 11, 2018                                             #
################################################################################
...
DEFINE p_folio     LIKE pag_cza_pag_patronal.folio_sua,
   ...
   LET v_consulta = "EXECUTE FUNCTION fn_sep_preliquidar_op40(?)"
   ...
   IF(v_sql_error <> 0)THEN
      ...
      DISPLAY "\nError de ejecución en la preliquidación Op. 40 (Código): ",v_sql_error
      DISPLAY "Error de ejecución en la preliquidación Op. 40 (Mensaje):",v_msn_error,"\n"
   END IF
   RETURN v_error
END FUNCTION
