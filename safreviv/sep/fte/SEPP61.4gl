...
#Módulo          => SEP                                                        #
#Programa        => SEPP61                                                     #
#Objetivo        => Programa de preliquidación de expedientes solo infonavit   #
...
DEFINE v_proceso_desc LIKE cat_proceso.proceso_desc,
   ...
   LET v_consulta = "EXECUTE FUNCTION safre_viv:fn_sep_preliquidar_solo_inf(?,?,?,?,?,?)"
   ...
   CALL fn_correo_proceso(p_pid, 
                          ...
                          p_opera_cod, 
                          '',
                          'Finalización de operación - Preliquidación de Expedientes Solo Infonavit - Preliquidación',
                          ' ID Proceso: '||p_pid||
