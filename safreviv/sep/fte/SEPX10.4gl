--===============================================================
-- Version: 2.0.0
-- Fecha ultima modificacion: 17-09-2015
--===============================================================
################################################################################
#Modulo            => SEP                                                      #
#Programa          => SEPX10                                                   #
...
#MODIFICACION      => 17 de Septiembre de 2015, se deja de considerar detalle03#
################################################################################
DATABASE safre_viv
...
DEFINE v_conteo_det_02    INTEGER,
   ...
   --SE ELIMINA DETALLE 03, por lo tanto no se considera
   --/////////////////////////////////////////////////////
   --SELECT COUNT(*)
   ...
   IF(v_conteo_det_02 <> v_total_sum_02)THEN
      DISPLAY "\n================================================================="
...
DEFINE v_consulta   STRING,
   ...
   PREPARE prp_crea_tbl_tmp FROM "CREATE TEMP TABLE sep_marca_tmp_inconsistencias_val(mensaje CHAR(254))"
   EXECUTE prp_crea_tbl_tmp

   LET v_consulta = "EXECUTE PROCEDURE sp_sep_valida_marca_op27()"
   ...
   SELECT COUNT(*) 
     INTO v_conteo_inc
     FROM sep_marca_tmp_inconsistencias_val
    WHERE 1 = 1
