...
#Modulo            => SEP                                                      #
#Programa          => SEPL43                                                   #
#Objetivo          => Reverso validacion operación 29                          #
...
DEFINE p_usuario_cod   LIKE seg_usuario.usuario, # usuario logeado
   ...
   LET v_proceso_cod_rev = 2220  # reverso de validacion de operacion 29
   LET v_opera_cod_rev   = 1 # reverso de validacion de operacion 29
   LET v_proceso_cod = 2203 # operacion 29
   LET v_opera_cod   = 1 # validacion de operacion 29

   
   LET v_folio = 0      # Se indica folio 0 para que el proceso de historico genere un nuevo folio
   LET v_programa_cod = "SEPL42"
   ...
   OPEN WINDOW vtna_reversa_folio WITH FORM v_ruta_bin CLIPPED||"/SEPL421"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            EXECUTE prp_rec_conteo_det3 USING v_archivo_eleg[1] 
            ...
            EXECUTE prp_rec_conteo_det2 USING v_archivo_eleg[1] 
                                         INTO v_count_detalle
            LET v_det_folio[1].tot_pareja = v_det_folio[1].tot_pareja + v_count_detalle
            ...
            EXECUTE prp_rec_conteo_det5 USING v_archivo_eleg[1] 
                                         INTO v_count_detalle
            ...
            EXECUTE prp_rec_conteo_det6 USING v_archivo_eleg[1] 
                                         INTO v_count_detalle
         ...
         ON ACTION reverso            
            ...
            IF(v_confirma)THEN
                ...
                DISPLAY "Valo proceso: ",v_proceso_cod_rev
                DISPLAY "Valo operaicon: ",v_opera_cod_rev
                # se invoca la funcion que valida ejecucion de reverso
                CALL fn_valida_operacion(0,v_proceso_cod_rev,v_opera_cod_rev) RETURNING r_res_opera
                ...
                IF(r_res_opera = 0)THEN
                   ...
                   LET v_comando = "nohup fglrun ",v_ruta_bin CLIPPED,"/SEPR42.42r ",
                                                   p_usuario_cod, " ",
                                                   v_pid_rev, " ",
                                                   v_proceso_cod_rev," ",
                                                   v_opera_cod_rev," ",
         ...
         ON ACTION cancelar
            ...
            LET v_indice = 1
            DECLARE cur_rec_folios2 CURSOR FOR prp_rec_folios
            FOREACH cur_rec_folios2 USING v_proceso_cod,v_opera_cod
                           INTO v_archivo_pend[v_indice]
               -- se incrementa el indice del arreglo
               LET v_indice = v_indice + 1
            END FOREACH
