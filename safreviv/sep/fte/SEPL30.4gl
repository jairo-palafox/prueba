...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, --Clave de usuario
   ...
   LET g_proceso_cod               = 2202 -- validación de archivo para operacion 28
   ...
   IF ( v_estatus = 0 ) THEN
      ...
      LET v_comando = "fglrun ",v_ruta_ejecutable CLIPPED,"/SEPX30.42r ",
                                                          ...
                                                          0," ", # folio
                                                          "NA" # archivo
      CALL fn_display_proceso(0,"VALIDA ARCHIVO - OPERACION 28")
      ...
      CALL fn_display_proceso(1,"VALIDA ARCHIVO - OPERACION 28")
   ELSE
