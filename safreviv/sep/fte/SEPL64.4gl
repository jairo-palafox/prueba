...
#Modulo            => SEP                                                      #
#Programa          => SEPL64                                                   #
#Objetivo          => Reverso de liquidacion de expedientes sólo infonavit     #
...
DEFINE v_count_detalle INTEGER,
   ...
   LET v_proceso_cod_rev = v_proc_reverso_liq_exp_solo_infonavit # reverso de liquidación de expedientes sólo infonavit
   LET v_opera_cod_rev   = v_opera_reverso_liq_exp_solo_infonavit # reverso de liquidación de expedientes sólo infonavit
   LET v_proceso_cod     = v_proc_expedientes_solo_infonavit # expedientes sólo infonavit
   LET v_opera_cod       = v_opera_liq_expedientes_solo_infonavit # liquidacion de expedientes sólo infonavit
