...
#Modulo            => SEP                                                      #
#Programa          => SEPL38                                                   #
#Objetivo          => Reverso preliquidacion operacion 28                      #
...
DEFINE v_count_detalle INTEGER,
   ...
   LET v_proceso_cod_rev = 2222 # reverso de preliquidacion de operacion 28
   LET v_opera_cod_rev   = 1 # reverso de liquidacion de operacion 28
   ...
   OPEN WINDOW vtna_reversa_folio WITH FORM v_ruta_bin CLIPPED||"/SEPL371"
         ...
         ON ACTION reverso            
            ...
            IF ( v_confirma ) THEN
                ...
                IF ( r_res_opera = 0 ) THEN
                   ...
                   LET v_comando = "nohup fglrun ",v_ruta_bin CLIPPED,"/SEPR37.42r ",
