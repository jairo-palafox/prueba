...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, --Clave de usuario
   ...
   LET g_proceso_cod               = 2201 -- validación de archivo para operacion 27
   ...
   IF ( v_estatus = 0 ) THEN
      ...
      LET v_comando = "fglrun ",v_ruta_ejecutable CLIPPED,"/SEPX10.42r ",
                                                            p_usuario_cod," ",
                                                            g_pid," ",
                                                            g_proceso_cod," ",
                                                            g_opera_cod_carga," ",
      ...
      CALL fn_display_proceso(0,"VALIDA ARCHIVO - OPERACION 27")
      LET v_inicia_proceso = 1 # la carga de archivo inicia el proceso
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod_carga, p_tpo_ejecucion,"SEPL10",v_comando, p_usuario_cod, v_inicia_proceso)
           RETURNING r_bnd_carga;

      CALL fn_display_proceso(1,"VALIDA ARCHIVO - OPERACION 27")
   ELSE
