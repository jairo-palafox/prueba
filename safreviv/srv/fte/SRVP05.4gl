...
PUBLIC FUNCTION fn_genera_estado_cuenta(p_ruta, p_parametros)
   ...
   IF fgl_report_loadCurrentSettings("SRVP05.4rp") THEN
...
REPORT estado_cuenta(p_detalle)
   ...
   PRINTX   v_parametros.nombre_completo,
            ...
            v_parametros.desc_excedente,
            v_parametros.anterior_excedente,
            v_parametros.cargo_excedente,
            v_parametros.abono_excedente,
            v_parametros.final_excedente,
            v_parametros.desc_fortalecimiento,
            v_parametros.anterior_fortalecimiento,
   ...
   BEFORE GROUP OF p_detalle.subcuenta
      CASE p_detalle.subcuenta
            WHEN 41
                LET imagen_grupo = '/safreviv/img/amortizacion.png'
            WHEN 43
                LET imagen_grupo = '/safreviv/img/amortizacionI.png'
            WHEN 40
                LET imagen_grupo = '/safreviv/img/fondos.png'
            WHEN 8
                LET imagen_grupo = '/safreviv/img/viv2.png'
            WHEN 42
                LET imagen_grupo = '/safreviv/img/viv2_2.png'
            WHEN 4
                LET imagen_grupo = '/safreviv/img/viv97.png'
            WHEN 44
                LET imagen_grupo = '/safreviv/img/viv97_1.png'
            WHEN 45
                LET imagen_grupo = '/safreviv/img/voluntarias.png'
            WHEN 46
                LET imagen_grupo = '/safreviv/img/excedentes.png'
            WHEN 49
                LET imagen_grupo = '/safreviv/img/fortalecimiento.png'
        END CASE
        PRINTX imagen_grupo
   ON EVERY ROW
