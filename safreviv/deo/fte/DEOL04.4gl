...
#                para generar su reverso de carga a nuevo proceso.                      #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_deo_carga  -- carga
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "DEOL040"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_deo_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_deo_reverso_carga_archivo
...
FUNCTION fn_deo_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   CALL fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod)
    RETURNING v_i_bandera
   IF ( v_i_bandera = 0 ) THEN
   ...
   -- Si resultado = 0 
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DEOR04 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
   ...
   ELSE
      -- Error a intentar iniciar la operación
