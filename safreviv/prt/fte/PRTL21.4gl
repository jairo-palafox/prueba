...
#Modulo       => PRT                                                           #
#Programa     => PRTL21                                                        #
#Objetivo     => Integración de devolución de saldos cedente                   #
...
MAIN
   ...
   CALL fn_integra_devolucion_saldos_cedente()
...
# Descripción: 
FUNCTION fn_integra_devolucion_saldos_cedente()
...
CONSTANT v_sr_elegido    = "sr_elegido" # Se asigna el nombre de la tabla de archivos elegidos
   ...
   OPEN WINDOW vtna_integra_trasp_receptora WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL211"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION integrar
            ...
            CALL fn_ejecuta_integracion(v_archivos_elegidos[v_renglon_actual])RETURNING r_error
            IF( r_error )THEN
               CONTINUE DIALOG
            ELSE
...
DEFINE v_archivos_pendientes DYNAMIC ARRAY OF STRING,
   ...
   FOREACH cur_recupera_pendientes USING C_PROCESO_COD_DEV_SDO_CEDENTE,
                                         C_OPERA_COD_CARGA
                                    INTO v_archivo
...
FUNCTION fn_ejecuta_integracion(p_archivo)
DEFINE p_archivo  STRING,
   ...
   LET v_consulta = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/PRTE21.42r '",p_usuario_cod CLIPPED, "' ",
                                                                              g_pid CLIPPED, " ",
                                                                              C_PROCESO_COD_DEV_SDO_CEDENTE CLIPPED," ",
