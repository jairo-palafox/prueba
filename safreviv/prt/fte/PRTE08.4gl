...
#Modulo            => PRT                                                      #
#Programa          => PRTE08                                                   #
#Descripcion       => Batch de preliquidación de traspasos subsecuentes        #
#                     receptora                                                #
...
# Descripción: Ejecucion de SP de preliquidación de traspasos subsecuentes receptora
...
DEFINE p_folio     LIKE pag_cza_pag_patronal.folio_sua,
   ...
   LET v_consulta = "EXECUTE FUNCTION fn_prt_preliq_trasp_subsec_receptora(?,?)"
