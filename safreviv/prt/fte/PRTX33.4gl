...
#Modulo       => PRT                                                           #
#Programa     => PRTX33                                                        #
#Objetivo     => Integración rechazos contingente viv 92                       #
...
CONSTANT v_sr_elegido    = "sr_elegido" # Se asigna el nombre de la tabla de archivos elegidos
   ...
   OPEN WINDOW vtna_integra_trasp_receptora WITH FORM v_ruta_ejecutable CLIPPED||"/PRTX331"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         BEFORE DIALOG
            EXECUTE prp_recupera_pid USING "2818" --C_PROCESO_COD_TRANS_SDO_RECEPTORA
                                      INTO g_pid
...
DEFINE v_archivos_pendientes DYNAMIC ARRAY OF STRING,
   ...
   FOREACH cur_recupera_pendientes USING "2818", --C_PROCESO_COD_TRANS_SDO_RECEPTORA,
                                         C_OPERA_COD_CARGA
                                    INTO v_archivo
...
DEFINE p_archivo  STRING,
   ...
   LET v_consulta = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/PRTX34.42r '",p_usuario_cod CLIPPED, "' ",
                                                                              g_pid CLIPPED, " ",
