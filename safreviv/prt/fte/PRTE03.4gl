--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 24/03/2015
--==============================================================================
################################################################################
#Modulo            => PRT                                                      #
#Programa          => PRTE03                                                   #
#Descripcion       => Batch de preliquidación de traspasos de saldos receptora #
#Autor             => Hugo César Ramírez García                                #
#Fecha inicio      => 24 Marzo 2015                                            #
################################################################################
DATABASE safre_viv
...
DEFINE r_error          SMALLINT,
   ...
   LET p_titulo = "Finalización de operación - Preliquidación traspasos receptora"
...
# Descripción: Ejecucion de SP de preliquidación de traspasos receptora
...
DEFINE p_folio     LIKE pag_cza_pag_patronal.folio_sua,
   ...
   LET v_consulta = "EXECUTE FUNCTION fn_prt_preliquidar_traspaso_receptora(?,?,?,?)"
   PREPARE prp_ejecuta_preliquidacion FROM v_consulta
   EXECUTE prp_ejecuta_preliquidacion USING p_folio,
                                            C_ID_MAQUINARIA_SOL_RECP,
                                            C_SENAL_PRELIQUIDA_TRASPASO,
                                            p_usuario_cod
                                       INTO v_sql_error,
                                            v_msn_error,
