...
#Modulo            => PRT                                                      #
#Programa          => PRTX34                                                   #
#Objetivo          => Batch rechazos contingente viv 92                        # 
...
DEFINE r_contingente RECORD 
       nss char(11) ,
       tipo_operacion char(2), 
       mto_pesos_infonavit92 dec(16,2),
       diagnostico char(3)
END RECORD
   ...
   SELECT COUNT(*)
     ...
     FROM safre_tmp:tmp_prt_respuesta_contingente
   ...
   LET v_consulta = " SELECT nss,tipo_operacion,mto_pesos_infonavit92,diagnostico FROM safre_tmp:tmp_prt_respuesta_contingente "
   PREPARE prp_contingente FROM v_consulta 
   DECLARE cur_contingente CURSOR FOR prp_contingente 
   FOREACH cur_contingente INTO r_contingente.nss,
                                r_contingente.tipo_operacion,
                                r_contingente.mto_pesos_infonavit92,
         ...
         INSERT INTO safre_tmp:tmp_prt_integrados VALUES (r_contingente.tipo_operacion,
                                                r_contingente.nss ,
                                                "1" ,
                                                r_contingente.mto_pesos_infonavit92,
                                                r_contingente.diagnostico)
  ...
  -- END IF
   ...
   ELSE
      ...
      IF( v_total_procesados > 0 )THEN
         ...
         LET v_comando = "fglrun ",v_ruta_ejecutable CLIPPED,"/PRTX35.42r '",
                                   p_usuario CLIPPED, "' ",
                                   p_pid CLIPPED, " ",
