...
#Modulo       => PRT                                                           #
#Programa     => PRTX39                                                        #
#Objetivo     => Validación de archivo aceptados contingente portabilidad sar92#
#Fecha inicio => 25 Noviembre 2018                                             #
################################################################################
DATABASE safre_viv
...
DEFINE r_resultado_opera SMALLINT,
   ...
   OPEN WINDOW vtna_valicacion WITH FORM v_ruta_ejecutable CLIPPED||"/PRTX391"
      ...
      CALL fn_valida_operacion(v_pid,
                               ...
                               2819, -- carga resp archivo contingente
                               1) RETURNING r_resultado_opera
      
      IF(r_resultado_opera = 0)THEN
         -- validacion preliminar de layout 
         --LET v_comando = "fglrun ",v_ruta_ejecutable CLIPPED,"/PRTX33.42r ",p_usuario_cod," ",
                                                                            --v_pid," ",
                                                                            --C_PROCESO_COD_TRANS_SDO_RECEPTORA," ",
                                                                            --C_OPERA_COD_CARGA," ",
                                                                            --0," ", # folio
