...
#                    amortización para el módulo de Portabilidad   #
#Autor             =>Héctor Jiménez                                #
#Fecha inicio      =>6 de agosto de 2015                           #
####################################################################
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".PRTL26.log")
   ...
   OPEN WINDOW w_genera_archAmortizacion WITH FORM "PRTL261"
   ...
   ON ACTION ACCEPT
      ...
      LET v_v_nom_archivo = "PRT_" || v_c_liquidacion || "." || v_c_extension CLIPPED
      ...
      LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/PRTS01 ",
                                              p_v_usuario, " ",
                                              v_d_pid, " ",
                                              v_i_proceso_cod, " ",
                                              v_i_opera_cod, " ",
