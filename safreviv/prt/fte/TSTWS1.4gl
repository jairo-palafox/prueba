...
DEFINE wsstatus   INTEGER
   ...
   DEFINE salida DYNAMIC ARRAY OF RECORD
      nss CHAR(11),
   ...
   OPEN WINDOW ventana WITH FORM "TSTWSSVC11"

      DIALOG ATTRIBUTES(UNBUFFERED)

      INPUT BY NAME solicitudCancelacionPortabilidad.mensajeEntradaCancelacion.noCaso
         ON ACTION ACCEPT
            CALL salida.clear()
            CALL cancelacionSolicitudPortabilidad_g() RETURNING wsstatus
            LET salida[1].diagnostico = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.diagnostico
            LET salida[1].estatus = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.estatusAclaracion
            LET salida[1].materno = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.apMaterno
            LET salida[1].no_caso = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.noCaso
            LET salida[1].nombre = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.nombre
            LET salida[1].nss = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.nss
            LET salida[1].paterno = solicitudCancelacionPortabilidadResponse.mensajeSalidaCancelacion.apPaterno
      END INPUT

      DISPLAY ARRAY salida TO record1.*
      END DISPLAY
...
#   INPUT: GLOBAL solicitudCancelacionPortabilidad
...
FUNCTION cancelacionSolicitudPortabilidad_g()
  ...
  IF CancelacionSolicitudPortabilidadService_CancelacionSolicitudPortabilidadServicePortTypeEndpoint.Address.Uri IS NULL THEN
    LET CancelacionSolicitudPortabilidadService_CancelacionSolicitudPortabilidadServicePortTypeEndpoint.Address.Uri = "http://10.90.8.199:6141/ws/r/cancelacionSolicitudPortabilidad"
  END IF
  ...
  WHILE retry
    ...
    TRY
      ...
      #
      CALL xml.Serializer.VariableToStax(solicitudCancelacionPortabilidad,writer)
