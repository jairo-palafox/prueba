...
#Modulo            => PRT                                                      #
#Programa          => PRTL03                                                   #
#Descripcion       => Preliquidación de traspasos de saldos receptora          #
...
CONSTANT v_sr_elegido    = "sr_elegido" # Se asigna el nombre de la tabla de archivos elegidos
   ...
   OPEN WINDOW vtna_preliq_trasp_receptora WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL031"
   ...
   CLOSE WINDOW vtna_preliq_trasp_receptora
...
DEFINE p_folio_preliquidar STRING, 
   ...
   ELSE
      ...
      LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/PRTE03.42r ",p_usuario_cod, " ",
                                                                               g_pid, " ",
                                                                               C_PROCESO_COD_TRANS_SDO_RECEPTORA," ",
                                                                               C_OPERA_COD_PRELIQUIDACION," ",
                                                                               p_folio_preliquidar,
