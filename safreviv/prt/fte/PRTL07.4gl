...
#Modulo       => PRT                                                           #
#Programa     => PRTL07                                                        #
#Objetivo     => Integración de transferencia de saldos subsecuentes receptora #
...
CONSTANT v_sr_elegido    = "sr_elegido" # Se asigna el nombre de la tabla de archivos elegidos
   ...
   OPEN WINDOW vtna_integra_trasp_subsec_receptora WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL071"
   ...
   CLOSE WINDOW vtna_integra_trasp_subsec_receptora
...
DEFINE v_archivos_pendientes DYNAMIC ARRAY OF STRING,
   ...
   FOREACH cur_recupera_pendientes USING C_PROCESO_COD_TRANS_SDO_SUBSEC_RECEPTORA,
                                         C_OPERA_COD_CARGA
                                    INTO v_archivo
...
DEFINE p_archivo  STRING,
   ...
   LET v_consulta = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/PRTE07.42r '",p_usuario_cod CLIPPED, "' ",
                                                                              g_pid CLIPPED, " ",
                                                                              C_PROCESO_COD_TRANS_SDO_SUBSEC_RECEPTORA CLIPPED," ",
