...
#Modulo       => PRT                                                           #
#Programa     => PRTL16                                                        #
#Objetivo     => Validación de archivo de devolución de saldos receptora       #
...
MAIN
   ...
   CALL fn_valida_devolucion()
   
END MAIN

# Descripción: Carga archivo de traspaso de saldos receptora
FUNCTION fn_valida_devolucion()
DEFINE r_resultado_opera SMALLINT,
       r_bnd_carga       BOOLEAN
       
   OPEN WINDOW vtna_valicacion WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL161"
