--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 29 Junio 2015
--==============================================================================

################################################################################
#Modulo       => PRT                                                           #
#Programa     => PRTL20                                                        #
#Objetivo     => Validación de archivo de devolución de saldos cedente         #
...
MAIN
   ...
   CALL fn_valida_devolucion_cedente()
END MAIN

# Descripción: Carga archivo de devolución de saldos cedente
FUNCTION fn_valida_devolucion_cedente()
DEFINE r_resultado_opera SMALLINT,
       r_bnd_carga       BOOLEAN
       

   OPEN WINDOW vtna_valicacion WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL201"
      ...
      IF(r_resultado_opera = 0)THEN
         ...
         LET v_comando = "fglrun ",v_ruta_ejecutable CLIPPED,"/PRTX20.42r ",p_usuario_cod," ",
                                                                            v_pid," ",
                                                                            C_PROCESO_COD_DEV_SDO_CEDENTE," ",
                                                                            C_OPERA_COD_CARGA," ",
                                                                            0," ", # folio
