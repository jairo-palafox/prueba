...
#Modulo       => PRT                                                           #
#Programa     => PRTL17                                                        #
#Objetivo     => Integración de devolucion de saldos receptora                 #
...
# Descripción: 
FUNCTION fn_integra_devolucion()
...
CONSTANT v_sr_elegido    = "sr_elegido" # Se asigna el nombre de la tabla de archivos elegidos
   ...
   OPEN WINDOW vtna_integra_trasp_receptora WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL171"
...
DEFINE v_archivos_pendientes DYNAMIC ARRAY OF STRING,
   ...
   FOREACH cur_recupera_pendientes USING C_PROCESO_COD_DEV_SDO_RECEPTORA,
                                         C_OPERA_COD_CARGA
                                    INTO v_archivo
...
DEFINE p_archivo  STRING,
   ...
   LET v_consulta = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/PRTE17.42r '",p_usuario_cod CLIPPED, "' ",
                                                                              g_pid CLIPPED, " ",
                                                                              C_PROCESO_COD_DEV_SDO_RECEPTORA CLIPPED," ",
