--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 06 Abril 2015
--==============================================================================

################################################################################
#Modulo       => PRT                                                           #
#Programa     => PRTL06                                                        #
#Objetivo     => Validación de archivo de traspaso de saldos subsecuentes      #
#                receptora                                                     #
...
# Descripción: Carga archivo de traspaso de saldos subsecuentes receptora
FUNCTION fn_valida_traspaso_receptora()
DEFINE r_resultado_opera SMALLINT,
       r_bnd_carga       BOOLEAN
       

   OPEN WINDOW vtna_valicacion WITH FORM v_ruta_ejecutable CLIPPED||"/PRTL061"
      ...
      IF(r_resultado_opera = 0)THEN
         ...
         LET v_comando = "fglrun ",v_ruta_ejecutable CLIPPED,"/PRTX06.42r ",p_usuario_cod," ",
                                                                            v_pid," ",
                                                                            C_PROCESO_COD_TRANS_SDO_SUBSEC_RECEPTORA," ",
                                                                            C_OPERA_COD_CARGA," ",
                                                                            0," ", # folio
