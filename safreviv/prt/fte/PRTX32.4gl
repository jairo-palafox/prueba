...
#Modulo       => PRT                                                           #
#Programa     => PRTX321                                                       #
#Objetivo     => Validación de archivo de contingente portabilidad sar 92      #
...
DEFINE r_resultado_opera SMALLINT,
   ...
   OPEN WINDOW vtna_valicacion WITH FORM v_ruta_ejecutable CLIPPED||"/PRTX321"
      ...
      CALL fn_valida_operacion(v_pid,
                               ...
                               2818, -- carga resp archivo contingente
