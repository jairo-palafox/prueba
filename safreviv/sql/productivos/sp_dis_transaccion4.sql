...
CREATE PROCEDURE "safreviv".sp_dis_transaccion4(p_id_derechohabiente  DECIMAL(9,0), 
...
LET v_tpo_transferencia = 15; --Asigna valor Transferencia de Acreditados
...
LET v_movimiento        = 782; --Cargo devolución pago liquidado

  --###################################--
  --Se calcula el monto_pesos
  ...
  LET v_char = "Terminada transacción 4 correctamente";
