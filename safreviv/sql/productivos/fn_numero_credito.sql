...
create procedure "safreviv".fn_numero_credito(p_folio_liquida      DECIMAL(9,0),
...
END EXCEPTION
  ...
  {DROP TABLE dis_dse_num_cred;

  CREATE TABLE dis_dse_num_cred
  ...
  FOREACH
    ...
    WHERE  dse.id_derechohabiente = afi.id_derechohabiente
    {AND    dse.folio_referencia  IN (
                                     9913,
                                     9914,
                                     9915,
                                     9916,
    ...
    AND    dse.folio_referencia   = p_folio_liquida
    ...
    INSERT INTO dis_dse_num_cred VALUES (v_id_dse_devolucion,
                                         v_nss,
                                         v_id_derechohabiente,
                                         v_num_credito_err,
                                         v_num_credito_cor,
