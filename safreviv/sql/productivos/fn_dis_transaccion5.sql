...
CREATE PROCEDURE "safreviv".fn_dis_transaccion5(p_fecha_01mm           DATE,          --Fecha de movimiento, proceso
...
--TRACE ON;
  ...
  LET v_char = "  Preliquidación aclaratorio finalizo correctamente";
