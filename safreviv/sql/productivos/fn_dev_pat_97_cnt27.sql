...
create procedure "safreviv".fn_dev_pat_97_cnt27(p_folio_liquida      DECIMAL(9,0),  --Folio de liquidación del proceso
...
DEFINE v_monto_no_disp       DECIMAL(20,2);  --Monto no dispersados
  ...
  -- Cuenta Contable Devolución a Patrones
  -- (Cargo y Abono)
  ...
  FOREACH
    ...
    -- Cuenta Contable Subcuentas SAR 97 y Amortización (Concentradora)
    --(Cargo y Abono)
    SELECT SUM(monto_pesos)
    INTO   v_monto_pesos
    FROM   safre_viv:cta_movimiento
