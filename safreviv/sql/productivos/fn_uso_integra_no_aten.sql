...
CREATE FUNCTION "safreviv".fn_uso_integra_no_aten(p_v_usuario CHAR(20),
   ...
   DEFINE v_ax_cre_uso_garant      DECIMAL(9,0); -- identificador de uso garantia en temporal
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/usoIntegNoAtend.trace';
   --TRACE ON;
    ...
    SELECT *
      ...
      ELIF tmp_tpo_transferencia = "18" OR tmp_tpo_transferencia = "48" THEN
         ...
         FOREACH
            ...
            SELECT id_cre_uso_garantia, estado, edo_procesar, tpo_transferencia
              INTO v_ax_id_cre_uso_garantia, v_ax_estado_uso, v_ax_edo_proc_uso, tmp_tpo_transferencia
