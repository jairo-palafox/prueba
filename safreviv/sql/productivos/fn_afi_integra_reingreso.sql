...
CREATE FUNCTION "safreviv".fn_afi_integra_reingreso(p_usuario_cod CHAR(20)   , p_folio DECIMAL(10), 
...
DEFINE v_num_reingresos_realizados            INTEGER;
   ...
   FROM safre_tmp:tmp_afi_reingreso
      ...
      IF ( afi_relacion_laboral_nrp IS NULL ) THEN
         ...
         LET afi_his_derechohab_folio_lote_modifica  = p_folio;         LET afi_his_derechohab_ind_modifica         = 8; -- CAMBIO POR REINGRESO
