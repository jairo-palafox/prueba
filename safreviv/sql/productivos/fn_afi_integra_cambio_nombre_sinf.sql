...
CREATE FUNCTION "safreviv".fn_afi_integra_cambio_nombre_sinf(p_usuario_cod CHAR(20),
                                                  p_folio DECIMAL(10),
   ...
   --SET DEBUG FILE TO "/ds/safreviv_int/BD/debug_fn_afi_integra_cambio_nombre_sinf.trace";
   ...
   FROM safre_tmp:tmp_afi_sinf_cambio_nombre
      ...
      SET    nombre_imss   = tmp_afi_cambio_nombre_nombre_correcto,
             ap_paterno_af = afi_his_derechohab_ap_paterno_af     ,
             ap_materno_af = afi_his_derechohab_ap_materno_af     ,
             nombre_af     = afi_his_derechohab_nombre_af
      WHERE  nss = tmp_afi_cambio_nombre_nss;
