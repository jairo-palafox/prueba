...
CREATE FUNCTION "safreviv".fn_procesa_marca_cta_rec(p_v_usuario         CHAR(20),
   ...
   DEFINE v_ocg_formalizacion       DECIMAL(9,0);
                  ...
                  AND f_proceso  = TODAY;
{
               ...
               IF cre_tpo_credito = 2 THEN
                  ...
                  UPDATE ocg_acreditado
                     SET f_marca_infonavit    = v_ax_f_solicita,
