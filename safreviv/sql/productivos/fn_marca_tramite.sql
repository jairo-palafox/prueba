...
CREATE FUNCTION "safreviv".fn_marca_tramite(p_nss CHAR(11), p_num_credito DECIMAL(10,0), p_f_vigencia DATE)
         ...
         IF vcodResp <> 208 THEN
            IF NOT EXISTS (  ---Se verifica que no esté ya inciado el trámite
               ...
               IF vcodResp = "2000" THEN
                  ...
                  IF vid_cre_acreditado IS NULL OR vid_cre_acreditado = 0 THEN
                     LET vid_cre_acreditado = 0;
           ...
           {-----todos los trámites deben irse a Procesar SACI2017-45
            ...
            IF vcodResp <> "2000" AND vcodResp <> "3000" AND vcodResp <> "212" THEN
