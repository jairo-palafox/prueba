...
CREATE PROCEDURE "safreviv".sp_dis_apo_subs1_ea(v_folio DECIMAL(9,0), v_edo_rech SMALLINT)
...
END EXCEPTION
  ...
  INSERT INTO dis_ctr_ap_subsecuente_ea VALUES (v_folio,
                                                v_f_transferencia,
                                                v_tot_registros,
                                                v_tot_imp_apo_pat,
                                                v_tot_imp_amo_cred,
  ...
  LET v_char = "Terminado Apo_subs_ea_SPL";
