...
CREATE PROCEDURE "safreviv".sp_dis_apo_subs2(p_folio DECIMAL(9,0), p_edo_rech SMALLINT)
...
END EXCEPTION
   ...
   FOREACH
     ...
     INSERT INTO dis_ap_subsecuente
     VALUES (p_folio,
             v_folio_liquida,
             v_id_interface_ef,
     ...
     EXECUTE FUNCTION fn_dif_apo_sub(v_id_derechohabiente,
                                     v_folio_sua,
                                     v_periodo_bimestre,
                                     v_f_pago,
                                     v_reg_pag_imss,
   ...
   LET v_char = "Terminado Apo_subs2_SPL";
