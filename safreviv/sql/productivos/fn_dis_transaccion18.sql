...
CREATE PROCEDURE "safreviv".fn_dis_transaccion18(p_edo_credito          SMALLINT,       --Tipo de credito del derechohabiente
...
DEFINE v_id_crd_ceros        DECIMAL(9,0);  --Secuencia de interfaz
...
LET v_id_crd_ceros    = 0;
  ...
  LET v_char = "  Terminada lanzador de transacciones Créditos en Ceros";
