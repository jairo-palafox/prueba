...
CREATE PROCEDURE "safreviv".sp_integra_recurrente_sin_orig(p_v_usuario CHAR(20),
   ...
   DEFINE v_sin_sdo_deudor         DECIMAL(12,2);
   ...
   DEFINE v_sin_sdo_credito        DECIMAL(12,2);
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/acrIntegRecurrSinOrig.trace';
   --TRACE ON;
   
   -- se inicializan variables
   LET v_i_estado           = 2; -- estado Integrado en la tabla glo ctr archivo
   LET v_ax_tpo_originacion = 1; -- 1-Transferencia de Acreditados
