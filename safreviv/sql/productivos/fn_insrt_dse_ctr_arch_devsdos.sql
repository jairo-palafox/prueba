...
CREATE FUNCTION "safreviv".fn_insrt_dse_ctr_arch_devsdos(p_c_nom_archivo CHAR(40),
                                              p_d_pid         DECIMAL(9,0),
                                              p_v_usuario     CHAR(20),
                                              p_i_estado      SMALLINT)
   ...
   DEFINE v_cnt_nss                SMALLINT; -- contienene el número de nss no catalogados
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_insrt_dse_ctr_arch_devsdos.trace';
   --TRACE ON;

   -- se asigna la operacion del proceso (15 - Devocucion De Saldos)
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_cuenta_reg
        FROM safre_tmp:tmp_dse_devolucion_sum;
   ...
   IF p_i_estado = 10 THEN
      ...
      INSERT INTO safre_tmp:tmp_nss_no_catalogados_acr
      SELECT nss,
             saldo_vivienda97,
             saldo_vivienda92
        FROM safre_tmp:tmp_dse_devolucion
