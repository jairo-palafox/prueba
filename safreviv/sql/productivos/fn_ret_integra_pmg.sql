...
CREATE FUNCTION "safreviv".fn_ret_integra_pmg(p_usuario_cod CHAR(20), p_folio DECIMAL(9,0), p_nombre_archivo VARCHAR(40), 
                                   p_pid DECIMAL(9,0),p_proceso_cod SMALLINT ,p_marca SMALLINT) 
   ...
   FROM   safre_tmp:tmp_ret_det_pmg;
   ...
   FROM   safre_tmp:tmp_ret_sum_pmg;
   ...
   FOREACH
    ...
    FROM     safre_tmp:tmp_ret_cza_pmg 
   ...
   FROM
      ...
      IF ( v_validar_3_primeros_campos <> "030480" ) THEN
         -- se marca la bandera de rechazo de detalle
         LET v_b_rechazo_detalle    = 1;
         ...
         -- 3	Identificador de Operación	X	02	00	005	-	006	80 PMG
         IF ( tmp_ret_det_id_operacion <> "80" ) THEN
...
/*       
      ...
      IF ( tmp_ret_det_nombre_afore  <> v_nombre_af  ) THEN
         LET v_b_rechazo_detalle = 1;
      ...
      IF ( tmp_ret_det_paterno_afore  <> v_ap_paterno_af  ) THEN
         LET v_b_rechazo_detalle = 1;
      ...
      IF ( tmp_ret_det_materno_afore  <> v_ap_materno_af  ) THEN
         LET v_b_rechazo_detalle = 1;
...
*/       
      ...
      IF ( v_b_rechazo_detalle = 1 ) THEN
         ...
         -- No se considera la subcuenta de vivienda 72, segun requerimiento PRODINFXVI-128
      ...
      IF ( ret_disposicion_aivs_viv97 > 0 ) THEN
         ...
         --IF ( ret_disposicion_aivs_viv97 > (v_saldo_97_aivs + 1) ) THEN -- COMENTADO DE MOMENTO PARA LIBERAR CAMBIO
         IF v_saldo_97_aivs > 0 THEN   
            IF ( ret_disposicion_aivs_viv97 > (v_saldo_97_aivs + v_max_aivs_sobregiro) ) THEN
            ...
            ELSE
               ...
               ELSE
                  ...
                  ELSE
                     ...
                     ELSE
                        -- si se trata de algun retiro PMG
                        IF ( v_i_estado_marca = 808 ) THEN
