...
CREATE FUNCTION "safreviv".fn_cred_liq_vivienda (p_id_derechohabiente DECIMAL(9,0), p_valida SMALLINT)

   RETURNING SMALLINT, SMALLINT, SMALLINT, DECIMAL(10,0), DATE, DATE;
   ...
   ON EXCEPTION SET v_resultado
      ...
      RETURN v_resultado, v_tpo_originacion, v_tpo_credito, v_num_credito, v_f_otorga, v_f_liquida;
   END EXCEPTION
