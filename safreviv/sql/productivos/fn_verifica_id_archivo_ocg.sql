...
CREATE FUNCTION "safreviv".fn_verifica_id_archivo_ocg(p_subproc SMALLINT)
RETURNING DECIMAL(9,0), DECIMAL(9,0)
   ...
   IF p_subproc = 2 THEN
      LET v_id_proceso         = 3903;
      LET v_nom_archivo        = "ORIG_SAC43BIS_"||v_fecha[4,5]||v_fecha[1,2]||v_fecha[7,10]||".rcg";
      LET v_operacion          = 10;
   ELIF p_subproc = 3 THEN
      LET v_id_proceso         = 3906;
      LET v_nom_archivo        = "UG_SAC43BIS_"||v_fecha[4,5]||v_fecha[1,2]||v_fecha[7,10]||".rcu";
      LET v_operacion          = 10;
   ELSE
      LET v_id_proceso         = 3907;
      LET v_nom_archivo        = "DESMARCA_SAC43BIS_"||v_fecha[4,5]||v_fecha[1,2]||v_fecha[7,10]||".dmg";
      LET v_operacion          = 10;
   END IF
