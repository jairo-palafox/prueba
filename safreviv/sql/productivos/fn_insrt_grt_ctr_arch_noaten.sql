...
CREATE FUNCTION "safreviv".fn_insrt_grt_ctr_arch_noaten(p_c_nom_archivo CHAR(40),
                                             p_i_estado SMALLINT,
                                             p_v_usuario CHAR(20))
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/grtCtrArch_noAten.trace';
   --TRACE ON;
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_tot_regs_aux
        FROM safre_tmp:tmp_no_atend_sum_grt;
   ...
   IF p_i_estado = 10 THEN
      SELECT num_reg_marca, num_reg_sin_tram
