...
CREATE FUNCTION "safreviv".sp_mdt_inserta_inst_recurrente(
                               p_folio DECIMAL(9,0),
                               p_usuario CHAR(20))
...
DEFINE v_msg_error               CHAR(200);
   ...
   END FOREACH
   --TRACE '11';
   UPDATE STATISTICS FOR TABLE mdt_solicitud_mandato;   
   UPDATE STATISTICS FOR TABLE mdt_ctr_mandato ;
   UPDATE STATISTICS FOR TABLE mdt_det_ctr_mandato;
