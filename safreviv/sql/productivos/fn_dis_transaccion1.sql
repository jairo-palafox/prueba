...
create procedure "safreviv".fn_dis_transaccion1(p_edo_credito          SMALLINT,       --Tipo de credito del derechohabiente
                                     ...
                                     p_tpo_credito          SMALLINT)       --Tipo crédito 
...
LET v_bnd_transaccion      = 0;
  ...
  IF p_edo_credito = 2 THEN -- Si esta liquidado
     --DEVOLUCION DE IMPORTES EXCEDENTES para APORTACIONES
     EXECUTE PROCEDURE sp_dis_Transaccion4(p_derechohabiente_pag,
                                           p_num_credito,
                                           p_periodo_bimestre,
                                           p_f_pago,
                                           p_imp_ap_pat,
                                           ...
                                           p_aiv_ap_pat,
                                           p_tpo_credito) --Se agrega valor de AIVS
     ...
     EXECUTE PROCEDURE sp_dis_Transaccion5(p_derechohabiente_pag,
                                           ...
                                           p_destino_ap_viv,
                                           p_tpo_credito) --Se agrega destino
                  INTO v_bnd_transaccion, v_status, error_info;	

	
     --Incluir la sp_dis_transaccion12 solo con amortización
     {EXECUTE PROCEDURE sp_dis_Transaccion12(p_derechohabiente_pag,
                                            p_num_credito,
                                            p_periodo_bimestre,
                                            p_f_pago,
                                            p_imp_ap_pat,
                                            ...
                                            p_tpo_patron,
                                            p_localiza_trabajador,
                                            p_aiv_ap_pat, --Se agrega valor de las AIVS
                                            p_cve_ent_receptora,
                                            p_monto_pesos_real,
                                            p_nss,
                                            p_periodo_pago)
  ...
  ELSE --No se encuentra liquidado
     --Pago a Cartera
     EXECUTE PROCEDURE sp_dis_Transaccion3(p_derechohabiente_pag,
                                           p_imp_ap_pat,
                                           p_monto_pesos,
                                           p_monto_pesos_real,
                                           p_folio_disp,
  ...
  LET v_char = "  Terminada lanzador de transacciones sin AVANCE ABIERTO";
