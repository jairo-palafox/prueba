...
create procedure "safreviv".fn_compensa_int_ef()
...
{create table tmp_compensa_avance_ef (id_derechohabiente  decimal(9,0),
...
FOREACH
  ...
  FOREACH
    ...
    ELSE
       ...
       FROM   tmp_compensa_avance_ef tmp
       WHERE  tmp.id_dis_det_avance = v_id_dis_det_avance;
       IF DBINFO('sqlca.sqlerrd2') == 0 THEN
          INSERT INTO tmp_compensa_avance_ef VALUES(v_id_derechohabiente,
                                                    v_id_dis_det_avance,
                                                    v_folio_dis,
                                                    v_folio_liquida,
                                                    v_num_credito,
