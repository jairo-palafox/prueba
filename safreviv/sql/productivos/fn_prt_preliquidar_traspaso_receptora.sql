...
CREATE FUNCTION "safreviv".fn_prt_preliquidar_traspaso_receptora(p_folio         DECIMAL(9,0),
...
DEFINE v_registros_procesados    INTEGER;
...
DEFINE v_fecha_actual      DATE;
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_prt_preliquidar_traspaso_sdo_receptora.trace';
   --TRACE ON;
   ...
   LET v_total_abonos         = 0.0;
   LET v_total_saldo_insoluto = 0.0;
   LET v_tpo_operacion = "01"; --incializa como traspaso de saldo total

   LET v_subcuenta_prt  = 60; -- Subcuenta de portabilidad
   LET v_abono_traspaso = 1601; -- Movimiento de Abono por traspaso de saldos receptora
   LET v_cargo_traspaso = 1602; -- Movimiento de Cargo por traspaso de saldos receptora
   ...
   --se modifica fecha_valor a 1ero de mes actual
   LET v_fecha_1er_natural = MDY(MONTH(TODAY),'01',YEAR(TODAY));
   ...
   FOREACH SELECT id_prt_traspaso_receptora,
             ...
             INTO v_id_prt_traspaso_receptora,
                  ...
                  --v_curp,
                  v_tpo_operacion,
                  --v_id_credito_infonavit,
                  v_sdo_insoluto_infonavit,
                  --v_f_originacion_infonavit,
                  --v_precio_aiv_fov2008,
                  --v_f_precio_aiv_fov2008,
                  --v_mto_aivs_fov2008,
                  v_mto_pesos_fov2008
      ...
      LET v_ind = 0 ; LET v_error_sql = 0; --se inicializan

      IF v_tpo_operacion = "01" THEN --se valida maquinara solo cuando es traspaso de saldo, para subsecuentes simuladas como saldo no

         EXECUTE FUNCTION fn_glo_maq_individual(p_id_maquinaria,
                                                v_id_prt_solicitud_receptora,
                                                p_senal,
                                                p_usuario_cod)
         INTO v_ind,
      ...
      IF( v_ind = 0 AND v_error_sql = 0 )THEN
      ...
      END IF
      LET v_registros_procesados = v_registros_procesados + 1;
