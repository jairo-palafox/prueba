...
CREATE FUNCTION "safreviv".fn_acr_liquida_fondo72(p_folio DECIMAL(9,0))
   RETURNING SMALLINT;
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/acrLiquidaFondo72.trace';
   --TRACE ON;
   ...
   INSERT INTO safre_viv:cta_fondo72 SELECT * FROM safre_tmp:tmp_acr_fondo72;
