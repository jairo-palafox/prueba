...
CREATE FUNCTION "safreviv".fn_genera_saldo_mensual()
RETURNING SMALLINT, VARCHAR(100);
   ...
   WHERE sdo.movimiento NOT IN (422,601,841)  --Se omiten los movimientos de cargo y abono para el tanto adicional
   AND sdo.f_liquida <= v_fcorte
   GROUP BY sdo.subcuenta
   ;
