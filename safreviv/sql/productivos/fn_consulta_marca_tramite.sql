...
CREATE FUNCTION "safreviv".fn_consulta_marca_tramite(p_id_derechohabiente CHAR(11),
                                          p_nss CHAR(11))
...
RETURNING SMALLINT, DECIMAL(9,0), CHAR(4), VARCHAR(140)
   ...
   ON EXCEPTION SET verror
      ...
      RETURN verror, p_nss, vcodResp, vdescResp;
   END EXCEPTION

   --SET DEBUG FILE TO '/ds/safreviv_int/BD/consultaMarcaws.trace';
   --SET DEBUG FILE TO '/safreviv_req/PRODINFXV-106/consultaMarcaws.trace';
   --TRACE ON;
   ...
   IF vbnd = 0 THEN
      ...
      IF vcodResp <> "2000" AND
         ...
         RETURN verror, p_id_derechohabiente, vcodResp, vdescResp;
      ELSE
...

  {
   IF vbnd = 0 THEN
      ...
      RETURNING verror, p_id_derechohabiente, vcodResp, vdescResp;

      IF vcodResp = 208 THEN
         LET vbnd = 1;

         RETURN verror, p_id_derechohabiente, vcodResp, vdescResp, vpesos92, vpesos97;
      ELSE
         IF vcodResp = "2213" THEN
            LET vcodResp1  = "2213";
            LET vdescResp1 = vdescResp;
