...
CREATE PROCEDURE "safreviv".sp_bus_ejecuta_negocio_pr(p_id_bus_tramite           DECIMAL(9,0),
...
--SET DEBUG FILE TO '/afore/ing/safreps/sp_bus_ejecuta_negocio.trace';
--SET DEBUG FILE TO '/ds/safrebus/bus/log/sp_bus_ejecuta_negocio.trace';
--TRACE ON;
...
-- se pega la cadena variable de error
   ...
   END FOREACH;
           ...
           --LET v_txt = "EXECUTE PROCEDURE "||TRIM(v_programa)|| --invonavit
