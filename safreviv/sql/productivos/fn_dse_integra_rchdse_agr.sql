...
CREATE FUNCTION "safreviv".fn_dse_integra_rchdse_agr(p_d_pid DECIMAL(9,0),
                                          p_v_usuario CHAR(20),
   ...
   DEFINE tmp_nss_separacion          CHAR(11);
   DEFINE tmp_origen_devolucion       DECIMAL(2,0);
   DEFINE tmp_monto_aportaciones      DECIMAL(15,0); -- (13,2)
   DEFINE tmp_aplic_interes_aporta    DECIMAL(15,0);
   DEFINE tmp_filler5                 CHAR(2);
   --DEFINE tmp_num_aplic_interes92     DECIMAL(9,6); -- (9,6)
   DEFINE tmp_num_aplic_interes92     DECIMAL(15,0); -- (9,6)
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_dse_integra_rchdse_agr.trace';
   --TRACE ON;

   -- se inicializa el contador de registros
   LET v_ax_tpo_transf_dse     = "43"; -- 43-DSE Anualidades Garantizadas
   LET v_ax_tpo_transf_rch_dse = "36"; -- 36- Rechazo de DSE AGR
   ...
   FOREACH
      ...
      FOREACH
         ...
         -- se inserta registro
         INSERT INTO safre_tmp:tmp_deudor_rech_devol_saldo_agr (
                     id_dse_devolucion,
                     id_derechohabiente,
                     nss,
                     folio_archivo)
