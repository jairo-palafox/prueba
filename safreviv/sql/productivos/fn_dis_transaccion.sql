...
CREATE PROCEDURE "safreviv".fn_dis_transaccion(p_fecha_01mm           DATE,          --Fecha de movimiento, proceso
...
--SET DEBUG FILE TO '/safreviv/dis/sql/fn_dis_transaccion.TRACE';
--SET DEBUG FILE TO '/home/safreviv/fn_dis_transaccion.TRACE';
--TRACE ON;
  ...
  FOREACH
    ...
    --Valor resultado = 3:  Crédito en trámite   25072017
    LET v_edo_credito    = 0;
    LET v_f_liquida_cred = '';
    LET v_tpo_credito    = 0;
    LET v_valida         = 1;
    ...
    ELSE -- Del destino de la aportacion 
       ...
       IF v_destino_ap_viv = 1 THEN -- Dispersión a INFONAVIT
          ...
          -- v_tpo_credito = 21  UN CUARTO MAS
