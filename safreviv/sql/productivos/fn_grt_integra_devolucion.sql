...
CREATE FUNCTION "safreviv".fn_grt_integra_devolucion(p_v_usuario CHAR(20),
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/grtIntegDevolucion.trace';
   --TRACE ON;
    ...
    SELECT *
      ...
      FOREACH
       SELECT FIRST 1 id_cre_acreditado, estado, edo_procesar
        ...
        WHERE estado >= 20 --IN (20,900,910,920)
          AND edo_procesar < 120 -->= 55 --IN (5, 55, 60, 70, 200, 210)
      ...
      LET his_diagnostico        = tmp_mvo_devolucion;
      ...
      EXECUTE PROCEDURE safre_viv:sp_act_cre_transf(his_id_cre_acreditado, 70);
   END FOREACH;
   ...
   EXECUTE FUNCTION safre_viv:fn_act_edo_archivo(p_v_arch_proceso, p_d_folio, v_ax_glo_estado, p_v_usuario) INTO r_ax_bandera;
