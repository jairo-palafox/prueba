...
CREATE PROCEDURE "safreviv".sp_dis_transaccion2(p_id_derechohabiente  DECIMAL(9,0),   --ID Derechohabiente
...
LET v_id_ref_seq      = 0;
  ...
  IF p_imp_ap_pat > 0 THEN
     ...
     INSERT INTO dis_interface_ef_ad VALUES(seq_dis_interface_ef_ad.NEXTVAL,
     ...
     --Funcionalidad de Adelanto de Aportaciones Subsecuentes
     ...
     INSERT INTO dis_ctr_aps_tns VALUES(seq_dis_interface_ef_ad.CURRVAL,
                                        p_id_derechohabiente,
                                        p_folio_sua,
                                        p_periodo_pago,
                                        p_fecha_pago_val,
  ...
  LET v_char = "Terminada transacción 2 correctamente";
