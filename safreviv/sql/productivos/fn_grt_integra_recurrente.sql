   ...
   FOREACH
    SELECT t.*,
     ...
     -- se consulta el tipo de crédito y el tipo originación para el tipo credito
      ...
      -- * el tipo de credito debe ser de originación 2 (no debe ser nulo)
      IF v_ax_id_derechohabiente IS NOT NULL AND
         ...
         INSERT INTO cre_acreditado (
             ...
             VALUES (cre_id_cre_acreditado,
                     ...
                     cre_estado);
{
         -- se asigna el id credito correspondiente a Créditos en Garantía 34 Bis
         LET v_ax_id_credito = 2;
}
         -- 06/07/2012 12:35:08 p.m. Todos se actualizarán con id credito igual a 1
