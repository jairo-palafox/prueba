...
CREATE FUNCTION "safreviv".fn_busca_rechazo_ccnss
   ...
   FOREACH
      ...
      FROM   cta_rechazos_acl a
             INNER JOIN cta_pag_complemento b
                  ON (b.folio = a.folio AND b.id_referencia = a.id_referencia)
