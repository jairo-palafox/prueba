...
CREATE FUNCTION "safreviv".fn_glo_recupera_etiquetas_id(p_entidad             CHAR(40), -- Entidad principal de la cual se obtendran etiquetas y valores
...
DEFINE v_msg_error           CHAR(1024);
   ...
   LET v_consulta = "SELECT cat.etiqueta,"||
                    ...
                    " ORDER BY cat."||TRIM(v_nombre_col_orden);
