...
CREATE PROCEDURE "safreviv".sp_status_retiro_fondo_ahorro_acti(v_causa_rec   SMALLINT, --causa de rechazo
  ...
  --SET DEBUG FILE TO '/ds/safreviv_int/BD/sp_status_retiro_fondo_ahorro_acti.log';
  ...
  FOREACH cu_status_fondo_ahorro FOR SELECT id_referencia,id_afi_fondo72
   ...
   UPDATE  ret_fondo_ahorro_generico SET estado_solicitud     = v_estatus,
