...
create procedure "safreviv".fn_uni_ctas_cnt37(p_folio_liquida      DECIMAL(9,0),  --Folio de liquidación del proceso
...
DEFINE v_monto_pesos_si      DECIMAL(20,2);  --Monto en pesos solo infonavit
  ...
  LET v_monto_pesos         = 0;
  LET v_monto_pesos_si      = 0;

  --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_uni_ctas_cnt37.trace';
  ...
  FOREACH
    ...
    --ERE  cod_transaccion_cnt  = p_transaccion
    ...
    --Monto para la Subceunta Solo Infonavit 2504080001
    --Cargo y Abono
    IF v_cta_contable = '2504080001' THEN
       LET v_monto_pesos = v_monto_pesos_si;
    END IF
