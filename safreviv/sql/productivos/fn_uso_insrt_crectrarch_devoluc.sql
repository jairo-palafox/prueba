...
CREATE FUNCTION "safreviv".fn_uso_insrt_crectrarch_devoluc(p_c_nom_archivo CHAR(40),
                                                p_i_estado      SMALLINT,
                                                p_c_usuario     CHAR(20))
   RETURNING SMALLINT, INTEGER
   -- Registro de acr ctr archivo
   DEFINE v_ra_id_cre_ctr_arch DECIMAL(9,0);
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/usoCtrArch_devoluc.trace';
   --TRACE ON;
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_tot_regs_aux
        FROM safre_tmp:tmp_devoluc_sum_uso;
