...
CREATE PROCEDURE "safreviv".sp_hps_modifica_mandato(p_id_solicitud DECIMAL(10), p_credito DECIMAL(10), 
                                         p_id_derechohabiente DECIMAL(9), p_tpo_accion CHAR(1),p_usuario CHAR(20))
   RETURNING INTEGER;
   ...
   DEFINE nombre_campo_hps         CHAR(40);
   DEFINE vtabid                   INTEGER; 
   DEFINE vid_cat_dato_actualizado DECIMAL(9,0);
   DEFINE vid__mdt_his_mandato     DECIMAL(9,0);
   
   DEFINE v_id_cat_mandato         DECIMAL(9,0);
   DEFINE v_cve_mandato            CHAR(18);
   DEFINE v_id_det_ctr_mandato     DECIMAL(9,0);
   DEFINE v_existe                 INTEGER;
   
   SET DEBUG FILE TO '/safreviv_int/BD/sp_hps_modifica_mandato.trace';
   TRACE ON;
   ...
   SELECT p.id_cat_mandato  ,
     ...
     INTO v_id_cat_mandato ,
          v_cve_mandato
     FROM safre_viv:hps_solicitud_mandato   s , 
   ...
   --TRACE "Valida existencia en hps_cat_pago_servicio - v_id_cat_mandato: "||v_id_cat_mandato;
   SELECT UNIQUE estado, id_cat_pago_servicio
     INTO v_estado, v_id_det_ctr_mandato
     FROM safre_viv:hps_cat_pago_servicio
     WHERE id_solicitud_pago_servicio = v_id_ctr_mandato
  ...
  --TRACE "Valida estado 104 en tipo M";
   ...
   --TRACE "Inicia insert en historicos";
      ...
      WHERE a.tabname = "hps_solicitud_mandato";
    ...
    --TRACE "v_existe - "||v_existe;
         IF v_existe > 0 THEN
            IF nombre_campo <> 'estado' THEN
               ...
               LET nombre_campo_hps = nombre_campo;

               IF nombre_campo = "valor_descuento_mandato" THEN 
                  LET nombre_campo     = "valor_descuento_servicio";
               END IF;

               IF nombre_campo = "f_culmina_mandato" THEN 
                  LET nombre_campo     = "f_fin";
               END IF;

               LET vtxt1 = " SELECT a."||nombre_campo||" FROM safre_viv:hps_cat_pago_servicio a WHERE id_cat_pago_servicio = "||v_id_det_ctr_mandato;

               LET nombre_campo = nombre_campo_hps;
               ...
               FREE cptxt1;
               FREE ptxt1;               
               LET vtxt1 = " SELECT a."||nombre_campo||" FROM safre_viv:hps_solicitud_mandato a WHERE id_solicitud_mandato = "||p_id_solicitud;
   ...
   --TRACE "Campo: Antes - "||val1||", despues - "||val2;
               IF val1 <> val2 THEN
                  ...
                  LET vid__mdt_his_mandato = seq_hps_his_cat_pago_servicio.NEXTVAL;
                  ...
                  INSERT INTO safre_viv:hps_his_cat_pago_servicio VALUES ( vid__mdt_his_mandato     ,   
   ...
   --TRACE "Arma update";
                  LET vtxt1 = "UPDATE safre_viv:hps_cat_pago_servicio SET "||
                              nombre_campo||" = '"||val2||"' WHERE id_cat_pago_servicio = "||v_id_det_ctr_mandato||";";
   --TRACE "Prepare SQL - "||vtxt1;
            ...
            ELSE
               ...
               INSERT INTO safre_viv:hps_his_cat_pago_servicio VALUES ( vid__mdt_his_mandato     ,
                ...
                UPDATE safre_viv:hps_cat_pago_servicio
                  SET estado = val2
                 WHERE id_cat_pago_servicio = v_id_det_ctr_mandato;
