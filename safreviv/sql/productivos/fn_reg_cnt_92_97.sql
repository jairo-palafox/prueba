...
create procedure "safreviv".fn_reg_cnt_92_97(p_folio_liquida      DECIMAL(9,0),  --Folio de liquidación del proceso
...
DEFINE v_monto_pesos         DECIMAL(20,2);  --Monto en pesos
  ...
  --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_reg_cnt_92_97.trace';
