...
CREATE FUNCTION "safreviv".fn_finaliza_tipo_n(p_usuario_cod CHAR(20), p_folio DECIMAL(9,0),p_proceso_cod SMALLINT) 
 ...
 --SET DEBUG FILE TO "/ds/safreviv_int/BD/debug_finaliza_tipo_n.txt";
 ...
 LET v_marca_tipo_n   = 804; -- marca para tipo N
