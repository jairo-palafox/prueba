...
create procedure "safreviv".fn_ret_solo_inf97_cnt30(p_folio_liquida      DECIMAL(9,0),  --Folio de liquidación del proceso
...
DEFINE v_movimiento          SMALLINT;       --Tipo Movimiento
  ...
  --p_transaccion = 36 (Transacción Liquidación del proceso de Devolución del 
  --                    Saldo 97 en Adelante)
  --p_transaccion = 60 (El registro contable se deberá realizar en el momento
  --                    de la cancelación de DAP's no cobrados)
  ...
  --p_transaccion = 132 (El registro contable se deberá realizar en el momento
  --                    de la conciliación del Retiro Solo INFONAVIT)
