...
CREATE PROCEDURE "safreviv".sp_dis_transaccion14(p_id_derechohabiente  DECIMAL(9,0), 
...
END EXCEPTION
    ...
    IF p_tipo_credito = 19 THEN  	-- MEJORAVIT
       ...
       LET v_modulo_cod        = "mjv";
       LET v_origen            = "Dis DEV-"||p_periodo_pago;
       LET v_movimiento        = 1472; --Cargo devolución créditos mejoravit
       ...
       IF p_proceso_cod = 101 OR
          ...
          LET v_movimiento = 1482;
       END IF
    END IF
   
    IF p_tipo_credito = 20 THEN	-- MANOS A LA OBRA
       LET v_tpo_transferencia = 15; --Transferencia de Acreditados
       LET v_origen_devolucion = 02; --SAR (97)
       LET v_estado            = 10; --Asigna estado reenviada
       LET v_proceso_cod_RP    = 1401;
       LET v_modulo_cod        = "mao";
       LET v_origen            = "Dis DEV-"||p_periodo_pago;
       LET v_movimiento        = 1692;	--CARGO DEV PAGO CRÉD MANOS A LA OBRA
       ...
       IF p_proceso_cod = 101 OR
          ...
          p_proceso_cod = 107 OR 
          p_proceso_cod = 110 THEN
          LET v_movimiento = 1702;	--CARGO DEV PAGO ACL CRÉD MANOS A LA OBRA
       END IF
    END IF

    IF p_tipo_credito = 21 THEN	-- UN CUARTO MÁS
       LET v_tpo_transferencia = 15; --Transferencia de Acreditados
       LET v_origen_devolucion = 02; --SAR (97)
       LET v_estado            = 10; --Asigna estado reenviada
       LET v_proceso_cod_RP    = 1401;
       LET v_modulo_cod        = "ucm";
       LET v_origen            = "Dis DEV-"||p_periodo_pago;
       LET v_movimiento        = 1732;	--CARGO DEV PAGO CRÉD UN CUARTO MÁS
       ...
       IF p_proceso_cod = 101 OR
          ...
          p_proceso_cod = 107 OR 
          p_proceso_cod = 110 THEN
          LET v_movimiento = 1742;	--CARGO DEV PAGO ACL CRÉD UN CUARTO MÁS
       END IF
    END IF
    ...
    LET v_char = "Terminada transacción 14 correctamente";
