...
CREATE FUNCTION "safreviv".fn_finaliza_transferencia(p_usuario_cod CHAR(20), p_folio DECIMAL(9,0),p_proceso_cod SMALLINT) 
   RETURNING SMALLINT, INTEGER, CHAR(200)

 -- para desmarcar cuentas
 DEFINE ret_transferencia_id_solicitud        DECIMAL(9,0) ;
 DEFINE ret_transferencia_id_derechohabiente      DECIMAL(9,0) ;
 ...
 DEFINE v_marca_transferencia              INTEGER; -- 805 de acuerdo a catalogo
 ...
 --SET DEBUG FILE TO "/ds/safreviv_int/BD/debug_finaliza_transferencia.txt";
 ...
 --TRACE("Desmarcando cuentas liquidadas");
   ...
   LET v_marca_transferencia = 806; -- marca para disposicion de recursos
   ...
   UPDATE ret_transferencia
    ...
    WHERE estado_solicitud = 50 -- preliquidada
      ...
      SELECT
         ...
         id_derechohabiente    
      INTO
        ret_transferencia_id_solicitud,
        ret_transferencia_id_derechohabiente
      ...
      EXECUTE FUNCTION fn_desmarca_cuenta(
              ret_transferencia_id_derechohabiente
             ,v_marca_transferencia -- marca de disposicion
             ,ret_transferencia_id_solicitud -- identificador de registro de archivo o lote
             ,0 -- estado marca
             ,0 -- marca de la causa
             ,p_usuario_cod
             ,p_proceso_cod)
