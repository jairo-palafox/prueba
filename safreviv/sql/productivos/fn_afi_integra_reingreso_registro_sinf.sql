...
CREATE FUNCTION "safreviv".fn_afi_integra_reingreso_registro_sinf(p_folio                               DECIMAL(10) , 
   ...
   LET v_num_reingresos_realizados  = 0;
      ...
      IF ( v_id_derechohabiente IS NULL ) THEN
         ...
         IF ( tmp_afi_reingreso_t_trabajador = "5" ) THEN
         ...
         EXECUTE FUNCTION fn_apertura_cuenta_afi(tmp_afi_reingreso_nss             -- NSS
                                                ...
                                                ,v_alta_tipo_trabajador            -- segun evaluacion de tpo trabajador
                                                ,0                                 -- id_credito (sin credito)
                                                ,p_folio                           -- folio         
                                                ,"A"      )                        -- origen de afiliacion
                          INTO v_id_derechohabiente;

         -- si la cuenta se abrio sin problemas
         IF ( v_id_derechohabiente > 0 ) THEN
            ...
            IF ( v_alta_tipo_trabajador = "E" ) THEN
               ...
               CALL fn_separa_nombre(tmp_afi_reingreso_nombre)
            ...
            END IF
         ELSE -- si el id_derechohabiente es negativo, entonces hubo un error al abrir la cuenta
