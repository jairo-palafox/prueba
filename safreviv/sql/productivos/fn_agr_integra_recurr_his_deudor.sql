...
CREATE FUNCTION "safreviv".fn_agr_integra_recurr_his_deudor(p_d_folio DECIMAL(9,0),
   ...
   DEFINE v_error                  SMALLINT; -- contiene código error (ocurrido en el proceso)
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/agrIntegRecurrHisDeu.trace';
   --TRACE ON;
