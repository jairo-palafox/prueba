...
CREATE FUNCTION "safreviv".fn_insrt_grt_ctr_arch_rchsdo(p_c_nom_archivo CHAR(40),
                                             p_i_estado SMALLINT,
                                             p_v_usuario CHAR(20))
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/grtCtrArch_rech.trace';
   --TRACE ON;
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_tot_regs_aux
        FROM safre_tmp:tmp_rech_sdo_sum_grt;
