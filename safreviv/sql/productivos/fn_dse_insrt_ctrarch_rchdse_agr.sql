...
CREATE FUNCTION "safreviv".fn_dse_insrt_ctrarch_rchdse_agr(p_c_nom_archivo CHAR(40),
                                                p_d_pid DECIMAL(9,0),
                                                p_v_usuario CHAR(20),
                                                p_i_estado SMALLINT)
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/agrDseCtrArch_rechDSE.trace';
   --TRACE ON;

   -- se inicializan variables
   LET v_ax_tpo_transf = "36";
   ...
   SELECT f_presentacion, consecutivo_lote
     ...
     FROM safre_tmp:tmp_dse_rech_enc_agr;
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_cuenta_reg
        FROM safre_tmp:tmp_dse_rech_sum_agr;
