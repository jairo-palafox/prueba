...
CREATE FUNCTION "safreviv".fn_agr_preliquida_rem(p_folio_liq DECIMAL(9,0),
...
RETURNING SMALLINT
   ...
   --SET DEBUG FILE TO '/safreviv_int/archivos/preliquidaAgrRem.trace';
   --TRACE ON;
   ...
   --Finaliza la función de preliquidación de remanentes de anualidades garantizadas
END FUNCTION;
