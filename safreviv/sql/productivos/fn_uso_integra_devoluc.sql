...
CREATE FUNCTION "safreviv".fn_uso_integra_devoluc(p_v_usuario CHAR(20),
   ...
   DEFINE tmp_filler7             CHAR(43);
   DEFINE tmp_mvo_devolucion      CHAR(2);
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/usoIntegDevoluc.trace';
   --TRACE ON;
   ...
   LET v_ax_operacion        = 06; -- operación Devolución de Solicitudes
   LET v_error               = 0;
   LET v_isam_err            = 0;
   ...
   FOREACH
      ...
      -- se obtienen los identificadores de cre_uso_garantia para el id_derechohabiente
      FOREACH
         ...
         LET uso_f_movimiento        = ""; -- No viene fecha de movimiento en el layout
         ...
         LET uso_edo_procesar        = 100; -- Devolucion de solicitudes
         --LET uso_diagnostico         = tmp_diagnostico;
         LET uso_diagnostico         = tmp_mvo_devolucion;
         ...
         -- se inserta registro
         INSERT INTO safre_tmp:tmp_deudor_devoluc_grt (
                     id_cre_acreditado,
                     id_derechohabiente,
                     nss)
