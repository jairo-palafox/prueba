...
create procedure "safreviv".fn_ret_ley73_gps_cnt39(p_folio_liquida      DECIMAL(9,0),  --Folio de liquidación del proceso
...
DEFINE v_cta_tesofe          DECIMAL(20,2);  --Monto Cuenta TESOFE Dev SSV97 Laudos
DEFINE v_movimiento          SMALLINT;       --Tipo Movimiento
  ...
  --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_ret_ley73_gps_cnt39.trace';
  ...
  --Cuenta contable 1502050002 Cuenta de Conexión   
  --SAP-FICO
  ...
  --Cuenta contable 1502050002 TESOFE Dev SSV 97 Laudos
  --Falta obtener la información
  --SELECT SUM(importe)
  --INTO   v_cta_tesofe
  --FROM   safre_viv:cta_fondo72
  ...
  FOREACH
    ...
    --Cuenta contable Cuenta TESOFE Dev SSV 97 Laudos
    IF v_cta_contable = '1502050002' THEN
       LET v_monto_pesos = v_cta_tesofe;
    END IF
