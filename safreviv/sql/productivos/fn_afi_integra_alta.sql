...
CREATE FUNCTION "safreviv".fn_afi_integra_alta(p_usuario_cod CHAR(20)   , p_folio DECIMAL(10), 
...
DEFINE v_error_fec_mov_posterior_actual SMALLINT; -- la fecha de movimiento es posterior a la actual
   ...
   ON EXCEPTION SET sql_err, isam_err, err_txt
      ...
      RETURN v_i_resultado, isam_err, err_txt, v_num_altas_aceptadas, v_num_altas_rechazadas, tmp_afi_alta_nss;
   END EXCEPTION
   ...
   LET tmp_afi_alta_nss   = NULL; -- no hay nss con error

   --SET DEBUG FILE TO "/ds/safreviv_int/BD/debug_fn_afi_integra_alta.trace";
   ...
   FROM safre_tmp:tmp_afi_alta
      ...
      IF ( v_id_derechohabiente IS NOT NULL AND v_registro_rechazado = 0 ) THEN
         ...
         -- se revisa si el NRP ya lo tiene
         SELECT nrp
