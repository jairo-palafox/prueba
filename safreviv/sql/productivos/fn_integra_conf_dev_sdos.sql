...
CREATE FUNCTION "safreviv".fn_integra_conf_dev_sdos(p_d_pid DECIMAL(9,0),
                                         p_v_usuario CHAR(20),
   ...
   --DEFINE v_ax_proceso_cod SMALLINT; -- codigo del proceso
   --DEFINE v_ax_opera_cod SMALLINT; -- codigo de la operacion
   DEFINE v_ax_tpo_transf_dse         CHAR(2); -- tipo de transferencia DSE
   DEFINE v_ax_tpo_transf_rch_dse     CHAR(2); -- tipo de transferencia RCH DSE
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/dseIntegConfDevsSdos.trace';
   --TRACE ON;

   -- se inicializa el contador de registros
   --LET v_ax_proceso_cod = 8;
   --LET v_ax_opera_cod = 11;
   LET v_ax_tpo_transf_dse = "15"; -- 15-DSE Transferencia de Acreditados
   LET v_ax_tpo_transf_rch_dse = "59"; -- 59-Confirmación DSE ACR
   ...
   FOREACH
      ...
      LET v_ax_id_dse_grp_devolucion = NULL;
      LET v_ax_edo_proc_agrup = NULL;
      ...
      FOREACH
         ...
         LET dseh_pesos92               = tmp_saldo_vivienda92/100;
         ...
         EXECUTE PROCEDURE sp_inserta_his_dev(dseh_id_dse_grp_devolucion,
                                              dseh_folio,
         ...
         -- se inserta registro
         INSERT INTO safre_tmp:tmp_deudor_conf_devol_saldo (
                     id_dse_devolucion,
                     id_derechohabiente,
                     nss,
                     folio_archivo)
   ...
   -- actualiza estadisticas a la tabla de historicos DSE
