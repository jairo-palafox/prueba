...
CREATE FUNCTION "safreviv".fn_dse_grp_dev_nss(p_folio_agrupa DECIMAL(9,0),
   ...
   FOREACH
      ...
      SELECT UNIQUE d.id_derechohabiente, a.tipo_trabajador, a.nombre_imss
       ...
       WHERE d.estado = 10
         ...
         and d.id_derechohabiente = 33170108
      ...
      LET dsea_id_dse_grp_devolucion = safre_viv:seq_dse_grp_devolucion.NEXTVAL;
   ...
   -- se consulta la información de devolucion agrupadamente para las subcuentas (42,44)
   FOREACH
      -- se consulta el tipo de trabajador
      SELECT UNIQUE d.id_derechohabiente, a.tipo_trabajador, a.nombre_imss
        INTO dse_id_derechohabiente, v_ax_c_tipo_trabajador, v_ax_nombre_imss
   ...
   UPDATE STATISTICS FOR TABLE safre_viv:dse_agrupa_devolucion;
   UPDATE STATISTICS FOR TABLE safre_viv:dse_his_devolucion;
