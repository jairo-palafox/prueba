...
CREATE PROCEDURE "safreviv".sp_dis_apo_subs4(v_folio DECIMAL(9,0), v_edo_rech SMALLINT)
...
END EXCEPTION
  ...
  CREATE TABLE dis_dup_ap_subsecuente
  ...
  FOREACH
    ...
    ELSE
       ...
       INSERT INTO dis_dup_ap_subsecuente
  ...
  UPDATE STATISTICS FOR TABLE dis_dup_ap_subsecuente;
  ...
  LET v_char = "Terminado Apo_subs4_SPL";
