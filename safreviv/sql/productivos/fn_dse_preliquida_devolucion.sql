...
CREATE FUNCTION "safreviv".fn_dse_preliquida_devolucion(p_d_folio DECIMAL(10),
   ...
   DEFINE pre_monto_acciones         DECIMAL(16,6);
   DEFINE pre_monto_pesos            DECIMAL(12,2);
   ...
   FOREACH
      ...
      IF dsea_aivs92 > 0 THEN
         ...
         -- se inserta el registro en la tabla de preliquidación
         INSERT INTO dse_preliquida(
                     f_liquida,
                     id_derechohabiente,
                     subcuenta,
                     fondo_inversion,
