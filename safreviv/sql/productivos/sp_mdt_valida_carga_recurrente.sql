...
CREATE PROCEDURE "safreviv".sp_mdt_valida_carga_recurrente()
...
DEFINE v_msg_sql    CHAR(254);
   ...
   FOREACH SELECT TRIM(nss),
      ...
      ELSE
         ...
         LET v_error_sql = 0;
         EXECUTE FUNCTION fn_mdt_valida_fecha(v_fec_ini_mandato) INTO v_error_sql, v_msg_sql, v_fec_ini_val;
      ...
      EXECUTE FUNCTION fn_mdt_valida_fecha(v_fec_fin_mandato) INTO v_error_sql, v_msg_sql, v_fec_fin_val;
