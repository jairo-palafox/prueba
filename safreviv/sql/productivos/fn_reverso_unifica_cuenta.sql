...
CREATE FUNCTION "safreviv".fn_reverso_unifica_cuenta(p_id_derecho_unificado  DECIMAL(9,0), 
...
-- En caso de error se establecen códigos de error
   ...
   FOREACH 
      ...
      DELETE FROM cre_his_acreditado
       WHERE id_cre_acreditado = v_id_cre_acreditado
         AND id_cre_ctr_archivo = v_id_cre_ctr_archivo
         AND estado = 230;
