...
CREATE PROCEDURE "safreviv".sp_hps_baja_mandato(p_id_solicitud_mandato DECIMAL(10,0),
   ...
   DEFINE v_h_id_cat_dato_actualizado DECIMAL(9,0)    ;
   ...
   SET DEBUG FILE TO '/safreviv_int/BD/sp_hps_baja_mandato.trace';
   TRACE ON;
   ...
   SELECT NVL(id_solicitud_pago_servicio,0) INTO v_id_ctr_mandato
   ...
   SELECT UNIQUE NVL(estado,0), id_cat_pago_servicio INTO v_estado, v_h_id_det_ctr_mandato
  ...
  --TRACE "Recupera v_h_id_cat_dato_actualizado - "||v_h_id_cat_dato_actualizado;
      IF v_h_id_cat_dato_actualizado > 0 THEN
         ...
         INSERT INTO safre_viv:hps_his_cat_pago_servicio VALUES ( v_h_id_mdt_his_mandato     ,
      ...
      UPDATE safre_viv:hps_cat_pago_servicio
         SET estado = 106
       WHERE id_cat_pago_servicio     = v_h_id_det_ctr_mandato;
