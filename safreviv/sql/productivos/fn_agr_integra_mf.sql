...
CREATE FUNCTION "safreviv".fn_agr_integra_mf(p_nss                CHAR(11),
   ...
   ON EXCEPTION SET v_error
     ...
     --LET v_ax_cuenta_rech = 0;
      ...
      IF v_error = -239 THEN
         ...
         LET rch_num_credito        = p_num_credito;
   ...
   --SET DEBUG FILE TO '/safreviv_int/archivos/agrIntegMF.trace';
   --TRACE ON;
   ...
   LET v_ax_tpo_originacion       = 4;
   LET v_rt_tpo_credito           = 10;
   ...
   LET cre_num_credito        = p_num_credito;
