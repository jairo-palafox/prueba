...
CREATE FUNCTION "safreviv".fn_dae_preliquida_ajuste_ind(p_folio_lote  DECIMAL(10), 
...
DEFINE v_folio_solicitud           DECIMAL(9,0) ; 
   ...
   EXECUTE FUNCTION fn_genera_folio(p_proceso_cod,g_opera_cod,p_usuario_cod)             
   ...
   UPDATE STATISTICS FOR TABLE dae_preliquida;
