...
CREATE PROCEDURE "safreviv".fn_dse_integra_devsdos_grt(p_d_pid DECIMAL(9,0),
                                            p_v_usuario CHAR(20),
                                            p_v_arch_proceso CHAR(100),
                                            p_d_folio DECIMAL(9))
   -- REGISTRO tmp dse devol det grt
   ...
   DEFINE tmp_saldo_vivienda97        DECIMAL(15); -- 13 enteros 2 decimales
   ...
   DEFINE tmp_interes_saldo_viv97     DECIMAL(15); -- 13 enteros 2 decimales
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/dseIntegDevsSdos_grt.trace';
   --TRACE ON;
