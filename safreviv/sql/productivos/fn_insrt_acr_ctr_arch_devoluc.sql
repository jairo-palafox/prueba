...
CREATE FUNCTION "safreviv".fn_insrt_acr_ctr_arch_devoluc(p_c_nom_archivo CHAR(40),
                                              p_i_estado SMALLINT,
                                              p_c_usuario CHAR(20))
RETURNING SMALLINT, INTEGER
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_tot_regs_aux
        FROM safre_tmp:tmp_acr_sum_devol;
