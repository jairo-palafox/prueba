...
CREATE FUNCTION "selefp".fn_actualiza_liq_43bis2(p_clave INTEGER)
-----------------------------------------------------------
   ...
   SET DEBUG FILE TO '/safreviv_int/BD/fn_actualiza_liq_43bis2.trace';
   TRACE ON;
   ...
   IF p_clave = 18 THEN
       FOREACH
           ...
           FROM   safre_tmp:ocg_tmp_liq2_old a, afi_derechohabiente b
           WHERE  a.nss = b.nss

           LET cont_1 = cont_1 + 1 ;

           UPDATE safre_tmp:ocg_tmp_liq2_old
