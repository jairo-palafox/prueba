...
CREATE FUNCTION "safreviv".fn_agr_integra_uso_anualidad_deudor(p_d_folio DECIMAL(9,0),
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/agrIntegUsoAnualDeudor.trace';
   --TRACE ON;
