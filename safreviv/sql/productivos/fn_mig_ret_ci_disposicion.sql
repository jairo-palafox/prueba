...
CREATE FUNCTION "safreviv".fn_mig_ret_ci_disposicion(p_usuario_cod CHAR(20), p_folio DECIMAL(9,0),
...
-- RECUPERADOS
 ...
 DEFINE v_c_msj                                   VARCHAR(250);
   ...
   FROM
      ...
      -- la fecha de solicitud del trabajor debe ser mayor o igual 01/01/2012
      IF ( tmp_ret_det_f_solicitud_trab < "01/01/2012" ) THEN
         -- se rechaza
         LET v_b_rechazo_detalle    = 1;
   ...
   SET
      total_importe = v_sumario_importe_total
   WHERE
      folio = p_folio;
