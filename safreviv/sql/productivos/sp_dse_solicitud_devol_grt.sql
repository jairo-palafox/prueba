...
CREATE PROCEDURE "safreviv".sp_dse_solicitud_devol_grt(p_id_lote        decimal(10,0),
                                            p_lote           smallint,
                                            p_f_lote         date,
   ...
   --Variables para la tabla: tmp_rep_devolucion_grt
   ...
   DEFINE v_tmp_edo_procesar              SMALLINT;
      ...
      --Variables provenientes de la tabla: tmp_rep_devolucion_grt
   ...
   LET v_agrupa_tpo_transferencia     = "19";
   ...
   FOREACH
      SELECT *
       ...
       WHERE tpo_transferencia = '19'
         --AND estado            IN (140,142)
         AND estado       IN(140,142,20)
      ...
      INSERT INTO safre_tmp:tmp_ctr_devolucion_grt
      ...
      IF EXISTS ( SELECT nss
           ...
           UPDATE safre_tmp:tmp_rep_devolucion_grt
      ...
      ELSE
         ...
         INSERT INTO safre_tmp:tmp_rep_devolucion_grt
         VALUES ( v_tmp_curp             ,
                  v_tmp_nss              ,
                  v_tmp_rfc              ,
                  v_tmp_ap_paterno_af    ,
