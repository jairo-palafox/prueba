...
CREATE PROCEDURE "safreviv".sp_status_retiro_ley73_acti_cont(   v_causa_rec   SMALLINT,  --causa de rechazo
...
--SET DEBUG FILE TO '/ds/safreviv_int/BD/sp_status_retiro_ley73_acti.trace';
  ...
  FOREACH cu_status_ley73 FOR SELECT id_referencia, id_derechohabiente
