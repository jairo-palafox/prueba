...
CREATE FUNCTION "safreviv".fn_marca_cuenta_decreto(p_id_decreto DECIMAL(9,0),
   ...
   ON EXCEPTION
      ...
      LET v_des_excep = 'MARCAJE:'|| v_des_excep ||' '|| p_id_decreto ||' '||p_marca_entra;
   ...
   --- cuadrada regresa 9003 genera excepcion
      ...
      ---- p_codigo_rechazo = 0.
         ...
         FOREACH
            SELECT c.marca_activa,
              ...
              FROM sfr_convivencia c, 
                   sfr_marca_activa_decreto a
             WHERE a.id_decreto   = p_id_decreto
        ...
        ---- (convive con marca activa).
           ...
           INSERT INTO sfr_marca_activa_decreto VALUES (
                                              p_id_decreto ,  -- id_derechohabiente
                                              p_marca_entra        ,  -- marca
                                              p_n_referencia       ,  -- n_referencia 
                                              v_fecha_ini          ,  -- f_ini
