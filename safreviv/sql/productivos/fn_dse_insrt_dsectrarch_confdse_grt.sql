...
CREATE FUNCTION "safreviv".fn_dse_insrt_dsectrarch_confdse_grt(p_c_nom_archivo CHAR(40),
                                                    p_d_pid DECIMAL(9,0),
                                                    p_v_usuario CHAR(20),
                                                    p_i_estado SMALLINT)
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/grtDseCtrArch_confDSE.trace';
   --TRACE ON;

   -- se inicializan variables
   LET v_ax_tpo_transf = "99";
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_cuenta_reg
        FROM safre_tmp:tmp_dse_confirm_sum_grt;
