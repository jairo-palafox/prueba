...
create procedure "safreviv".fn_dis_desmarca_mtc()
...
--SET DEBUG FILE TO '/safreviv/dis/sql/fn_dis_desmarca_mtc.TRACE';
--SET DEBUG FILE TO '/home/safreviv/fn_dis_desmarca_mtc.TRACE';
--TRACE ON;
   ...
   FOREACH
     ...
     EXECUTE PROCEDURE sp_reversa_marca(v_derechohabiente_pag,
                                        450,
                                        v_folio_sua,
                                        v_folio_dis);
   ...
   LET v_char = "  Reverso Marcaje finalizo correctamente (Créditos MTC´s)";
