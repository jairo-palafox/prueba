...
CREATE FUNCTION "safreviv".fn_uso_insrt_ctr_arch_sdotrans(p_c_nom_archivo CHAR(40),
                                               p_i_estado SMALLINT,
                                               p_v_usuario CHAR(20))
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/usoCtrArch_sdosTrans.trace';
   --TRACE ON;
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_tot_regs_aux
        FROM safre_tmp:tmp_sdo_transf_sum_uso;
