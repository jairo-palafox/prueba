...
CREATE FUNCTION "safreviv".fn_unifica_cuenta(p_id_unificador         DECIMAL(9,0), 
...
DEFINE v_marca_inhabilita        SMALLINT;
   ...
   --SET DEBUG FILE TO '/safreviv_int/BD/fn_unifica_cuenta.trace';
   --TRACE ON;
   ...
   FOREACH
      ...
      INSERT INTO uni_cre_unificado(id_cre_unificado,
                             ...
                             VALUES(seq_uni_cre_unificado.NEXTVAL,              
                                    ...
                                    1); --Estado que índica que fue ACEPTADO
      -------------------
      --Se agrega el tipo de originación para que devuelva una sola marca  
      SELECT marca_inf,
             marca_prc
