...
create procedure "safreviv".fn_dis_rev_trans_ao_mtc(p_folio_ajuste         DECIMAL(9,0),  --Folio Ajuste
...
--SET DEBUG FILE TO '/safreviv/dis/sql/fn_dis_rev_trans_ao_mtc.TRACE';
--SET DEBUG FILE TO '/home/safreviv/fn_dis_rev_trans_ao_mtc.TRACE';
--TRACE ON;

   --Leer los registros de la tabla dis_interface_hs_mtc
   FOREACH
