...
CREATE FUNCTION "safreviv".fn_unifica_cuenta_sin_desmarcar(p_id_unificador         DECIMAL(9,0), 
...
DEFINE v_nom_archivo             CHAR(40);
   ...
   --SET DEBUG FILE TO '/safreviv/uni/unl/fn_unifica_cuenta_sin_desmarcar.trace';
   --TRACE ON;
   ...
   EXECUTE FUNCTION fn_genera_folio(p_id_proceso, 22, p_usuario) 
   ...
   FOREACH
      ...
      LET v_id_cre_ctr_archivo = v_secuencia;
      ...
      LET v_h_id_cre_ctr_archivo = v_secuencia;
      LET v_h_estado      = 220;
      LET v_h_f_proceso   = TODAY;
      ...
      IF p_id_proceso = 2301 THEN
         LET v_marca_inhabilita = 501;
      ELSE
         IF p_id_proceso = 2302 THEN
   ...
   LET v_ctr_id_cre_ctr_archivo	= v_secuencia;
   --LET v_ctr_folio_archivo	    = ;
   LET v_ctr_lote	              = p_lote	         ;
   LET v_ctr_f_lote	            = p_f_lote	       ;
   LET v_ctr_id_proceso	        = p_id_proceso	   ;
   LET v_ctr_operacion	        = 22;
   LET v_ctr_nom_archivo	      = v_nom_archivo	   ;
   LET v_ctr_tot_registros	    = v_num_registros  ; -- Por definir contabilizacion
   LET v_ctr_tot_aceptados	    = v_num_registros  ; -- Por definir contabilizacion
   LET v_ctr_tot_rechazados	    = 0;
   LET v_ctr_tot_sin_origen	    = 0;
   LET v_ctr_estado	            = 20;
   LET v_ctr_f_proceso	        = TODAY;
   LET v_ctr_usuario	          = p_usuario;
