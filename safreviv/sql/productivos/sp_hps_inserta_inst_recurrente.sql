...
CREATE FUNCTION "safreviv".sp_hps_inserta_inst_recurrente(
                               p_folio DECIMAL(9,0),
                               p_usuario CHAR(20))
...
DEFINE v_msg_error               CHAR(200);
   ...
   SET DEBUG FILE TO '/safreviv_int/BD/sp_hps_inserta_inst_recurrente.trace';
   TRACE ON;
   --TRACE '1';
   ...
   FOREACH SELECT tpo_registro   ,
      ...
      IF(v_id_derechohabiente > 0 )THEN
         ...
         EXECUTE PROCEDURE sp_hps_cambia_formato_fecha(v_fec_ini_mandato) 
                     INTO v_f_inicio;
         --TRACE '7';
         EXECUTE PROCEDURE sp_hps_cambia_formato_fecha(v_fec_fin_mandato) 
                     INTO v_f_culmina;
         --TRACE '8';
         ...
         INSERT INTO safre_viv:hps_solicitud_mandato 
               (id_solicitud_mandato    ,
                ...
                tipo_operacion          ,
                diagnostico)      
         VALUES(safre_viv:seq_hps_solicitud_mandato.NEXTVAL ,
