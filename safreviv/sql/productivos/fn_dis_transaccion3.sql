...
CREATE PROCEDURE "safreviv".fn_dis_transaccion3(p_fecha_01mm           DATE,          --Fecha de movimiento, proceso
...
--SET DEBUG FILE TO '/safreviv/dis/sql/fn_dis_transaccion3.TRACE';
--SET DEBUG FILE TO '/home/safreviv/fn_dis_transaccion3.TRACE';
--TRACE ON;
  ...
  --y el periodo de pago sea menor al masivo
       ...
       IF v_periodo_bimestre <= '200505' THEN --PAGO VIRTUAL--
          ...
          IF v_monto_pesos_real > 0 THEN   -- Amortización
             ...
             EXECUTE PROCEDURE sp_dis_transaccion7(p_folio_disp,
                                                   ...
                                                   v_tpo_patron,
                                                   v_localiza_trabajador,
                                                   0) --Se agrega el valor de las AIVS
                          INTO v_bnd_transaccion, v_status,error_info;
          END IF -- Amortización
  ...
  LET error_info = "  Preliquidación finalizo correctamente (Masivo Infonavit Avance Pagos";
