...
CREATE PROCEDURE "safreviv".fn_dse_integra_devsdos_agr(p_d_pid DECIMAL(9,0),
                                            p_v_usuario CHAR(20),
                                            p_v_arch_proceso CHAR(100),
                                            p_d_folio DECIMAL(9))
   -- REGISTRO tmp devolución de saldos excedentes de agr
   ...
   DEFINE tmp_num_aplic_interes92     DECIMAL(15); -- 9 enteros 6 decimale
   DEFINE tmp_filler6                 CHAR(18);
   ...
   DEFINE dse_aivs97               DECIMAL(22,2);
   DEFINE dse_pesos97              DECIMAL(22,2);
   DEFINE dse_aivs92               DECIMAL(22,2);
   DEFINE dse_pesos92              DECIMAL(22,2);
   DEFINE dse_monto_aportacion     DECIMAL(22,2);
   DEFINE dse_aivs_aportacion      DECIMAL(22,2);
   ...
   DEFINE dse_monto_aivs           DECIMAL(22,2);
   DEFINE dse_monto_pesos          DECIMAL(22,2);
   DEFINE dse_monto_aportacion     DECIMAL(22,2);
   DEFINE dse_aivs_aportacion      DECIMAL(22,2);
   DEFINE dse_nss_separacion       CHAR(11);
   DEFINE dse_estado               SMALLINT;
   ...
   DEFINE his_aivs97               DECIMAL(22,2);
   DEFINE his_pesos97              DECIMAL(22,2);
   DEFINE his_aivs92               DECIMAL(22,2);
   DEFINE his_pesos92              DECIMAL(22,2);
   DEFINE his_monto_aportacion     DECIMAL(22,2);
   DEFINE his_aivs_aportacion      DECIMAL(22,2);
   ...
   FOREACH
      ...
      INTO tmp_tpo_registro,
           ...
           tmp_filler7
      FROM safre_tmp:tmp_dse_devol_det_agr
      ...
      IF tmp_num_aplic_interes97 >= 0 THEN
         ...
         LET dse_monto_pesos        = tmp_filler4 / 100; --0;--tmp_saldo_vivienda97/100; VPD
      ...
      IF tmp_num_aplic_interes92 >= 0 THEN
         -- se asignan los valores en las variables que se usaran para insertar el registro
         LET dse_id_dse_devolucion  = safre_viv:seq_dse_devolucion.NEXTVAL;
         LET dse_folio              = 0;
         LET dse_modulo_cod         = "agr";
         ...
         LET dse_monto_pesos        = tmp_filler6 / 100; --0;--tmp_saldo_vivienda92/100; VPD
         LET dse_monto_aportacion   = tmp_monto_aportaciones/100;
         LET dse_aivs_aportacion    = tmp_aplic_interes_aporta/1000000;
         LET dse_nss_separacion     = tmp_nss_separacion;
         LET dse_estado             = 10;
