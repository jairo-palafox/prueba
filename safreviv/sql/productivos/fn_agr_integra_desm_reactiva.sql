...
CREATE FUNCTION "safreviv".fn_agr_integra_desm_reactiva(p_v_usuario          CHAR(20),
   ...
   DEFINE v_ax_exist_numcred        INTEGER;    --Contador para la existencia de número de crédito
   ...
   FOREACH
    SELECT *
      ...
      -- se consulta el tipo originación y la marca infonavit para el tipo credito
      FOREACH
