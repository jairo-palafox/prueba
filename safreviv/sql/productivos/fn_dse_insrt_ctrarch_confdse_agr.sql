...
CREATE FUNCTION "safreviv".fn_dse_insrt_ctrarch_confdse_agr(p_c_nom_archivo CHAR(40),
                                                 p_d_pid DECIMAL(9,0),
                                                 p_v_usuario CHAR(20),
                                                 p_i_estado SMALLINT)
   ...
   LET v_ax_tpo_transf = "39"; -- DSE Anualidades Garantizadas
   ...
   IF p_i_estado = 10 THEN
      SELECT COUNT(*)
        INTO v_ax_cuenta_reg
        FROM safre_tmp:tmp_dse_confirm_sum_agr;
