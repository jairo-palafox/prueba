...
CREATE FUNCTION "safreviv".fn_insert_preliquidacion_retiro_fondo_ahorro(v_folio_liquida    DECIMAL(10,0),
  ...
  --SET DEBUG FILE TO '/ds/safreviv_int/BD/fn_insert_preliquidacion_retiro_fondo_ahorro.log';
   ...
   FOREACH cu_ret_det FOR SELECT det.saldo_viv72, det.tanto_adicional , det.id_afi_fondo72
                                     INTO r_pes_viv72
                                         ,r_tanto_adicional
                                         ,v_id_afi_fondo72
        ...
        --Let v_count = v_count + 1;
         ...
         END FOREACH;
            ...
            --IF sqlcode <> 0 THEN
            UPDATE  ret_fondo_ahorro SET estado_solicitud   = 50,
