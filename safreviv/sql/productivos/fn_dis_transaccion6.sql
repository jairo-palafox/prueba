...
CREATE PROCEDURE "safreviv".fn_dis_transaccion6(p_fecha_01mm           DATE,          --Fecha de movimiento, proceso
...
--SET DEBUG FILE TO '/safreviv/dis/sql/fn_dis_transaccion6.TRACE';
--SET DEBUG FILE TO '/home/safreviv/fn_dis_transaccion6.TRACE';
--TRACE ON;
   ...
   FOREACH
     ...
     --Destino de la aportacion 1 INFONAVIT (Cartera)
   ...
   --TRACE 'Finaliza fn_dis_transaccion6 con valor '||v_bnd_proceso;
