...
CREATE FUNCTION "safreviv".fn_dse_integra_confdse_grt(p_d_pid DECIMAL(9,0),
                                           p_v_usuario CHAR(20),
   ...
   --SET DEBUG FILE TO '/ds/safreviv_int/BD/grtDse_IntegConfDevsSdos.trace';
   --TRACE ON;

   -- se inicializa el contador de registros
   --LET v_ax_proceso_cod = 8;
   --LET v_ax_opera_cod = 11;
   LET v_ax_tpo_transf_dse = "19"; -- 19-DSE Anualidades Garantizadas
   LET v_ax_tpo_transf_conf_dse = "99"; -- 99- Rechazo de DSE AGR
   ...
   SELECT consecutivo_lote
     INTO v_ax_lote
     FROM safre_tmp:tmp_dse_confirm_enc_grt;
   ...
   FOREACH
    SELECT *
      INTO tmp_tpo_registro,
           ...
           tmp_filler5
      FROM safre_tmp:tmp_dse_confirm_det_grt
      ...
      FOREACH
         ...
         -- se inserta registro
         INSERT INTO safre_tmp:tmp_deudor_conf_devol_saldo_grt (
                     id_dse_devolucion,
                     id_derechohabiente,
                     nss,
                     folio_archivo)
