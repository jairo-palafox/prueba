...
DEFINE v_tpo_patron             CHAR(2); --Tipo Patron
   ...
   --### Se agrega validación para rechazo por diferencia en periodos de pago y se le asigna rechazo general###--
   ...
   IF v_estado = 10 THEN
      FOREACH
         ...
         --Nota: En espera de validación "0000000000"  -- Se agrega la validación 24/08/2012
