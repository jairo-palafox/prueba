...
#Modulo       => CNT                                                           #
#Programa     => CNTR01                                                        #
#Objetivo     => Realizar el reverso de la generación de la póliza contable    #
################################################################################
...
-- se asignan los parametros que vienen del fglrun
   ...
   CLOSE WINDOW SCREEN
   OPEN WINDOW wMain WITH FORM "CNTR011"
          ...
          BEFORE INPUT          
            ...
            CALL f_forma.setElementHidden("grp_valida_proceso",TRUE)
             ...
             ON ACTION ACCEPT
                  ...
                  CALL fn_valida_poliza() RETURNING v_registros  
                  ...
                  DISPLAY ARRAY v_arr_valida_proceso TO scr_valida_procesos.* ATTRIBUTES (ACCEPT = FALSE)
                      ...
                      ON ACTION reverso
                           ...
                           IF v_respuesta = 1 THEN
                              ...
                              LET v_s_mensaje = "Se ha enviado el Reverso de la Generación de la Póliza Contable con el pid: ",
                                  p_pid CLIPPED,
...
FUNCTION fn_valida_poliza() 
   DEFINE
      ...
      LET consulta =   "\n SELECT T.f_liquida, T.cod_proceso_cnt || '-' || PC.desc_proceso_cnt Proceso, T.folio_liquida, T.folio_cnt,",
                         ...
                         "\n AND P.num_poliza is null",
                         "\n AND T.estado in (20,70)"
