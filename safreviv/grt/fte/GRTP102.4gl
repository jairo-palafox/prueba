...
MAIN
   ...
   CALL STARTLOG(p_usuario CLIPPED|| ".GRTP102.log")

   DISPLAY "=INICIA GRTP102="
   ...
   LET v_s_qry = "EXECUTE FUNCTION fn_grt_valida_subpr2_formalizacion(?)"
