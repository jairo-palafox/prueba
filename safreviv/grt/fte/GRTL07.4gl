...
#Modulo            =>GRT                                           #
#Programa          =>GRTL07                                        #
#Objetivo          =>Programa lanzador para la validación del      #
#                    archivo de Devolucion de Solicitudes para el  #
...
#Objetivo:
#  Menu principal de Archivos entrada Devluciones del modulo de Solicitud de Saldo en Garantía.
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL07.log")
   ...
   LET g_proceso_cod    = g_proc_cod_grt_devol_solic -- recepción devolución solicitudes 43bis
   ...
   IF ( r_b_valida = 0 ) THEN
      ...
      --LET v_s_comando = "nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTP05 ",
      LET v_s_comando = "fglrun ",r_c_ruta_bin CLIPPED,"/GRTP05 ",
                        p_v_usuario CLIPPED, " ",
                        v_d_pid, " ",
                        g_proceso_cod, " ",
                        g_opera_cod, " ",
      ...
      -- Se invoca la funcion que valida y carga la informacion en las tablas de paso
