...
#                    archivo de Solicitudes no atendidas para el   #
...
#Objetivo: Programa que permite la validación y carga del archivo Solicitudes no
#          Atendidas mediante la funcion general de carga para el módulo GRT
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL09.log")
   ...
   LET v_c_programa_cod = "GRTL09" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTP06 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/GRTP06 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
