...
#Módulo            => GRT                                           #
#Programa          => GRTE07                                        #
#Objetivo          => Programa para integrar el archivo Uso Garantía#
#                     que ha sido validado, para el módulo de       #
#                     Uso de Garantia                               #
#Autor             => Daniel Buendia, EFP                           #
#Fecha inicio      => 24 Abril 2011                                 #
#####################################################################
...
MAIN
   ...
   CALL STARTLOG(g_v_usuario CLIPPED|| ".GRTE07.log")

   DISPLAY "=INICIA GRTE07="
   ...
   IF v_si_cuenta_valor = 0 THEN
      DISPLAY " ERROR: No existe precio de acción para el día de hoy,",
              " por lo que no es posible generar solicitud de cargo por uso de garantía"
   ...
   LET v_s_qryTxt = " SELECT FIRST 1 fec_presentacion\n",
   ...
   EXECUTE prp_id_creCtrArchivo INTO g_id_cre_ctr_archivo
