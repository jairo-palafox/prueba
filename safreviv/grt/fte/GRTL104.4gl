...
#Modulo             => GRT                                                       #
#Programa           => GRTL104                                                   #
#Objetivo           => Programa Lanzador del subproceso 2 (formalizacion)        #
...
MAIN
   ...
   ELSE
      ...
      CALL fn_ventana_confirma("Alerta","Se ejecutara el SP002 Formalización.\n¿Está seguro que desea continuar?","") RETURNING v_msj_confirma

      IF v_msj_confirma = 1 THEN
         LET v_s_mensaje = "Se ejecuta el SP002 con PID: ",v_pid CLIPPED,
