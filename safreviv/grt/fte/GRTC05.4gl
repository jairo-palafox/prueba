...
MAIN
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".GRTC05.log")
   ...
   LET g_tpo_transferencia = "19" -- 19- DSE Créditos en Garantía 43 bis
...
FUNCTION fn_consulta_historico_dev()
   ...
   OPEN WINDOW w_op_consulta WITH FORM  "GRTC051"
...
FUNCTION fn_consulta_derechohabiente_dev()
   ...
   OPEN WINDOW w_op_derechohab WITH FORM "GRTC052"   
...
FUNCTION fn_consulta_estado_dev()
   ...
   OPEN WINDOW w_op_estado WITH FORM "GRTC054"
   CONSTRUCT v_s_condicion
          ON estado,
             edo_procesar
        FROM cmb_estado,
...
FUNCTION fn_consulta_historica_dev()
   ...
   OPEN WINDOW w_op_historica WITH FORM "GRTC056"
   CONSTRUCT v_s_condicion
          ON estado,
             edo_procesar,
             diagnostico
...
FUNCTION fn_consulta_archivo_dev()
   ...
   OPEN WINDOW w_op_archivo WITH FORM "GRTC059"
   ...
   INPUT v_folio FROM cmb_archivo ATTRIBUTE (UNBUFFERED) 
      ...
      BEFORE INPUT
         ...
         LET v_sqlqry = " SELECT nom_archivo, folio ",
                        ...
                        "  WHERE tpo_transferencia IN ('19','96','99')",
                        "    AND estado = 20 " 
...
FUNCTION fn_despliega_archivo_dev(p_folio, p_nom_archivo)
   ...
   OPEN WINDOW w_des_archivo WITH FORM "GRTC055"
      ...
      DISPLAY ARRAY v_ar_archivo TO tabla_estado.* ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION reporte
            ...
            IF fgl_report_loadCurrentSettings("GRTC054.4rp") THEN 
               CALL fgl_report_selectDevice("PDF") 
               LET v_nom_reporte = p_usuario_cod CLIPPED || "-GRTC054-","00000","-","00000","-","00000" 
...
FUNCTION fn_obt_derechohabiente(p_s_condicion)
   ...
   OPEN WINDOW w_list_derechohabiente WITH FORM "GRTC058" 
...
FUNCTION fn_despliega_derechohab_dev(p_id_derechohabiente)
  ...
  OPEN WINDOW w_des_derechohab WITH FORM "GRTC053"
     LET  w = ui.Window.getCurrent()
     LET  f_w = w.getForm()   
     ...
     DIALOG ATTRIBUTES (FIELD ORDER FORM, UNBUFFERED)
        ...
        ON ACTION reporte
           ...
           # Se indica que el reporte usara la plantilla creada
           IF fgl_report_loadCurrentSettings("GRTC051.4rp") THEN 
              CALL fgl_report_selectDevice("PDF") 
              LET v_nom_reporte = p_usuario_cod CLIPPED || "-GRTC051-","00000","-","00000","-","00000" 
              CALL fgl_report_setOutputFileName(r_ruta_listados CLIPPED||"/"||v_nom_reporte CLIPPED)
...
FUNCTION fn_despliega_estado_dev(p_s_condicion)
   ...
   OPEN WINDOW w_des_estado WITH FORM "GRTC055"
      LET  w = ui.Window.getCurrent()
      LET  f_w = w.getForm()  
      ...
      DISPLAY ARRAY v_ar_estado TO tabla_estado.* ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION reporte
            ...
            # Se indica que el reporte usara la plantilla creada
            IF fgl_report_loadCurrentSettings("GRTC052.4rp") THEN 
               CALL fgl_report_selectDevice("PDF") 
               LET v_nom_reporte = p_usuario_cod CLIPPED || "-GRTC052-","00000","-","00000","-","00000" 
               CALL fgl_report_setOutputFileName(r_ruta_listados CLIPPED||"/"||v_nom_reporte CLIPPED)
...
FUNCTION fn_despliega_historica_dev(p_s_condicion)
   ...
   OPEN WINDOW w_des_historica WITH FORM "GRTC057"
      LET  w = ui.Window.getCurrent()
      LET  f_w = w.getForm()  
      ...
      DISPLAY ARRAY v_ar_historica TO tabla_historica.* ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION reporte
            ...
            # Se indica que el reporte usara la plantilla creada
            IF fgl_report_loadCurrentSettings("GRTC053.4rp") THEN 
               CALL fgl_report_selectDevice("PDF") 
               LET v_nom_reporte = p_usuario_cod CLIPPED || "-GRTC053-","00000","-","00000","-","00000" 
               CALL fgl_report_setOutputFileName(r_ruta_listados CLIPPED||"/"||v_nom_reporte CLIPPED)
