...
#                    control correspondiente al proceso Valida Rechazo  #
#                    DSE para el módulo de Créditos en Garantía 43 bis  #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP22.log")

   DISPLAY "=INICIA GRTP22="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_dse_insrt_dsectrarch_rchdse_grt(?,?,?,?)"
