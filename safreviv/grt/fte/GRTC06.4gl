...
#Propietario       => E.F.P.                                                  #
#-----------------------------------------------------------------------------#
#Modulo            => Devolución de saldos excedentes GRT                     #
#Programa          => GRT06                                                   #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # Clave del usuario firmado
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".GRTC06.log")
   ...
   LET g_proceso_cod = g_proc_cod_grt_liquida_dse # afectación cta ind dev sdos exc grt
