...
#                    archivo de entrada Rechazo de Saldos del      #
#                    del módulo de Solicitud de Saldo en Garantía  #
...
MAIN
   DEFINE p_v_usuario       LIKE seg_usuario.usuario,-- usuario firmado al sistema
          ...
          r_c_ruta_bin      LIKE seg_modulo.ruta_bin, -- ruta el bin del módulo
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL04.log")
   ...
   LET v_d_folio = 0
   LET v_c_programa_cod = "GRTL04" -- nombrel del programa
   ...
   EXECUTE prp_slc_ruta_bin INTO r_c_ruta_bin
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTE02 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
