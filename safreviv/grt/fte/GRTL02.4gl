...
#                    Recurrente del módulo Solicitud de Saldo en Garantía  #
...
#  del archivo de entrada Recurrente en la base de datos de historicos (his transferencia)
MAIN
   DEFINE p_v_usuario         LIKE seg_usuario.usuario,-- usuario firmado al sistema
          ...
          v_c_ruta_listados   LIKE seg_modulo.ruta_listados, -- ruta listados del módulo
          v_c_ruta_list_bat   LIKE seg_modulo.ruta_listados, -- ruta listados de bat
          v_c_programa_cod    LIKE bat_ctr_operacion.programa_cod, -- nombre del programa
          v_si_cuenta_valor   SMALLINT, -- variable que indica si existe el precio de acción
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL02.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_grt_recurrente -- recepción recurrente originación ag
   ...
   OPEN WINDOW w_integra_arch_recurr WITH FORM "GRTL021"
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION integrar
            ...
            IF v_si_cuenta_valor = 0 THEN
               LET v_s_mensaje = "No existe el precio de acción para el día de hoy por lo que\n",
                                 "no es posible continuar con la integración del archivo"

               -- se informa al usuario
               CALL fn_mensaje("Integración Recurrente",v_s_mensaje,"information")
               EXIT PROGRAM
            END IF
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/GRTE01 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
