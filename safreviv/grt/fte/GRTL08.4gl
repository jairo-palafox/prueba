...
DEFINE g_proceso_cod     LIKE bat_ctr_operacion.proceso_cod,
       ...
       g_si_tpo_originac LIKE cre_acreditado.tpo_originacion
END GLOBALS
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL08.log")
   ...
   LET g_c_programa_cod = "GRTL08"
   LET g_si_tpo_originac = 2 -- Créditos en Garantía
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = "nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTE04 ",
                                     p_v_usuario, " ", -- usuario
                                     v_d_pid, " ",
                                     g_proceso_cod, " ",
                                     g_opera_cod, " ",
...
FUNCTION f_valida_arch_integra()
   ...
   FOREACH cur_tmp_nss INTO v_c_nss_tmp
      ...
      LET v_s_qryTxt = " SELECT estado\n",
                       ...
                       "    AND tpo_originacion = ",g_si_tpo_originac
