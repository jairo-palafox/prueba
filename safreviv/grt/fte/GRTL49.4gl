...
#                     de solicitudes UG, el cual contendrá el detalle de los    #
#                     registros que Cartera solicitó para pagos de UG 43BIS.    #
...
MAIN 
   ...
   LET g_proceso_cod    = 1233 -- GENERACIÓN ARCHIVO SOLICITUDES UG
   LET g_opera_cod      = 1
      ...
      INPUT BY NAME cbox ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION ACCEPT 
            ...
            ELSE 
               ...
               LET v_mensaje = "Se ejecutó la generación del archivo solicitudes UG"," \n",
...
FUNCTION fn_carga_cbox()
   ...
   # 1202 --> Recepción uso garantía 43Bis
   # Recupera archivos que envía CARTERA desde el cambio de plataforma ADS-43BIS (Enero-2017)
