...
#                devoluciones del módulo de Créd. Garant. 43 bis     #
...
GLOBALS
   ...
   DEFINE g_opera_cod_preliquidacion LIKE cat_operacion.opera_cod --codigo de operacion
   DEFINE g_num_folio                DECIMAL(9) -- número de folio
...
MAIN
   ...
   CALL STARTLOG (g_usuario_cod CLIPPED|| ".GRTL37.log")
   ...
   LET g_proceso_cod = g_proc_cod_grt_arch_solic_dse -- generación solicitud devolución sdo exc grt
   LET g_opera_cod   = 1 -- solicitud devolución saldo excedente grt
   LET g_pid         = 0
   LET g_num_folio   = 0
...
#Objetivo: Verifica si se está ejecutando el proceso en batch o en línea para
#          mandar llamar la función correspondiente.
FUNCTION fn_ini_solcitud_devolucion()

   DEFINE v_c_tpo_transf_dse        LIKE dse_agrupa_devolucion.tpo_transferencia
   DEFINE v_c_tpo_transf_rch        LIKE dse_agrupa_devolucion.tpo_transferencia
   ...
   -- se asigna la fecha para el nombrel archivo
   LET v_f_fecha_archivo  = TODAY
   LET v_c_tpo_transf_dse = "19" -- Créditos en Garantía 43 bis
   LET v_c_tpo_transf_rch = "91" -- Solicitud DSE GRT
...

  {
   ...
   LET v_s_qryTxt = " SELECT MAX(lote)\n",
                    ...
                    "  WHERE f_lote = '",v_dt_f_presentacion,"'\n",
                    "    AND tpo_transferencia = '",v_c_tpo_transf_rch,"'"
   ...
   IF ( v_estatus = 0 ) THEN
      ...
      OPEN WINDOW w_solicitud_devolucion WITH FORM "GRTL371"
         CLEAR FORM
         ...
         MENU
            ...
            COMMAND "Generar"
               ...
               CALL fn_grt_gen_solicitud_devolucion()
...
FUNCTION fn_grt_gen_solicitud_devolucion()
   ...
   --Obtenemos las rutas
   CALL fn_rutas("grt") RETURNING v_ruta_ejecutable, v_ruta_vacia
   ...
   --tablas históricas
   LET v_comando = "nohup time fglrun ",v_ruta_ejecutable CLIPPED,"/GRTS04 ",
                                        g_usuario_cod, " ",
                                        g_pid, " ",
                                        g_proceso_cod," ",
                                        g_opera_cod," ",
