...
#Modulo            =>GRT                                                #
#Programa          =>GRTP03                                             #
#Objetivo          =>Programa que inserta registro de Recurrente en la  #
#                    tabla de control para el módulo de Solicitud de    #
#                    Saldo en Garantía                                  #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP03.log")

   DISPLAY "=INICIA GRTP03="
   ...
   -- se invoca la funcion que inserta el registro en la tabla de control archivo
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_grt_ctr_arch_rchsdo(?,?,?)"

   PREPARE prp_procd_ins_reg_ctr_arch FROM v_s_qryTxt
   EXECUTE prp_procd_ins_reg_ctr_arch USING p_v_arch_proceso, v_i_estado, p_v_usuario
