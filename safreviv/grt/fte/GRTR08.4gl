...
#                    de salida de Solicitud de Devolucion para el  #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTR08.log")

   DISPLAY "=INICIA GRTR08="
   ...
   LET v_c_tpo_transf = "19" -- Devolución de Saldos Excedentes GRT
