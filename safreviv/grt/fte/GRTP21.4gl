...
#                    control correspondiente al proceso de Devolución   #
#                    de Saldos Excedentes para el módulo de Créditos en #
#                    Garantía 43 bis                                    #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP21.log")

   DISPLAY "=INICIA GRTP21="
   ...
   DATABASE safre_tmp
   LET v_s_qryTxt = "EXECUTE PROCEDURE sp_nss_no_catalogados_grt()"
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION fn_grt_insrt_dsectrarch_devsdos(?,?,?,?)"
...
FUNCTION fn_genera_archivo_no_catalogados(v_arch_proceso)
   ...
   CALL v_arch_format.replace(".dcg","",0)
   ...
   LET v_nom_archivo_salida = v_arch_format.toString() CLIPPED || "_" || v_f_format.toString() CLIPPED ||".rdcg"
