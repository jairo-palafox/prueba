...
#                    tabla de control de archivos para el módulo de     #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP10.log")

   DISPLAY "=INICIA GRTP10="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_uso_insrt_ctr_arch_rchsdo(?,?,?)"
