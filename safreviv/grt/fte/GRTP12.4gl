...
#                    control de archivos correspondiente a Saldos       #
#                    Transferidos del módulo de Uso de Garantía 43 bis  #
#Autor             =>Daniel Buendia, EFP                                #
#Fecha inicio      =>26 Abirl 2012                                      #
#########################################################################
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP12.log")

   DISPLAY "=INICIA GRTP12="
   DISPLAY " USUARIO       : ",p_v_usuario
   DISPLAY " PID           : ",p_d_pid
   DISPLAY " FOLIO         : ",p_d_folio USING "#########&"

   -- se inciializan variables
   LET v_i_estado_cod = 2
   ...
   -- se invoca la funcion que inserta el registro en la tabla de contrl
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_uso_insrt_ctr_arch_sdotrans(?,?,?)"
