...
#                    archivo de entrada Uso Garantía para el       #
#                    módulo de Uso Garantía                        #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL16.log")
   ...
   LET v_i_opera_cod = 2 -- integra archivo solicitud uso 43bis
   LET v_i_opera_cod_ant = 1  -- Valida Rechazo Saldos
   LET v_i_operacion = 18 -- operacion del proceso
   LET v_si_id_proceso = g_id_proceso_grt_uso -- Uso de Garantía 43 bis
   LET v_d_folio = 0
   LET v_c_programa_cod = "GRTL16"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION integrar
            ...
            IF v_si_cuenta_valor = 0 THEN
               ...
               CALL fn_mensaje("Integración Uso Garantía",v_s_mensaje,"information")
               EXIT PROGRAM
            END IF
            -- se procesan los archivos seleccionados para integrar
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTE07 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
