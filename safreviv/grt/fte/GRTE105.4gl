...
#Modulo            => GRT                                                     #
#Programa          => GRTE105                                                 #
#Objetivo          => Programa para la ejecución de cancelación del SP002     #
#Autor             => Héctor F. Jiménez Lara                                  #
#Fecha inicio      => 10 Febrero 2016                                         #
###############################################################################
DATABASE safre_viv
...
FUNCTION fn_cancela_formalizacion(p_nss,p_id_grt_tramite)
   ...
   MENU
      ON ACTION cancelacion
         ...
         IF v_confirma_exe = 1 THEN
            ...
            LET v_s_qry = " INSERT INTO grt_his_formalizacion VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
