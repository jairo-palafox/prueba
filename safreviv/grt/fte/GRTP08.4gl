...
#                    control de archivos de Uso Garantía del módulo de  #
#                    Uso de Garantía                                    #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP08.log")

   DISPLAY "=INICIA GRTP08="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_uso_insrt_ctr_arch_usogar(?,?,?)"
...
FUNCTION fn_display(v_b_estatus_proc)
   ...
   CASE v_b_estatus_proc
      ...
      WHEN 4
         DISPLAY " ERROR: EL TOTAL EN SUMARIO NO COINCIDE CON EL TOTAL DE REGISTROS EN DETALLE"
      WHEN 5
      ...
      WHEN 8
         DISPLAY " ERROR: EL SALDOS TOTAL EN SUMARIO NO COINCIDE CON EL SALDO TOTAL EN DETALLE"
   END CASE
END FUNCTION
