...
MAIN
   ...
   DEFINE r_si_cod_error           SMALLINT -- indica si el proceso puede continuar o no (contiene el código de error)
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTE11.log")

   DISPLAY "=INICIA GRTE11="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION fn_uso_integra_no_aten(?,?,?,?)"
