...
#                    de archivos de Recurrente del módulo de Solicitud de  #
#                    Saldo en Garantía                                     #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP01.log")

   DISPLAY "=INICIA GRTP01="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_grt_ctr_arch_recurr(?,?,?)"
