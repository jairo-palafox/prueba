...
#                    para el Módulo de Créditos en Garantía 43 bis #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL33.log")
   ...
   LET v_i_opera_cod = 1 -- valida rechazos devolución sdo exc grt
   LET v_d_folio = 0 -- para la carga no se envia folio
   LET p_b_tipo_carga = 2
   LET v_v_nom_archivo = NULL
   LET v_c_programa_cod = "GRTL33" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTP22 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/GRTP22 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
