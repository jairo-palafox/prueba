...
#                    del archivo Uso Garantía para el módulo de    #
#                    Uso de Garantía                               #
...
#Objetivo:
#  Menu principal de Archivos entrada Recurrente del modulo de Uso de Garantía.
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL15.log")
   ...
   LET v_d_pid = 0
   LET v_i_proceso_cod = g_proc_cod_grt_uso_garantia --11 -- recepción uso de garantía 43bis
   LET v_i_opera_cod = 1 -- valida archivo solicitud uso 43bis
   LET v_d_folio = 0
   LET p_b_tipo_carga = 2
   LET v_v_nom_archivo = NULL
   LET v_c_programa_cod = "GRTL15"
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTP08 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/GRTP08 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
