...
#                    conciliación correspondiente para el módulo   #
#                    de Uso de Garantías                           #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL29.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_grt_uso_cocilia -- conciliación uso garantía 43bis
   LET v_i_opera_cod = 1 -- conciliación uso 43bis
   LET v_d_pid = 0
   LET v_d_folio = 0
   LET v_v_nom_archivo = "N/A"
   LET v_c_programa_cod = "GRTL29"
   ...
   OPEN WINDOW w_genera_conciliacion WITH FORM "GRTL291"
            ...
            IF r_b_valida = 0 THEN
               ...
               CASE v_cmb_operacion
                  WHEN "01" -- Rechazo de saldos
                     LET v_s_comando = v_s_comando,"GRTP11 "

                  WHEN "06" -- Devolución solicitada
                     LET v_s_comando = v_s_comando,"GRTP15 "

                  WHEN "09" -- Saldos transferidos
                     LET v_s_comando = v_s_comando,"GRTP13 "

                  WHEN "14" -- Solicitud no atendida
                     LET v_s_comando = v_s_comando,"GRTP17 "
