...
#Modulo            => GRT                                           #
#Programa          => GRTL47                                        #
#Objetivo          => Programa que ejecuta desmarca créditos        #
#garantía             43BIS                                         #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTL47.log")
   ...
   LET v_i_proceso_cod  = 1230
   LET v_i_opera_cod    = 1 -- generación de desmarca
   LET v_d_pid          = 0
   LET v_c_programa_cod = "GRTL47"
   LET v_d_folio        = 0
   LET v_i_cont_regs    = 0
   LET v_t_cont_regs    = 0
   ...
   DISPLAY "valida operacion: ", r_b_valida
   ...
   OPEN WINDOW w_sol_marca WITH FORM "GRTL471"
   ...
   Display "r_b_valida inicializa ", r_b_valida
           ...
           END IF
              ...
              -- se crea el comando que ejecuta el módulo que genera el archivo de solicitud de desmarca de 43 bis
              LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED    ,     "/GRTP32 ",
                                                      p_v_usuario             ,     " "       ,
                                                      v_d_pid                 ,     " "       ,
                                                      v_i_proceso_cod         ,     " "       ,
                                                      v_i_opera_cod           ,     " "       ,
              ...
              LET v_mensaje_final = "Se ejecutó el proceso de solicitud desmarca créditos gtia 43bis con el PID : "||v_d_pid
