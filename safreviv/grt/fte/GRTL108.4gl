...
#Modulo             => GRT                                                          #
#Programa           => GRTL108                                                      #
#Objetivo           => Programa Lanzador para consulta de rechazos de acreditados o #
#                      pendientes de acreditar para 43BIS                           #
#Autor              => José Eduardo Ventura                                         #
#Fecha inicio       => 16 de Febrero del 2016                                       #
#####################################################################################
DATABASE safre_viv
...
MAIN 
   ...
   LET g_proceso_cod   = 3910   -- numero de proceso correspondiente   
   LET g_opera_cod     = 1       -- numero de operacion correspondiente 

       -- se abre la ventana de consulta
   OPEN WINDOW GRTL1081 WITH FORM "GRTL1081"
   CALL ui.Interface.setText ( p_nom_ventana )

   --LET v_arch = "Tramitados",TODAY USING "DDMMYYYY",".Sal"
   --LET bnd_arch = 0
