...
#Modulo            =>GRT                                                #
#Programa          =>GRTP05                                             #
#Objetivo          =>Programa que inserta el registro correspondiente a #
#                    Devoluciones  para el módulo de Solicitud de Saldo #
#                    en Garantía                                        #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP05.log")

   DISPLAY "=INICIA GRTP05="
   ...
   -- se crea la sentencia que ejecuta el procedure que realiza la inserción de
   -- registro en la tabla de control de archivos
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_grt_ctr_arch_devol(?,?,?)"
