...
#                preliquidacion de DSE del módulo de Créd. Garant. 43 bis#
...
MAIN
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".GRTL39.log")

   -- se asigna proceso y operacion
   LET g_proceso_cod  = g_proc_cod_grt_liquida_dse -- liquidación devolución saldos exc grt
   LET g_opera_cod    = 1 -- preliquida devolución de saldos exc grt
   LET v_c_tpo_transf = "19" -- 19-Créditos en Garantía 43 bis
...
#Objetivo: Ejecuta la preliquidación de una DSE devoluciones para un folio dado
FUNCTION fn_dse_ejecuta_preliquidacion(p_folio, p_usuario_cod)
   ...
   LET v_b_resultado = fn_valida_operacion(0,g_proceso_cod,g_opera_cod)
   ...
   LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/GRTP25 ",
