...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL03.log")
   ...
   LET v_c_programa_cod = "GRTL03" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTP03 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/GRTP03 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
