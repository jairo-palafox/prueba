...
#Modulo             => GRT                                                       #
#Programa           => GRTL105                                                   #
#Objetivo           => Programa Lanzador del subproceso 3 (uso de garantía)      #
...
MAIN
   ...
   ELSE
      ...
      CALL fn_ventana_confirma("Alerta","Se ejecutara el SP003 Uso de Garantía.\n¿Está seguro que desea continuar?","") RETURNING v_msj_confirma
      ...
      IF v_msj_confirma = 1 THEN
         ...
         CALL fn_inicializa_proceso(v_pid,p_proceso_cod,p_opera_cod,
                                    "","GRTP103","",p_v_usuario) RETURNING r_b_valida
