...
#Modulo            =>GRT                                                #
#Programa          =>GRTP04                                             #
#Objetivo          =>Programa que inserta el registro correspondiente   #
#                    a Saldos Transferidos en la tabla de control de    #
#                    archivos del módulo de Solic. de Saldo en Garantía #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP04.log")

   DISPLAY "=INICIA GRTP04="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_grt_ctr_arch_sdotrans(?,?,?)"
