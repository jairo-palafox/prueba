...
#                     archivo recurrente para el módulo de Solicitud de    #
#                     Saldo en Garantía                                    #
...
#Objetivo:
#  Menu principal de Archivos entrada Recurrente del modulo de Transferencia de aceditados.
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".GRTL01.log")
   ...
   IF r_b_valida = 0 THEN      
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/GRTP01 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/GRTP01 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
