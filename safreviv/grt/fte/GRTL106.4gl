...
#Modulo             => GRT                                                       #
#Programa           => GRTL106                                                   #
#Objetivo           => Programa Lanzador del subproceso 5 (liquidación)          #
#                      del proceso de otorgamiento de créditos en garantía 43 bis#
#Autor              => Héctor F. Jiménez Lara                                    #
#Fecha inicio       => 20 de Noviembre del 2015                                  #
##################################################################################
DATABASE safre_viv
...
MAIN
   ...
   DEFINE v_r_id_grt_arch   DECIMAL(9,0)
   DEFINE v_r_nom_grt_arch  CHAR(40)
   ...
   ELSE
      ...
      CALL fn_recupera_archivo() RETURNING v_r_id_grt_arch, v_r_nom_grt_arch

      CALL fn_ventana_confirma("Alerta","Se ejecutara el SP005 Liquidación.\n¿Está seguro que desea continuar?","") RETURNING v_msj_confirma

      IF v_msj_confirma = 1 THEN
         LET v_s_mensaje = "Se ejecuta el SP003 con PID: ",v_pid CLIPPED,
                           ".\nPuede revisar el avance del proceso en el monitor de ejecución de procesos"

         CALL fn_mensaje("Alerta",v_s_mensaje,"information")

         CALL fn_inicializa_proceso(v_pid,p_proceso_cod,p_opera_cod,
                                    "","GRTP104","",p_v_usuario) RETURNING r_b_valida
...
FUNCTION fn_recupera_archivo()
   ...
   LET v_s_qryTxt = " SELECT id_grt_ctr_archivo,
                             COUNT(*)
   ...
   RETURN v_id_grt_ctr_arch, v_nom_arch
END FUNCTION
