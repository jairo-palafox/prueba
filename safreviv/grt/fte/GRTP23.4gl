...
#                    control del proceso Valida Confirmación DSE para   #
#                    el módulo de Créditos en Garatía 43 bis            #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP23.log")

   DISPLAY "=INICIA GRTP23="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_dse_insrt_dsectrarch_confdse_grt(?,?,?,?)"
