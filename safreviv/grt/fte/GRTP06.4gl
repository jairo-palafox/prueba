...
#Modulo            =>GRT                                                #
#Programa          =>GRTP06                                             #
#Objetivo          =>Programa que inserta registro de No Atendidas en   #
#                    la tabla de control de archivos correspondiente al #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".GRTP06.log")

   DISPLAY "=INICIA GRTP06="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_grt_ctr_arch_noaten(?,?,?)"
