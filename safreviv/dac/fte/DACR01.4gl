...
#OBJETIVO: Eliminar el registro del archivo
FUNCTION fn_reversa_validacion(p_nombre_archivo)
  DEFINE 
   p_nombre_archivo  LIKE glo_ctr_archivo.nombre_archivo -- nombre del archivo
   --    
   ,v_s_qry          STRING
   ...
   PREPARE prp_elimina_archivo FROM v_s_qry 
   EXECUTE prp_elimina_archivo USING  p_nombre_archivo, g_proceso_cod

END FUNCTION -- fn_reversa_validacion
