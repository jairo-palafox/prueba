...
#Modulo       => DAC                                                           #
#Programa     => DACL08                                                        #
#Objetivo     => Programa lanzador que ejecuta el reverso de la preliquidación #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "DACL080"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dac_reverso_preliquidacion(v_folio, p_usuario_cod, v_r_glo_ctr_archivo.nombre_archivo)
         EXIT INPUT
...
#OBJETIVO: Ejecutar la reverso de liquidación de devolución de amortización MTC
FUNCTION fn_dac_reverso_preliquidacion(p_folio, p_usuario_cod, v_nombre_archivo)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DACR03 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
