...
FUNCTION fn_genera_consulta_rechazo_INFONAVIT(p_usuario_cod)
   ...
   OPEN WINDOW win_ConsInfo WITH FORM "DPEC090"
   CLOSE WINDOW SCREEN
   ...
   CALL v_cbx_folios.clear()
         ...
         WHERE g.proceso_cod = g_proceso_cod_dpe_infonavit -- codigo de proceso asignado
      ...
      DISPLAY ARRAY v_ar_registro TO tb_registro.* 
         ...
         BEFORE ROW
            ...
            ON ACTION regresa
               ...
               SELECT DISTINCT d.folio, g.nombre_archivo
               FROM glo_ctr_archivo g, glo_folio d
               WHERE g.proceso_cod = g_proceso_cod_dpe_infonavit -- Proceso_cod asignado
                 AND g.estado = 2 -- integrado
                 AND g.folio = d.folio
            ...
            ON ACTION reporte
                # Recupera la ruta de listados en el que se enviara el archivo
                  ...
                  IF fgl_report_loadCurrentSettings("DPEC02.4rp") THEN 
                     ...
                     LET v_nom_reporte = p_usuario_cod CLIPPED || "-DPEC09-","00000","-","00000","-","00000"||".pdf"
