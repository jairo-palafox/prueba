...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se asigna proceso y operacion
      ...
      OPEN WINDOW w_folio_preliquida WITH FORM "DACL090"
      ...
      ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            CALL fn_dac_reverso_liquidacion(v_folio, p_usuario_cod)
            EXIT INPUT
...
FUNCTION fn_dac_reverso_liquidacion(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET v_nombre_archivo = "ARCHIVOAQUI"
      ...
      IF ( fn_valida_reverso(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DACR04 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
