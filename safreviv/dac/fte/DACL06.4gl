...
#Modulo       => DAC                                                           #
#Programa     => DACL06                                                        #
#Objetivo     => Programa lanzado del reverso de la carga del archivo de       #
...
MAIN
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "DACL060"
...
FUNCTION fn_dpe_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/DACR01 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
