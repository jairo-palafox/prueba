...
#                    en la integración de Unificación Complementaria Recurrente#
...
GLOBALS
   DEFINE g_pid          LIKE bat_ctr_proceso.pid, --  ID del proceso
          ...
          p_mensaje_integra STRING, -- cuerpo del mensaje enviado
...
DEFINE p_pid             LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   LET p_mensaje_integra = ARG_VAL(7)
   ...
   ---- Inicio operacion.
   CALL fn_genera_archivo_rechazos_imss(p_usuario_cod, p_folio)
...
FUNCTION fn_genera_archivo_rechazos_imss(p_usuario_cod, p_folio)
...
END RECORD
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".UNIS08.log")
   ...
   LET v_busca_archivo = "RECH_REC"||v_d_hoy
   ...
   LET v_v_nom_archivo = v_busca_archivo||v_reg_dia||".rchrec"
