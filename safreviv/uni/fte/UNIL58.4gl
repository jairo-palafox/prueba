...
#Modulo       => UNI                                                           #
#Programa     => UNIL58                                                        #
#Objetivo     => Lanzador reverso generar archivo salida unificación recurrente#
...
-- Fecha      -- Modificación
-- 13-11-2014 Se ordenan los folios en el combo de 
--==============================================================================
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = 6    -- Archivo de Salida
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL580"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR36 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
