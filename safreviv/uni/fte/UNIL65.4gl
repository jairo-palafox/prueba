...
#Modulo       => UNI                                                           #
#Programa     => UNIL65                                                        #
#Objetivo     => Lanzador generar archivo salida                               #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   END IF
      ...
      OPEN WINDOW w_folio_genera WITH FORM "UNIL650"
         ...
         BEFORE INPUT
            ...
            ON ACTION Generar
               ...
               CALL fn_ejecuta_generacion_archivo_IMSS(v_folio_liquida , p_usuario_cod)
                  EXIT INPUT
...
FUNCTION fn_ejecuta_generacion_archivo_IMSS(p_folio, p_usuario_cod)
   ...
   AND    opera_cod = 1
{
   ...
   IF r_bdn_valida_op = 0 THEN 
   	  CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL65 ","",p_usuario_cod)
           RETURNING r_bnd_fin_oper
           
      IF (r_bnd_fin_oper = 0) THEN}
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/UNIS13 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
