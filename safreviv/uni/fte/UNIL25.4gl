...
#Modulo       => UNI                                                           #
#Programa     => UNIL25                                                        #
#Objetivo     => Programa lanzador de la  integración del archivo operación 22 #
...
-- 03/12/2014 -- Se cambia para aceptar tipo de ejecución manual y automática AG
--==============================================================================

GLOBALS "UNIG01.4gl"
GLOBALS
DEFINE g_pid          LIKE bat_ctr_proceso.pid, --  ID del proceso
       g_proceso_cod  SMALLINT,--LIKE cat_proceso.proceso_cod, -- codigo del proceso
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_uni_operacion22 -- Unificación de cuentas operacion 22
   LET g_opera_cod   = g_opera_cod_uni_integraop22 -- Integracion confronta
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            LET v_s_qry = "\n SELECT tot_nss_unificadores,",
                          ...
                          "\n        tot_cuentas_unificadas",
                          "\n FROM safre_tmp:tmp_sum_op22_notificacion"
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Atención",
              ...
              " de Unificación de cuentas Operación 22?",
              "quest") RETURNING v_respuesta
     
        IF v_respuesta = 1 THEN
           DISPLAY "Entro"
           CALL fn_uni_ejecuta_integracion_op22(p_usuario_cod, l_v_arch_proceso)
           EXIT DIALOG
        END IF
...
#OBJETIVO: Ejecutar el proceso de la integración UNI Operación 22
FUNCTION fn_uni_ejecuta_integracion_op22(p_usuario_cod, p_nombre_archivo)
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
          LET v_folio = 0
         -- Inicio operacion.
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,"UNIL25","",p_usuario_cod)
              RETURNING r_bnd_fin_oper
         IF (r_bnd_fin_oper = 0) THEN
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIP06 ",
                               p_usuario_cod, " ",
                               g_pid  , " " ,
                               g_proceso_cod , " " ,
                               g_opera_cod ," ",
...
END FUNCTION -- fn_uni_ejecuta_integracion_op22
