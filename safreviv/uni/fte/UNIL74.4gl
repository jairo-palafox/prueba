...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = 2307 --Nuevo modelo de unificación IMSS
   LET g_opera_cod   = 3
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL740"
...
======================================================================
Clave: 
Nombre: fn_uni_ejecuta_preliquidacion
...
DISPLAY "ARCHIVO : ", v_nombre_archivo
   ...
   IF ( r_bnd_valida_opera = 0 ) THEN
      -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL74","",p_usuario)
      RETURNING r_bnd_opera_ini

      IF (r_bnd_opera_ini = 0) THEN
         LET v_s_comando = " fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/UNIP24 " CLIPPED," ",
                             p_usuario CLIPPED," ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
