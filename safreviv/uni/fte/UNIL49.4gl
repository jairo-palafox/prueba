...
DEFINE p_usuario     LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   END IF
      ...
      OPEN WINDOW w_folio_genera WITH FORM "UNIL490"
         ...
         ATTRIBUTES (UNBUFFERED, ACCEPT = FALSE)
            ...
            ON ACTION Generar
               ...
               CALL fn_generar_archivo_trm_aceptados(v_folio, p_usuario , v_fecha_ini, v_fecha_fin)
                  EXIT INPUT
...
FUNCTION fn_generar_archivo_trm_aceptados(p_folio, p_usuario, p_fecha_ini, p_fecha_fin)
DEFINE p_usuario          LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( r_bnd_valida_op = 0 ) THEN  
      ...
      --Inicia proceso
      CALL fn_inicializa_proceso(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL49","",p_usuario )
      RETURNING v_inicia_proceso

      IF (v_inicia_proceso = 0)THEN
         -- Inicio operacion.
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL49","",p_usuario )
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/UNIS10 ",
                             p_usuario , " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
