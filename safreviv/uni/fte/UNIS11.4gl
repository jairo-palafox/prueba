...
#Modulo            =>UNI                                                       #
#Programa          =>UNIS11                                                    #
#Objetivo          =>Programa extractor TRM solo INFONAVIT                     #
...
MAIN
   ...
   SELECT MAX(pid)
    ...
    DISPLAY "###############################################"
    DISPLAY "# Parámetros de Consulta                       "
    DISPLAY "# " 
   ...
   CALL fn_archivo_salida_trm_uni(p_usuario_cod, p_folio, p_fecha_ini, p_fecha_fin)
...
#OBJETIVO: Generar el archivo de salida para TRM INFONAVIT 
FUNCTION fn_archivo_salida_trm_uni(p_usuario_cod, p_folio, p_fecha_ini, p_fecha_fin)
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".UNIS11.log")
   ...
   LET v_busca_archivo = "TRM"||v_d_hoy
   ...
   LET v_s_sql = "\n SELECT a.*,",
                 ...
                 "\n AND    a.f_liquidacion BETWEEN ", "'", p_fecha_ini,"'", 
                 "\n AND ", "'", p_fecha_fin,"'",
                 "\n AND    b.proceso_cod = 2302"
   ...
   FOREACH Cur_reg_unificacion INTO v_r_inf_unificador.*,
      ...
      EXECUTE prp_consulta_creditos USING v_r_inf_unificador.id_derechohabiente, 
                                          v_r_inf_unificador.id_inf_unificador,
                                          v_num_credito,
                                          v_r_inf_unificador.folio_unificacion
   ...
   LET p_titulo = "Finalización de proceso - " || v_proceso_desc CLIPPED || " - GENERA ARCHIVO TRM INFONAVIT"
