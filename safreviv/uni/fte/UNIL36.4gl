...
#Modulo       => UNI                                                                 #
#Programa     => UNIL36                                                              #
#Objetivo     => Programa que interfaz de usuario para capturar folio respuesta OCI  #
#                generar sus reverso                                                 # 
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR28 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
       ...
       RUN v_s_comando
       CALL fn_mensaje("Atención","Se ha enviado el reverso de la integracion de archivo respuesta sistemas IMSS.\n"||
