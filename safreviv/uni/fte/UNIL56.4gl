...
#Modulo       => UNI                                                           #
#Programa     => UNIL56                                                        #
#Objetivo     => Lanzador reverso liquidación unificación recurrente           #
...
-- Fecha ultima modificacion: 06/Nov/2014 Se corrige combo para no borrar registro 
--                            en combo, después de Aceptar  AG
--==============================================================================
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL560"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         SELECT DISTINCT a.nombre_archivo, b.folio
          FROM glo_ctr_archivo a,
               glo_folio b, 
               uni_det_unificador c
         WHERE a.proceso_cod = b.proceso_cod
           AND a.proceso_cod = g_proceso_cod
           AND b.folio_referencia = a.folio
           AND b.folio_referencia = c.folio_unificacion           
           AND b.opera_cod  = 5
           AND b.status     = 2
           AND c.diagnostico = 4
...
Fecha creacion: Junio 06, 2012
Narrativa del proceso que realiza:
Ejecuta la reverso preliquidacion de una unificación de cuentas
======================================================================}
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   -- contable
DISPLAY "Folio : ", p_folio, "Proceso: ", g_proceso_cod
   CALL fn_valida_poliza_cnt(p_folio, g_proceso_cod)
   RETURNING v_resultado_poliza
DISPLAY "Validación de la póliza: ", v_resultado_poliza
   ...
   -- se verifica si se puede continuar con la operacion   
      ...
      IF v_si_codigo = 0 THEN 
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR34 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
