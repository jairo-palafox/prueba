...
#Modulo       => UNI                                                           #
#Programa     => UNIP21                                                        #
#Objetivo     => Lanzado preliquidación unificación                            #
...
MAIN
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| "UNIP21.log")
   ...
   LET g_pid         = p_pid      
   LET g_proceso_cod = p_proceso_cod -- Nuevo modelo de unificación IMSS
   ...
   DISPLAY "# "
   DISPLAY "#    Total movimientos de cargo en subcuenta: "||v_i_total_registros
   DISPLAY "# "
   DISPLAY "# # # # # # # # # # # # # # # # # # # # # # # # # #"
