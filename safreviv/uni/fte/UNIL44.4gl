...
#Modulo       => UNI                                                           #
#Programa     => UNIL44                                                        #
#Objetivo     => Lanzador integración Unificación Complementaria Recurrente    #
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Atención",
              ...
              " Unificación de cuentas recurrente por archivo?",
...
DEFINE p_usuario      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( r_bnd_valida_opera = 0 ) THEN
      -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL44","",p_usuario)
      RETURNING r_bnd_opera_ini
      
      IF (r_bnd_opera_ini = 0) THEN	
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/UNIP15 ",
                            g_pid  , " " ,
                            g_proceso_cod , " " ,
                            g_opera_cod ," ",
                            p_usuario, " ",
