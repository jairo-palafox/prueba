...
#Modulo       => UNI                                                           #
#Programa     => UNIL38                                                        #
#Objetivo     => Programa lanzador de integración respuesta sistemas INFONAVIT #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_uni_resp_sist_inf  -- RESPUESTA SISTEMAS INFONAVIT
   LET g_opera_cod   = g_opera_cod_uni_integra_resp_inf --INTEGRACION RESPUESTA SISTEMAS INFONAVIT     
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         CALL fn_ventana_confirma("Atención",
              ...
              " de Unificación de cuentas respuesta sistemas INFONAVIT?",
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
           ...
           -- Inicio operacion.
         CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,"UNIL38",
                                 "",p_usuario_cod)
              RETURNING r_bnd_fin_oper
         IF (r_bnd_fin_oper = 0) THEN
       	
             LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIP10 ",
                               g_pid  , " " ,
                               g_proceso_cod , " " ,
                               g_opera_cod ," ",
                               p_usuario_cod, " ",
