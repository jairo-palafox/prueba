...
#Modulo       => UNI                                                           #
#Programa     => UNIL77                                                        #
#Objetivo     => Lanzador reverso carga archivo                                #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "UNIL770"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_uni_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
         EXIT INPUT
...
#OBJETIVO: Ejecuta la reverso de carga de archivo
FUNCTION fn_uni_reverso_carga_archivo(v_nombre_archivo, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF (v_si_codigo = 0) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR43 ",
