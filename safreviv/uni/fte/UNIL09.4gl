...
#Modulo       => UNI                                                           #
#Programa     => UNIL09                                                        #
#Objetivo     => Programa lanzado de reverso de carga de archivo de solicitudes#
#                unificación de cuentas IMSS OP21                              #
#Fecha inicio => Junio 05, 2012                                                #
################################################################################
--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 
-- 20/11/2014 Se modifica cambio de código de proceso y operación por automatización AG
--==============================================================================
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = 1    -- CARGA ARCHIVO DE SOLICITUDES
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR09 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
