...
#Modulo       => UNI                                                           #
#Programa     => UNIL57                                                        #
#Objetivo     => Lanzador reverso de indicadores de crédito y desmarca de      #
...
-- Fecha ultima modificacion: 06/Nov/2014 Se agrega descripción de Proceso y Operación -AG
--==============================================================================
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL570"
      ...
      BEFORE INPUT
         ...
         IF(v_i_conArch<1)THEN
            CALL fn_mensaje("Atención","No existen folios a reversar","info")
            EXIT INPUT
         END IF
         ...
         ON ACTION ACCEPT
            ...
            CALL fn_reverso_indicadores(v_folio, p_usuario_cod)
            EXIT INPUT
...
#OBJETIVO: Ejecutar el reverso de los indicadores de crédito y remarcar las cuentas
FUNCTION fn_reverso_indicadores(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR35 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
       ...
       CALL fn_mensaje("Atención","Se ha enviado el reverso de los Indicadores.\n"||
