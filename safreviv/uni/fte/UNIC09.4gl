...
DEFINE w ui.Window,
       ...
       v_r_res_resumen RECORD -- registro llenar el resumen de patrones
          ...
          cont_unificador     SMALLINT,
          cont_unificado      SMALLINT,
...
DEFINE v_i_conArch          INTEGER,
   ...
   OPEN WINDOW win_ConsInfo WITH FORM "UNIC090"
...
DISPLAY "v_s_sql global: ", v_s_sql
...
DEFINE p_folio              LIKE glo_folio.folio,
   ...
   FOREACH Curr_ObtDatos_unificador INTO v_r_res_unificador.*
      ...
      LET v_ar_res_unificador[v_si_indice].v_nombre = v_r_res_unificador.v_nombre
      ...
      DIALOG ATTRIBUTES (UNBUFFERED)
         ...
         BEFORE ROW
            ...
            ON ACTION Consulta_Derechohabiente
               ...
               LET v_comando = "fglrun ../../afi/bin/AFIC01.42r " || g_usuario_cod || "1 'Consulta de Derechohabiente' " || v_ar_res_unificador[ARR_CURR()].v_nss_unificador  
         ...
         DISPLAY ARRAY v_ar_res_unificado TO scr_unificado.*
            ...
            ON ACTION Consulta_Derechohabiente
               -- se ejecuta la consulta del derechohabiente usando la consulta general
               LET v_comando = "fglrun ../../afi/bin/AFIC01.42r " || g_usuario_cod || "1 'Consulta de Derechohabiente' " || v_ar_res_unificado[ARR_CURR()].v_nsscta1
               RUN v_comando
...
DEFINE p_folio            LIKE glo_folio.folio,
   ...
   LET v_s_sql = "\n SELECT a.folio_unificacion, ",  
                 ...
                 "\n        a.id_derechohabiente", 
                 "\n  FROM  uni_det_unificado a ", 
                 "\n  LEFT  OUTER JOIN uni_estado_solicitud b",
                 "\n    ON  a.estado_unificacion = b.id_estado ", 
                 "\n  LEFT  OUTER JOIN uni_diagnostico_sol c",
                 "\n    ON  a.diagnostico = c.id_diagnostico ",
                 --"\n   WHERE 1= 1", 
                 p_QryTxt
   ...
   FOREACH Curr_ObtDatos_unificado INTO v_r_res_unificado.v_folio_unificacion THRU v_r_res_unificado.v_id_derechohabiente
      ...
      CALL fn_credito_vivienda(v_r_res_unificado.v_nsscta1, 0)
      ...
      INTO    v_r_res_unificado.v_tpo_originacion
      FROM    cat_cre_originacion
      WHERE   tpo_originacion = r_tpo_originacion;

      SELECT  desc_credito
      INTO    v_r_res_unificado.v_tpo_credito
      FROM    cat_tipo_credito
      WHERE   tpo_credito = r_tpo_credito;
      ...
      LET v_ar_res_unificado[v_si_indice].v_numero_credito =  r_num_credito --v_r_res_unificado.v_numero_credito
