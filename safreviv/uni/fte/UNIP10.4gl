...
#Modulo       => UNI                                                           #
#Programa     => UNIP10                                                        #
#Objetivo     => Programa lanzado de integración respuesta sistemas INFONAVIT  #
...
DEFINE v_folio_int_resp_sist_inf  DECIMAL(9,0),
   ...
   EXECUTE prp_integra_op22 USING v_folio_int_resp_sist_inf,
            ...
            WHEN (SQLCA.SQLCODE = 0)
               ...
               DISPLAY "#    "
               DISPLAY "#    Folio integración respuesta: "||v_folio_int_resp_sist_inf
               DISPLAY "#    "
               ...
               IF v_i_resultado >= 0 THEN
                  ...
                  LET p_mensaje = "# # # # # # # # # # # # # # # # # # # # # # # # # #","\n",
                                  ...
                                  "#  ","\n",
                                  "#  Folio integración respuesta : ",v_folio_int_resp_sist_inf,"\n",
                                  "#  ","\n",
                                  "# # # # # # # # # # # # # # # # # # # # # # # # # #"
