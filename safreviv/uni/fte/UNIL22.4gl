...
-- 19/11/2014 Se modifica consulta para recuperar folios. AG
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL22"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_uni_reverso_generar_archivo(v_folio, p_usuario_cod)
         EXIT INPUT
...
{======================================================================
Clave: 
Nombre: fn_uni_reverso_generar_archivo
Fecha creacion: Junio 06, 2012
Narrativa del proceso que realiza:
Ejecuta la reverso preliquidacion de una unificación de cuentas
======================================================================}
FUNCTION fn_uni_reverso_generar_archivo(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR22 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
       ...
       DISPLAY v_s_comando
       RUN v_s_comando
       CALL fn_mensaje("Atención","Se ha enviado el reverso de la generacion de archivo.\n"||
