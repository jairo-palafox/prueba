...
#Modulo       => UNI                                                           #
#Programa     => UNIL32                                                        #
#Objetivo     => Programa lanzador del reverso de liquidación de unificación   #
#                de cuentas IMSS                                               #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL120"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   -- se verifica si se puede continuar con la operacion   
      ...
      IF v_si_codigo = 0 THEN 
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR12 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
