...
#Modulo       => UNI                                                           #
#Programa     => UNIL33                                                        #
#Objetivo     => Programa lanzador de la  validación de archivo respuesta      #
#                sistemas IMSS                                                 #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_uni_carga_resp_imss -- Carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      IF (fn_carga_archivo(g_pid,g_proceso_cod,g_opera_cod,2,"UNIL33",
