...
#Modulo       => UNI                                                           #
#Programa     => UNIL12                                                        #
#Objetivo     => Programa lanzador del reverso de la generación del archivo de #
#                salida unificación de cuentas IMSS                            #
#Fecha inicio => Junio 05, 2012                                                #
################################################################################
--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 05/06/2012
-- 26/11/2014 Se modifica para que tome parametros de ejecución automática AG
--==============================================================================
GLOBALS "UNIG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL190"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR18 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
