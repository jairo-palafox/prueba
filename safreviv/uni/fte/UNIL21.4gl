...
#Modulo       => UNI                                                                    #
#Programa     => UNIL21                                                                 #
#Objetivo     => Programa que interfaz de usuario  para generar reverso de Indicadores. #
#                                                                                       #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL21"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR21 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
