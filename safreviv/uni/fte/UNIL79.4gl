...
#Modulo       => UNI                                                           #
#Programa     => UNIL78                                                        #
#Objetivo     => Lanzador reverso preliquidación                               #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL790"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      DECLARE cur_folios CURSOR FOR SELECT g.folio, a.nombre_archivo
                                    ...
                                    WHERE  a.proceso_cod = 2307
                                    AND    a.proceso_cod =   g.proceso_cod
                                    AND    a.folio = g.folio
                                    AND    g.status = 1
                                    AND    g.folio = c.folio_complentario
                                    AND    c.diagnostico = 3
                                    GROUP BY 1,2
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR45 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
