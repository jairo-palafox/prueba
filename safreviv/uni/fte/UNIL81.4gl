...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_opera_cod   = 5    -- Archivo Salida
   ...
   FROM cmb_folio ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_uni_reverso_archivo_salida(v_folio, p_usuario_cod)
         EXIT INPUT
...
FUNCTION fn_uni_reverso_archivo_salida(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF bnd_resultado = 0 THEN
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR47 ",
