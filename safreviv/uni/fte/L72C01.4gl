...
MAIN
   ...
   CALL STARTLOG(p_usuario CLIPPED ||".L72C011.log")
   ...
   OPEN WINDOW vtn_L72C011 WITH FORM "L72C011"
            ...
            DIALOG ATTRIBUTES(UNBUFFERED)
               ...
               BEFORE DISPLAY 
                  ...
                  --ON ACTION Unificacion 
                     --CALL fn_unifica_ley72(v_condicion)
                  --###  Botón que ejecuta la función de separación
                  --ON ACTION Separacion 
                     --CALL fn_mensaje ("Atencion", "Se ejecutará la separacion", "About")
                  --###  Botón que ejecuta la función de separación
