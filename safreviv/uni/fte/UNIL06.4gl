--===============================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 23/05/2012
--===============================================================
...
#                del detalle de la unificacion de cuentas IMSS                          #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_uni_infonavit -- Unificación de cuentas solo infonavit
   LET g_opera_cod   = g_opera_cod_uni_integracion -- Integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
       ...
       l_arr_integrados   DYNAMIC ARRAY OF RECORD -- Detalle archivos a integrar
            ...
            tot_unificadores   INTEGER,
            tot_unificados     INTEGER
       END RECORD,
...
END RECORD
   ...
   OPEN WINDOW w_inte_devol WITH FORM "UNIL060"
      ...
      ON ACTION ACCEPT
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
            ...
            FOREACH  c_unificador INTO rec_totales.rec_tot_unificadores
               ...
               LET l_arr_integrados[l_i_iter].tot_unificadores = l_i_iter_r
            ...
            LET l_arr_integrados[l_i_iter].tot_unificados = rec_totales.rec_tot_unificados          
         END FOR
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod -- usuario que ejecuta el programa
       ...
       IF ( v_i_resultado = 0 ) THEN
             CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,v_folio,"UNIL06",
                                 "",p_usuario_cod)
              RETURNING r_bnd_fin_oper
         IF (r_bnd_fin_oper = 0) THEN

          --Genera folio de integración
          CALL fn_genera_folio(g_proceso_cod,g_opera_cod,p_usuario_cod)
               RETURNING v_folio
          
          LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIP03 ",
                            g_pid  , " " ,
                            g_proceso_cod , " " ,
                            g_opera_cod ," ",
                            p_usuario_cod, " ",
