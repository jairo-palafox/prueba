...
#                para unificación de cuentas solo IMSS.                                 #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   END IF
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".UNIR09-1.log")

   LET g_proceso_cod = g_proceso_cod_uni_IMSS -- dpe
   LET g_opera_cod   = g_opera_cod_uni_carga_confronta  -- carga confronta
