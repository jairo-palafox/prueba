...
#Modulo       => UNI                                                           #
#Programa     => UNIL32                                                        #
#Objetivo     => Programa lanzador del reverso de integración de respuesta con-#
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_dpe_reverso_integracion(v_folio, p_usuario_cod, v_r_glo_ctr_archivo.nombre_archivo)
         EXIT INPUT
...
======================================================================}
FUNCTION fn_dpe_reverso_integracion(p_folio, p_usuario_cod, v_nombre_archivo)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR26 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
