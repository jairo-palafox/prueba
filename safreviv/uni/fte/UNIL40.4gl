...
#Modulo       => UNI                                                           #
#Programa     => UNIL40                                                        #
#Objetivo     => Programa lanzador del reverso de integración del archivo      #
#                respuesta sistemas INFONAVIT                                  #
#Fecha inicio => 31/07/2012                                                    #
################################################################################
GLOBALS "UNIG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL360"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF v_si_codigo = 0 THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR30 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
       ...
       RUN v_s_comando
       CALL fn_mensaje("Atención","Se ha enviado el reverso de la integracion de archivo respuesta OCI.\n"||
