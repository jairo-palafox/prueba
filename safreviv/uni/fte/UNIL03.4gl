...
#Modulo       => UNI                                                           #
#Programa     => UNIL03                                                        #
#Objetivo     => Programa para ejecutar la preliquidación  unificacion de      #
#                cuentas solo IMSS                                             #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL030"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_uni_ejecuta_preliquidacion_IMSS(v_folio, p_usuario_cod)
         EXIT INPUT
...
FUNCTION fn_uni_ejecuta_preliquidacion_IMSS(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( fn_valida_operacion(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
   	    ...
   	    -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL03",
                                 "",p_usuario_cod)
       RETURNING r_bnd_fin_oper
      IF (r_bnd_fin_oper = 0) THEN
      
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIP02 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
