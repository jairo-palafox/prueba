...
#Modulo     => UNI                                                             #
#Programa   => UNIL45                                                          #
#Objetivo   => Lanzador de preliquidación Unificación Complementaria Recurrente#
...
FUNCTION fn_uni_ejecuta_preliquidacion_IMSS(p_folio, p_usuario)
...
DISPLAY "ARCHIVO : ", v_nombre_archivo
   ...
   IF ( r_bnd_valida_opera = 0 ) THEN
      -- Inicio operacion.
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL45","",p_usuario)
      RETURNING r_bnd_opera_ini
      
      IF (r_bnd_opera_ini = 0) THEN	
         LET v_s_comando = " fglrun ",g_reg_modulo.ruta_bin CLIPPED,"/UNIP17 ",
                             p_usuario, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
