...
#Modulo       => UNI                                                           #
#Programa     => UNIL17                                                        #
#Objetivo     => Programa lanzador de liquidación de unificiación INFONAVIT    #
#                solo  INFONAVIT.                                              #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL17"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado_poliza = 0 ) THEN
      ...
      IF v_si_codigo = 0 THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR17 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
