...
#                     en la integración unificación IMSS                       # 
...
-- Fecha ultima modificacion: 01/12/2014   MHM
--===============================================================
...
FUNCTION fn_genera_archivo_rechazos_imss(p_usuario_cod,
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".UNIS04.log")
   ...
   LET v_v_nom_archivo = "/"||v_busca_archivo||v_reg_dia||".rchop21"
