...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   END IF
      ...
      LET g_proceso_cod = g_proceso_cod_uni_IMSS -- Unificación de cuentas
      LET g_opera_cod   = g_opera_cod_uni_generacion -- generacion de archivo
...
DEFINE p_folio, v_folio     LIKE glo_folio.folio,
       v_i_unificador       SMALLINT,
       v_i_unificado        SMALLINT,
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( fn_valida_operacion(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
   	      ...
   	      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIL42",
                                 "",p_usuario_cod)
