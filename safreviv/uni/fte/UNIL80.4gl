...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "UNIL800"
   ...
   FROM cmb_folio ATTRIBUTES (UNBUFFERED)
      ...
      BEFORE INPUT
         ...
         DECLARE cur_folios CURSOR FOR SELECT g.folio, a.nombre_archivo
                                       ...
                                       AND    g.status = 2
                                       AND    g.folio = c.folio_liquidacion
                                       AND    c.diagnostico = 4
                                       GROUP BY 1,2
         LET v_i_conArch = 0
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_uni_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_resultado_poliza = 0 ) THEN
      ...
      IF v_si_codigo = 0 THEN 
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR46 ",
                             p_usuario_cod, " ",
                             g_pid  , " " ,
                             g_proceso_cod , " " ,
                             g_opera_cod ," ",
