...
#Modulo       => UNI                                                           #
#Programa     => UNIL37                                                        #
#Objetivo     => Programa lanzador de validación respuesta sistemas IMFONAVIT  #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_uni_carga_resp_inf -- Carga de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      IF (fn_carga_archivo(g_pid,g_proceso_cod,g_opera_cod,2,"UNIL37",
