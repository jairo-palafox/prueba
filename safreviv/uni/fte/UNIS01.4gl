...
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET v_s_sql = "\n SELECT a.*, c.nsscta1",
                 ...
                 "\n        uni_det_unificado c",
                 "\n WHERE  a.folio_liquidacion = ",v_folio,
   ...
   FOREACH Cur_reg_unificacion INTO v_r_det_unificador.*, v_nss_unificado
      ...
      --DISPLAY "ID_DH UNIFICADOR : ", v_r_det_unificador.id_derechohabiente  
      ...
      IF v_id_credito <> 0 THEN
         ...
         LET v_cont_con_credito = v_cont_con_credito + 1
          ...
          --DISPLAY "ID_UNIFICADOR : ", v_r_det_unificador.id_unificador
