--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion:21/Ene/2016
--==============================================================================
################################################################################
#Modulo       => UNI                                                           #
#Programa     => UNIL78                                                        #
#Objetivo     => Lanzador reverso integración                                  #
#Fecha inicio => 21/Ene/2016                                                   #
################################################################################
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_rev_integracion WITH FORM "UNIL780"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_uni_reverso_integracion(v_folio, p_usuario_cod, v_r_glo_ctr_archivo.nombre_archivo)
         EXIT INPUT
   ...
   CLOSE WINDOW w_rev_integracion
END MAIN

#OBJETIVO: Ejecutar el reverso integración de una unificación de cuenta
FUNCTION fn_uni_reverso_integracion(p_folio, p_usuario_cod,v_nombre_archivo)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, 
   ...
   IF (v_si_codigo = 0) THEN
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR44 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
