...
#Modulo       => UNI                                                           #
#Programa     => UNIS09                                                        #
#Objetivo     => Programa que ejecuta el proceso de generación del archivo     #
...
DEFINE r_resultado            SMALLINT,
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".UNIS09.log")
...
-- se obtienen la ruta envio del modulo
   ...
   LET v_busca_archivo = "UNI_RECS"||v_d_hoy 
   ...
   LET v_s_sql = "\n SELECT a.*, c.nsscta1",
                 ...
                 "\n        uni_det_unificado c",
                 "\n WHERE  a.folio_unificacion = ",v_folio,
   ...
   FOREACH Cur_reg_unificacion INTO v_r_det_unificador.*, v_nss_unificado
      ...
      IF r_resultado = 0 THEN
         ...
         DECLARE cur_tpo_cre CURSOR FOR SELECT a.tpo_credito,
                                               a.num_credito,
                                               a.valor_dscto
