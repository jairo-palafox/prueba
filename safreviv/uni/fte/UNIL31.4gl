...
#Modulo       => UNI                                                           #
#Programa     => UNIL31                                                        #
#Objetivo     => Programa lanzador del reverso de validación de respuesta con- #
#                frontación unificación de cuentas IMSS                        # 
#Fecha inicio => Junio 05, 2012                                                #
################################################################################
--==============================================================================
-- Version: 1.0.0
-- Fecha ultima modificacion: 20/06/2012
-- 26/11/2014 Se actualiza proceso y opera cod por automatización  AG
--==============================================================================
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = 2301 -- UNI
   LET g_opera_cod   = 1    -- Carga archivo confronta
  ...
  -- se abre la ventana que envia el proceso de preliquidacion
   OPEN WINDOW w_folio_archivo WITH FORM "UNIL090"
   ...
   -- se captura el folio
   INPUT v_nombre_archivo WITHOUT DEFAULTS
   FROM  cmb_archivo
...
Ejecuta la reverso de carga de archivo segun archivo modulo UNI solo IMSS
======================================================================}
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/UNIR25 ",
                          p_usuario_cod, " ",
                          g_pid  , " " ,
                          g_proceso_cod , " " ,
                          g_opera_cod ," ",
