...
#Modulo       => UNI                                                                    #
#Programa     => UNIR18                                                                 #
#Objetivo     => Programa que ejecuta el rutna de reverso indicadores y desmarca        #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   END IF
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".UNIR18.log")

   LET g_proceso_cod = g_proceso_cod_uni_IMSS-- devolucion de operaciones
   LET g_opera_cod   = g_opera_cod_uni_indicadores -- Indicadores
  ...
  END FOREACH  
   ...
   --HERE a.id_pre_unificador = b.id_pre_unificador
   where b.id_derechohabiente in (SELECT id_derechohabiente
...
FUNCTION fn_reverso_indicadores()
