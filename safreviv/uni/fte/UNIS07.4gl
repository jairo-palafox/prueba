...
DEFINE p_pid            LIKE bat_ctr_operacion.pid, -- PID del proceso
   ...
   DISPLAY "FOLIO ARCHIVO DE SALIDA: ",p_folio          
   ...
   ---- Inicio operacion.
   --CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,0,"UNIS01",
   --                              "",p_usuario_cod)
...
======================================================================}
FUNCTION fn_archivo_salida_OCI(p_usuario_cod, p_folio)
DEFINE p_usuario_cod       LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".UNIS01.log")
...
-- se obtienen la ruta envio del modulo
   ...
   EXECUTE Prpr_Obt_folio INTO v_folio
     
    -- se crea el nombre del archivo y posteriormente se concatena con la ruta
   LET v_d_hoy  = TODAY USING "YYYYMMDD"
   LET v_busca_archivo = "NOT_APLI"||v_d_hoy 
   ...
   FOREACH Cur_reg_unificacion INTO v_r_det_unificador.*, v_nss_unificado
      SELECT id_credito 
        INTO v_id_credito
        FROM afi_derechohabiente
       WHERE id_derechohabiente = v_r_det_unificador.id_derechohabiente
      ...
      IF v_id_credito <> 0 THEN
         ...
         --INTO   v_tpo_credito,
                --v_num_credito,
                --v_valor_dscto
         --FROM   cre_acreditado a, cta_credito b
         --WHERE  a.id_derechohabiente = v_r_det_unificador.id_derechohabiente
         --AND    a.id_derechohabiente = b.id_derechohabiente
         --AND    a.tpo_credito = b.tpo_credito
         --AND    a.num_credito = b.num_credito
DISPLAY "ID UNIFICADOR:", v_r_det_unificador.id_unificador
          ...
          SELECT a.tpo_credito,
            ...
            FROM uni_cre_unificador a,
                 cta_credito b
           WHERE a.id_unificador = v_r_det_unificador.id_unificador
             AND a.num_credito <> 0
             AND a.tpo_credito = b.tpo_credito
             AND a.num_credito = b.num_credito
           GROUP BY 1,2,3   
   ...
   ELSE
      ...
      UPDATE uni_det_unificador
         SET diagnostico = 34 -- indicadores
   ...
   DATABASE safre_tmp
   DROP TABLE tmp_pre_no_liquidado 
   DATABASE safre_viv
