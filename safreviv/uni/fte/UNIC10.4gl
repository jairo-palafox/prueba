...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- clave del usuario
   ...
   OPEN WINDOW win_ConsInfo WITH FORM "UNIC100"
   CLOSE WINDOW SCREEN
   ...
   CALL v_cbx_registros.addItem(2, " Detalle.Unificador")
   CALL v_cbx_registros.addItem(3, " Detalle.Unificado")
   ...
   IF(v_i_conArch<1)THEN
      CALL fn_mensaje("Atención","Nostes molestandome poquito","info")
