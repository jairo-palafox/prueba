...
#Modulo       => MDT                                                                    #
#Programa     => MDTL12                                                                 #
#Objetivo     => Programa lanzador del reverso de validacion de instrucciones con       #
#                origen recurrente                                                      #
...
{ ==========================================================================
Clave:  fn_consulta_lote_reverso
Nombre: fn_consulta_lote_reverso
Fecha creacion: 23/04/2012
Autor: Hugo César Ramírez Gracía
Narrativa del proceso que realiza:
 Pantalla de consulta para el folio a reversar de validación de instrrucciones
...
DEFINE v_lote_reversar  STRING,-- LIKE mdt_lote_mandato.lote,
   ...
   LET v_proceso_cod = 1304 # Reverso de validacion recurrente
   LET v_opera_cod   = 1
   ...
   OPEN WINDOW vtna_reverso_validacion_recurrente WITH FORM p_ruta_ejecutable CLIPPED||"/MDTL121"
...
{ ==========================================================================
Clave:  fn_consulta_lote
Nombre: fn_consulta_lote
Fecha creacion: 23/04/2012
Autor: Hugo César Ramírez Gracía
Narrativa del proceso que realiza:
 Pantalla de consulta para el folio a reversar de validación de instrrucciones
...
DEFINE cb_lote  ui.ComboBox,
   ...
   {DECLARE cur_recupera_lotes CURSOR FOR SELECT DISTINCT lote, f_lote
    ...
    SELECT NVL(max(a.folio),0),a.f_proceso
      INTO  v_folio      ,
            v_f_proceso
    ...
    GROUP BY 2
      ...
      ELSE
        ...
        LET v_folios[v_indice].v_folio         = v_folio      -- folio con error
        LET v_folios[v_indice].v_fecha_proceso = v_f_proceso
        RETURN TRUE
      END IF        

  IF v_indice = 0 THEN
   DECLARE cur_recupera_lotes CURSOR FOR SELECT MAX(folio), f_proceso
                                           FROM mdt_lote_mandato
...
{ ==========================================================================
Clave:  fn_recupera_detalle_lote
Nombre: fn_recupera_detalle_lote
Fecha creacion: 23/04/2012
Autor: Hugo César Ramírez Gracía
Narrativa del proceso que realiza:
 Consulta que recupera el detalle de folio a reversar
...
{ ==========================================================================
Clave:  fn_incializa_proceso
Nombre: fn_incializa_proceso
Fecha creacion: 23/04/2012
Autor: Hugo César Ramírez Gracía
Narrativa del proceso que realiza:
 Funcion que inicializa proceso y ejecuta batch
...
DEFINE v_folio    LIKE mdt_lote_mandato.folio,
   ...
   END IF
   #Construye comando
   LET v_comando = "nohup fglrun ",p_ruta_ejecutable CLIPPED,"/MDTR12.42r ",
                                   r_usuario_cod," ",
                                   v_pid," ",
                                   v_proceso_cod," ",
                                   v_opera_cod," ",
