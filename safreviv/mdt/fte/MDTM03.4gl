...
DEFINE v_consulta       STRING,
   ...
   OPEN WINDOW w_eli_mandato WITH FORM "MDTM031"
   ...
   DIALOG ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION eliminar
         IF fn_existe_instruccion_mdt(cmbmdt) THEN
            LET v_s_nota = "\nSe eliminarán las instrucciones de mandato relacionadas a este,\ny para poderlas reactivar será necesario informarlo a través del recurrente."
         ELSE
            LET v_s_nota = " "
         END IF
         ...
         IF fn_ventana_confirma("Confimar","Confirmar eliminación del mandato: "||r_mandato.desc_mandato||v_s_nota,"info") = 1 THEN
