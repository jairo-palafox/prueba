...
DEFINE p_usuario_cod   LIKE seg_usuario.usuario, # usuario logeado
   ...
   OPEN WINDOW vtna_reversa_folio WITH FORM v_ruta_bin CLIPPED||"/MDTL351"
         ...
         ON ACTION reverso
            ...
            IF ( r_res_opera = 0 ) THEN         
               ...
               IF ( v_confirma ) THEN                
                   ...
                   LET v_comando = "nohup fglrun ",v_ruta_bin CLIPPED,"/MDTR35.42r ",p_usuario_cod CLIPPED, " ",
                                                                                     v_pid_rev            , " ",
                                                                                     v_proceso_cod_rev    , " ",
                                                                                     v_opera_cod_rev      , " ",
                                                                                     v_folio              , " '",
