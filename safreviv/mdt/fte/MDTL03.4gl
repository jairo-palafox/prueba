...
MAIN
   ...
   LET v_i_opera_cod = 2 -- Integracion de VALIDACION DE SUSTENTABILIDAD
   ...
   OPEN WINDOW w_elige_acred WITH FORM "MDTL031"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         DISPLAY ARRAY v_arr_arch_pend TO tbl_pendientes.*
            ...
            ON DROP(v_ui_dnd)
               ...
               CALL DIALOG.setActionHidden("accpet",0)
         ...
         ON ACTION ACCEPT
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               LET v_v_nomArch_proc = v_arr_arch_int[v_i_iter]
                ...
                FROM   safre_tmp:tmp_sol_mandato
                WHERE  resultado_operacion = '01'
                --Obtenemos el total RECHAZADAS del archivo
                SELECT COUNT(*)
                INTO   v_arr_integrados[v_i_iter].rechazadas
                FROM   safre_tmp:tmp_sol_mandato
                WHERE  resultado_operacion = '02'
         ...
         ON ACTION integrar
            ...
            --FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  LET v_s_comando = "nohup fglrun ",v_c_ruta_bin CLIPPED,"/MDTS03.42r "
                                                   ,p_v_usuario, " "
                                                   ,v_d_pid, " "
                                                   ,v_i_proceso_cod," "
                                                   ,v_i_opera_cod," "
