...
MAIN
   DEFINE v_arr_arch_pend   DYNAMIC ARRAY OF STRING, -- arreglo que contiene los lotes pendientes
          v_arr_archPendAux SMALLINT, -- arreglo auxiliar que contiene los lotes pendientes
          ...
          v_arr_elegidos    DYNAMIC ARRAY OF RECORD -- arreglo que contiene los archivos elegidos
             f_proceso        LIKE mdt_lote_mandato.f_proceso,--LIKE mdt_lote_mandato.f_lote,
   ...
   LET p_proceso_cod = 1303 -- 46 anterior -- lanzar recurrentes AHM 2012 04 25 Cambio de procesos
   ...
   -- TMP verificar si va esto LET v_c_programa_cod = "MDTL01"
   ...
   OPEN WINDOW w_elige_acred WITH FORM "MDTL01"
...
FUNCTION lanza_archivo_mdt(p_folio, p_cont_lote, p_tot_lote)
   ...
   ELSE
      ...
      IF r_b_valida = 0 THEN
         ...
         LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin_mdt CLIPPED,"/MDTE01 ",
                                                 p_v_usuario, " ",
                                                 r_pid, " ",
                                                 p_proceso_cod, " ",
                                                 p_opera_cod, " ",
