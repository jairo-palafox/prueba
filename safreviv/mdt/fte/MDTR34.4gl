...
DEFINE v_proceso_desc   LIKE cat_proceso.proceso_desc,
   ...
   LET v_opera_cod   = g_opera_cod_carga     # Preliquidación pago mandatos
   ...
   ELSE
      ...
      LET v_consulta = "EXECUTE FUNCTION fn_mdt_r_preliquidar_pagos(?,?,?,?,?)"
   ...
   CALL fn_correo_proceso(p_pid_rev, 
                          ...
                          p_opera_cod_rev, 
                          '', # Archivo adjunto
                          'Finalización de operación - '||v_proceso_desc CLIPPED||' - Reverso de liquidación pagos mandatos',
                          v_mensaje
                          )
