...
DEFINE r_proceso_desc    LIKE cat_proceso.proceso_desc,
   ...
   OPEN WINDOW vtna_rpt_abonos_mandatos WITH FORM v_ruta_ejecutable CLIPPED||"/MDTL301"

      MENU ""
         BEFORE MENU
            CALL fn_recupera_datos_folio(g_proceso_cod_abonos_mandatos,
         ...
         ON ACTION aceptar
            ...
            IF(r_resultado_opera = 0)THEN
               CALL fn_ventana_confirma(p_titulo_vtna,"¿Generar reporte de abonos mandatos?","question") RETURNING r_confirma
               ...
               LET v_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/MDTP30.42r '",p_usuario CLIPPED, "' ",
                                                                                         r_pid CLIPPED, " ",
