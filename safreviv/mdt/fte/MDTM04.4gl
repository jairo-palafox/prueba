...
DEFINE v_bnd_municipio    BOOLEAN
   ...
   SELECT ruta_docto,ruta_bin
     INTO v_ruta_docto,v_ruta_ejecutable
     FROM seg_modulo
   ...
   OPEN WINDOW w_mant_mandatos WITH FORM v_ruta_ejecutable CLIPPED||"/MDTM041"
   ...
   OPEN WINDOW w_mant_mandatos_detalle WITH FORM v_ruta_ejecutable CLIPPED||"/MDTM042"
...
--    IF NOT fn_verifica_privilegios("MDTM04",p_usuario_cod) THEN
...
--    
--    --Se abre la ventana de captura del nuevo mandato
--    OPEN WINDOW w_modifi_mant_mandatos WITH FORM "MDTM041"
