...
DEFINE v_desc_tpo_mandato LIKE mdt_tpo_mandato.desc_tpo_mandato,
   ...
   OPEN WINDOW w_arbol_mandato WITH FORM "MDTC022"
   ...
   WHILE v_modifica_mdt 
      DISPLAY ARRAY tree TO scr_tree.*
         ...
         ON ACTION alta
            ...
            ELSE
               IF tree[ARR_CURR()].pid <> 99 THEN
                  LET v_ejecuta = "fglrun MDTM01 ", p_v_usuario CLIPPED," ",
                                                    p_b_tipo_carga," ",
                                                    "Alta ", 
                                                    tree[ARR_CURR()].pid
         ...
         ON ACTION baja
            ...
            ELSE
               LET v_ejecuta = "fglrun MDTM03 ", p_v_usuario CLIPPED," ",
                                                 p_b_tipo_carga," ",
                                                 "Baja ", 
                                                 tree[ARR_CURR()].pid, " ",
                                                 tree[ARR_CURR()].id
         ...
         ON ACTION modificar
            IF (tree[ARR_CURR()].pid IS NULL OR tree[ARR_CURR()].pid = 0) OR
               ...
               CALL fn_mensaje("Advertencia","Es requerido que seleccione el mandato","error")
            ELSE
               LET v_ejecuta = "fglrun MDTM04 ", p_v_usuario CLIPPED," ",
                                                 p_b_tipo_carga," ",
                                                 "Modificar ", 
                                                 tree[ARR_CURR()].pid, " ",
                                                 tree[ARR_CURR()].id
...
DEFINE p_id_cat_mandato LIKE mdt_cat_mandato_paquete.id_cat_mandato,
   ...
   OPEN WINDOW vtna_configuracion WITH FORM v_ruta_ejecutable CLIPPED||"/MDTC027" ATTRIBUTES(STYLE = "dialog")
...
FUNCTION fn_consulta_detalle(p_tpo_mdt, p_cat_mdt) 
   ...
   OPEN WINDOW w_con_mandato WITH FORM "MDTC02"
...
DEFINE p_id_cat_mandato  LIKE mdt_cat_mandato_paquete.id_cat_mandato,
   ...
   OPEN WINDOW vtna_paquete WITH FORM v_ruta_ejecutable CLIPPED||"/MDTC023"
...
DEFINE p_id_cat_mandato LIKE mdt_cat_mandato_paquete.id_cat_mandato,
   ...
   OPEN WINDOW vtna_tipo_consulta_mov WITH FORM v_ruta_ejecutable CLIPPED||"/MDTC024" ATTRIBUTES( STYLE = "dialog")
...
DEFINE p_id_cat_mandato LIKE mdt_cat_mandato.id_cat_mandato,
   ...
   OPEN WINDOW vtna_consulta_global WITH FORM v_ruta_ejecutable CLIPPED||"/MDTC026"
...
DEFINE p_id_cat_mandato LIKE mdt_cat_mandato_paquete.id_cat_mandato,
   ...
   OPEN WINDOW vtna_consulta_det_mandato WITH FORM v_ruta_ejecutable CLIPPED||"/MDTC025"
