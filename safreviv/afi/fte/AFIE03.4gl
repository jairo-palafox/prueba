...
#Modulo       => AFI                                                                    #
#Programa     => AFIE03                                                                 #
#Objetivo     => Invoca la carga de datos para movimientos afiliatorios  opt75          #
#Fecha inicio => Junio 10, 2012                                                         #
#########################################################################################
DATABASE safre_viv
GLOBALS "AFIG01.4gl"
GLOBALS
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_afi_movimientos_opt75     -- movimientos afiliatorios OP
   LET g_opera_cod   = g_opera_cod_afi_movimientos_carga_opt75 -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "AFIE03",
