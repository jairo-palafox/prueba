...
Fecha creacion: 27 de Marzo de 2012
Autor: Mauro Muñiz, EFP
Narrativa del proceso que realiza:
Abre el proceso principal de consulta de datos del derechohabiente

Registro de modificaciones:
Autor       Fecha                  Descrip. cambio
Ivan Vega   22 de junio de 2012     - Se agrega NSS como parametro. Si se recibe y es válido
...
FUNCTION fn_consulta_afi(p_nss)
   ...
   DEFINE vr_afi_telefono   RECORD LIKE afi_telefono.* -- registro de telefono
   ...
   CASE v_resultado
     WHEN 0 LET reg_derechohabiente.edo_credito = "CREDITO VIGENTE"
     WHEN 2 LET reg_derechohabiente.edo_credito = "CREDITO LIQUIDADO"
     WHEN 3 LET reg_derechohabiente.edo_credito = "CREDITO EN TRÁMITE"
...
FUNCTION f_credito_vivienda(p_id_derechohabiente)
   ...
   FOREACH cur_cred INTO v_originacion,
      ...
      CASE v_entidad
         WHEN 1 LET v_edo_cred = "CRÉDITO VIGENTE"
         WHEN 2 LET v_edo_cred = "CRÉDITO LIQUIDADO"
         WHEN 3 LET v_edo_cred = "CRÉDITO EN TRÁMITE"
         WHEN 4 LET v_edo_cred = "HISTÓRICO SIN ORIGINACIÓN"
         OTHERWISE LET v_edo_cred = ""
      END CASE
