...
#                de carga recurrente de correo electronico de derechohabientes          #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AFIL09.log")
   
   -- se asigna proceso y operacion
   LET g_proceso_cod = g_proceso_cod_afi_correoelectronico -- recurrente afiliacion correo electronico
   LET g_opera_cod   = g_opera_cod_afi_integracion_correoelectronico -- integracion
...
DEFINE p_usuario_cod LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo"
                    ...
                    ,"\n   AND opera_cod   = ", g_opera_cod_afi_carga_correoelectronico --,g_opera_cod que tiene la carga 
   ...
   OPEN WINDOW w_inte_devol WITH FORM "AFIL091"
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
        ...
        IF ( v_respuesta = 1 ) THEN
           CALL fn_afi_integracion_correoe(p_usuario_cod)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_afi_integracion_correoe
Fecha creacion: Agosto 27, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de carga de datos de correo electronico
...
FUNCTION fn_afi_integracion_correoe(p_usuario_cod)
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_i_resultado = 0 ) THEN
     ...
     IF ( r_resultado_opera = 0 ) THEN
       LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/AFIP09 ", --MIGE20
