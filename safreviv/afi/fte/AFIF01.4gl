...
#Modulo       => AFI                                                                    #
#Programa     => AFIF01                                                                 #
#Objetivo     => Invoca la carga de datos para movimientos afiliatorios                 #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_opera_cod   = g_opera_cod_afi_movimientos_carga_imss -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "AFIE01",
