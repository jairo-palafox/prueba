...
#Modulo       => AFI                                                                    #
#Programa     => AFIL08                                                                 #
#Objetivo     => Invoca la carga de datos para recurrente de contacto electronico AFI   #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_afi_correoelectronico -- AFI contacto electronico
   LET g_opera_cod   = g_opera_cod_afi_carga_correoelectronico -- recepcion de archivo
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "AFIL08",
