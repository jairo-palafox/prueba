...
# Modulo       => AFI                                                                              #
# Programa     => AFIL25                                                                           #      
# Objetivo     => Lanzador para carga de archivo de modificacione CURP                             #
...
MAIN 
   ...
   LET g_proceso_cod = 1820        --se asigna valor al proceso
   LET g_opera_cod   = 1           --se asigna la operacion
   LET v_extension   = "curpact"    --se asigna el tipo de extenxion que se tomara de la ruta rescate
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AFIL25.log")

   OPEN WINDOW AFIL25 WITH FORM "AFIL25"
