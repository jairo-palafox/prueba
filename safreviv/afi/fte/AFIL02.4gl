...
FUNCTION fn_drgandrop_integra_devol(p_usuario_cod)
   ...
   -- se inicializa el índice del arreglo
   LET l_i_indice = 0
...
Fecha creación: 22 de junio de 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integración de movimientos afiliatorios solo infonavit

Registro de modificaciones:
Autor           Fecha                   Descrip. cambio
Ivan Vega    23julio2013              Si el proceso 703-Generacion de archivo para precalificación está en
                                      ejecución, entonces no se puede ejecutar la integración de movimientos
                                      afiliatorios
======================================================================
}
...
FUNCTION fn_ret_ejecuta_integracion_afiliacion(p_usuario_cod, v_archivo)
   ...
   -- se verifica si está ejecutando el proceso de generación de archivo de precalificación
   SELECT pid
     INTO v_pid_proceso_703
     FROM bat_ctr_proceso
    WHERE proceso_cod = 703 -- generación de archivo de precalificación
