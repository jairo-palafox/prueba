...
#                de carga recurrente de teléfonos de derechohabientes                   #
...
MAIN
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AFIL07.log")

   -- se asigna proceso y operación
   LET g_proceso_cod = g_proceso_cod_afi_telefono -- recurrente afiliación teléfonos
   LET g_opera_cod   = g_opera_cod_afi_integracion_telefono -- integración
   ...
   CALL fn_drgandrop_integra_tel(p_usuario_cod)

END MAIN

FUNCTION fn_drgandrop_integra_tel(p_usuario_cod)
   ...
   DEFINE l_i_iter              INTEGER  -- variable usada para iteracion
   DEFINE l_i_indice            SMALLINT -- indice del arrego de archivos pendientes
   DEFINE l_i_tot_reg           INTEGER  -- total de registros en archivo
   ...
   LET l_s_qryTxt = "SELECT nombre_archivo",
                    ...
                    "\n WHERE proceso_cod = ", g_proceso_cod,
                    "\n   AND opera_cod   = ", g_opera_cod_afi_carga_telefono, --,g_opera_cod que tiene la carga
   ...
   OPEN WINDOW w_inte_devol WITH FORM "AFIL071"
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
        ...
        IF ( v_respuesta = 1 ) THEN
           CALL fn_afi_integracion_telefono(p_usuario_cod)
           EXIT DIALOG
        END IF
...
======================================================================
Clave: 
Nombre: fn_afi_integracion_telefono
Fecha creacion: Agosto 27, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta la integracion de carga de datos de telefono
recurrente de derechohabientes
...
FUNCTION fn_afi_integracion_telefono(p_usuario_cod)
   ...
   IF ( v_i_resultado = 0 ) THEN
      ...
      IF ( r_resultado_opera = 0 ) THEN
         LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/AFIP07 ", --MIGE20
