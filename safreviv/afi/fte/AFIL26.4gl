...
# Modulo       => AFI                                                                              #
# Programa     => AFIL26                                                                           #      
# Objetivo     => Lanzador para carga de archivo de modificacione paterno, materno y nombre        #
...
MAIN 
   ...
   LET g_proceso_cod = 1821        --se asigna valor al proceso
   LET g_opera_cod   = 1           --se asigna la operacion
   LET v_extension   = "nomact"    --se asigna el tipo de extenxion que se tomara de la ruta rescate
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AFIL26.log")

   OPEN WINDOW AFIL26 WITH FORM "AFIL26"
      ...
      INPUT BY NAME v_nom_archivo ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            IF v_nom_archivo IS NULL THEN
               CALL fn_mensaje("Información", "Se tiene que elegir un archivo", "about")
