...
# Modulo       => AFI                                                                              #
# Programa     => AFIL24                                                                           #      
# Objetivo     => Lanzador para carga de archivo de modificacione RFC                              #
...
MAIN 
   ...
   LET g_proceso_cod = 1819        --se asigna valor al proceso
   LET g_opera_cod   = 1           --se asigna la operacion
   LET v_extension   = "rfcact"    --se asigna el tipo de extenxion que se tomara de la ruta rescate
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AFIL24.log")

   OPEN WINDOW AFIL24 WITH FORM "AFIL24"
