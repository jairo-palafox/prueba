...
# Modulo       => AFI                                                                              #
# Programa     => AFIL23                                                                           #      
# Objetivo     => Lanzador para cargar afores                                                      # 
# Autor        =>                                                                                  #
# Fecha        => 22/ABRIL/2015                                                                    #
####################################################################################################
IMPORT os
...
MAIN 
   ...
   LET g_proceso_cod = 1818        --se asigna valor al proceso
   LET g_opera_cod   = 1           --se asigna la operacion
   LET v_extension = "cvaf"        --se asigna el tipo de extenxion que se tomara de la ruta rescate
   ...
   CALL STARTLOG (g_usuario CLIPPED||".AFIL23.log")

   OPEN WINDOW AFIL23 WITH FORM "AFIL23"
      ...
      INPUT BY NAME v_nom_archivo ATTRIBUTES (UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            ELSE
               ...
               DISPLAY "esto es lo que trae el comando ",v_s_comando
               RUN v_s_comando
