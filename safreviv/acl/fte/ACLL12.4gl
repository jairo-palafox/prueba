...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_acl_registro_pagos -- Aclaraciones en aclara
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "ACLL121"
...
Fecha creacion: 28/02/2012
Autor: Francisco López, EFP
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de ENACLARA
para un folio dado
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                  "ACLP06",v_nombre_archivo,p_usuario_cod)
      ...
      IF ( v_si_codigo = 0 ) THEN                         
         ...
         LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/ACLP06 ",
                           p_usuario_cod, " ",
                           g_pid  , " " ,
                           g_proceso_cod , " " ,
                           g_opera_cod ," ",
