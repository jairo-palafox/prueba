...
-- Modulo       => ACL                                                                    --
-- Programa     => ACLS03                                                                 --
-- Objetivo     => Generacion del archivo de rechazos de Aclaraciones Con Cambio de NSS   --
-- Autor        => Ivan Vega                                                              --
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".ACLS03.log")
...
--   FROM   cta_his_pagos        --saci2018-67
   ...
   LET v_v_nom_archi = "Rechazos", v_v_nom_archi[4,5], v_v_nom_archi[7,8],'.CONNSS'
   ...
   LET v_v_nom_archi    = v_archivo_original[1,v_longitud] || "_" || v_folio_formato || "_rechazoACL.CONNSS"
...
--   FROM   cta_rechazos_acl   --saci2018-67   
   ...
   LET v_c_tipo_registro = 2
   LET v_v_nom_archi = TIME
   LET v_v_nom_archi = "Rechazos", v_v_nom_archi[4,5], v_v_nom_archi[7,8],'.CONNSS_EXT'
   ...
   LET v_v_nom_archi    = v_archivo_original[1,v_longitud] || "_" || v_folio_formato || "_rechazoACL.CONNSS_EXT"
   LET v_v_ruta_nomarch = v_c_ruta_env_acr CLIPPED ||"/"|| v_v_nom_archi
