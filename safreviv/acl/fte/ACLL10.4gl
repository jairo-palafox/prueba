...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_acl_reg_pag_cambio -- Aclaracion CON cambio
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "ACLL101"
...
Fecha creacion: Febrero 27, 2012
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                 "ACLP04",v_nombre_archivo,p_usuario_cod)
      ...
      IF ( v_si_codigo = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/ACLP04.42r ",
                           p_usuario_cod, " ",
                           g_pid  , " " ,
                           g_proceso_cod , " " ,
                           g_opera_cod ," ",
