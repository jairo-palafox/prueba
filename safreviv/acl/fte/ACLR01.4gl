...
#Modulo       => ACL                                                                    #
#Programa     => ACLR01                                                                 #
#Objetivo     => Programa que realiza el reverso de integracion/carga de aclaraciones   #
#                sin cambio                                                             #
...
DEFINE p_usuario_cod      LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   -- se inicia el log
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".ACLR01.log")

   -- se ejecuta el SP de reverso de integracion de LQINFO  
   LET v_SqlQry = "EXECUTE PROCEDURE sp_acl_sc_rev_integracion(?)"
