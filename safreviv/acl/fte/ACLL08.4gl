...
#                de aclaraciones SIN cambio                                             #
#Fecha inicio => Febrero 27, 2012                                                       #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED||".ACLL08.log")
   ...
   LET g_proceso_cod = g_proceso_cod_acl_reg_pag_sin_cambio -- aclaraciones SIN cambio
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "ACLL081"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         IF ( v_si_conteo < 1 ) THEN
            CALL fn_mensaje("Atención", "El folio capturado no se reconoce como un folio válido","stop")
            CONTINUE INPUT
         END IF
         
         -- se invoca la ejecucion del stored procedure
         CALL fn_preliquidacion_sin_cambio(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_preliquidacion_sin_cambio
Fecha creacion: Enero 31, 2012
Autor: Francisco López
Narrativa del proceso que realiza:
Ejecuta la preliquidacion de Aclaraciones SIN cambio
para un folio dado
...
FUNCTION fn_preliquidacion_sin_cambio(p_folio, p_usuario_cod)
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, -- usuario que ejecuta el programa
   ...
   IF ( v_si_codigo = 0 ) THEN
      ...
      CALL fn_actualiza_opera_ini(g_pid,g_proceso_cod,g_opera_cod,p_folio,
                                  "ACLP02",v_nombre_archivo,p_usuario_cod)
      ...
      IF ( v_si_codigo = 0 ) THEN
         ...
         LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/ACLP02.42r ",
                           p_usuario_cod, " ",
                           g_pid  , " " ,
                           g_proceso_cod , " " ,
                           g_opera_cod ," ",
