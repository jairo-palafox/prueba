...
#Modulo            => ACLC                                                    #
#Programa          => ACLC02                                                  #
#Objetivo          => CONSULTA DE PRELIQUIDACION DE ACLARACIONES CO CAMBIO NSS#
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # Clave del usuario
   ...
   --LET g_proceso_cod = 103 # Aclaracioners con cambio NSS
   --LET g_opera_cod   = 3 # PRELIQUIDACION REGISTRO PAGOS 
   
   CALL fn_consulta_preliq(p_usuario_cod, g_proceso_cod_acl_reg_pag_cambio, g_opera_cod_preliquidacion)
END MAIN