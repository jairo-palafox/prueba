...
#Modulo       => ACL                                                                    #
#Programa     => ACLL26                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de registro de ACL Sin Cambio   #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_acl_reg_pag_sin_cambio -- registro pagos aclaratorio sin cambio NSS
...
--g-   LET g_opera_cod = 5
 ...
 {  SELECT MAX(pid)
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "ACLL261"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_aclsc_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_aclsc_reverso_liquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de ACL Sin Cambio
...
FUNCTION fn_pag_aclsc_reverso_liquidacion(p_folio, p_usuario_cod)
   ...
   SELECT pid 
    ...
    WHERE proceso_cod =  g_proceso_cod
     ...
     IF ( v_resultado = 0 ) THEN
        ...
        LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/ACLR03 ",
