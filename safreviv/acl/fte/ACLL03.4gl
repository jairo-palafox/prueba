...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod,
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED||".ACLL03.log")
...
Narrativa del proceso que realiza:
 Esta función carga un archivo del proceso de "Aclaraciones con cambio"
...
DEFINE p_usuario_cod     LIKE seg_usuario.usuario_cod, #Clave de usuario
   ...
   --LET g_proceso_cod           = 103 # Aclaraciones con cambio
   --LET g_opera_cod_carga       = 1  # Carga archivos Aclaraciones con cambio
   ...
   --OPEN WINDOW w_sin_cambio WITH FORM v_ruta_ejecutable CLIPPED||"/ACLL011"
      ...
      CALL fn_valida_operacion(0,g_proceso_cod_acl_reg_pag_cambio,g_opera_cod_carga) RETURNING r_resultado_opera
      ...
      IF(r_resultado_opera = 0)THEN
         ...
         LET v_cadena_proc  = g_proceso_cod_acl_reg_pag_cambio USING "&&&&&"
         ...
         CALL fn_carga_archivo(g_pid, g_proceso_cod_acl_reg_pag_cambio, g_opera_cod_carga, p_tpo_ejecucion,
                               "ACLL03",v_comando, p_usuario_cod, TRUE) RETURNING r_bnd_carga
         # Si se realizó la carga se continua con el proceso
         IF NOT(r_bnd_carga)THEN
            CALL fn_mensaje("ACLARACION CON CAMBIO","Se ha cancelado la carga de información","about")
         END IF
      ELSE
