...
#Módulo          => ACL                                                     #
#Programa        => ACLP02.4gl                                              #
#Objetivo        => Programa de preliquidación de Aclaracion si cambio NSS  #
   ...
   IF(NUM_ARGS() > 0)THEN
      ...
      CALL fn_display_proceso(0,"Aclaraciones Sin Cambio")
         ...
         IF(r_resultado_opera)THEN
            ...
            LET p_titulo = "Error de operación - Aclaraciones Sin Cambio - Preliquidación"
            SELECT descripcion
              INTO v_descripcion 
         ...
         ELSE
            ...
            LET p_titulo = "Finalización de operación - Aclaraciones Sin Cambio - Preliquidación"
...
Narrativa del proceso que realiza:
 ...
 de la preliquidación para el módulo de "Aclaracion sin cambio NSS"
