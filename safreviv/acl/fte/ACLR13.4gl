...
#Modulo       => ACL                                                                    #
#Programa     => ACLR07                                                                 #
#Objetivo     => Programa que realiza el reverso parcial(preliquidación) para SAR92     #
...
Narrativa del proceso que realiza:
 Esta función captura/valida el folio a reversar para la preliquidacion 
 de SAR92
      ...
      INPUT BY NAME v_folio ATTRIBUTES (UNBUFFERED, ACCEPT = FALSE, CANCEL = FALSE)
         ...
         ON ACTION reverso
            ...
            IF(v_tmp_folio = 0)THEN
               ...
               NEXT FIELD v_folio 
            END IF
            CALL fn_ventana_confirma("Reverso Preliquidación","Se realizara el reverso para el folio "||
                                     v_folio||"\n¿Desea continuar?" ,"")
