...
#Modulo            => ACL                                                     #
#Programa          => ACLC09                                                  #
#Objetivo          => CONSULTA DE    LIQUIDACION ENACLARA                     #
#Fecha Inicio      =>                                                         #
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   --LET g_proceso_cod = 101
   --LET g_opera_cod   = 4  --3

   -- se invoca la funcion general de consulta de liquidacion
   CALL fn_liquida(p_usuario_cod, g_proceso_cod_acl_registro_pagos, g_opera_cod_liquidacion,1)
END MAIN