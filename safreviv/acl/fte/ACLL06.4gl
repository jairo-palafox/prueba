...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # Clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".ACLL06.log")

   --LET g_proceso_cod = 101 # Aclaracion si cambio
   --LET g_opera_cod   = 4 # LIQUIDACION 
   LET g_operacion   = 2 # Liquidar

   # Funcion global (GLOG) de liquidación
   CALL fn_liquida(p_usuario_cod, g_proceso_cod_acl_registro_pagos, g_opera_cod_liquidacion, g_operacion)
