...
#Modulo       => ACL                                                           #
#Programa     => ACLC17                                                        #
#Objetivo     => Inconsistencias aclaratorio con cambio                        #
...
DEFINE arr_salida_aclara_cc    DYNAMIC ARRAY OF RECORD
      ...
      ,nss_disp                    CHAR(11)      -- nss_disp             char(11)
...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
   ...
   LET g_origen_archivo = 7 -- con cambio de nombre
      ...
      IF NOT INT_FLAG THEN           
         ...
         IF v_registros > 0 THEN
            ...
            FOREACH cur_folio INTO  arr_salida_aclara_cc[v_indice].num_reg_pat            
                                 ...
                                 --,arr_salida_aclara_cc[v_indice].nss_disp               
...
DEFINE v_tot_imp_ap_pat               DECIMAL(12,2),  
   ...
   LET g_nom_archivo = YEAR(TODAY) USING "&&&&",MONTH(TODAY) USING "&&",DAY(TODAY) USING "&&"
                      , g_nom_archivo[4,5], g_nom_archivo[7,8],".INCCCNOM"
   ...
   FOR v_i_indice_for = 1 TO v_indice
      ...
      LET v_c_d_nss_disp                    = arr_salida_aclara_cc[v_i_indice_for].nss_disp
...
FUNCTION fn_reporte_acl_inconsistencias( v_tot_imp_ap_pat          ,
 ...
 DEFINE v_tot_imp_ap_pat             DECIMAL(12,2),
    ...
    IF fgl_report_loadCurrentSettings("ACLC17.4rp") THEN 
        CALL fgl_report_selectDevice ("PDF")
                    
        LET v_ruta_reporte = v_ruta_listados CLIPPED,"/","rpt_acl_inconsistenca"
