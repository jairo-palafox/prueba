...
-- Modulo       => ACL                                                                    --
-- Programa     => ACLS04                                                                 --
-- Objetivo     => Generacion del archivo de rechazos de Aclaraciones Con Cambio Nombre   --
-- Autor        => Ivan Vega                                                              --
...
------------------------------------------------------------------------------------------------
-- Actualizado  => Gerardo Alfonso Vega Paredes.                                              --
-- Fec Mod.     => 18 de septiembre de 2018.                                                  --
...
DEFINE p_usuario_cod         LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".ACLS04.log")
...
--   FROM   cta_his_pagos       --sacie2018-67
   ...
   LET v_v_nom_archi = "Rechazos", v_v_nom_archi[4,5], v_v_nom_archi[7,8],'.CONNOM'
   ...
   LET v_v_nom_archi    = v_archivo_original[1,v_longitud] || "_" || v_folio_formato || "_rechazoACL.CONNOM"
...
--DISPLAY "...............SI ES ESTE  ........................"
   ...
   LET l_s_cadena_sum_acl  = "9"                                                     ,
                             ...
                             (v_r_pag_sum_acl.sum_am * 100)              USING "&&&&&&&&&&&&&&&",
...
--   FROM   cta_his_pagos      --saci2018-67
   ...
   LET v_c_tipo_registro = 2
   LET v_v_nom_archi = TIME
   LET v_v_nom_archi = "Rechazos", v_v_nom_archi[4,5], v_v_nom_archi[7,8],'.CONNOM_EXT'
   ...
   LET v_v_nom_archi    = v_archivo_original[1,v_longitud] || "_" || v_folio_formato || "_rechazoACL.CONNOM_EXT"
   LET v_v_ruta_nomarch = v_c_ruta_env_acr CLIPPED ||"/"|| v_v_nom_archi
