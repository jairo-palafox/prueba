...
-- para su correspondiente integracion
MAIN
   ...
   --CALL STARTLOG (p_v_usuario CLIPPED|| ".ACLL09.log")
   ...
   LET v_i_proceso_cod   = g_proceso_cod_acl_reg_pag_cambio -- Aclaraciones con cambio
   ...
   OPEN WINDOW w_inte_acred WITH FORM "ACLL091"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               CALL fn_actualiza_opera_ini(v_d_pid,v_i_proceso_cod,v_i_opera_cod,v_d_folio,
                                          "ACLP03",v_v_nomArch_proc,p_v_usuario) 
