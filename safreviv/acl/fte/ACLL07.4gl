...
MAIN
   DEFINE p_v_usuario       LIKE seg_usuario.usuario,-- usuario firmado al sistema
          ...
          v_arr_integrados  DYNAMIC ARRAY OF RECORD -- arreglo que contiene los archivos integrados
             ...
             tot_ap           INTEGER,
             ap_pat           DECIMAL(18,2),
             suma_am          DECIMAL(18,2),
             suma_aivs        DECIMAL(18,6),
             int_viv_pgo_ext  DECIMAL(18,2),
             suma_aiv_pgo_ext DECIMAL(18,6)
          END RECORD,
          ...
          v_ruta_vacia      STRING,
          v_suma_ap_pat     DECIMAL(18,0),
          v_suma_am         DECIMAL(18,0),
          v_suma_aivs       DECIMAL(18,0),
          v_suma_int_viv_pgo_ext DECIMAL(18,0),
          v_suma_aiv_pgo_ext   DECIMAL(18,0)
   ...
   --CALL STARTLOG (p_v_usuario CLIPPED|| ".ACLL07.log")
   ...
   LET v_i_proceso_cod   = g_proceso_cod_acl_reg_pag_sin_cambio -- Aclaraciones sin cambio
   LET v_i_opera_cod     = g_opera_cod_integracion   -- Integracion
   ...
   OPEN WINDOW w_inte_acred WITH FORM "ACLL071"
      ...
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         ON ACTION ACCEPT
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               SELECT  tot_ap, suma_ap_pat, suma_am, suma_aivs, 
                       suma_int_viv_pgo_ext, suma_aiv_pgo_ext
               ...
               display "v_arr_integrados[v_i_iter].tot_ap:", v_arr_integrados[v_i_iter].tot_ap
               display "v_suma_ap_pat:", v_suma_ap_pat
               display "v_suma_am:", v_suma_am
               display "v_suma_aivs:", v_suma_aivs
               display "v_suma_int_viv_pgo_ext:", v_suma_int_viv_pgo_ext
               display "v_suma_aiv_pgo_ext:", v_suma_aiv_pgo_ext
            END FOR
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               CALL fn_actualiza_opera_ini(v_d_pid,v_i_proceso_cod,v_i_opera_cod,v_d_folio,
                                           "ACLP01",v_v_nomArch_proc,p_v_usuario) 
