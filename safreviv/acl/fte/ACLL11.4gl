...
#                    archivo de entrada de Aclaraciones en aclara  #
...
MAIN
   ...
   --CALL STARTLOG (p_v_usuario CLIPPED|| ".ACLL11.log")
   ...
   LET v_i_proceso_cod   = g_proceso_cod_acl_registro_pagos -- Aclaraciones en aclara
   ...
   OPEN WINDOW w_inte_acred WITH FORM "ACLL111"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               CALL fn_actualiza_opera_ini(v_d_pid,v_i_proceso_cod,v_i_opera_cod,v_d_folio,
                                          "ACLP05",v_v_nomArch_proc,p_v_usuario) 
