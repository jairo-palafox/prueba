...
#                   módulo de "Aclaraciones sin cambio"                     #
...
DEFINE p_opera_cod_carga LIKE cat_operacion.opera_cod, # Código de operacion
   ...
   CALL fn_display_proceso(0," Integración sin cambio de aclaración ")
   # Genera folio
      ...
      LET r_resultado_opera = 0     
        ...
        # Actualiza el estado del archivo en glo_ctr_archivo a integrado
         ...
         IF(r_resultado_opera)THEN  
            ...
            LET p_titulo = "Error de operación - Aclaraciones Sin Cambio - Integración"
            SELECT descripcion
              INTO v_descripcion 
         ...
         ELSE
            ...
            CALL fn_display_proceso(1," Integración sin cambio de aclaración ")
         ...
         {    
               ...
               IF(r_resultado_opera)THEN
                  ...
                  END IF
               ELSE}
                 LET p_titulo = "Finalización de operación - Aclaraciones Sin Cambio - Integración"
               --END IF
            END IF
         END IF
