...
DEFINE p_usuario_cod    LIKE seg_usuario.usuario_cod, # Clave del usuario firmado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".ACLL02.log")

   --LET g_proceso_cod = 102 # Aclaracion si cambio
   --LET g_opera_cod   = 4 # LIQUIDACION 
   LET g_operacion   = 2 # Liquidar

  
   # Funcion global (GLOG) de liquidación
   CALL fn_liquida(p_usuario_cod, g_proceso_cod_acl_reg_pag_sin_cambio, g_opera_cod_liquidacion, g_operacion)
