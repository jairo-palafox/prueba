...
#Modulo       => ACL                                                                    #
#Programa     => ACLL29                                                                 #
#Objetivo     => Lanzador del reverso de la liquidacion de registro de ACL Con Cambio   #
#Fecha inicio => Agosto 31, 2012                                                        #
#########################################################################################
DATABASE safre_viv
GLOBALS "ACLG02.4gl"
GLOBALS
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
   ...
   LET g_proceso_cod = g_proceso_cod_acl_reg_pag_cambio -- registro pagos aclaratorio cambio NSS
   LET g_opera_cod   = g_opera_cod_liquidacion -- liquidacion
 ...
 {  SELECT MAX(pid)
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "ACLL291"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_aclcc_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_aclcc_reverso_liquidacion
Fecha creacion: Febrero 28, 2012
Autor: Ivan Vega, EFP
Narrativa del proceso que realiza:
Ejecuta el reverso de la liquidacion de ACL Con Cambio
...
FUNCTION fn_pag_aclcc_reverso_liquidacion(p_folio, p_usuario_cod)
  ...
  RETURNING v_resultado
   ...
   SELECT pid 
    ...
    WHERE proceso_cod =  g_proceso_cod
      AND folio       =  p_folio
                                             -- g_opera_cod
     CALL fn_valida_reverso(g_pid,g_proceso_cod,5) RETURNING v_resultado
display "v_resultado de valida reverso ",v_resultado
     -- se verifica si se puede continuar con la operacion
     IF ( v_resultado = 0 ) THEN
        -- se construye la cadena de ejecucion del programa lanzado de reverso
        LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/ACLR06 ",
       ...
       RUN v_s_comando
       CALL fn_mensaje("Atención","Se ha enviado el reverso de la Liquidación.\n"||
            "Puede revisar el avance del proceso en el monitor de ejecución de procesos"
            ,"information")
     ELSE
        CALL fn_recupera_inconsis_opera(v_resultado) RETURNING v_mensaje
        CALL fn_mensaje("Atención", v_mensaje, "stop")
        --CALL fn_mensaje("Atención",,"stop")
     END IF
