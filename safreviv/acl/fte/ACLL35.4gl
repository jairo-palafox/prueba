...
#Modulo       => ACL                                                                    #
#Programa     => ACLL35                                                                 #
#Objetivo     => Lanzador reverso de la liquidacion de registro de ACL Cambio Nombre    #
...
DEFINE  p_usuario_cod        LIKE seg_usuario.usuario_cod -- clave del usuario firmado
 ...
 {  SELECT MAX(pid)
   ...
   OPEN WINDOW w_folio_preliquida WITH FORM "ACLL351"
   ...
   ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         CALL fn_pag_aclcn_reverso_liquidacion(v_folio, p_usuario_cod)
         EXIT INPUT
...
======================================================================
Clave: 
Nombre: fn_pag_aclcn_reverso_liquidacion
...
FUNCTION fn_pag_aclcn_reverso_liquidacion(p_folio, p_usuario_cod)
...
display "v_resultado de valida reverso ",v_resultado
     ...
     IF ( v_resultado = 0 ) THEN
        ...
        LET v_s_comando = " nohup time fglrun ",g_reg_modulo.ruta_exp CLIPPED,"/ACLR18 ",
