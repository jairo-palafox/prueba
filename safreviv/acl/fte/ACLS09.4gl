...
-- Modulo       => ACL                                                                   
-- Programa     => ACLS09                                                                
-- Objetivo     => Reporte Cifras rechazos aclaratorio DISSCNSS
...
MAIN
   ...
   -- se abre la ventana
   OPEN WINDOW w_consulta WITH FORM "ACLS091"
...
--===============================================================================
    ...
    LET v_v_nom_reporte = g_usuario_cod CLIPPED,"-ACLS09-",
                          TODAY USING 'YYYYMMDD','DISSCNSS'

    CALL fn_rutas("acl") RETURNING r_ruta_bin, r_ruta_listados
     
    -- Ejecución de archivo de rechazo 
    LET p_pid = 0
    LET p_proceso_cod = 102
    LET g_opera_cod = 0
    LET p_folio = v_folio
    ...
    LET v_s_qry = " fglrun ",r_ruta_bin CLIPPED,"/ACLS02 ",
                            p_usuario, " ",
                            p_pid, " ",
                            p_proceso_cod, " ",
                            p_opera_cod, " ",
    ...
    CALL fgl_report_loadCurrentSettings(r_ruta_bin CLIPPED ||"/ACLS09.4rp") RETURNING v_existe
