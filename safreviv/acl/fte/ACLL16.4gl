...
MAIN
   ...
   LET v_i_proceso_cod = 106 -- ACL-1402
   LET v_i_opera_cod = 2 -- Integracion de LQINFO
   ...
   OPEN WINDOW w_inte_acred WITH FORM "ACLL161"
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               SELECT  tot_ap, suma_ap_pat, suma_am, suma_aivs
                INTO   v_arr_integrados[v_i_iter].tot_ap,
                       ...
                       v_suma_am,
                       v_suma_aivs 
                FROM   safre_tmp:tmp_sum_aclaracion
