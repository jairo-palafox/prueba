...
#                    archivo Solicitudes no atendidas              #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL14.log")
   ...
   LET v_c_programa_cod = "ACRL14" -- nombre del programa
   ...
   --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRP14 ",
   LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/ACRP14 ",
                                p_v_usuario, " ",
                                v_d_pid, " ",
                                v_i_proceso_cod, " ",
                                v_i_opera_cod, " ",
