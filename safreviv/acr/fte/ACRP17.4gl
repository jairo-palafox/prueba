...
#                    y genera el reporte de liquidacion de DSE          #
...
MAIN
   ...
   CALL STARTLOG(g_usuario_cod CLIPPED|| ".ACRP17.log")

   DISPLAY "=INICIA ACRP17="
   DISPLAY " USUARIO       : ",g_usuario_cod
   DISPLAY " PID           : ",g_pid
   DISPLAY " FOLIO         : ",g_folio_liquida USING "#########&"

   -- se inicializan variables
   LET v_c_tpo_transferencia = "15" -- 15-Transferencia de Acreditados
   ...
   CALL fn_gen_reporte_liquida()
{
   ...
   LET v_s_titulo_correo = "Proceso: LIQUIDACIÓN DE DEVOLUCIÓN DE SALDOS EXCEDENTES ACREDITADOS"
   ...
   LET v_s_mens_correo =  "ID Proceso   : ",g_pid,"\n",
                          "Proceso      : LIQUIDACIÓN DEVOLUCIÓN DE SALDOS EXCEDENTES ACREDITADOS\n",
...
FUNCTION fn_gen_reporte_liquida()
   ...
   -- se inicializan variables
   --LET v_c_programa_cod = "ACRL38" -- programa lanzador
