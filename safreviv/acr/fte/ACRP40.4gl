   ...
   DIALOG ATTRIBUTES (UNBUFFERED)
      ...
      ON ACTION ACCEPT
         ...
         IF (LENGTH(v_nss) <> 11) AND
            ...
            CALL fn_mensaje("Aviso","Cantidad de dígitos de NSS no es válido","stop")
         END IF
         ...
         IF (bnd_dato = 1) AND
            ...
            (v_cta_marca > 0) THEN
            CALL fn_mensaje("Aviso","No es posible desplegar información para NSS ingresado","stop")
            EXIT DIALOG
         END IF
         ...
         IF ( bnd_dato = 1) AND
            ...
            IF (v_valor_fondo IS NULL) OR
               ...
               CALL fn_mensaje("Aviso","No exíste precio de aiv para el día de hoy","stop")
            ELSE
