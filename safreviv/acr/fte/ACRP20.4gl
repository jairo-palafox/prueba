...
#                    control de archivos de Fondo Ahorro 72 del módulo  #
#                    de Transferencia de Aacreditados                   #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRP20.log")

   DISPLAY "=INICIA ACRP20="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_acr_ctr_arch_ahorro_72(?,?,?)"
...
FUNCTION fn_display(v_b_estatus_proc)
   ...
   CASE v_b_estatus_proc
      ...
      WHEN 8
         DISPLAY " ERROR: EL ARCHIVO NO CONTIENE DETALLE"
      WHEN 9
         DISPLAY " ERROR: EL TOTAL DE REGISTROS EN EL SUMARIO NO CORRESPONDE CON EL DETALLE"   
   END CASE
END FUNCTION
