...
#Objetivo: Programa que permite la validación del archivo de Solicitud Desmarca
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL41.log")
   ...
   LET v_c_programa_cod = "ACRL41" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRP25 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/ACRP25 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
