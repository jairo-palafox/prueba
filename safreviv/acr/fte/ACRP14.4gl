...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRP14.log")

   DISPLAY "=INICIA ACRP14="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_acr_ctr_arch_noaten(?,?,?)"

   PREPARE prp_procd_ins_cre_ctr_arch FROM v_s_qryTxt
   EXECUTE prp_procd_ins_cre_ctr_arch USING p_v_arch_proceso,
                                            v_i_estado,
                                            p_v_usuario 
