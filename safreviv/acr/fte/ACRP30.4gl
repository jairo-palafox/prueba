...
MAIN
   ...
   DEFINE v_c_programa_cod      LIKE bat_ctr_operacion.programa_cod -- nombre del programa origen
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRP30.log")

   DISPLAY "=INICIA ACRP30="
   DISPLAY " USUARIO       : ",p_v_usuario
   DISPLAY " PID           : ",p_d_pid
   DISPLAY " FOLIO         : ",p_d_folio USING "#########&"
   DISPLAY " ARCHIVO       : ",p_v_arch_proceso
   DISPLAY " CONCILIACIÓN DE CONFIRMACIÓN DE DEV. DE SDOS. EXC. ACR"
   ...
   LET v_s_qryTxt = " SELECT UNIQUE folio_archivo\n",
                    "   FROM safre_tmp:tmp_deudor_conf_devol_saldo"
   ...
   IF fgl_report_loadCurrentSettings("ACRP301.4rp") THEN  -- if  the file loaded OK
   ...
   LET v_d_pid_arch = fn_max_pid(g_proc_cod_acr_conf_dse, 2)
   ...
   LET v_s_qryTxt = " SELECT *\n",
                    ...
                    "    AND proceso_cod = ",g_proc_cod_acr_conf_dse,"\n",
                    "    AND opera_cod = 2\n",
   ...
   LET v_s_qryTxt = " SELECT NVL(SUM(num_aplic_interes92 / 1000000),0),\n",
                    "        NVL(SUM(saldo_vivienda92 / 100),0)\n",
                    "   FROM safre_tmp:tmp_confirmacion_saldos"

   PREPARE con_pagCredTradAfore92_Rech FROM v_s_qryTxt
   EXECUTE con_pagCredTradAfore92_Rech INTO v_r_pago_cred_trad_afo.aivs92_afore, v_r_pago_cred_trad_afo.pesos92_afore
   ...
   LET v_s_titulo_correo = "Proceso: CONCILIACIÓN CONFIRMACIÓN DEVOLUCIÓN DE SALDOS EXCEDENTES ACREDITADOS"
   ...
   LET v_s_mens_correo =  "ID Proceso   : ",p_d_pid,"\n",
                          "Proceso      : DEVOLUCIÓN DE SALDOS EXCEDENTES\n",
