...
#                    del archivo de saldos a la tabla temporal     #
...
MAIN
   DEFINE p_v_nom_prog VARCHAR(30), -- nombre del programa
          ...
          --v_i_tot_registros INTEGER, -- numero de registros procesados en el archivo
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL12.log")
      ...
      --                                       v_v_nom_archivo, p_v_usuario)
               ...
               --ELSE 
                DISPLAY " NO ENTRA A VALIDA SALDOS"
                  ...
                  --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRP12 ",
                  LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/ACRP12 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
