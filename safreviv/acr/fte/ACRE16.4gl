...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRE16.log")

   DISPLAY "=INICIA ACRE16="
   ...
   LET v_s_qryTxt = "EXECUTE PROCEDURE fn_dse_integra_devsdos_acr(?,?,?,?)"
   ...
   --LET v_v_nom_reporte = p_v_usuario CLIPPED, "-", "ACRL32" CLIPPED, "-", p_d_pid USING "&&&&&", "-", p_i_proceso_cod USING "&&&&&", "-", p_i_opera_cod USING "&&&&&"
   ...
   IF NOT r_b_existe_err THEN
      ...
      LET v_s_mens_correo =  "ID Proceso   : ",p_d_pid,"\n",
                             ...
                             "Operación    : INTEGRA DEVOLUCIÓN SALDOS EXC ACR\n",
                             "Fecha Inicio : ",TODAY,"\n",
                             "Fecha Fin    : ",TODAY
...
FUNCTION f_genera_rpt_IntegraDSE(p_c_ruta_listados, p_v_nom_reporte)
   ...
   DEFINE v_tot_acept_viv92      DECIMAL(15,2)
   DEFINE v_tot_acept_viv97      DECIMAL(15,2)
   ...
   LET v_tot_acept_viv97 = 0
   LET v_tot_acept_viv92 = 0
   LET v_tot_rech_viv97  = 0
   LET v_tot_rech_viv92  = 0

   -- se indica que el reporte usara la plantilla creada
   IF fgl_report_loadCurrentSettings("ACRE161.4rp") THEN
   ...
   PREPARE prp_no_catalog FROM v_s_qryTxt
   EXECUTE prp_no_catalog INTO v_r_dse_ctr_arch.tot_rechazados
   ...
   LET v_s_qryTxt = "SELECT SUM(saldo_vivienda97) / 100,
                            SUM(saldo_vivienda92) / 100
                       FROM safre_tmp:tmp_dse_devolucion"

   PREPARE prp_totales_acept FROM v_s_qryTxt
   EXECUTE prp_totales_acept INTO v_tot_acept_viv97,
                                  v_tot_acept_viv92
   ...
   DISPLAY " ***   ACEPTADOS   ***"
   DISPLAY " MONTO TOTAL DE VIVIENDA 97 : ", v_tot_acept_viv97
   DISPLAY " MONTO TOTAL DE VIVIENDA 92 : ", v_tot_acept_viv92
   DISPLAY "\n ***   RECHAZADOS   ***"
   DISPLAY " MONTO TOTAL DE VIVIENDA 97 : ", v_tot_rech_viv97
   DISPLAY " MONTO TOTAL DE VIVIENDA 92 : ", v_tot_rech_viv92

   -- inicia el reporte de registros con rechazo
   START REPORT reporte_integra_dse TO XML HANDLER v_manejador_rpt

   -- salida del reporte
   OUTPUT TO REPORT reporte_integra_dse(v_r_rpt_res.*,v_tot_acept_viv97,v_tot_acept_viv92,v_tot_rech_viv97,v_tot_rech_viv92)
...
REPORT reporte_integra_dse(p_r_res,p_tot_viv97,p_tot_viv92,p_tot_rech_viv97,p_tot_rech_viv92)
