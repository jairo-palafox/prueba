...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL32.log")
   ...
   LET v_i_operacion = 15 -- operacion del proceso
   LET v_d_folio = 0
   LET v_c_programa_cod = "ACRL32"
   ...
   OPEN WINDOW w_integra_arch_dse WITH FORM "ACRL321"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRE16 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
