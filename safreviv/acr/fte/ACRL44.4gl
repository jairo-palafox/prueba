...
#                    del archivo devolucion fondo de ahorro 72     #
#Autor             =>Daniel Buendia, EFP                           #
#Fecha inicio      =>26 de junio del 2012                          #
####################################################################
...
#Objetivo:
#  Menu principal de Archivos entrada fondo de ahorro 72.
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL44.log")
   ...
   LET v_i_opera_cod = 1 -- valida archivo fondo de ahorro
   LET v_d_folio = 0
   LET p_b_tipo_carga = 2
   LET v_v_nom_archivo = NULL
   LET v_c_programa_cod = "ACRL44"
   ...
   IF r_b_valida = 0 THEN
      ...
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/ACRP20 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
