...
#                   de Rechazo de Devolución de Saldos                  #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRP23.log")

   DISPLAY "=INICIA ACRP23="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_dse_ctr_arch_rchdevsdos(?,?,?,?)"
