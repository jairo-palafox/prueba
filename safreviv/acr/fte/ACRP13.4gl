...
#                    control, para el módulo de Devoluciones            #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRP13.log")

   DISPLAY "=INICIA ACRP13="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_acr_ctr_arch_devoluc(?,?,?)"
