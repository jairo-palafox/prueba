...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRS11.log")

   DISPLAY "=INICIA ACRS11="
   ...
   IF fgl_report_loadCurrentSettings("ACRS111.4rp") THEN  -- if  the file loaded OK
   ...
   LET v_s_qryTxt = " SELECT padre.id_derechohabiente,\n",
                    ...
                    "           AND movimiento IN (482,132,572,582)\n",
                    "         GROUP BY 1,2) v92\n",
                    ...
                    "    AND padre.movimiento IN (482,132,572,582)\n",
   ...
   DISPLAY "SALDO DEUDOR SAR 92: ",v_total_deudor92
   DISPLAY "SALDO DEUDOR SAR 97: ",v_total_deudor97

   OUTPUT TO REPORT reporte_archivo_salida(p_v_usuario, p_d_folio, p_v_arch_proceso, v_total_deudor92,v_total_deudor97, v_i_cont_reg_det)
   ...
   LET v_nom_fin = "A_cred_ta." || v_c_extension
   ...
   LET v_ejecuta_sh = "\n sh /opt/Interpel/Scripts/A_cred_ta.sh"
   RUN v_ejecuta_sh
...
FUNCTION fn_Obt_Nss_Credito_Trab(p_id_derechohabiente, p_d_folio_liq)
   ...
   DEFINE p_d_folio_liq        LIKE glo_ctr_archivo.folio -- numero de folio de liquidación
...
REPORT reporte_archivo_salida(p_v_usuario, p_d_folio, p_v_arch_proceso, p_total_deudor92, p_total_deudor97, p_count_reg)
   ...
   DEFINE p_total_deudor92       LIKE cta_movimiento.monto_pesos
   DEFINE p_total_deudor97       LIKE cta_movimiento.monto_pesos
