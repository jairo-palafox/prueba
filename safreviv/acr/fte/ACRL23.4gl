...
MAIN
   DEFINE p_v_usuario         LIKE seg_usuario.usuario,-- usuario firmado al sistema
          ...
          v_s_mensaje         STRING, -- se asigna un mensaje que será presentado al usuario
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL23.log")
   ...
   OPEN WINDOW w_integra_arch_recurr WITH FORM "ACRL231"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRE10 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
