...
#Modulo            =>ACR                                                #
#Programa          =>ACRR13                                             #
#Objetivo          =>Programa lanzado que ejecuta el reverso de la      #
#                    validación e Integración del proceso seleccionado  #
#                    por el usuario (la opción viene como parámetro)    #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRR13.log")

   DISPLAY "=INICIA ACRR13="
   ...
   CASE p_c_op_arch_ent
      WHEN "opt1" -- Devolución de Saldos
         DISPLAY " OPCIÓN        : ",p_c_op_arch_ent, " DEVOLUCIÓN DE SALDOS"
         LET v_i_proceso_cod_rev = g_proc_cod_acr_dse
         LET v_i_opera_cod_rev = 2
      WHEN "opt2" -- Recepción Rechazo Devolución
         DISPLAY " OPCIÓN        : ",p_c_op_arch_ent, " RECEPCIÓN RECHAZO DEVOLUCIÓN"
         LET v_i_proceso_cod_rev = g_proc_cod_acr_rech_dse
         LET v_i_opera_cod_rev = 2
      WHEN "opt3" -- Recepción Confirmación Devolución
         DISPLAY " OPCIÓN        : ",p_c_op_arch_ent, " RECEPCIÓN CONFIRMACIÓN DEVOLUCIÓN"
         LET v_i_proceso_cod_rev = g_proc_cod_acr_conf_dse
         LET v_i_opera_cod_rev = 2
      WHEN "opt8" -- Recepción Fondo de Ahorro 72
         DISPLAY " OPCIÓN        : ",p_c_op_arch_ent, " RECEPCIÓN FONDO DE AHORRO 72"
         LET v_i_proceso_cod_rev = g_proc_cod_acr_fondo72
         LET v_i_opera_cod_rev = 2
      OTHERWISE -- En otro caso
         DISPLAY " OPCIÓN        : ",p_c_op_arch_ent, " NO RECONOCIDA"
