...
#                para la Devolución de Saldos Excedentes                       #
...
MAIN
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".ACRL38.log")
   ...
   LET g_proceso_cod = g_proc_cod_acr_liquida_dse -- liquidación
