...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL11.log")
   ...
   LET v_c_programa_cod = "ACRL11" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --IF r_b_valida = 0 THEN
         ...
         --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRP11 ",
         LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/ACRP11 ",
                           p_v_usuario, " ",
                           v_d_pid, " ",
                           v_i_proceso_cod, " ",
                           v_i_opera_cod, " ",
