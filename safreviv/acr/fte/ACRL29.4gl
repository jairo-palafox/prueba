...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL29.log")
   ...
   LET m_i_proceso_cod = g_proc_cod_acr_reverso -- reverso transferencia acreditados
   LET m_i_opera_cod = 1 -- reverso transferencia acreditados
   LET m_c_programa_cod = "ACRL29"
   LET m_i_tpo_originacion = 1 -- Transferencia de acreditados
   LET v_d_pid = 0
   LET v_d_folio = 0
   ...
   CALL fn_rutas("acr") RETURNING m_c_ruta_bin, m_c_ruta_listados
   ...
   OPEN WINDOW w_reverso WITH FORM "ACRL291"
...
FUNCTION fn_reversa_arch_entrada(p_c_op_arch_ent)
   ...
   OPEN WINDOW w_arch_entrada WITH FORM "ACRL292"
      ...
      ON ACTION ACCEPT
         ...
         IF r_b_valida = 0 THEN
            ...
            IF r_b_valida = 0 THEN
               ...
               LET v_s_comando = " nohup time fglrun ",m_c_ruta_bin CLIPPED,"/ACRR10 ",
                                                       p_v_usuario, " ",
                                                       v_d_pid, " ",
                                                       m_i_proceso_cod, " ",
                                                       m_i_opera_cod, " ",
...
FUNCTION fn_valida_ext_archivo(p_c_op_arch_ent, p_c_nom_archivo)
   ...
   CASE p_c_op_arch_ent
      ...
      WHEN "opt4" -- Solicitudes Devueltas
         LET v_i_proceso_cod = g_proc_cod_acr_devol_solic -- recepciÓn devoluciÓn solicitudes acr
      ...
      WHEN "opt6" -- Solicitudes de Desmarca
         LET v_i_proceso_cod = g_proc_cod_acr_solic_desmarca -- solicitud desmarca acreditados
...
FUNCTION fn_reversa_transacciones(p_c_op_arch_tran)
   ...
   OPEN WINDOW w_arch_transaccion WITH FORM "ACRL294"
      ...
      ON ACTION ACCEPT
         ...
         IF r_b_valida = 0 THEN
            ...
            IF r_b_valida = 0 THEN
               ...
               LET v_s_comando = " nohup time fglrun ",m_c_ruta_bin CLIPPED,"/ACRR11 ",
                                                       p_v_usuario, " ",
                                                       v_d_pid, " ",
                                                       m_i_proceso_cod, " ",
                                                       m_i_opera_cod, " ",
...
FUNCTION fn_reversa_arch_salida()
   ...
   OPEN WINDOW w_arch_salida WITH FORM "ACRL293"
   -- se deplega el nombre del proceso a reversar en el grupo
   LET v_ui_ventana = ui.Window.getCurrent()
   LET v_ui_forma = v_ui_ventana.getForm()
   CALL v_ui_forma.setElementText("grevent",v_nom_grupo)
            ...
            ON ACTION ACCEPT
               ...
               IF r_b_valida = 0 THEN
                  ...
                  IF r_b_valida = 0 THEN
                     ...
                     LET v_s_comando = " nohup time fglrun ",m_c_ruta_bin CLIPPED,"/ACRR12 ",
                                                             p_v_usuario, " ",
                                                             v_d_pid, " ",
                                                             m_i_proceso_cod, " ",
                                                             m_i_opera_cod, " ",
...
FUNCTION fn_valida_preliquidacion(p_d_folio)
   ...
   PREPARE prp_count_acrPreliquida FROM v_s_qryTxt
   EXECUTE prp_count_acrPreliquida INTO v_i_cta_reg
