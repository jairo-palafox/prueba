...
#                    control de archivos correspondiente al módulo de   #
#                    saldos transferidos                                #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".ACRP12.log")

   DISPLAY "=INICIA ACRP12="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_insrt_acr_ctr_arch_sdotrans(?,?,?)"
