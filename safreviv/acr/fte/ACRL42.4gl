...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".ACRL42.log")
   ...
   OPEN WINDOW w_integra_arch_desmar WITH FORM "ACRL231"
            ...
            # La función de integración los detecta y los rechaza 23/11/2012
{
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/ACRE15 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
