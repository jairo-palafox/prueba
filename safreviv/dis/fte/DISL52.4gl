################################################################################
#Version                    => 1.0.0                                           #
#Fecha ultima modificacion  => 11/02/2016                                      #
################################################################################
################################################################################
...
#Modulo            => DIS                                                      #
#Programa          => DISL52                                                   #
#Objetivo          => Programa lanzador para validar archivos de Aportaciones  #
#                     Subsecuentes Sin Conciliar                               #
#Fecha inicio      => 11/02/2016                                               #
################################################################################
DATABASE safre_viv
...
MAIN
  ...
  IF (fn_valida_operacion(g_pid, g_proceso_cod, g_opera_cod) = 0 ) THEN
     ...
     CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 3, "DISL52",
                           "", v_usuario, FALSE)
