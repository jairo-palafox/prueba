...
#Modulo       => DIS                                                           #
#Programa     => DISR08                                                        #
#Objetivo     => Realizar el reverso de la carga del archivo de rechazo de     #
#                diferencias de avances de pago                                #
#Fecha inicio => 13/09/2012                                                    #
################################################################################
DATABASE safre_viv
GLOBALS 
DEFINE 
...
DEFINE 
  ...
  LET p_proceso_cod = 906 -- Código asignado al proceso 
  ...
  OPEN WINDOW vtn_AvancePagos WITH FORM "DISR081"
            ...
            ATTRIBUTES (ACCEPT = FALSE, CANCEL = FALSE)
              ...
              ON ACTION reverso
                 ...
                 IF v_respuesta = 1 THEN 
                    ...
                    LET v_s_mensaje = "Se ha enviado el Reverso del Rechazo por Diferencias de Avance de Pagos con el pid: ",
                                      p_pid CLIPPED,
...
DEFINE 
  ...
  LET v_qry_txt = "\n SELECT folio, f_presentacion",
                  ...
                  "\n WHERE  estado = 300"  --Buscamos el estado de rechazo de diferencias válido
...
FUNCTION fn_consulta_diferencias()
  DEFINE 
    v_query                  STRING,
  ...
  --Obtenemos aceptados
  SELECT COUNT(*) aceptados
  INTO   v_total_aceptados
  FROM   dse_devolucion   
  WHERE  folio_referencia = v_edit_Folio
