...
MAIN
  ...
  DEFINE arr_det_crt         DYNAMIC ARRAY OF RECORD
    r_tot_imp_apo_aiv        DECIMAL(12,2),--LIKE dis_ctr_ap_subsecuente.tot_imp_apo_pat,
    r_tot_imp_apo_pat        DECIMAL(12,2),--LIKE dis_ctr_ap_subsecuente.tot_imp_apo_pat,
    r_tot_imp_amo_cred       DECIMAL(12,2),--LIKE dis_ctr_ap_subsecuente.tot_imp_amo_cred
    r_folio_det_ctr          DECIMAL(9,0)
  END RECORD
                             
  DEFINE r_tot_registros     INTEGER --LIKE dis_ctr_ap_subsecuente.tot_registros
  
  DEFINE arr_apo_sub         DYNAMIC ARRAY OF RECORD
    r_sum_apo_aiv_sub        DECIMAL(12,2),--LIKE dis_ap_subsecuente.imp_apo_pat,
    r_sum_apo_pat_sub        DECIMAL(12,2),--LIKE dis_ap_subsecuente.imp_apo_pat,
    r_sum_amo_cred_sub       DECIMAL(12,2),--LIKE dis_ap_subsecuente.imp_amo_cred
  ...
  OPEN WINDOW vtn_reverso_apo_sub WITH FORM "DISR051"   
      ...
      ON ACTION ACCEPT
         IF v_folio_carga_ap_sub IS NULL AND v_fecha_trans IS NULL THEN
            CALL fn_mensaje("ATENCIÓN",
                            ...
                            "about")
            NEXT FIELD v_folio_carga_ap_sub
         ELSE
         ...
         IF r_bandera = 0 THEN   
            ...
            IF r_bandera = 1 THEN
               ...
               LET l_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,
                               "/DISR051.42r ",p_usuario_cod," ",p_pid," ",
...
FUNCTION fn_consulta_cifras(p_folio, p_fecha)
  ...
  DISPLAY "pa ver que esta mal>>", v_QryTxt
