...
MAIN 
   ...
   IF  v_folio <> 0 THEN
      ...
      AND ((di.edo_compensa_apo =2 AND av.monto_dif_apo*(-1) >2)
      OR   (di.edo_compensa_amo =2 AND av.monto_dif_amo*(-1) >2))
      --Se multiplica por -1 para hacer positivas las diferencias negativas
   ...
   LET v_nom_archivo = "/esp_abono_avance_hs_mdt"
   #LET v_nom_archivo = "/abono_avance_hs"
   LET v_ddmmaaaa = TODAY USING "ddmmyyyy"
   LET v_busca_nom_archivo = "esp_abono_avance_hs_mdt" || v_ddmmaaaa
   ...
   FOREACH cur_consulta INTO v_folio,
                     ...
                     LET v_cve_rechazo = "          " --10 blancos  
                      ...
                      --DISPLAY "monto dif apo: ",v_importe_apo2
                      --DISPLAY "monto dif amo: ",v_importe_amo2
...
FUNCTION fn_genera_copia_interface_abono(p_archivo_envio,p_ruta_destino)
    ...
    LET v_archivo_copia = "esp_abono_avance_hs_mdt"
