################################################################################
#Version                    => 1.0.1                                           #
#Fecha ultima modificacion  => 11/06/2014                                      #
################################################################################
################################################################################
...
#                     916 - Pagos por Avance                                   #
#Fecha inicio      => 11/06/2014                                               #
################################################################################
DATABASE safre_viv 
...
MAIN
  ...
  CALL STARTLOG (v_usurio CLIPPED|| ".DISL24.log")
...
FUNCTION fn_drgandrop_avancepago()
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL241"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN
               LET l_comando = "nohup fglrun ", 
                               v_ruta_ejecutable CLIPPED, "/DISE13.42r ",
                               v_usurio, " ",
                               v_max_pid, " ",
                               g_proceso_cod, " ",
                               g_opera_cod, " ",
