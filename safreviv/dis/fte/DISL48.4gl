...
MAIN
  ...
  CALL STARTLOG (v_usurio CLIPPED|| ".DISL48.log")
...
FUNCTION fn_drgandrop_avancepago()
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL481"
    DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION accept
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
             ...
             LET l_s_qryTxt = "\n SELECT tot_registros, tot_aplic_int_viv_apo, tot_imp_apo_pat,",
                              "\n        tot_imp_amo_cred",
             ...
             LET l_i_tot_aiv = l_i_tot_aiv/1000000
             ...
             LET l_arr_integrados[l_i_iter].tot_aivs           = l_i_tot_aiv
      ...
      ON ACTION integrar
         ...
         IF r_bandera = 0 THEN  
            ...
            CALL fn_actualiza_opera_ini(v_max_pid, g_proceso_cod, g_opera_cod, g_folio, "DISE23", l_v_arch_proceso, v_usurio)
            RETURNING r_b_valida
                                                
            IF r_b_valida = 0 THEN
               LET l_comando = "nohup fglrun ", v_ruta_ejecutable CLIPPED, "/DISE23.42r ",
                               v_usurio, " ",
                               v_max_pid, " ",
                               g_proceso_cod, " ",
                               g_opera_cod, " ",
