...
#Modulo       => DIS                                                           #
#Programa     => DISR091                                                       #
#Objetivo     => Programa que ejecuta el reverso del ajuste de avances         #
#                abiertos                                                      #
...
MAIN
   ...
   CALL fn_reversa_ajustes_avances_abiertos()
...
FUNCTION fn_reversa_ajustes_avances_abiertos()
   ...
   WHENEVER ERROR CONTINUE 
      LET v_QryTxt = "EXECUTE PROCEDURE sp_rev_dis_avances_pago_ajuste(?)"
   ...
   DISPLAY " ############################################ "
   DISPLAY "\n  El reverso del Ajuste de Avances Abiertos ha concluido satisfactoriamente.  "
