...
#                    histórico del proceso de Registro de Pagos o PAU para su  #
#                    Dispersión.                                               #
#Fecha de Inicio  => 22/12/2011                                                #
################################################################################
DATABASE safre_viv
...
MAIN 
  ...
  OPEN FORM vtn_ConsultaFolios FROM "DISL011"
    DISPLAY FORM vtn_ConsultaFolios
    --OPEN WINDOW lanz_dis_pre WITH FORM "DISL011"
                     ...
                     IF r_bandera = 1 THEN
                        ...
                        ELSE
                           ...
                           IF (fn_valida_operacion(p_pid, p_proceso_cod, p_opera_cod) = 0 ) THEN
                              ...
                              LET l_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,"/DISP01.42r ",
                                              v_folio_disp," ",
                                              v_cb_folio," ",
                                              v_proceso_cod_pagos," ",
                                              v_fecha_actualiza," ",
...
FUNCTION fn_llena_combo(p_fecha)               
  ...
  --Se agregan los procesos 101-Registro Pag en Aclara y 110-Carga Inicial Aclara
  --Se agrega el proceso 1403-Registro de Pagos Solo INFONAVIT
  LET v_QryTxt = "\n SELECT gf.folio,",
                 "\n        gf.folio||'-'||gc.nombre_archivo,",
                 "\n        gf.f_actualiza",
                 "\n FROM   glo_folio gf,glo_ctr_archivo gc",
                 "\n WHERE  gf.status = 2",
                 "\n AND    gf.proceso_cod IN (1401,1403,101,102,103,107,110)", 
