...
FUNCTION fn_drgandrop_avancepago()
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL031"
    DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         --Valida Operación
         --IF (fn_valida_operacion(v_max_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN --Actualiza Operación Inicial        
               ...
               LET v_s_mensaje = "Se ha enviado la integración de avances de pago con PID: ",
                                 v_max_pid CLIPPED,
                                 ".\nPuede revisar el avance del proceso en el monitor de ejecución de procesos"
               CALL fn_mensaje("Integración",v_s_mensaje,"information")
            END IF --Actualiza Operación
            --Envia mensaje con la descripcin del Error
