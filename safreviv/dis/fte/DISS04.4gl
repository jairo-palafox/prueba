...
FUNCTION fn_crea_interface_liquidacion()
  ...
  LET v_nom_archivo       = "/cargo_avance_hs_"
  LET v_ddmmaaaa          = TODAY USING "ddmmyyyy"
  LET v_busca_nom_archivo = "cargo_avance_hs_" || v_ddmmaaaa
...
FUNCTION fn_crea_interface_cancelacion()
  ...
  --Se crea el nombre del archivo y posteriormente se concatena con la ruta
  LET v_nom_archivo       = "/cargo_avance_hs_can"
  LET v_busca_nom_archivo = "cargo_avance_hs_can"
...
FUNCTION fn_genera_copia_interface_dif(p_archivo_envio,p_ruta_destino)
  ...
  LET v_archivo_copia = "cargo_avance_hs"
