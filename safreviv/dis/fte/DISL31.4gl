...
MAIN
  ...
  CALL STARTLOG (v_usuario CLIPPED|| ".DISL31.log")
  ...
  CALL fn_drgandrop_disp_cartera()
   
END MAIN

FUNCTION fn_drgandrop_disp_cartera()
  DEFINE 
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL311"
    DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION accept
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
             ...
             LET l_s_qryTxt = "\n SELECT COUNT(dis_cart.nss) ",
                              --"\n        SUM(ava.ava_aportacion), ",
                              --"\n        SUM(ava.ava_amortizacion) ",
                              "\n FROM   safre_tmp:tmp_ext_dis_cart1 dis_cart"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN
               LET l_comando = "nohup fglrun ", 
                               v_ruta_ejecutable CLIPPED, "/DISE16.42r ",
                               v_usuario, " ",
                               v_max_pid, " ",
                               g_proceso_cod, " ",
                               g_opera_cod, " ",
