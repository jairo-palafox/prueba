...
#Modulo       => DIS                                                           #
#Programa     => DISR281                                                       #
#Objetivo     => Programa de Reverso de la liquidación de cancelación parcial  #
#                de avances de pago.                                           #
...
MAIN
  ...
  IF (NUM_ARGS() > 0)THEN
     ...
     CALL STARTLOG(g_usuario_cod CLIPPED||".DISR281.log")
     CALL fn_reverso()
  END IF
END MAIN
...
FUNCTION fn_reverso()
  ...
  DISPLAY ""
  DISPLAY ("##############################################################")
  DISPLAY "Inicio del Reverso de Liquidación Cancelación Parcial Avances de Pago"
  ...
  IF r_sql_code = 0 THEN
     ...
     DISPLAY "Reverso de Liquidación de Cancelación Parcial Avances de Pago Finalizado"
     DISPLAY ""
     DISPLAY ("##############################################################")
  ELSE
     DISPLAY ("##############################################################")
