...
#                de avances de pago por aclaraciones patronales                #
...
DEFINE 
  ...
  LET p_proceso_cod = 937 --Código asignado al proceso 
  ...
  OPEN WINDOW vtn_AvancePagos WITH FORM "DISR251"
              ...
              ON ACTION reverso
                 ...
                 IF v_respuesta = 1 THEN 
                    ...
                    IF r_bnd_cnt = 0 THEN --Si el registro contable no manda error entonces
                       ...
                       LET v_s_mensaje = "Se ha enviado el Reverso de la Cancelación de Avance de Pagos por Aclaraciones Patronales con el pid: ",
                                         p_pid CLIPPED,
