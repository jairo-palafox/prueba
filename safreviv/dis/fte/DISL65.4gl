################################################################################
#Version                    => 1.0.0                                           #
#Fecha ultima modificacion  => 28/05/2018                                      #
################################################################################
################################################################################
...
#Modulo            => DIS                                                      #
#Programa          => DISL65                                                   #
#Objetivo          => Programa lanzador para la integración de Cancelación     #
...
DEFINE 
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL651"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN --Actualiza Operación Inicial
               LET l_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,
                               "/DISE28.42r ",v_usuario," ",v_max_pid," ",
               ...
               LET v_s_mensaje = "Se ha enviado la integración de la Cancelación de Avances de Pago por Aclaraciones Patronales con PID: ",
                                 v_max_pid CLIPPED,
