...
#                     por Depuración (Avance de Pagos)                         #
...
DEFINE 
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL101"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN --Actualiza Operación Inicial
               LET l_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,
                               "/DISE09.42r ",v_usuario," ",v_max_pid," ",
               ...
               LET v_s_mensaje = "Se ha enviado la integración de la Cancelación por Depuración (Avances de Pago) con PID: ",
                                 v_max_pid CLIPPED,
