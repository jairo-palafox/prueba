...
#Modulo            => DIS                                                      #
#Programa          => DISL20                                                   #
#Objetivo          => Generación de la interface de pagos abiertos con pagos   #
#                     por cubrir (Masivo)                                      #
#Fecha inicio      => 29/04/2014                                               #
################################################################################
DATABASE safre_viv
GLOBALS
  DEFINE 
...
MAIN 
  ...
  LET g_proceso_cod = 913 --Avance con pago (Masivo)
  ...
  OPEN WINDOW DISL201 WITH FORM "DISL201"
...
FUNCTION fn_envia_operacion(p_folio,p_usuario)
  ...
  IF ( v_bandera = 0 ) THEN
     ...
     IF ( v_bandera = 0 ) THEN
        ...
        LET v_comando = "nohup fglrun ",v_ruta_origen CLIPPED,"/DISS26.42r ",
                        p_usuario CLIPPED, " ",
                        g_pid            , " ",
                        g_proceso_cod    , " ",
                        g_opera_cod      , " ",
