...
#Modulo       => DIS                                                           #
#Programa     => DISR071                                                       #
#Objetivo     => Programa que ejecuta el reverso de la cancelación por         #
#                depuración (Avances de pago) en batch                         #
...
FUNCTION fn_reversa_cancelacion_avance_pagos()
  ...
  DISPLAY " ############################################ "
  DISPLAY "\n  El reverso de la Cancelación por Depuración (Avance de Pagos) ha concluido satisfactoriamente.  "
