...
#                    información del último folio liquidado del histórico del  #
        ...
        ON ACTION accept
           ...
           IF (v_de_Fecha IS NOT NULL AND v_cb_folio IS NULL) THEN 
              ...
              ELSE
                ...
                CALL fn_llena_combo(v_de_Fecha) RETURNING v_cb_folio,     --Aquí me quede!!
                                                          v_fecha_actualiza, 
                                                          v_ind_llena_cb
             ...
             ATTRIBUTES (ACCEPT = FALSE, CANCEL = FALSE)
               ...
               AFTER DISPLAY 
                 ...
                 ON ACTION preliquidar
                    ...
                    CALL fn_ventana_confirma("APORTACIONES SUBSECUENTES SIN CONCILIAR", "¿Desea ejecutar la preliquidación?", "quest")
                    RETURNING r_bandera
                    ...
                    IF r_bandera = 1 THEN
                       ...
                       IF r_count_folio >= 1 THEN 
                          ...
                          END IF 
                       ELSE
                         -- Si se acepta la ejecución se recuperá el PID del proceso                         
                    ...
                    ELSE 
                      ...
                      CALL fn_mensaje("APORTACIONES SUBSECUENTES SIN CONCILIAR", "Se ha cancelado la preliquidación", "information")                     
                      CLEAR FORM
                      EXIT INPUT                     
                    END IF 
             END DISPLAY
...
#Objetivo: Genera el ComboBox para la preliquidación de aportaciones subsecuentes sin conciliar
