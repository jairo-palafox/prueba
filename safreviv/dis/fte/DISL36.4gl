...
#                     924 - Dispersión de Número de Crédito                    #
...
MAIN
  ...
  CALL STARTLOG (v_usuario CLIPPED|| ".DISL36.log")
  ...
  CALL fn_drgandrop_disp_nc()
   
END MAIN

FUNCTION fn_drgandrop_disp_nc()
  DEFINE 
  ...
  OPEN WINDOW w_inte_nc WITH FORM "DISL311"
      ...
      ON ACTION accept
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
             ...
             LET l_s_qryTxt = "\n SELECT COUNT(num_credito) ",                                                        
                              "\n FROM   safre_tmp:tmp_ext_dis_x_nc1"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN
               LET l_comando = "nohup fglrun ", 
                               v_ruta_ejecutable CLIPPED, "/DISE19.42r ",
                               v_usuario, " ",
                               v_max_pid, " ",
                               g_proceso_cod, " ",
                               g_opera_cod, " ",
