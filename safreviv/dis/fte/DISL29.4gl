...
MAIN
  ...
  CALL STARTLOG (v_usuario CLIPPED||".DISL29.log")
  ...
  --CALL fn_genera_folio_dis(g_proceso_cod, g_opera_cod, 0, "OPSISSACI")
  --RETURNING g_folio
                         
  DISPLAY "g_folio", g_folio
  CALL fn_drgandrop_avancepago_cred_cero()
   
END MAIN

FUNCTION fn_drgandrop_avancepago_cred_cero()
  DEFINE 
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL291"
    DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION accept
         ...
         FOR l_i_iter = 1 TO l_i_num_arch
             ...
             LET l_s_qryTxt = "\n SELECT COUNT(cred_c.nss) ",
                              --"\n        SUM(ava.ava_aportacion), ",
                              --"\n        SUM(ava.ava_amortizacion) ",
                              "\n FROM   safre_tmp:tmp_dis_cred_cero1 cred_c"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN
               LET l_comando = "nohup fglrun ", 
                               v_ruta_ejecutable CLIPPED, "/DISE15.42r ",
                               v_usuario, " ",
                               v_max_pid, " ",
                               g_proceso_cod, " ",
                               g_opera_cod, " ",
