#############################################################################
#Módulo          => DIS                                                     #
#Programa        => DISR031.4gl                                             #
#Objetivo        => Programa de Reverso Liquidacion de Dispersion           #
...
FUNCTION fn_reverso()
   ...
   DISPLAY ""
   DISPLAY ("##############################################################")
   DISPLAY "Inicio del Reverso de Liquidación de Dispersión"
   ...
   IF r_sql_code = 0 THEN
      ...
      DISPLAY "Reverso de Liquidación de Dispersión Finalizado"
      DISPLAY ""
      DISPLAY ("##############################################################")
   ELSE
      DISPLAY ("##############################################################")
