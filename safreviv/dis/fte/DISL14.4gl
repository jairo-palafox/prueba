...
#Modulo            => DIS                                                      #
#Programa          => DISL14                                                   #
#Objetivo          => Programa lanzador para la integración de los ajustes     #
#                     de Avance de Pagos                                       #
#Fecha inicio      => 19/12/2012                                               #
################################################################################
DATABASE safre_viv
GLOBALS
...
DEFINE v_tipo_proceso        SMALLINT,   --Forma como ejecutara el programa 
  ...
  CALL fn_drgandrop_ajuste_avancepago()
  
END MAIN

#Objetico: Función que permite seleccionar y arrastrar el archivo a integrar
FUNCTION fn_drgandrop_ajuste_avancepago()
DEFINE 
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL141"
    DIALOG ATTRIBUTE(UNBUFFERED)
      ...
      ON ACTION integrar
         ...
         IF r_bandera = 0 THEN  
            CALL fn_actualiza_opera_ini(v_max_pid,g_proceso_cod,g_opera_cod,g_folio,"DISE03",l_v_arch_proceso,v_usuario)
            RETURNING r_b_valida
                                                
            IF r_b_valida = 0 THEN --Actualiza Operación Inicial           
               LET l_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,
                               "/DISE11.42r ",v_usuario," ",v_max_pid," ",
               ...
               LET v_s_mensaje = "Se ha enviado la integración de los ajustes de Avances de Pago con PID: ",
                                  v_max_pid CLIPPED,
