...
#Modulo            => DIS                                                      #
#Programa          => DISL08                                                   #
#Objetivo          => Programa lanzador para integrar archivos de rechazo      #
...
DEFINE l_arr_arch_pend       DYNAMIC ARRAY OF VARCHAR(100), --Archivos pendientes 
       ...
       l_arr_integrados      DYNAMIC ARRAY OF RECORD        --Detalle archivos a integrar
         ...
         f_presenta          DATE,
         tot_apo             DECIMAL(12,2),
         tot_amo             DECIMAL(12,2),
  ...
  OPEN WINDOW w_inte_acred WITH FORM "DISL081"
         ...
         IF r_bandera = 0 THEN  
            ...
            IF r_b_valida = 0 THEN --Actualiza Operación Inicial
               LET l_comando = "nohup fglrun ",v_ruta_ejecutable CLIPPED,
                               "/DISE08.42r ",v_usuario," ",v_max_pid," ",
               ...
               {LET l_comando = "fglrun ",v_ruta_ejecutable CLIPPED,
                                "/DISE08.42r ",v_usuario," ",v_max_pid," ",
                               g_proceso_cod," ",g_opera_cod," ",g_folio," ",
                               l_v_arch_proceso}
