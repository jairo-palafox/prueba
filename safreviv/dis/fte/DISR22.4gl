...
MAIN
  ...
  OPEN WINDOW vtn_prel_disp WITH FORM "DISR221"
    DIALOG ATTRIBUTES(UNBUFFERED) 
      ...
      ON ACTION reverso
         ...
         CALL fn_ventana_confirma("Aportaciones Subsecuentes Sin Conciliar", 
         ...
         IF r_respuesta = 1 THEN
            ...
            LET v_QryTxt = " nohup time fglrun ",v_seg_modulo.ruta_bin CLIPPED,"/DISR221.42r ",
