...
#                    recuperar la información del último folio liquidado del   #
#                    histórico del proceso de Aportaciones Subsecuentes        #
#                    (Sin Adelanto) para su Dispersión.                        #
...
MAIN 
  ...
  LET v_de_Fecha    = ""
  LET p_proceso_cod = 932 --Código del Proceso de Aportaciones Subsecuentes Sin Adelanto 932)
              ...
              ATTRIBUTES (ACCEPT = FALSE, CANCEL = FALSE)
                AFTER DISPLAY 
                  ...
                  ON ACTION preliquidar
                     ...
                     CALL fn_ventana_confirma("APORTACIONES SUBSECUENTES", "¿Desea ejecutar la preliquidación?", "quest")
                     RETURNING r_bandera
                     ...
                     IF r_bandera = 1 THEN
                        ...
                        ELSE
                           ...
                           IF (fn_valida_operacion(p_pid, p_proceso_cod, p_opera_cod) = 0 ) THEN
                              ...
                              DISPLAY "El folio a enviar de preliquidación de aportaciones subsecuentes es: ", v_cb_folio
                     ...
                     ELSE 
                        ...
                        CALL fn_mensaje("APORTACIONES SUBSECUENTES", "Se ha cancelado la preliquidación", "information")                     
                        CLEAR FORM
                        EXIT INPUT                     
                     END IF 
              END DISPLAY
...
#Objetivo: Genera el ComboBox para la preliquidación de aportaciones subsecuentes
