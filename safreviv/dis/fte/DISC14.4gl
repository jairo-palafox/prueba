...
FUNCTION fn_consulta_inconsistencias(f_folio, f_nss)
  ...
  -- Valida si se capturo el folio de dispersión 
  IF f_folio IS NOT NULL THEN
...
FUNCTION fn_genera_archivo_inconsistencias(v_folio, v_nss)
  ...
  LET v_encabezado = " NSS |NOMBRE COMPLETO |NÚMERO DE CRÉDITO |FOLIO DISPERSIÓN |FOLIO PAGOS |NRP |FECHA PAGO |PERIODO PAGO |FOLIO SUA |AIVS |MONTO APORTACIÓN |MONTO AMORTIZACIÓN|"
  CALL v_ch_arch_salida.write([v_encabezado])
