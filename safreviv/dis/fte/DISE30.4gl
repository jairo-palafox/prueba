...
#                     actualización indicador adelanto liquidación del proceso #
#                     de dispersión de pagos.                                  #
...
MAIN
  ...
  DISPLAY "Inicia integración del archivo de actualización indicador adelanto liquidación del proceso de dispersión de pagos. ", TIME
  DISPLAY ""
 
  --Ejecuta StoreProcedure para llevar a cabo la actualización
  ...
  DISPLAY ""
  DISPLAY "Finalizó integración del archivo de actualización indicador adelanto liquidación del proceso de dispersión de pagos. ", TIME
  DISPLAY ""
  ...
  IF r_b_valida <> 0 THEN
     ...
     CALL fn_desplega_inc_operacion(r_bnd_oera_error)
  ELSE
     DISPLAY "Inicia la generación del reporte de actualización indicador adelanto liquidación del proceso de dispersión de pagos. ", TIME
     DISPLAY ""
     CALL fn_genera_reporte_act_ind()
     DISPLAY ""
     DISPLAY "Finalizó la generación del reporte de actualización indicador adelanto liquidación del proceso de dispersión de pagos. ", TIME
     DISPLAY ""
     ...
     DISPLAY "\n ############### GENERACIÓN ARCHIVO ###############"
     DISPLAY "Inicia la generación del archivo de actualización indicador adelanto liquidación del proceso de dispersión de pagos. ", TIME
     DISPLAY ""
     CALL fn_genera_arh_aidis()
     DISPLAY ""
     DISPLAY "Finalizó la generación del archivo de actualización indicador adelanto liquidación del proceso de dispersión de pagos. ", TIME
     DISPLAY ""
  ...
  CALL fn_correo_proceso(l_pid,
                         ...
                         g_opera_cod,
                         'adjunto?',
                         'Integración de Actualización Indicador Adelanto Liquidación DIS',
                         'ID Proceso   : '||l_pid||
...
--Genera el reporte de los datos que fueron procesados en la Actualización Indicador Ade Liq DIS
FUNCTION fn_genera_reporte_act_ind()
  ...
  DISPLAY "\n ############### INTEGRACIÓN ACTUALIZACIÓN INDICADOR ADELANTO (DIS) ###############"
...
--Reporte de la actualización indicador adelanto (DIS)
...
FUNCTION fn_genera_arh_aidis()
  ...
  DISPLAY "Se ha generado el archivo de Actualización Indicador Adelanto Liquidación DIS\n     en la ruta ",v_ruta_nomarch
