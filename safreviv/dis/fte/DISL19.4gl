...
#Modulo       => DIS                                                           #
#Programa     => DISL19                                                        #
#Objetivo     => Programa de captura de criterios para enviar a generar las    #
#                interfaces del proceso contingente de los créditos MTC's      #
...
MAIN
  ...
  LET g_proceso_cod = 911 -- dispersion
  LET g_opera_cod   = 1 -- 
  LET p_operacion   = 2 -- 
    ...
    INPUT BY NAME v_folio ATTRIBUTES(WITHOUT DEFAULTS, UNBUFFERED)
      ...
      ON ACTION ACCEPT
         IF v_folio IS NULL THEN
            CALL fn_ventana_confirma("Error", "Debe capturar un folio para generar las interfaces", "information")
...
FUNCTION fn_envia_operacion(p_folio,p_usuario)
  ...
  IF ( v_bandera = 0 ) THEN
     ...
     IF ( v_bandera = 0 ) THEN
        ...
        LET v_comando = "nohup fglrun ",v_ruta_origen CLIPPED,"/DISS22.42r ",
                        p_usuario CLIPPED, " ",
                        g_pid            , " ",
                        g_proceso_cod    , " ",
                        g_opera_cod      , " ",
        ...
        CALL fn_mensaje("Atención","Se ha enviado a generar las interfaces.\nPuede revisar el avance del proceso en el monitor de ejecución de procesos","")
     ELSE
        ...
        LET v_comando = "No se puede iniciar la operación. No se ha enviado el proceso de generación de interfaces.\nError: ", v_desc_salida CLIPPED
