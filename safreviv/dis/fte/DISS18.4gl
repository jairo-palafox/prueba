...
MAIN 
   ...
   --IF p_proceso_cod = 901 THEN --Si viene de liquidación generamos la interfaz con dis_compensa_avance 
...
FUNCTION fn_crea_interface_liquidacion_esp()
   ...
   IF  v_folio <> 0 THEN
      ...
      AND ((di.edo_compensa_apo = 1 AND av.monto_dif_apo >2)
      OR   (di.edo_compensa_amo = 1 AND av.monto_dif_amo >2))
   ...
   LET v_nom_archivo = "/esp_cargo_avance_hs_mdt"

   LET v_ddmmaaaa = TODAY USING "ddmmyyyy"
   LET v_busca_nom_archivo = "esp_cargo_avance_hs_mdt" || v_ddmmaaaa
   ...
   FOREACH cur_consulta INTO v_folio,
                     ...
                     --Se obtiene valor absoluto de amortizaciones
                     ...
                     LET v_cve_rechazo = "          " --10 blancos 
                      ...
                      --Escribe en archivo tipo de registro 2
                        --DISPLAY "v_edo_compensa_apo> ",v_edo_compensa_apo
                        --DISPLAY "c_importe_apo2: ",c_importe_apo2
                        --DISPLAY "v_edo_compensa_amo> ",v_edo_compensa_amo
...
FUNCTION fn_genera_copia_interface_dif(p_archivo_envio,p_ruta_destino)
    ...
    LET v_archivo_copia = "esp_cargo_avance_hs_mdt"
