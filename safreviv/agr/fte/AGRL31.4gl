...
#                preliquidacion de DSE para el módulo de Anualidades G.  #
...
DEFINE g_pid           LIKE bat_ctr_proceso.pid, --  ID del proceso
       ...
       g_arr_arbol_pre         DYNAMIC ARRAY OF RECORD
...
DEFINE p_usuario_cod        LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
       ...
       v_folio              LIKE deo_preliquida.folio_liquida, -- folio de liquidación
       ...
       v_num_regs           INTEGER, -- número de registros encontrados
       v_ban_salir          SMALLINT, -- bandera que indica si el usuario salió
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".AGRL31.log")

   -- se asigna proceso y operacion
   LET g_proceso_cod  = g_proc_cod_agr_liquida_dse -- liquidación devolución saldos exc agr
   LET g_opera_cod    = 1 -- preliquida devolución de saldos
   LET v_c_tpo_transf = "43" -- 43-Anualidades Garantizadas
...
FUNCTION fn_dse_ejecuta_preliquidacion(p_folio, p_usuario_cod)
   ...
   IF ( v_b_resultado = 0 ) THEN
      ...
      CALL fn_inicializa_proceso(g_pid, g_proceso_cod, g_opera_cod,
                                 p_folio, "AGRL31", v_nombre_archivo, p_usuario_cod)
                                 RETURNING v_b_resultado
      ...
      LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/AGRP21 ",
...
FUNCTION fn_folio_preliquidar(p_usuario, p_proceso_cod, p_opera_cod, p_folio, p_c_tpo_transferencia)
   DEFINE p_usuario              CHAR(20),
          ...
          p_folio                DECIMAL(9,0),          
          p_c_tpo_transferencia  LIKE dse_agrupa_devolucion.tpo_transferencia, -- tipo de transferencia
          i                      SMALLINT,
          v_folio                DECIMAL(9,0),   
   ...
   DIALOG ATTRIBUTES(UNBUFFERED)
      ...
      ATTRIBUTES(APPEND ROW = FALSE, INSERT ROW = FALSE, DELETE ROW = FALSE, AUTO APPEND= FALSE)
         ...
         BEFORE ROW
            ...
            CALL fn_llena_arbol_montos_pre(p_folio, p_c_tpo_transferencia)
...
FUNCTION fn_llena_arbol_montos_pre(p_folio, p_c_tpo_transferencia)
   ...
   DEFINE j              INTEGER
   DEFINE k              INTEGER
   DEFINE v_i_indice     INTEGER -- indice del arbol
   ...
   v_d_monto_pesos    DECIMAL(28,6),
   v_d_monto_aivs     DECIMAL(28,6),
   v_d_monto_aivs92   DECIMAL(28,6),
   v_d_monto_aivs97   DECIMAL(28,6)
   ...
   -- se obtiene el precio de accion
   SELECT precio_fondo
   ...
   -- se valida las acciones obtenidas
