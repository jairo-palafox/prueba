...
#                    control de archivos para el proceso de Recurrente  #
#                    marca y desmarca Anualidades Garantizadas          #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP27.log")

   DISPLAY "=INICIA AGRP27="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_agr_insrt_ctr_arch_marca_desmarca(?,?,?)"
