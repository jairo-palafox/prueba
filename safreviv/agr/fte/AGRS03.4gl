...
#                    liquidación que entra como parámetro            #
...
#                     Generación de archivos de cargo a capital      #
...
MAIN
   ...
   DEFINE v_c_f_liquida_aux         CHAR(8) -- fecha auxiliar de presentacion con formato YYYYMMDD
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRS03.log")

   DISPLAY "=INICIA AGRS03="
   ...
   --LET p_v_arch_proceso = "A" || v_c_f_liquida_aux || ".cca"
   ...
   LET v_r_reg_inicial.fec_archivo  = v_c_f_liquida_aux
   ...
   LET v_r_encabezado.f_genera_archivo = v_c_f_liquida_aux
   ...
   FOREACH cur_tmp_liquidaDeudor INTO v_id_cre_acreditado, v_sum_mto_pesos
      ...
      LET v_r_detalle.fec_pago              = v_c_f_liquida_aux
   ...
   LET v_nom_fin = "A_cap_ag." || v_c_extension
   ...
   --LET v_ejecuta_sh = "\n sh /opt/Interpel/Scripts/A_cap_ag.sh"
   --RUN v_ejecuta_sh
   ...
   IF fgl_report_loadCurrentSettings("AGRS031.4rp") THEN  -- if  the file loaded OK
