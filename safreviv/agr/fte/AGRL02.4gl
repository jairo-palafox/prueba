...
#                    archivo de entrada Recurrente para el módulo  #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL02.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_recurrente -- recepción recurrente originación ag
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRE01 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
