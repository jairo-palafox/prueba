...
#                    de Uso de Garantía de Estados y Municipios    #
...
MAIN
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_liq_gtia_ed_mc -- liquidación de uso garantía estado y municipio
   LET v_i_opera_cod = 1 -- preliquidación estado y municipio
   LET v_d_pid = 0
   ...
   IF v_cuenta_accion = 0 THEN
      LET v_s_mensaje = "No es posible realizar la preliquidación, ya que no hay precios\n",
   ...
   IF r_b_valida = 0 THEN
      -- se crea el comando que ejecuta la preliquidación de Uso Gtía Edo Mcpio
