...
#                de DSE para el módulo de Anualidades Garantizadas             #
...
MAIN
   DEFINE p_usuario_cod              LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
          ...
          p_operacion                SMALLINT, -- operacion del proceso
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".AGRL32.log")
   ...
   LET g_opera_cod   = 2 -- liquida devolución de saldos agr
   ...
   LET v_c_programa_cod = "AGRL32"
   LET v_c_tpo_transferencia = 43 -- 43-Anualidades Garantizadas
