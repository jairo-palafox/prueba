...
#                    archivo de entrada Confirmación DSE para el   #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL28.log")
   ...
   LET v_i_opera_cod = 2 -- integra confirmación devolución sdo exc agr
   LET v_i_opera_cod_ant = 1 -- Valida Rechazo Saldos
   LET v_c_tpo_transf = "39" -- Confirmación de DSE AGR
   LET v_d_folio = 0
   LET v_c_programa_cod = "AGRL28"
   ...
   OPEN WINDOW w_integra_arch_confdse WITH FORM "AGRL241"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRE10 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
