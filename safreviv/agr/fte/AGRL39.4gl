...
#                    archivo Solicitud de Saldo AGR                #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL39.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_solic_devol -- recepción solicitud devolucion agr
   LET v_i_opera_cod = 1 -- Valida solicitud devolucion
   LET v_d_folio = 0 -- para la carga no se envia folio
   LET p_b_tipo_carga = 2
   LET v_v_nom_archivo = NULL
   LET v_c_programa_cod = "AGRL39" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      LET v_s_comando = " fglrun ",v_c_ruta_bin CLIPPED,"/AGRP28 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
