...
#Modulo       => AGR                                                           #
#Programa     => AGRL18                                                        #
#Objetivo     => Programa que ejecuta la función general de la liquidacion     #
#                para el módulo de Anualidades Garantizadas                    #
#Fecha inicio => Mayo 25, 2012                                                 #
...
MAIN
   DEFINE p_usuario_cod              LIKE seg_usuario.usuario_cod, -- clave del usuario firmado
          ...
          v_marca_entra              SMALLINT, --marca de liquidado
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".AGRL18.log")
   ...
   LET g_opera_cod           = 2 -- liquida saldo
   ...
   LET v_marca_entra         = 221 --marca para Anualidades
