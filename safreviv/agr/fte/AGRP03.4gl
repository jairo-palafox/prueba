...
#                    control de archivos para Rechazo de Saldos AGR     #
#Autor             =>Daniel Buendia, EFP                                #
#Fecha inicio      =>18 Marzo 2012                                      #
#########################################################################
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP03.log")

   DISPLAY "=INICIA AGRP03="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_agr_insrt_ctr_arch_rchsdo(?,?,?)"
