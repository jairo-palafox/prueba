...
#Modulo            => AGR                                            #
#Programa          => AGRL17                                         #
#Objetivo          => Programa que realiza la preliquidación para    #
#                     el módulo de Anualidades Garantizadas          #
#Autor             => Daniel Buendia, EFP                            #
#Fecha inicio      => 11 Mayo 2012                                   #
#Modificación      => Mauro Muñiz Caballero                          #
#Fecha modifación  => 26 de agosto de 2015                           #
#                     Preliquidación de ministraciones               #
...
MAIN
   ...
   -- se asignan los parámetros recibidos
   ...
   LET v_i_proceso_cod       = g_proc_cod_agr_liquidacion -- liquidación anualidad garantizada
   ...
   DISPLAY "Fecha presentación archivo op09: ", v_f_liq USING "DD/MM/YYYY"

   LET v_f_liq = MDY(MONTH(v_f_liq),1,YEAR(v_f_liq)) + 1 UNITS MONTH

   DISPLAY "Fecha liquidación proyectada   : ", v_f_liq USING "DD/MM/YYYY"
   ...
   IF v_cuenta_accion = 0 THEN
      LET v_s_mensaje = "No es posible realizar la preliquidación ya que no\n",
                        "hay precios de aiv para el día "||v_f_liq USING "dd-mm-yyyy"
   ...
   LET v_s_qryTxt = " SELECT COUNT(cre.id_cre_acreditado)\n",
                    ...
                    --"    AND edo_procesar = 120\n",  ---PRODINFXV-106 eliminación de adelantos
                    "    AND edo_procesar IN(120,7)\n",  ---PRODINFXV-106 eliminación de adelantos y solo infonavit
...
{
   -- se obtiene la subcuenta y descripción para las subcuentas requeridas (4,8,42,44,49,55)
