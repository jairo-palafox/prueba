...
#Objetivo:
#  Menú principal de archivos entrada recurrente del módulo de Acreditados.
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL01.log")
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/AGRP01 ",
      LET v_s_comando = " fglrun ",v_c_ruta_bin CLIPPED,"/AGRP01 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
