...
#                    archivo de entrada Devoluciones de Saldos     #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL24.log")
   ...
   LET v_i_opera_cod = 2 -- integra devolución saldos agr
   LET v_i_opera_cod_ant = 1 -- Valida Rechazo Saldos agr
   LET v_c_tpo_transf = "43" -- Anualidades Garantizadas
   LET v_d_folio = 0
   LET v_c_programa_cod = "AGRL24"
   ...
   OPEN WINDOW w_integra_arch_dse WITH FORM "AGRL241"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRE08 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
