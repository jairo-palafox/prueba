...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL19.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_conciliacion -- conciliación anualidad garantizada
   LET v_i_opera_cod = 1 -- conciliación agr
   LET v_d_pid = 0
   LET v_d_folio = 0
   LET v_v_nom_archivo = "N/A"
   LET v_c_programa_cod = "AGRL19"
   ...
   OPEN WINDOW w_genera_conciliacion WITH FORM "AGRL191"
      ...
      ON ACTION ACCEPT
         ...
         IF r_b_valida = 0 THEN
            ...
            IF r_b_valida = 0 THEN
               ...
               LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/"

               CASE v_cmb_operacion
                  WHEN "01" -- Rechazo de saldos
                     LET v_s_comando = v_s_comando,"AGRP04 "

                  WHEN "06" -- Devolución solicitada
                     LET v_s_comando = v_s_comando,"AGRP08 "

                  WHEN "09" -- Saldos transferidos
                     LET v_s_comando = v_s_comando,"AGRP06 "

                  WHEN "14" -- Solicitud no atendida
                     LET v_s_comando = v_s_comando,"AGRP10 "
...
DEFINE v_v_nombre_combo VARCHAR(20),   -- nombre del combobox
   ...
   CALL cb.addItem("06","06 - Devolución solicitada")
