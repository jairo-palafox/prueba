...
#                    de salida de Solicitud de Devolucion del      #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRR06.log")

   DISPLAY "=INICIA AGRR06="
   ...
   LET v_c_tpo_transf = "43" -- Devolución de Saldos Excedentes AGR
