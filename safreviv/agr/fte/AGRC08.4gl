...
#Fecha inicio       => 3 de octubre de 2012                          #
...
MAIN
   ...
   CALL STARTLOG(g_usuario_cod CLIPPED|| ".AGRC08.log")
...
FUNCTION fn_consulta_derechohabiente()
   ...
   OPEN WINDOW w_op_derechohab WITH FORM "AGRC084"
   ...
   IF v_cta_nombre = 0 THEN
      CALL fn_mensaje(g_aviso,"No existe información del derechohabiente","stop")
   ...
   IF v_cta_nombre > 1 THEN
      ...
      IF v_cta_reg = 0 THEN 
         CALL fn_mensaje(g_aviso,"No existe información de créditos para el derechohabiente","stop")
   ...
   ELSE
      ...
      IF v_cta_reg = 0 THEN 
         CALL fn_mensaje(g_aviso,"No existe información para el derechohabiente","stop")
...
FUNCTION fn_selec_derechohabiente(p_s_condicion)
   ...
   OPEN WINDOW w_list_derechohabiente WITH FORM "AGRC085"
...
--DISPLAY "edo proc : ", v_edo_procesar
   ...
   OPEN WINDOW w_des_derechohab WITH FORM "AGRC086"
      LET w = ui.Window.getCurrent()
      LET f_w = w.getForm()
      ...
      DIALOG ATTRIBUTES (FIELD ORDER FORM, UNBUFFERED)
         ...
         ON ACTION reporte
            ...
            IF fgl_report_loadCurrentSettings("AGRC082.4rp") THEN 
               CALL fgl_report_selectDevice("PDF") 

               LET v_nom_reporte = g_usuario_cod CLIPPED || "-AGRC08-","00000","-","00000","-","00000"
               ...
               CALL fn_mensaje(g_aviso,"Se ha generado el reporte por derechohabiente","info") 
            ELSE
...
#          como parámetro, el usuario debe seleccionar uno para continuar con la consulta
FUNCTION fn_selecciona_credito(p_id_derechohabiente)
   ...
   OPEN WINDOW w_list_derechohabiente WITH FORM "AGRC087" 
