...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP11.log")

   DISPLAY "=INICIA AGRP11="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_agr_insrt_ctr_arch_desmarca(?,?,?)"
...
FUNCTION fn_finaliza_procesos()
   ...
   DEFINE v_i_opera_cod    LIKE cat_operacion.opera_cod -- código de la operación
