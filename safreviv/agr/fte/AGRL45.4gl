...
#Modulo            =>AGR                                           #
#Programa          =>AGRL45                                        #
#Objetivo          =>Programa que permite la selección del archivo #
#                    de Uso de Garantía Estados y Municipios a     #
#                    integrar                                      #
...
MAIN
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_gtia_edo_mcpio -- Recepción uso gtÍa edos y mcpios
   LET v_i_opera_cod = 2 -- integra uso gtÍa edos y mcpios
   LET v_i_opera_cod_ant = 1 -- Valida uso gtÍa edos y mcpios
