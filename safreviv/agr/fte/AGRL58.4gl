...
#                de consulta masiva de saldos y marcas procesar     #
#                    de Anualidades Garantizadas                    #
#Autor        => Jose Eduardo Ventura                               #
#Fecha inicio => 14 JUNIO de 2016                                   #
#####################################################################
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL58.log")
   ...
   OPEN WINDOW w_integra_arch_cred_liq WITH FORM "AGRL581"
         ...
         ON ACTION ACCEPT
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               LET v_s_qryTxt = " SELECT COUNT(*)
                                    FROM safre_tmp:tmp_cons_mca_prcr "
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRE16 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
