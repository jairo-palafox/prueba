...
#                    transferidos del módulo Anualidades Garantizadas   #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP05.log")

   DISPLAY "=INICIA AGRP05="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_agr_insrt_ctr_arch_sdotrans(?,?,?)"
