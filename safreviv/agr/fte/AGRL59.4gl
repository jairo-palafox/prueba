...
#Módulo       => AGR                                                                  #
#Programa     => AGRLL57                                                              #
#Objetivo     => Valida archivo para homologación de creditos y marcas procesar       # 
#Autor        => José Eduardo Ventura                                                 #
#Fecha inicio => 05 de Agosto de 2016                                                  #
#######################################################################################
...
MAIN
   ...
   IF ( v_rest_valida = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid, g_proceso_cod, g_opera_cod, 2, "AGRL59",
