...
#                    archivo de entrada Solicitud de Saldo AGR     #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL40.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_solic_devol -- recepción solicitud de saldo ag
   LET v_i_opera_cod = 2 -- integra solicitud de saldo
   LET v_i_opera_cod_ant = 1 -- Valida solicitud de saldo
   LET v_i_operacion = 24 -- operacion del proceso (24 - solicitud de saldo)
   LET v_si_id_proceso = g_id_proceso_agr -- Anualidades Garantizadas
   LET v_d_folio = 0
   LET v_c_programa_cod = "AGRL40"
   ...
   OPEN WINDOW w_integra_arch_solic_sdo WITH FORM "AGRL021"
      DIALOG ATTRIBUTE(UNBUFFERED)
         ...
         BEFORE DIALOG
            -- se ocultan el boton de integración
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               LET v_s_qryTxt = " SELECT *\n",
                ...
                IF v_r_cre_ctr_arch.id_cre_ctr_archivo IS NULL THEN
                   CALL fn_mensaje("Integración","El archivo está marcado como Rechazado, no se puede continuar\ncon la integración del archivo","stop")
                   CONTINUE DIALOG
                END IF
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/AGRE12 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
