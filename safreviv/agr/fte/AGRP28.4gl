...
#                    control de archivos para el proceso de Soliciud    #
#                    de Saldo AGR                                       #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP28.log")

   DISPLAY "=INICIA AGRP28="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_agr_insrt_ctr_arch_solicsdo(?,?,?)"
