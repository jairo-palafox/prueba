...
#                    control, para el módulo de Devoluciones AG         #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP07.log")

   DISPLAY "=INICIA AGRP07="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_agr_insrt_ctr_arch_devoluc(?,?,?)"
