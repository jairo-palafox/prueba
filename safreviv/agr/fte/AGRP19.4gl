...
#                    control correspondiente al proceso Valida archivo  #
#                    Confirmación DSE de Anualidades Garantizadas       #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP19.log")

   DISPLAY "=INICIA AGRP19="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_dse_insrt_ctrarch_confdse_agr(?,?,?,?)"
