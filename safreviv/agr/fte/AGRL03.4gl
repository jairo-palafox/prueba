...
#Objetivo: Programa que permite la validación y carga del archivo de Rechazo Saldos
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL03.log")
   ...
   LET v_c_programa_cod = "AGRL03" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/AGRP03 ",
      LET v_s_comando = " fglrun ",v_c_ruta_bin CLIPPED,"/AGRP03 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
