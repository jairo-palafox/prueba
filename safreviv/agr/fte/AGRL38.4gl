...
#                    archivo de entrada Marca y desmarca del       #
#                    módulo de Anualidades Garantizadas            #
#Autor             =>Daniel Buendia, EFP                           #
#Fecha inicio      =>21 Septiembre 2012                            #
####################################################################
...
#  del archivo de entrada Marca y Desmarca
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL38.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_recurr_marca -- recepción marca y desmarca
   LET v_i_opera_cod = 2 -- integra archivo marca y desmarca
   LET v_i_opera_cod_ant = 1  -- valida archivo marca y desmarca
   LET v_i_operacion = 23 -- operacion del proceso
   LET v_si_id_proceso = g_id_proceso_agr -- Anualidades Garantizadas
   LET v_d_folio = 0
   LET v_c_programa_cod = "AGRL38"
   ...
   OPEN WINDOW w_integra_arch_recurr WITH FORM "AGRL021"
            ...
            END IF
{
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRE11 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
