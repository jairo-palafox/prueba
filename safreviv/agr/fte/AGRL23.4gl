...
#Modulo            =>AGR                                                       #
#Programa          =>AGRL31                                                    #
#Objetivo          =>Programa que permite la validacion del archivo Devolución #
#                    de Saldos Excedentes para  el módulo de Anualidades       #
#                    Garantizadas                                              #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL31.log")
   ...
   LET v_c_programa_cod = "AGRL31"           -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/AGRP17 ",
                        p_v_usuario     , " ",
                        v_d_pid         , " ",
                        v_i_proceso_cod , " ",
                        v_i_opera_cod   , " ",
