...
#                    del archivo Uso Anualidad o Garantía para el  #
...
#Objetivo:
#  Menu principal de Archivos entrada Recurrente del modulo de Anualidades Garantizadas.
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL21.log")
   ...
   IF r_b_valida = 0 THEN
      ...
      --LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRP12 ",
      LET v_s_comando = " fglrun ",r_c_ruta_bin CLIPPED,"/AGRP12 ",
                        p_v_usuario, " ",
                        v_d_pid, " ",
                        v_i_proceso_cod, " ",
                        v_i_opera_cod, " ",
