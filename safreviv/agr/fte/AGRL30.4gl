...
#                agrupacion para DSE devoluciones para el módulo de       #
...
MAIN
   ...
   CALL STARTLOG (p_usuario_cod CLIPPED|| ".AGRL30.log")
   
   -- se asigna proceso y operacion
   LET g_proceso_cod = g_proc_cod_agr_agrupacion_dse -- agrupación registros con devolución agr
   LET g_opera_cod   = 1  --  agrupacion
   LET v_c_tpo_transf = "43"
   ...
   OPEN WINDOW w_agrupacion WITH FORM "AGRL301"
   MENU
      BEFORE MENU
         -- se obtienen los totales para DSE
         CALL fn_obt_agrup_modulo("agr", v_c_tpo_transf) RETURNING v_r_agrup.aivs97_dse, v_r_agrup.pesos97_dse, v_r_agrup.aivs92_dse, v_r_agrup.pesos92_dse
   ...
   CLOSE WINDOW w_agrupacion
{
   ...
   LET v_s_mensaje = "Confirme la ejecución del proceso de Agrupación de\n",
                     "Devolución de Saldos Excedentes AGR"
   ...
   EXECUTE prp_slc_rutaListadosBat2 INTO v_c_ruta_list_bat
{
   ...
   LET v_s_comando = " nohup time fglrun ",g_ruta_bin CLIPPED,"/AGRP20 ",
