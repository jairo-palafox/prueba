...
#                    control de archivos de Uso Anualidad o Garantía    #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP12.log")

   DISPLAY "=INICIA AGRP12="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_uso_insrt_ctr_arch_usoanual(?,?,?)"
