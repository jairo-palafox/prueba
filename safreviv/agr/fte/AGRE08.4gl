...
#                    devoluciones de saldo que ha sido validado            #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRE08.log")

   DISPLAY "=INICIA AGRE08="
   ...
   LET v_s_qryTxt = "EXECUTE PROCEDURE fn_dse_integra_devsdos_agr(?,?,?,?)"
   ...
   IF NOT r_b_existe_err THEN
      ...
      LET v_s_titulo_correo = "Proceso: RECEPCIÓN DEVOLUCIÓN SALDOS EXC ACR"
      ...
      LET v_s_mens_correo =  "ID Proceso   : ",p_d_pid,"\n",
                             "Proceso      : RECEPCIÓN DEVOLUCIÓN SALDOS EXC ACR\n",
                             "Operacion    : INTEGRA DEVOLUCIÓN SALDOS EXC ACR\n",
                             "Fecha Inicio : ",TODAY,"\n",
                             "Fecha Fin    : ",TODAY
...
FUNCTION f_genera_rpt_IntegraDSE(p_c_ruta_listados, p_v_nom_reporte)
   ...
   LET v_s_qryTxt = "SELECT SUM(num_aplic_interes97)/1000000,
                            SUM(num_aplic_interes92)/1000000
   ...
   LET v_s_qryTxt = "SELECT SUM(saldo_vivienda97)/1000000,
                            SUM(saldo_vivienda92)/1000000
                       FROM safre_tmp:tmp_nss_no_catalogados_agr"
   ...
   DISPLAY "\n ***   ACEPTADOS   ***"
   DISPLAY " MONTO TOTAL EN AIVS VIVIENDA 97 : ", v_tot_viv97
   DISPLAY " MONTO TOTAL EN AIVS VIVIENDA 92 : ", v_tot_viv92
   DISPLAY "\n ***   RECHAZADOS   ***"
   DISPLAY " MONTO TOTAL EN AIVS VIVIENDA 97 : ", v_tot_rech_viv97
   DISPLAY " MONTO TOTAL EN AIVS VIVIENDA 92 : ", v_tot_rech_viv92

   -- inicia el reporte de registros con rechazo
   START REPORT reporte_integra_dse TO XML HANDLER v_manejador_rpt

   -- salida del reporte
   OUTPUT TO REPORT reporte_integra_dse(v_r_rpt_res.*,v_tot_viv92,v_tot_viv97,v_tot_rech_viv92,v_tot_rech_viv97)
...
REPORT reporte_integra_dse(p_r_res,p_tot_viv92,p_tot_viv97,p_tot_rech_viv92,p_tot_rech_viv97)
   ...
   DEFINE p_tot_viv92       DECIMAL(15,2)
   DEFINE p_tot_rech_viv92  DECIMAL(15,2)
