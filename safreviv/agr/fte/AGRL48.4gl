...
#Modulo            =>AGR                                           #
#Programa          =>AGRL48                                        #
#Objetivo          =>Programa que permite lanzar la validación     #
...
DEFINE v_usurio          VARCHAR(30), -- Almacena al usuario
   ...
   IF (fn_valida_operacion(g_pid,g_proceso_cod,g_opera_cod) = 0 ) THEN
      ...
      CALL fn_carga_archivo(g_pid,g_proceso_cod,g_opera_cod,2,"AGRL48",
                            "NA",v_usurio,TRUE)RETURNING r_bnd_carga
