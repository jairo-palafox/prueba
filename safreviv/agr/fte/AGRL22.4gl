...
#                    archivo de entrada Uso Anualidad o Garantía   #
#                    para el módulo de Anualidades Garantizadas    #
#Autor             =>Daniel Buendia, EFP                           #
#Fecha inicio      =>23 Mayo 2012                                  #
####################################################################
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL22.log")
   ...
   LET v_i_operacion = 43 -- operacion del proceso
   LET v_si_id_proceso = g_id_proceso_agr -- Anualidades Garantizadas
   LET v_d_folio = 0
   LET v_c_programa_cod = "AGRL22"
         ...
         ON ACTION integrar
            ...
            FOR v_i_iter = 1 TO v_i_num_arch
               ...
               IF r_b_valida = 0 THEN
                  ...
                  LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRE07 ",
                                    p_v_usuario, " ",
                                    v_d_pid, " ",
                                    v_i_proceso_cod, " ",
                                    v_i_opera_cod, " ",
