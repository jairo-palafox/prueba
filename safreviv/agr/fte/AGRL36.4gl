...
#                    amortización fondo 72 para el módulo de AGR   #
...
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL36.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_arch_amort72 -- generación archivo amortización fondo72
   LET v_i_opera_cod = 1 -- genera archivo amortización fondo72 agr
   LET v_d_pid = 0
   ...
   OPEN WINDOW w_genera_archAmortizacion WITH FORM "AGRL361"
   ...
   ON ACTION ACCEPT
      ...
      END IF
         ...
         LET v_s_comando = " nohup time fglrun ",r_c_ruta_bin CLIPPED,"/AGRS06 ",
                                                 p_v_usuario, " ",
                                                 v_d_pid, " ",
                                                 v_i_proceso_cod, " ",
                                                 v_i_opera_cod, " ",
