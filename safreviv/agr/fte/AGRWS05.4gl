...
MAIN
   ...
   CALL CreateInformaCreditoEjercidoService() RETURNING servicio
...
FUNCTION CreateInformaCreditoEjercidoService()
  DEFINE service      com.WebService
  DEFINE operation    com.WebOperation

  TRY
    # Create Web Service
    LET service = com.WebService.CreateWebService("InformaCreditoEjercidoServices","http://services.safre.efp.com")

    # Publish Operation : informarCreditoEjercido
    LET operation = com.WebOperation.CreateDOCStyle("informarCreditoEjercido","informarCreditoEjercido",ns1informarCreditoEjercido,ns1informarCreditoEjercidoResponse)
...
FUNCTION informarCreditoEjercido()
   CALL fn_informar_credito_ejercido()
END FUNCTION