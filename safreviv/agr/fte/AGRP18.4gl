...
#                   control para el proceso Valida archivo Rechazo DSE  #
...
MAIN
   ...
   CALL STARTLOG(p_v_usuario CLIPPED|| ".AGRP18.log")

   DISPLAY "=INICIA AGRP18="
   ...
   LET v_s_qryTxt = "EXECUTE FUNCTION safre_viv:fn_dse_insrt_ctrarch_rchdse_agr(?,?,?,?)"
