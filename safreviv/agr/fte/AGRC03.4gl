...
#Modulo            =>AGR                                           #
#Programa          =>AGRC03                                        #
#Objetivo          =>Programa que realiza la consulta del proceso  #
#                    de Liquidación módulo AG                      #
...
MAIN
   ...
   CALL STARTLOG(p_usuario_cod CLIPPED|| ".AGRC03.log")
   ...
   LET g_proceso_cod = g_proc_cod_agr_liquidacion -- liquidacion de AGR
   LET g_opera_cod   = 2 -- operacion 2
...
FUNCTION fn_consulta_folios_liquida(p_usuario, p_proceso_cod, p_opera_cod)
   ...
   OPEN WINDOW vent_folios WITH FORM "AGRC031"
...
FUNCTION fn_folios_consulta_liquida(v_tabla, p_proceso_cod, p_opera_cod, p_usuario_cod)
   ...
   DEFINE r_c_ruta_listados  LIKE seg_modulo.ruta_listados -- ruta listados del
   DEFINE f_w                ui.form
   ...
   DIALOG ATTRIBUTES(UNBUFFERED)
      DISPLAY ARRAY arr_folios TO arr_folios.*
         BEFORE ROW
            ...
            CALL fn_llena_arbol_montos_agr(v_folio, v_tabla)
...
FUNCTION fn_llena_arbol_montos_agr(p_folio, v_tabla)
