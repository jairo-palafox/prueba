...
#                    archivo de Solicitudes no Atendidas de AG     #
...
#          atendidas mediante la funcion general de carga
MAIN
   ...
   CALL STARTLOG (p_v_usuario CLIPPED|| ".AGRL09.log")
   ...
   LET v_i_proceso_cod = g_proc_cod_agr_no_atendidas -- recepción solicitudes no atendidas ag
   ...
   LET v_c_programa_cod = "AGRL09" -- nombre del programa
   ...
   IF r_b_valida = 0 THEN
      ...
      --IF r_b_valida = 0 THEN
         ...
         --LET v_s_comando = " nohup time fglrun ",v_c_ruta_bin CLIPPED,"/AGRP09 ",
         LET v_s_comando = " fglrun ",v_c_ruta_bin CLIPPED,"/AGRP09 ",
                           p_v_usuario, " ",
                           v_d_pid, " ",
                           v_i_proceso_cod, " ",
                           v_i_opera_cod, " ",
